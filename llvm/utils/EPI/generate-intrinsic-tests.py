...
class SingleType(object):
    def __init__(self, value_type, llvm_type):
...
integer_type_i8 = SingleType("i8",  "i8")
integer_type_i16 = SingleType("i16",  "i16")
integer_type_i32 = SingleType("i32",  "i32")
integer_type_i64 = SingleType("i64",  "i64")
...
float_type_f32 = SingleType("f32", "float")
float_type_f64 = SingleType("f64", "double")
...
class BinaryIntrinsic(Intrinsic):
    pattern_vv = """
declare <vscale x 1 x ${llvm_result_type}> @llvm.epi.${intrinsic}.nxv1${value_result_type}.nxv1${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}>, <vscale x 1 x ${llvm_rhs_type}>);
...
; CHECK:       ${instruction}.${suffix} v0, v0, v0
  %a = call <vscale x 1 x  ${llvm_result_type}> @llvm.epi.${intrinsic}.nxv1${value_result_type}.nxv1${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}> undef, <vscale x 1 x ${llvm_rhs_type}> undef)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
"""
    pattern_vv_mask = """
declare <vscale x 1 x ${llvm_result_type}> @llvm.epi.${intrinsic}.mask.nxv1${value_result_type}.nxv1${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}>, <vscale x 1 x ${llvm_rhs_type}>, <vscale x 1 x i1>);
...
; CHECK:       ${instruction}.${suffix} v0, v0, v0, v0.t
  %a = call <vscale x 1 x  ${llvm_result_type}> @llvm.epi.${intrinsic}.mask.nxv1${value_result_type}.nxv1${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}> undef, <vscale x 1 x ${llvm_rhs_type}> undef, <vscale x 1 x i1> undef)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
"""
    pattern_vx = """
declare <vscale x 1 x ${llvm_result_type}> @llvm.epi.${intrinsic}.nxv1${value_result_type}.${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}>, ${llvm_rhs_type});
define void @intrinsic_${intrinsic}_${suffix}_${value_result_type}_${value_lhs_type}_${value_rhs_type}() nounwind {
entry:
; CHECK-LABEL: intrinsic_${intrinsic}_${suffix}_${value_result_type}_${value_lhs_type}_${value_rhs_type}
; CHECK:       ${instruction}.${suffix} v0, v0, ${scalar_register}
  %a = call <vscale x 1 x  ${llvm_result_type}> @llvm.epi.${intrinsic}.nxv1${value_result_type}.${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}> undef, ${llvm_rhs_type} undef)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
"""
    pattern_vx_mask = """
declare <vscale x 1 x ${llvm_result_type}> @llvm.epi.${intrinsic}.mask.nxv1${value_result_type}.${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}>, ${llvm_rhs_type}, <vscale x 1 x i1>);
define void @intrinsic_${intrinsic}_mask_${suffix}_${value_result_type}_${value_lhs_type}_${value_rhs_type}() nounwind {
entry:
; CHECK-LABEL: intrinsic_${intrinsic}_mask_${suffix}_${value_result_type}_${value_lhs_type}_${value_rhs_type}
; CHECK:       ${instruction}.${suffix} v0, v0, ${scalar_register}, v0.t
  %a = call <vscale x 1 x  ${llvm_result_type}> @llvm.epi.${intrinsic}.mask.nxv1${value_result_type}.${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}> undef, ${llvm_rhs_type} undef, <vscale x 1 x i1> undef)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
...
; CHECK:       ${instruction}.${suffix} v0, v0, 9
  %a = call <vscale x 1 x  ${llvm_result_type}> @llvm.epi.${intrinsic}.nxv1${value_result_type}.${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}> undef, ${llvm_rhs_type} 9)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
...
; CHECK:       ${instruction}.${suffix} v0, v0, 9, v0.t
  %a = call <vscale x 1 x  ${llvm_result_type}> @llvm.epi.${intrinsic}.mask.nxv1${value_result_type}.${value_rhs_type}(<vscale x 1 x ${llvm_lhs_type}> undef, ${llvm_rhs_type} 9, <vscale x 1 x i1> undef)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
...
#         BinaryIntrinsic("vwaddu", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
#         BinaryIntrinsic("vwadd", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
#
...
#
#         BinaryIntrinsic("vwsubu", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
#         BinaryIntrinsic("vwsub", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
#
...
#          BinaryIntrinsic("vwmul", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
#          BinaryIntrinsic("vwmulu", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
#          BinaryIntrinsic("vwmulsu", type_generator = generate_binary_integer_types_widened, variants = vv_vx),
...
#         BinaryIntrinsic("vnclip", type_generator = generate_binary_integer_types_narrowed, variants = vv_vx_vi),
         ...
         # BinaryIntrinsic("vfwadd", type_generator = generate_binary_float_types_widened, variants = vv_vf),
         # BinaryIntrinsic("vfwsub", type_generator = generate_binary_float_types_widened, variants = vv_vf),
...
#         BinaryIntrinsic("vfwmul", type_generator = generate_binary_float_types_widened, variants = vv_vf),
...
pattern_unary = """define void @intrinsic_${op}_${value_type}() nounwind {
entry:
; CHECK-LABEL: intrinsic_${op}_${value_type}:
; CHECK:       ${instr}.vv v0, v0
  %a = call <vscale x 1 x ${llvm_result_type}> @llvm.epi.${op}.${value_type}(<vscale x 1 x ${llvm_type}> undef)
  %p = bitcast i8* @scratch to <vscale x 1 x ${llvm_result_type}>*
  store <vscale x 1 x ${llvm_result_type}> %a, <vscale x 1 x ${llvm_result_type}>* %p
  ret void
}
declare <vscale x 1 x ${llvm_result_type}> @llvm.epi.${op}.${value_type}(<vscale x 1 x ${llvm_type}>);
"""
