...
; CHECK:       vsetvli {{.*}}, a0, ${sew}, ${vlmul}
; CHECK:       ${instruction}.${suffix} ${prepend_extra_ops}v0, ${scalar_register}
...
; CHECK:       vsetvli {{.*}}, a0, ${sew}, ${vlmul}
; CHECK:       ${instruction}.${suffix} ${prepend_extra_ops}v0, ${scalar_register}, v0.t
...
intrinsics = [
        ...
        BinaryIntrinsic("vseq", type_generator = generate_binary_integer_types_relational, variants = vv_vx_vi, instruction = "vmseq"),
        BinaryIntrinsic("vsne", type_generator = generate_binary_integer_types_relational, variants = vv_vx_vi, instruction = "vmsne"),
        BinaryIntrinsic("vsltu", type_generator = generate_binary_integer_types_relational, variants = vv_vx, instruction = "vmsltu"),
        BinaryIntrinsic("vslt", type_generator = generate_binary_integer_types_relational, variants = vv_vx, instruction = "vmslt"),
        BinaryIntrinsic("vsleu", type_generator = generate_binary_integer_types_relational, variants = vv_vx_vi, instruction = "vmsleu"),
        BinaryIntrinsic("vsle", type_generator = generate_binary_integer_types_relational, variants = vv_vx_vi, instruction = "vmsle"),
        BinaryIntrinsic("vsgtu", type_generator = generate_binary_integer_types_relational, variants = vv, instruction = "vmsltu"),
        BinaryIntrinsic("vsgtu", type_generator = generate_binary_integer_types_relational, variants = vx_vi, instruction = "vmsgtu"),
        BinaryIntrinsic("vsgt", type_generator = generate_binary_integer_types_relational, variants = vv, instruction = "vmslt"),
        BinaryIntrinsic("vsgt", type_generator = generate_binary_integer_types_relational, variants = vx_vi, instruction = "vmsgt"),
        ...
        BinaryIntrinsic("vfeq", type_generator = generate_binary_float_types_relational, variants = vv_vf, instruction = "vmfeq"),
        BinaryIntrinsic("vfne", type_generator = generate_binary_float_types_relational, variants = vv_vf, instruction = "vmfne"),
        BinaryIntrinsic("vflt", type_generator = generate_binary_float_types_relational, variants = vv_vf, instruction = "vmflt"),
        BinaryIntrinsic("vfle", type_generator = generate_binary_float_types_relational, variants = vv_vf, instruction = "vmfle"),
        BinaryIntrinsic("vfgt", type_generator = generate_binary_float_types_relational, variants = vv, instruction = "vmflt"),
        BinaryIntrinsic("vfgt", type_generator = generate_binary_float_types_relational, variants = vf, instruction = "vmfgt"),
        BinaryIntrinsic("vfge", type_generator = generate_binary_float_types_relational, variants = vv, instruction = "vmfle"),
        BinaryIntrinsic("vfge", type_generator = generate_binary_float_types_relational, variants = vf, instruction = "vmfge"),
        BinaryIntrinsic("vford", type_generator = generate_binary_float_types_relational, variants = vv_vf, instruction = "vmford"),
