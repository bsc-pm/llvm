...
; CHECK-NEXT:    vsll.vi v1, v16, 0
; CHECK-NEXT:    vsll.vi v1, v1, 31
; CHECK-NEXT:    addi a0, zero, -1
; CHECK-NEXT:    vsll.vx v1, v1, a0
; CHECK-NEXT:    addi a1, zero, 32
; CHECK-NEXT:    vsll.vx v1, v1, a1
; CHECK-NEXT:    vsrl.vi v1, v1, 0
; CHECK-NEXT:    vsrl.vi v1, v1, 31
; CHECK-NEXT:    vsrl.vx v1, v1, a0
; CHECK-NEXT:    vsrl.vx v1, v1, a1
; CHECK-NEXT:    vsra.vi v1, v1, 0
; CHECK-NEXT:    vsra.vi v1, v1, 31
; CHECK-NEXT:    vsra.vx v1, v1, a0
; CHECK-NEXT:    vsra.vx v1, v1, a1
; CHECK-NEXT:    vssrl.vi v1, v1, 0
; CHECK-NEXT:    vssrl.vi v1, v1, 31
; CHECK-NEXT:    vssrl.vx v1, v1, a0
; CHECK-NEXT:    vssrl.vx v1, v1, a1
; CHECK-NEXT:    vssra.vi v1, v1, 0
; CHECK-NEXT:    vssra.vi v1, v1, 31
; CHECK-NEXT:    vssra.vx v1, v1, a0
; CHECK-NEXT:    vssra.vx v1, v1, a1
; CHECK-NEXT:    vslideup.vi v2, v1, 0
; CHECK-NEXT:    vslideup.vi v1, v2, 31
; CHECK-NEXT:    vslideup.vx v2, v1, a0
; CHECK-NEXT:    vslideup.vx v1, v2, a1
; CHECK-NEXT:    vslidedown.vi v1, v1, 0
; CHECK-NEXT:    vslidedown.vi v1, v1, 31
; CHECK-NEXT:    vslidedown.vx v1, v1, a0
; CHECK-NEXT:    vslidedown.vx v1, v1, a1
; CHECK-NEXT:    vrgather.vi v2, v1, 0
; CHECK-NEXT:    vrgather.vi v1, v2, 31
; CHECK-NEXT:    vrgather.vx v2, v1, a0
; CHECK-NEXT:    vrgather.vx v16, v2, a1
; CHECK-NEXT:    ret
{
