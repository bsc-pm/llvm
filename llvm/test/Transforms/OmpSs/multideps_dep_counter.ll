...
; CHECK:       for.cond:
; CHECK-NEXT:    [[TMP9:%.*]] = call [[STRUCT__DEPEND_UNPACK_T_0]] @compute_dep.1(i32* [[I]], i32* [[J]], i64 0), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP10:%.*]] = extractvalue [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP9]], 2, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i32, i32* [[I]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP12:%.*]] = icmp sle i32 [[TMP11]], [[TMP10]], !dbg [[DBG13]]
; CHECK-NEXT:    br i1 [[TMP12]], label [[FOR_BODY:%.*]], label [[TMP23:%.*]], !dbg [[DBG13]]
; CHECK:       for.body:
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, i32* [[I]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    store i32 [[TMP13]], i32* [[I_REMAP]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    store i32 0, i32* [[J]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP14:%.*]] = call [[STRUCT__DEPEND_UNPACK_T_0]] @compute_dep.1(i32* [[I]], i32* [[J]], i64 1), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP15:%.*]] = extractvalue [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP14]], 4, !dbg [[DBG13]]
; CHECK-NEXT:    store i32 [[TMP15]], i32* [[J]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    br label [[FOR_COND1:%.*]], !dbg [[DBG13]]
; CHECK:       for.cond1:
; CHECK-NEXT:    [[TMP16:%.*]] = call [[STRUCT__DEPEND_UNPACK_T_0]] @compute_dep.1(i32* [[I]], i32* [[J]], i64 1), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP17:%.*]] = extractvalue [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP16]], 6, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP18:%.*]] = load i32, i32* [[J]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP19:%.*]] = icmp sle i32 [[TMP18]], [[TMP17]], !dbg [[DBG13]]
; CHECK-NEXT:    br i1 [[TMP19]], label [[FOR_BODY2:%.*]], label [[FOR_INCR:%.*]], !dbg [[DBG13]]
; CHECK:       for.body2:
; CHECK-NEXT:    [[TMP20:%.*]] = load i32, i32* [[J]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    store i32 [[TMP20]], i32* [[J_REMAP]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP21:%.*]] = load i64, i64* [[NUM_DEPS]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP22:%.*]] = add i64 [[TMP21]], 1, !dbg [[DBG13]]
; CHECK-NEXT:    store i64 [[TMP22]], i64* [[NUM_DEPS]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    br label [[FOR_INCR3:%.*]], !dbg [[DBG13]]
; CHECK:       23:
; CHECK-NEXT:    [[TMP24:%.*]] = load i64, i64* [[NUM_DEPS]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_main0, %nanos6_task_invocation_info_t* @task_invocation_info_main0, i64 16, i8** [[TMP3]], i8** [[TMP2]], i64 0, i64 [[TMP24]]), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP25:%.*]] = load %nanos6_task_args_main0*, %nanos6_task_args_main0** [[TMP1]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP26:%.*]] = bitcast %nanos6_task_args_main0* [[TMP25]] to i8*, !dbg [[DBG13]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP26]], i64 16, !dbg [[DBG13]]
; CHECK-NEXT:    [[GEP_ARRAY:%.*]] = getelementptr [[NANOS6_TASK_ARGS_MAIN0:%.*]], %nanos6_task_args_main0* [[TMP25]], i32 0, i32 0, !dbg [[DBG13]]
; CHECK-NEXT:    store [10 x i32]* [[ARRAY]], [10 x i32]** [[GEP_ARRAY]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP27:%.*]] = load i8*, i8** [[TMP2]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP27]]), !dbg [[DBG13]]
...
; CHECK:       final.cond:
; CHECK-NEXT:    [[TMP28:%.*]] = call i32 @nanos6_in_final(), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP29:%.*]] = icmp ne i32 [[TMP28]], 0, !dbg [[DBG13]]
; CHECK-NEXT:    br i1 [[TMP29]], label [[FINAL_THEN:%.*]], label [[CODEREPL:%.*]], !dbg [[DBG13]]
; CHECK:       for.incr:
; CHECK-NEXT:    [[TMP30:%.*]] = call [[STRUCT__DEPEND_UNPACK_T_0]] @compute_dep.1(i32* [[I]], i32* [[J]], i64 0), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP31:%.*]] = extractvalue [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP30]], 3, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP32:%.*]] = load i32, i32* [[I]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP33:%.*]] = add i32 [[TMP32]], [[TMP31]], !dbg [[DBG13]]
; CHECK-NEXT:    store i32 [[TMP33]], i32* [[I]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    br label [[FOR_COND]], !dbg [[DBG13]]
; CHECK:       for.incr3:
; CHECK-NEXT:    [[TMP34:%.*]] = call [[STRUCT__DEPEND_UNPACK_T_0]] @compute_dep.1(i32* [[I]], i32* [[J]], i64 1), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP35:%.*]] = extractvalue [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP34]], 7, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP36:%.*]] = load i32, i32* [[J]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP37:%.*]] = add i32 [[TMP36]], [[TMP35]], !dbg [[DBG13]]
; CHECK-NEXT:    store i32 [[TMP37]], i32* [[J]], align 4, !dbg [[DBG13]]
; CHECK-NEXT:    br label [[FOR_COND1]], !dbg [[DBG13]]
;
entry:
