...
; CHECK-NEXT:    [[NUM_DEPS25:%.*]] = alloca i64, align 8, !dbg [[DBG13]]
...
; CHECK-NEXT:    call void @nanos6_create_loop(ptr @task_info_var__Z3foov0, ptr @task_invocation_info__Z3foov0, ptr null, i64 [[TMP11]], ptr [[TMP3]], ptr [[TMP4]], i64 8, i64 [[TMP12]], i64 0, i64 [[TMP21]], i64 0, i64 0), !dbg [[DBG12]]
; CHECK-NEXT:    [[TMP22:%.*]] = load ptr, ptr [[TMP3]], align 8, !dbg [[DBG12]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, ptr [[TMP22]], i64 32, !dbg [[DBG12]]
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0:%.*]], ptr [[TMP22]], i32 0, i32 0, !dbg [[DBG12]]
...
; CHECK-NEXT:    [[GEP_VLA19:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TMP22]], i32 0, i32 0, !dbg [[DBG12]]
; CHECK-NEXT:    store ptr [[VLA]], ptr [[GEP_VLA19]], align 8, !dbg [[DBG12]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TMP22]], i32 0, i32 2, !dbg [[DBG12]]
...
; CHECK-NEXT:    br label [[FOR_END17:%.*]], !dbg [[DBG12]]
; CHECK:       final.end:
; CHECK-NEXT:    store i32 0, ptr [[I1]], align 4, !dbg [[DBG16:![0-9]+]]
; CHECK-NEXT:    br label [[FINAL_COND6:%.*]], !dbg [[DBG13]]
; CHECK:       codeRepl24:
...
; CHECK-NEXT:    store i64 0, ptr [[NUM_DEPS25]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP29:%.*]] = load i64, ptr [[NUM_DEPS25]], align 8, !dbg [[DBG13]]
...
; CHECK-NEXT:    call void @nanos6_create_loop(ptr @task_info_var__Z3foov1, ptr @task_invocation_info__Z3foov1, ptr null, i64 [[TMP28]], ptr [[TMP5]], ptr [[TMP6]], i64 8, i64 [[TMP29]], i64 0, i64 [[TMP38]], i64 0, i64 0), !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP39:%.*]] = load ptr, ptr [[TMP5]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[ARGS_END26:%.*]] = getelementptr i8, ptr [[TMP39]], i64 32, !dbg [[DBG13]]
; CHECK-NEXT:    [[GEP_VLA27:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1:%.*]], ptr [[TMP39]], i32 0, i32 0, !dbg [[DBG13]]
; CHECK-NEXT:    store ptr [[ARGS_END26]], ptr [[GEP_VLA27]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP40:%.*]] = mul nuw i64 1, [[TMP1]], !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr [[ARGS_END26]], i64 [[TMP40]], !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP42:%.*]] = mul nuw i64 1, [[TMP1]], !dbg [[DBG13]]
; CHECK-NEXT:    [[GEP_VLA28:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TMP39]], i32 0, i32 0, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP43:%.*]] = load ptr, ptr [[GEP_VLA28]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    call void @oss_ctor_ZN1SC1Ev(ptr [[TMP43]], i64 [[TMP42]]), !dbg [[DBG13]]
; CHECK-NEXT:    [[CAPT_GEP_29:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TMP39]], i32 0, i32 2, !dbg [[DBG13]]
; CHECK-NEXT:    store i64 [[TMP1]], ptr [[CAPT_GEP_29]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[TMP44:%.*]] = load ptr, ptr [[TMP6]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    call void @nanos6_submit_task(ptr [[TMP44]]), !dbg [[DBG13]]
; CHECK-NEXT:    br label [[FOR_END22:%.*]], !dbg [[DBG13]]
; CHECK:       final.end5:
; CHECK-NEXT:    store i32 0, ptr [[I2]], align 4, !dbg [[DBG17:![0-9]+]]
; CHECK-NEXT:    br label [[FINAL_COND13:%.*]], !dbg [[DBG14]]
; CHECK:       codeRepl34:
...
; CHECK-NEXT:    call void @nanos6_create_loop(ptr @task_info_var__Z3foov2, ptr @task_invocation_info__Z3foov2, ptr null, i64 [[TMP47]], ptr [[TMP7]], ptr [[TMP8]], i64 8, i64 [[TMP48]], i64 0, i64 [[TMP57]], i64 0, i64 0), !dbg [[DBG14]]
; CHECK-NEXT:    [[TMP58:%.*]] = load ptr, ptr [[TMP7]], align 8, !dbg [[DBG14]]
; CHECK-NEXT:    [[ARGS_END36:%.*]] = getelementptr i8, ptr [[TMP58]], i64 32, !dbg [[DBG14]]
; CHECK-NEXT:    [[GEP_VLA37:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2:%.*]], ptr [[TMP58]], i32 0, i32 1, !dbg [[DBG14]]
...
; CHECK-NEXT:    [[GEP_VLA38:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TMP58]], i32 0, i32 1, !dbg [[DBG14]]
...
; CHECK-NEXT:    [[CAPT_GEP_39:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TMP58]], i32 0, i32 2, !dbg [[DBG14]]
...
; CHECK-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi ptr [ [[TMP64]], [[FINAL_END12:%.*]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ], !dbg [[DBG18]]
...
; CHECK-NEXT:    br i1 [[TMP76]], label [[TMP77:%.*]], label [[FOR_END3:%.*]], !dbg [[DBG13]]
; CHECK:       77:
; CHECK-NEXT:    br label [[FOR_BODY2:%.*]], !dbg [[DBG13]]
; CHECK:       for.body2:
; CHECK-NEXT:    br label [[FOR_INCR4:%.*]], !dbg [[DBG17]]
; CHECK:       final.then14:
...
; CHECK-NEXT:    br label [[FOR_COND8:%.*]], !dbg [[DBG14]]
; CHECK:       for.cond8:
; CHECK-NEXT:    [[TMP81:%.*]] = load i32, ptr [[I2]], align 4, !dbg [[DBG14]]
; CHECK-NEXT:    [[TMP82:%.*]] = icmp slt i32 [[TMP81]], [[TMP79]], !dbg [[DBG14]]
; CHECK-NEXT:    br i1 [[TMP82]], label [[TMP83:%.*]], label [[FOR_END10:%.*]], !dbg [[DBG14]]
; CHECK:       83:
; CHECK-NEXT:    br label [[FOR_BODY9:%.*]], !dbg [[DBG14]]
; CHECK:       for.body9:
; CHECK-NEXT:    br label [[FOR_INCR11:%.*]], !dbg [[DBG18]]
; CHECK:       for.end:
...
; CHECK:       for.end3:
; CHECK-NEXT:    br label [[FINAL_END5:%.*]], !dbg [[DBG13]]
; CHECK:       for.incr4:
...
; CHECK-NEXT:    br i1 [[TMP91]], label [[FINAL_THEN7:%.*]], label [[CODEREPL24:%.*]], !dbg [[DBG13]]
; CHECK:       for.end10:
; CHECK-NEXT:    br label [[FINAL_END12]], !dbg [[DBG14]]
; CHECK:       for.incr11:
...
; CHECK-NEXT:    br i1 [[TMP95]], label [[FINAL_THEN14:%.*]], label [[CODEREPL34:%.*]], !dbg [[DBG14]]
; CHECK:       for.end17:
; CHECK-NEXT:    br label [[FINAL_END]], !dbg [[DBG12]]
; CHECK:       for.end22:
; CHECK-NEXT:    br label [[FINAL_END5]], !dbg [[DBG13]]
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_ol_duplicate__Z3foov0
...
; CHECK-NEXT:    [[GEP_DST_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0:%.*]], ptr [[TMP0]], i32 0, i32 0
; CHECK-NEXT:    store ptr [[ARGS_END]], ptr [[GEP_DST_VLA]], align 8
; CHECK-NEXT:    [[GEP_DST_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TMP0]], i32 0, i32 2
...
; CHECK-NEXT:    [[GEP_SRC_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TASK_ARGS_SRC]], i32 0, i32 0
; CHECK-NEXT:    [[GEP_DST_VLA1:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TMP0]], i32 0, i32 0
; CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[GEP_SRC_VLA]], align 8
; CHECK-NEXT:    store ptr [[TMP4]], ptr [[GEP_DST_VLA1]], align 8
; CHECK-NEXT:    [[CAPT_GEP_SRC_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TASK_ARGS_SRC]], i32 0, i32 2
; CHECK-NEXT:    [[CAPT_GEP_DST_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TMP0]], i32 0, i32 2
...
; CHECK-NEXT:    br label [[FOR_COND15:%.*]], !dbg [[DBG57]]
; CHECK:       for.cond15:
...
; CHECK-NEXT:    br label [[FOR_BODY16:%.*]], !dbg [[DBG57]]
; CHECK:       for.body16:
; CHECK-NEXT:    br label [[FOR_INCR18:%.*]], !dbg [[DBG58:![0-9]+]]
; CHECK:       for.incr18:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0:%.*]], ptr [[TASK_ARGS]], i32 0, i32 0
...
; CHECK-NEXT:    [[CAPT_GEP:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV0]], ptr [[TASK_ARGS]], i32 0, i32 2
...
; CHECK:       2:
; CHECK-NEXT:    call void @nanos6_unpacked_task_region__Z3foov0(ptr [[LOAD_GEP_VLA]], ptr [[GEP_I]], i64 [[LOAD_CAPT_GEP]], ptr [[LOOP_BOUNDS]], ptr [[ADDRESS_TRANSLATION_TABLE]])
; CHECK-NEXT:    ret void
;
;
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1:%.*]], ptr [[TASK_ARGS]], i32 0, i32 0
; CHECK-NEXT:    [[LOAD_GEP_VLA:%.*]] = load ptr, ptr [[GEP_VLA]], align 8
; CHECK-NEXT:    [[GEP_I1:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TASK_ARGS]], i32 0, i32 1
; CHECK-NEXT:    [[CAPT_GEP:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TASK_ARGS]], i32 0, i32 2
; CHECK-NEXT:    [[LOAD_CAPT_GEP:%.*]] = load i64, ptr [[CAPT_GEP]], align 8
; CHECK-NEXT:    call void @nanos6_unpacked_destroy__Z3foov1(ptr [[LOAD_GEP_VLA]], ptr [[GEP_I1]], i64 [[LOAD_CAPT_GEP]])
; CHECK-NEXT:    ret void
;
;
...
; CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[TASK_ARGS_DST]], align 8
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, ptr [[TMP0]], i64 32
; CHECK-NEXT:    [[GEP_DST_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1:%.*]], ptr [[TMP0]], i32 0, i32 0
; CHECK-NEXT:    store ptr [[ARGS_END]], ptr [[GEP_DST_VLA]], align 8
; CHECK-NEXT:    [[GEP_DST_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TMP0]], i32 0, i32 2
; CHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr [[GEP_DST_]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = mul nuw i64 1, [[TMP1]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[ARGS_END]], i64 [[TMP2]]
; CHECK-NEXT:    [[GEP_SRC_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TASK_ARGS_SRC]], i32 0, i32 2
; CHECK-NEXT:    [[TMP4:%.*]] = load i64, ptr [[GEP_SRC_]], align 8
; CHECK-NEXT:    [[TMP5:%.*]] = mul nuw i64 1, [[TMP4]]
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TMP0]], i32 0, i32 0
; CHECK-NEXT:    [[TMP6:%.*]] = load ptr, ptr [[GEP_VLA]], align 8
; CHECK-NEXT:    call void @oss_ctor_ZN1SC1Ev(ptr [[TMP6]], i64 [[TMP5]])
; CHECK-NEXT:    [[CAPT_GEP_SRC_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TASK_ARGS_SRC]], i32 0, i32 2
; CHECK-NEXT:    [[CAPT_GEP_DST_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV1]], ptr [[TMP0]], i32 0, i32 2
...
; CHECK-NEXT:    br label [[FOR_COND20:%.*]], !dbg [[DBG60]]
; CHECK:       for.cond20:
...
; CHECK-NEXT:    br label [[FOR_BODY21:%.*]], !dbg [[DBG60]]
; CHECK:       for.body21:
; CHECK-NEXT:    br label [[FOR_INCR23:%.*]], !dbg [[DBG61:![0-9]+]]
; CHECK:       for.incr23:
...
; CHECK-NEXT:    br label [[TMP2]]
; CHECK:       2:
; CHECK-NEXT:    call void @nanos6_unpacked_task_region__Z3foov1(ptr [[LOAD_GEP_VLA]], ptr [[GEP_I1]], i64 [[LOAD_CAPT_GEP]], ptr [[LOOP_BOUNDS]], ptr [[ADDRESS_TRANSLATION_TABLE]])
; CHECK-NEXT:    ret void
;
;
...
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TASK_ARGS]], i32 0, i32 1
; CHECK-NEXT:    [[LOAD_GEP_VLA:%.*]] = load ptr, ptr [[GEP_VLA]], align 8
; CHECK-NEXT:    [[CAPT_GEP:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TASK_ARGS]], i32 0, i32 2
; CHECK-NEXT:    [[LOAD_CAPT_GEP:%.*]] = load i64, ptr [[CAPT_GEP]], align 8
; CHECK-NEXT:    call void @nanos6_unpacked_destroy__Z3foov2(ptr [[GEP_I2]], ptr [[LOAD_GEP_VLA]], i64 [[LOAD_CAPT_GEP]])
; CHECK-NEXT:    ret void
;
;
...
; CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[TASK_ARGS_DST]], align 8
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, ptr [[TMP0]], i64 32
; CHECK-NEXT:    [[GEP_DST_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2:%.*]], ptr [[TMP0]], i32 0, i32 1
; CHECK-NEXT:    store ptr [[ARGS_END]], ptr [[GEP_DST_VLA]], align 8
; CHECK-NEXT:    [[GEP_DST_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TMP0]], i32 0, i32 2
; CHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr [[GEP_DST_]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = mul nuw i64 1, [[TMP1]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[ARGS_END]], i64 [[TMP2]]
; CHECK-NEXT:    [[GEP_SRC_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TASK_ARGS_SRC]], i32 0, i32 2
; CHECK-NEXT:    [[TMP4:%.*]] = load i64, ptr [[GEP_SRC_]], align 8
; CHECK-NEXT:    [[TMP5:%.*]] = mul nuw i64 1, [[TMP4]]
; CHECK-NEXT:    [[GEP_SRC_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TASK_ARGS_SRC]], i32 0, i32 1
; CHECK-NEXT:    [[GEP_DST_VLA1:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TMP0]], i32 0, i32 1
...
; CHECK-NEXT:    [[CAPT_GEP_SRC_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TASK_ARGS_SRC]], i32 0, i32 2
; CHECK-NEXT:    [[CAPT_GEP_DST_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3FOOV2]], ptr [[TMP0]], i32 0, i32 2
...
; CHECK-NEXT:    br label [[TMP2]]
; CHECK:       2:
; CHECK-NEXT:    call void @nanos6_unpacked_task_region__Z3foov2(ptr [[GEP_I2]], ptr [[LOAD_GEP_VLA]], i64 [[LOAD_CAPT_GEP]], ptr [[LOOP_BOUNDS]], ptr [[ADDRESS_TRANSLATION_TABLE]])
; CHECK-NEXT:    ret void
;
