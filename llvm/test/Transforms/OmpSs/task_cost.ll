...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_unpacked_constraints__Z3bari0
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_ol_constraints__Z3bari0
; CHECK-SAME: (ptr [[TASK_ARGS:%.*]], ptr [[CONSTRAINTS:%.*]]) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @nanos6_unpacked_constraints__Z3bari0(ptr [[CONSTRAINTS]])
; CHECK-NEXT:    ret void
;
;
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_unpacked_constraints__Z3bari1
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_ol_constraints__Z3bari1
; CHECK-SAME: (ptr [[TASK_ARGS:%.*]], ptr [[CONSTRAINTS:%.*]]) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[GEP_N_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI1:%.*]], ptr [[TASK_ARGS]], i32 0, i32 0
; CHECK-NEXT:    call void @nanos6_unpacked_constraints__Z3bari1(ptr [[GEP_N_ADDR]], ptr [[CONSTRAINTS]])
; CHECK-NEXT:    ret void
;
;
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_unpacked_constraints__Z3bari2
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_ol_constraints__Z3bari2
; CHECK-SAME: (ptr [[TASK_ARGS:%.*]], ptr [[CONSTRAINTS:%.*]]) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI2:%.*]], ptr [[TASK_ARGS]], i32 0, i32 0
; CHECK-NEXT:    [[LOAD_GEP_VLA:%.*]] = load ptr, ptr [[GEP_VLA]], align 8
; CHECK-NEXT:    [[CAPT_GEP:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI2]], ptr [[TASK_ARGS]], i32 0, i32 1
; CHECK-NEXT:    [[LOAD_CAPT_GEP:%.*]] = load i64, ptr [[CAPT_GEP]], align 8
; CHECK-NEXT:    call void @nanos6_unpacked_constraints__Z3bari2(ptr [[LOAD_GEP_VLA]], i64 [[LOAD_CAPT_GEP]], ptr [[CONSTRAINTS]])
; CHECK-NEXT:    ret void
;
