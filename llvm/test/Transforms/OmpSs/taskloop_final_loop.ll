...
; CHECK-NEXT:    [[TMP4:%.*]] = sub i32 [[UB_VALUE]], [[LB_VALUE]], [[DBG8]]
; CHECK-NEXT:    [[TMP5:%.*]] = sub i32 [[TMP4]], 1, [[DBG8]]
; CHECK-NEXT:    [[TMP6:%.*]] = sdiv i32 [[TMP5]], [[STEP_VALUE]], [[DBG8]]
; CHECK-NEXT:    [[TMP7:%.*]] = add i32 [[TMP6]], 1, [[DBG8]]
; CHECK-NEXT:    [[TMP8:%.*]] = sext i32 [[TMP7]] to i64, [[DBG8]]
; CHECK-NEXT:    call void @nanos6_create_loop(%nanos6_task_info_t* @task_info_var_taskloop0, %nanos6_task_invocation_info_t* @task_invocation_info_taskloop0, i64 16, i8** [[TMP2]], i8** [[TMP1]], i64 4, i64 [[TMP3]], i64 0, i64 [[TMP8]], i64 0, i64 0), [[DBG8]]
; CHECK-NEXT:    [[TMP9:%.*]] = load %nanos6_task_args_taskloop0*, %nanos6_task_args_taskloop0** [[TMP0]], align 8, [[DBG8]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast %nanos6_task_args_taskloop0* [[TMP9]] to i8*, [[DBG8]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP10]], i64 16, [[DBG8]]
; CHECK-NEXT:    [[CAPT_GEP_LB_VALUE:%.*]] = getelementptr [[NANOS6_TASK_ARGS_TASKLOOP0:%.*]], %nanos6_task_args_taskloop0* [[TMP9]], i32 0, i32 1, [[DBG8]]
; CHECK-NEXT:    store i32 [[LB_VALUE]], i32* [[CAPT_GEP_LB_VALUE]], align 4, [[DBG8]]
; CHECK-NEXT:    [[CAPT_GEP_UB_VALUE:%.*]] = getelementptr [[NANOS6_TASK_ARGS_TASKLOOP0]], %nanos6_task_args_taskloop0* [[TMP9]], i32 0, i32 2, [[DBG8]]
; CHECK-NEXT:    store i32 [[UB_VALUE]], i32* [[CAPT_GEP_UB_VALUE]], align 4, [[DBG8]]
; CHECK-NEXT:    [[CAPT_GEP_STEP_VALUE:%.*]] = getelementptr [[NANOS6_TASK_ARGS_TASKLOOP0]], %nanos6_task_args_taskloop0* [[TMP9]], i32 0, i32 3, [[DBG8]]
; CHECK-NEXT:    store i32 [[STEP_VALUE]], i32* [[CAPT_GEP_STEP_VALUE]], align 4, [[DBG8]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i8*, i8** [[TMP1]], align 8, [[DBG8]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP11]]), [[DBG8]]
