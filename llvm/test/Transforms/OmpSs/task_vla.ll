...
; CHECK:       codeRepl:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[TMP3]]), !dbg [[DBG18]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[TMP4]]), !dbg [[DBG18]]
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[TMP3]]), !dbg [[DBG18]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[TMP4]]), !dbg [[DBG18]]
; CHECK-NEXT:    br label [[FINAL_END:%.*]], !dbg [[DBG18]]
; CHECK:       final.end:
; CHECK-NEXT:    br label [[FINAL_COND3:%.*]], !dbg [[DBG19]]
; CHECK:       codeRepl5:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[TMP5]]), !dbg [[DBG19]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[TMP6]]), !dbg [[DBG19]]
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[TMP5]]), !dbg [[DBG19]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[TMP6]]), !dbg [[DBG19]]
