...
; CHECK-NEXT:    [[TMP3:%.*]] = alloca %nanos6_task_args__Z9pod_arrayi0*, align 8, [[DBG10:!dbg !.*]]
; CHECK-NEXT:    [[TMP4:%.*]] = alloca i8*, align 8, [[DBG10]]
; CHECK-NEXT:    [[NUM_DEPS:%.*]] = alloca i64, align 8, [[DBG10]]
; CHECK-NEXT:    [[TMP5:%.*]] = alloca %nanos6_task_args__Z9pod_arrayi1*, align 8, [[DBG11:!dbg !.*]]
; CHECK-NEXT:    [[TMP6:%.*]] = alloca i8*, align 8, [[DBG11]]
; CHECK-NEXT:    [[NUM_DEPS5:%.*]] = alloca i64, align 8, [[DBG11]]
; CHECK-NEXT:    br label [[FINAL_COND:%.*]], [[DBG10]]
; CHECK:       codeRepl:
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast %nanos6_task_args__Z9pod_arrayi0** [[TMP3]] to i8**, [[DBG10]]
; CHECK-NEXT:    [[TMP8:%.*]] = mul nuw i64 4, [[TMP1]], [[DBG10]]
; CHECK-NEXT:    [[TMP9:%.*]] = add nuw i64 0, [[TMP8]], [[DBG10]]
; CHECK-NEXT:    [[TMP10:%.*]] = add nuw i64 16, [[TMP9]], [[DBG10]]
; CHECK-NEXT:    store i64 0, i64* [[NUM_DEPS]], align 8, [[DBG10]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, i64* [[NUM_DEPS]], align 8, [[DBG10]]
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var__Z9pod_arrayi0, %nanos6_task_invocation_info_t* @task_invocation_info__Z9pod_arrayi0, i64 [[TMP10]], i8** [[TMP7]], i8** [[TMP4]], i64 0, i64 [[TMP11]]), [[DBG10]]
; CHECK-NEXT:    [[TMP12:%.*]] = load %nanos6_task_args__Z9pod_arrayi0*, %nanos6_task_args__Z9pod_arrayi0** [[TMP3]], align 8, [[DBG10]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast %nanos6_task_args__Z9pod_arrayi0* [[TMP12]] to i8*, [[DBG10]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP13]], i64 16, [[DBG10]]
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z9POD_ARRAYI0:%.*]], %nanos6_task_args__Z9pod_arrayi0* [[TMP12]], i32 0, i32 0, [[DBG10]]
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i32** [[GEP_VLA]] to i8**, [[DBG10]]
; CHECK-NEXT:    store i8* [[ARGS_END]], i8** [[TMP14]], align 4, [[DBG10]]
; CHECK-NEXT:    [[TMP15:%.*]] = mul nuw i64 4, [[TMP1]], [[DBG10]]
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i8, i8* [[ARGS_END]], i64 [[TMP15]], [[DBG10]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z9POD_ARRAYI0]], %nanos6_task_args__Z9pod_arrayi0* [[TMP12]], i32 0, i32 1, [[DBG10]]
; CHECK-NEXT:    store i64 [[TMP1]], i64* [[CAPT_GEP_]], align 8, [[DBG10]]
; CHECK-NEXT:    [[TMP17:%.*]] = load i8*, i8** [[TMP4]], align 8, [[DBG10]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP17]]), [[DBG10]]
; CHECK-NEXT:    br label [[FINAL_END:%.*]], [[DBG10]]
; CHECK:       final.end:
; CHECK-NEXT:    br label [[FINAL_COND2:%.*]], [[DBG11]]
; CHECK:       codeRepl4:
; CHECK-NEXT:    [[TMP18:%.*]] = bitcast %nanos6_task_args__Z9pod_arrayi1** [[TMP5]] to i8**, [[DBG11]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var__Z9pod_arrayi1, %nanos6_task_invocation_info_t* @task_invocation_info__Z9pod_arrayi1, i64 [[TMP21]], i8** [[TMP18]], i8** [[TMP6]], i64 0, i64 [[TMP22]]), [[DBG11]]
; CHECK-NEXT:    [[TMP23:%.*]] = load %nanos6_task_args__Z9pod_arrayi1*, %nanos6_task_args__Z9pod_arrayi1** [[TMP5]], align 8, [[DBG11]]
...
; CHECK-NEXT:    [[TMP33:%.*]] = load i8*, i8** [[TMP6]], align 8, [[DBG11]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = alloca %nanos6_task_args__Z13non_pod_arrayi0*, align 8, [[DBG17:!dbg !.*]]
; CHECK-NEXT:    [[TMP4:%.*]] = alloca i8*, align 8, [[DBG17]]
; CHECK-NEXT:    [[NUM_DEPS:%.*]] = alloca i64, align 8, [[DBG17]]
; CHECK-NEXT:    [[TMP5:%.*]] = alloca %nanos6_task_args__Z13non_pod_arrayi1*, align 8, [[DBG18:!dbg !.*]]
; CHECK-NEXT:    [[TMP6:%.*]] = alloca i8*, align 8, [[DBG18]]
...
; CHECK-NEXT:    br label [[FINAL_COND:%.*]], [[DBG17]]
; CHECK:       codeRepl:
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast %nanos6_task_args__Z13non_pod_arrayi0** [[TMP3]] to i8**, [[DBG17]]
; CHECK-NEXT:    [[TMP8:%.*]] = mul nuw i64 4, [[TMP1]], [[DBG17]]
; CHECK-NEXT:    [[TMP9:%.*]] = add nuw i64 0, [[TMP8]], [[DBG17]]
; CHECK-NEXT:    [[TMP10:%.*]] = add nuw i64 16, [[TMP9]], [[DBG17]]
; CHECK-NEXT:    store i64 0, i64* [[NUM_DEPS]], align 8, [[DBG17]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, i64* [[NUM_DEPS]], align 8, [[DBG17]]
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var__Z13non_pod_arrayi0, %nanos6_task_invocation_info_t* @task_invocation_info__Z13non_pod_arrayi0, i64 [[TMP10]], i8** [[TMP7]], i8** [[TMP4]], i64 0, i64 [[TMP11]]), [[DBG17]]
; CHECK-NEXT:    [[TMP12:%.*]] = load %nanos6_task_args__Z13non_pod_arrayi0*, %nanos6_task_args__Z13non_pod_arrayi0** [[TMP3]], align 8, [[DBG17]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast %nanos6_task_args__Z13non_pod_arrayi0* [[TMP12]] to i8*, [[DBG17]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP13]], i64 16, [[DBG17]]
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z13NON_POD_ARRAYI0:%.*]], %nanos6_task_args__Z13non_pod_arrayi0* [[TMP12]], i32 0, i32 0, [[DBG17]]
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast %struct.S** [[GEP_VLA]] to i8**, [[DBG17]]
; CHECK-NEXT:    store i8* [[ARGS_END]], i8** [[TMP14]], align 8, [[DBG17]]
; CHECK-NEXT:    [[TMP15:%.*]] = mul nuw i64 4, [[TMP1]], [[DBG17]]
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i8, i8* [[ARGS_END]], i64 [[TMP15]], [[DBG17]]
; CHECK-NEXT:    [[TMP17:%.*]] = mul nuw i64 1, [[TMP1]], [[DBG17]]
; CHECK-NEXT:    [[GEP_VLA1:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z13NON_POD_ARRAYI0]], %nanos6_task_args__Z13non_pod_arrayi0* [[TMP12]], i32 0, i32 0, [[DBG17]]
; CHECK-NEXT:    [[TMP18:%.*]] = load %struct.S*, %struct.S** [[GEP_VLA1]], align 8, [[DBG17]]
; CHECK-NEXT:    call void @oss_ctor_ZN1SC1Ev(%struct.S* [[TMP18]], i64 [[TMP17]]), [[DBG17]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z13NON_POD_ARRAYI0]], %nanos6_task_args__Z13non_pod_arrayi0* [[TMP12]], i32 0, i32 1, [[DBG17]]
; CHECK-NEXT:    store i64 [[TMP1]], i64* [[CAPT_GEP_]], align 8, [[DBG17]]
; CHECK-NEXT:    [[TMP19:%.*]] = load i8*, i8** [[TMP4]], align 8, [[DBG17]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP19]]), [[DBG17]]
; CHECK-NEXT:    br label [[FINAL_END:%.*]], [[DBG17]]
; CHECK:       final.end:
; CHECK-NEXT:    br label [[FINAL_COND3:%.*]], [[DBG18]]
; CHECK:       codeRepl5:
; CHECK-NEXT:    [[TMP20:%.*]] = bitcast %nanos6_task_args__Z13non_pod_arrayi1** [[TMP5]] to i8**, [[DBG18]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var__Z13non_pod_arrayi1, %nanos6_task_invocation_info_t* @task_invocation_info__Z13non_pod_arrayi1, i64 [[TMP23]], i8** [[TMP20]], i8** [[TMP6]], i64 0, i64 [[TMP24]]), [[DBG18]]
; CHECK-NEXT:    [[TMP25:%.*]] = load %nanos6_task_args__Z13non_pod_arrayi1*, %nanos6_task_args__Z13non_pod_arrayi1** [[TMP5]], align 8, [[DBG18]]
...
; CHECK-NEXT:    [[TMP32:%.*]] = load i8*, i8** [[TMP6]], align 8, [[DBG18]]
