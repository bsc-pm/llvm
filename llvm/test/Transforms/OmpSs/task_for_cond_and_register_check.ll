...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_signed_loop_slt0, %nanos6_task_invocation_info_t* @task_invocation_info_signed_loop_slt0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG9]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_signed_loop_slt0*, %nanos6_task_args_signed_loop_slt0** [[TMP4]], align 8, [[DBG9]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_signed_loop_slt0* [[TMP8]] to i8*, [[DBG9]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG9]]
; CHECK-NEXT:    [[GEP_LB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLT0:%.*]], %nanos6_task_args_signed_loop_slt0* [[TMP8]], i32 0, i32 1, [[DBG9]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_LB_ADDR]] to i8*, [[DBG9]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[LB_ADDR]] to i8*, [[DBG9]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG9]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLT0]], %nanos6_task_args_signed_loop_slt0* [[TMP8]], i32 0, i32 2, [[DBG9]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG9]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG9]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG9]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLT0]], %nanos6_task_args_signed_loop_slt0* [[TMP8]], i32 0, i32 3, [[DBG9]]
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG9]]
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG9]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP14]], i8* align 4 [[TMP15]], i64 4, i1 false), [[DBG9]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLT0]], %nanos6_task_args_signed_loop_slt0* [[TMP8]], i32 0, i32 4, [[DBG9]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG9]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLT0]], %nanos6_task_args_signed_loop_slt0* [[TMP8]], i32 0, i32 5, [[DBG9]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG9]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLT0]], %nanos6_task_args_signed_loop_slt0* [[TMP8]], i32 0, i32 6, [[DBG9]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG9]]
; CHECK-NEXT:    [[TMP16:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG9]]
; CHECK-NEXT:    [[TMP17:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG9]]
; CHECK-NEXT:    [[TMP18:%.*]] = sub i32 [[TMP17]], 1, [[DBG9]]
; CHECK-NEXT:    [[TMP19:%.*]] = sdiv i32 [[TMP18]], [[TMP3]], [[DBG9]]
; CHECK-NEXT:    [[TMP20:%.*]] = add i32 [[TMP19]], 1, [[DBG9]]
; CHECK-NEXT:    [[TMP21:%.*]] = sext i32 [[TMP20]] to i64, [[DBG9]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP16]], i64 0, i64 [[TMP21]], i64 0, i64 0), [[DBG9]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP16]]), [[DBG9]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_signed_loop_sle0, %nanos6_task_invocation_info_t* @task_invocation_info_signed_loop_sle0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG12]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_signed_loop_sle0*, %nanos6_task_args_signed_loop_sle0** [[TMP4]], align 8, [[DBG12]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_signed_loop_sle0* [[TMP8]] to i8*, [[DBG12]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG12]]
; CHECK-NEXT:    [[GEP_LB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLE0:%.*]], %nanos6_task_args_signed_loop_sle0* [[TMP8]], i32 0, i32 1, [[DBG12]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_LB_ADDR]] to i8*, [[DBG12]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[LB_ADDR]] to i8*, [[DBG12]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG12]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLE0]], %nanos6_task_args_signed_loop_sle0* [[TMP8]], i32 0, i32 2, [[DBG12]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG12]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG12]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG12]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLE0]], %nanos6_task_args_signed_loop_sle0* [[TMP8]], i32 0, i32 3, [[DBG12]]
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG12]]
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG12]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP14]], i8* align 4 [[TMP15]], i64 4, i1 false), [[DBG12]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLE0]], %nanos6_task_args_signed_loop_sle0* [[TMP8]], i32 0, i32 4, [[DBG12]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG12]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLE0]], %nanos6_task_args_signed_loop_sle0* [[TMP8]], i32 0, i32 5, [[DBG12]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG12]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SLE0]], %nanos6_task_args_signed_loop_sle0* [[TMP8]], i32 0, i32 6, [[DBG12]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG12]]
; CHECK-NEXT:    [[TMP16:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG12]]
; CHECK-NEXT:    [[TMP17:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG12]]
; CHECK-NEXT:    [[TMP18:%.*]] = sdiv i32 [[TMP17]], [[TMP3]], [[DBG12]]
; CHECK-NEXT:    [[TMP19:%.*]] = add i32 [[TMP18]], 1, [[DBG12]]
; CHECK-NEXT:    [[TMP20:%.*]] = sext i32 [[TMP19]] to i64, [[DBG12]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP16]], i64 0, i64 [[TMP20]], i64 0, i64 0), [[DBG12]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP16]]), [[DBG12]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_signed_loop_sgt0, %nanos6_task_invocation_info_t* @task_invocation_info_signed_loop_sgt0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG15]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_signed_loop_sgt0*, %nanos6_task_args_signed_loop_sgt0** [[TMP4]], align 8, [[DBG15]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_signed_loop_sgt0* [[TMP8]] to i8*, [[DBG15]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG15]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGT0:%.*]], %nanos6_task_args_signed_loop_sgt0* [[TMP8]], i32 0, i32 1, [[DBG15]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG15]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG15]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG15]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGT0]], %nanos6_task_args_signed_loop_sgt0* [[TMP8]], i32 0, i32 2, [[DBG15]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG15]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG15]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG15]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGT0]], %nanos6_task_args_signed_loop_sgt0* [[TMP8]], i32 0, i32 3, [[DBG15]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG15]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGT0]], %nanos6_task_args_signed_loop_sgt0* [[TMP8]], i32 0, i32 4, [[DBG15]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG15]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGT0]], %nanos6_task_args_signed_loop_sgt0* [[TMP8]], i32 0, i32 5, [[DBG15]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG15]]
; CHECK-NEXT:    [[TMP14:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG15]]
; CHECK-NEXT:    [[TMP15:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG15]]
; CHECK-NEXT:    [[TMP16:%.*]] = add i32 [[TMP15]], 1, [[DBG15]]
; CHECK-NEXT:    [[TMP17:%.*]] = sdiv i32 [[TMP16]], [[TMP3]], [[DBG15]]
; CHECK-NEXT:    [[TMP18:%.*]] = add i32 [[TMP17]], 1, [[DBG15]]
; CHECK-NEXT:    [[TMP19:%.*]] = sext i32 [[TMP18]] to i64, [[DBG15]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP14]], i64 0, i64 [[TMP19]], i64 0, i64 0), [[DBG15]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP14]]), [[DBG15]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_signed_loop_sge0, %nanos6_task_invocation_info_t* @task_invocation_info_signed_loop_sge0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG18]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_signed_loop_sge0*, %nanos6_task_args_signed_loop_sge0** [[TMP4]], align 8, [[DBG18]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_signed_loop_sge0* [[TMP8]] to i8*, [[DBG18]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG18]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGE0:%.*]], %nanos6_task_args_signed_loop_sge0* [[TMP8]], i32 0, i32 1, [[DBG18]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG18]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG18]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG18]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGE0]], %nanos6_task_args_signed_loop_sge0* [[TMP8]], i32 0, i32 2, [[DBG18]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG18]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG18]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG18]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGE0]], %nanos6_task_args_signed_loop_sge0* [[TMP8]], i32 0, i32 3, [[DBG18]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG18]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGE0]], %nanos6_task_args_signed_loop_sge0* [[TMP8]], i32 0, i32 4, [[DBG18]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG18]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_SIGNED_LOOP_SGE0]], %nanos6_task_args_signed_loop_sge0* [[TMP8]], i32 0, i32 5, [[DBG18]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG18]]
; CHECK-NEXT:    [[TMP14:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG18]]
; CHECK-NEXT:    [[TMP15:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG18]]
; CHECK-NEXT:    [[TMP16:%.*]] = sdiv i32 [[TMP15]], [[TMP3]], [[DBG18]]
; CHECK-NEXT:    [[TMP17:%.*]] = add i32 [[TMP16]], 1, [[DBG18]]
; CHECK-NEXT:    [[TMP18:%.*]] = sext i32 [[TMP17]] to i64, [[DBG18]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP14]], i64 0, i64 [[TMP18]], i64 0, i64 0), [[DBG18]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP14]]), [[DBG18]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_unsigned_loop_slt0, %nanos6_task_invocation_info_t* @task_invocation_info_unsigned_loop_slt0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG21]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_unsigned_loop_slt0*, %nanos6_task_args_unsigned_loop_slt0** [[TMP4]], align 8, [[DBG21]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_unsigned_loop_slt0* [[TMP8]] to i8*, [[DBG21]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG21]]
; CHECK-NEXT:    [[GEP_LB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLT0:%.*]], %nanos6_task_args_unsigned_loop_slt0* [[TMP8]], i32 0, i32 1, [[DBG21]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_LB_ADDR]] to i8*, [[DBG21]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[LB_ADDR]] to i8*, [[DBG21]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG21]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLT0]], %nanos6_task_args_unsigned_loop_slt0* [[TMP8]], i32 0, i32 2, [[DBG21]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG21]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG21]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG21]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLT0]], %nanos6_task_args_unsigned_loop_slt0* [[TMP8]], i32 0, i32 3, [[DBG21]]
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG21]]
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG21]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP14]], i8* align 4 [[TMP15]], i64 4, i1 false), [[DBG21]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLT0]], %nanos6_task_args_unsigned_loop_slt0* [[TMP8]], i32 0, i32 4, [[DBG21]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG21]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLT0]], %nanos6_task_args_unsigned_loop_slt0* [[TMP8]], i32 0, i32 5, [[DBG21]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG21]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLT0]], %nanos6_task_args_unsigned_loop_slt0* [[TMP8]], i32 0, i32 6, [[DBG21]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG21]]
; CHECK-NEXT:    [[TMP16:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG21]]
; CHECK-NEXT:    [[TMP17:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG21]]
; CHECK-NEXT:    [[TMP18:%.*]] = sub i32 [[TMP17]], 1, [[DBG21]]
; CHECK-NEXT:    [[TMP19:%.*]] = udiv i32 [[TMP18]], [[TMP3]], [[DBG21]]
; CHECK-NEXT:    [[TMP20:%.*]] = add i32 [[TMP19]], 1, [[DBG21]]
; CHECK-NEXT:    [[TMP21:%.*]] = zext i32 [[TMP20]] to i64, [[DBG21]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP16]], i64 0, i64 [[TMP21]], i64 0, i64 0), [[DBG21]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP16]]), [[DBG21]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_unsigned_loop_sle0, %nanos6_task_invocation_info_t* @task_invocation_info_unsigned_loop_sle0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG24]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_unsigned_loop_sle0*, %nanos6_task_args_unsigned_loop_sle0** [[TMP4]], align 8, [[DBG24]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_unsigned_loop_sle0* [[TMP8]] to i8*, [[DBG24]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG24]]
; CHECK-NEXT:    [[GEP_LB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLE0:%.*]], %nanos6_task_args_unsigned_loop_sle0* [[TMP8]], i32 0, i32 1, [[DBG24]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_LB_ADDR]] to i8*, [[DBG24]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[LB_ADDR]] to i8*, [[DBG24]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG24]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLE0]], %nanos6_task_args_unsigned_loop_sle0* [[TMP8]], i32 0, i32 2, [[DBG24]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG24]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG24]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG24]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLE0]], %nanos6_task_args_unsigned_loop_sle0* [[TMP8]], i32 0, i32 3, [[DBG24]]
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG24]]
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG24]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP14]], i8* align 4 [[TMP15]], i64 4, i1 false), [[DBG24]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLE0]], %nanos6_task_args_unsigned_loop_sle0* [[TMP8]], i32 0, i32 4, [[DBG24]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG24]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLE0]], %nanos6_task_args_unsigned_loop_sle0* [[TMP8]], i32 0, i32 5, [[DBG24]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG24]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SLE0]], %nanos6_task_args_unsigned_loop_sle0* [[TMP8]], i32 0, i32 6, [[DBG24]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG24]]
; CHECK-NEXT:    [[TMP16:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG24]]
; CHECK-NEXT:    [[TMP17:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG24]]
; CHECK-NEXT:    [[TMP18:%.*]] = udiv i32 [[TMP17]], [[TMP3]], [[DBG24]]
; CHECK-NEXT:    [[TMP19:%.*]] = add i32 [[TMP18]], 1, [[DBG24]]
; CHECK-NEXT:    [[TMP20:%.*]] = zext i32 [[TMP19]] to i64, [[DBG24]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP16]], i64 0, i64 [[TMP20]], i64 0, i64 0), [[DBG24]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP16]]), [[DBG24]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_unsigned_loop_sgt0, %nanos6_task_invocation_info_t* @task_invocation_info_unsigned_loop_sgt0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG27]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_unsigned_loop_sgt0*, %nanos6_task_args_unsigned_loop_sgt0** [[TMP4]], align 8, [[DBG27]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_unsigned_loop_sgt0* [[TMP8]] to i8*, [[DBG27]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG27]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGT0:%.*]], %nanos6_task_args_unsigned_loop_sgt0* [[TMP8]], i32 0, i32 1, [[DBG27]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG27]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG27]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG27]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGT0]], %nanos6_task_args_unsigned_loop_sgt0* [[TMP8]], i32 0, i32 2, [[DBG27]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG27]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG27]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG27]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGT0]], %nanos6_task_args_unsigned_loop_sgt0* [[TMP8]], i32 0, i32 3, [[DBG27]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG27]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGT0]], %nanos6_task_args_unsigned_loop_sgt0* [[TMP8]], i32 0, i32 4, [[DBG27]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG27]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGT0]], %nanos6_task_args_unsigned_loop_sgt0* [[TMP8]], i32 0, i32 5, [[DBG27]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG27]]
; CHECK-NEXT:    [[TMP14:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG27]]
; CHECK-NEXT:    [[TMP15:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG27]]
; CHECK-NEXT:    [[TMP16:%.*]] = add i32 [[TMP15]], 1, [[DBG27]]
; CHECK-NEXT:    [[TMP17:%.*]] = udiv i32 [[TMP16]], [[TMP3]], [[DBG27]]
; CHECK-NEXT:    [[TMP18:%.*]] = add i32 [[TMP17]], 1, [[DBG27]]
; CHECK-NEXT:    [[TMP19:%.*]] = zext i32 [[TMP18]] to i64, [[DBG27]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP14]], i64 0, i64 [[TMP19]], i64 0, i64 0), [[DBG27]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP14]]), [[DBG27]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_unsigned_loop_sge0, %nanos6_task_invocation_info_t* @task_invocation_info_unsigned_loop_sge0, i64 32, i8** [[TMP6]], i8** [[TMP5]], i64 8, i64 [[TMP7]]), [[DBG30]]
; CHECK-NEXT:    [[TMP8:%.*]] = load %nanos6_task_args_unsigned_loop_sge0*, %nanos6_task_args_unsigned_loop_sge0** [[TMP4]], align 8, [[DBG30]]
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %nanos6_task_args_unsigned_loop_sge0* [[TMP8]] to i8*, [[DBG30]]
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP9]], i64 32, [[DBG30]]
; CHECK-NEXT:    [[GEP_UB_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGE0:%.*]], %nanos6_task_args_unsigned_loop_sge0* [[TMP8]], i32 0, i32 1, [[DBG30]]
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[GEP_UB_ADDR]] to i8*, [[DBG30]]
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast i32* [[UB_ADDR]] to i8*, [[DBG30]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP10]], i8* align 4 [[TMP11]], i64 4, i1 false), [[DBG30]]
; CHECK-NEXT:    [[GEP_STEP_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGE0]], %nanos6_task_args_unsigned_loop_sge0* [[TMP8]], i32 0, i32 2, [[DBG30]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[GEP_STEP_ADDR]] to i8*, [[DBG30]]
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32* [[STEP_ADDR]] to i8*, [[DBG30]]
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP12]], i8* align 4 [[TMP13]], i64 4, i1 false), [[DBG30]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGE0]], %nanos6_task_args_unsigned_loop_sge0* [[TMP8]], i32 0, i32 3, [[DBG30]]
; CHECK-NEXT:    store i32 [[TMP1]], i32* [[CAPT_GEP_]], align 4, [[DBG30]]
; CHECK-NEXT:    [[CAPT_GEP_6:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGE0]], %nanos6_task_args_unsigned_loop_sge0* [[TMP8]], i32 0, i32 4, [[DBG30]]
; CHECK-NEXT:    store i32 [[TMP2]], i32* [[CAPT_GEP_6]], align 4, [[DBG30]]
; CHECK-NEXT:    [[CAPT_GEP_7:%.*]] = getelementptr [[NANOS6_TASK_ARGS_UNSIGNED_LOOP_SGE0]], %nanos6_task_args_unsigned_loop_sge0* [[TMP8]], i32 0, i32 5, [[DBG30]]
; CHECK-NEXT:    store i32 [[TMP3]], i32* [[CAPT_GEP_7]], align 4, [[DBG30]]
; CHECK-NEXT:    [[TMP14:%.*]] = load i8*, i8** [[TMP5]], align 8, [[DBG30]]
; CHECK-NEXT:    [[TMP15:%.*]] = sub i32 [[TMP2]], [[TMP1]], [[DBG30]]
; CHECK-NEXT:    [[TMP16:%.*]] = udiv i32 [[TMP15]], [[TMP3]], [[DBG30]]
; CHECK-NEXT:    [[TMP17:%.*]] = add i32 [[TMP16]], 1, [[DBG30]]
; CHECK-NEXT:    [[TMP18:%.*]] = zext i32 [[TMP17]] to i64, [[DBG30]]
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP14]], i64 0, i64 [[TMP18]], i64 0, i64 0), [[DBG30]]
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP14]]), [[DBG30]]
...
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_constants_loop0, %nanos6_task_invocation_info_t* @task_invocation_info_constants_loop0, i64 16, i8** [[TMP2]], i8** [[TMP1]], i64 8, i64 [[TMP3]]), [[DBG33]]
...
; CHECK-NEXT:    call void @nanos6_register_loop_bounds(i8* [[TMP6]], i64 0, i64 10, i64 0, i64 0), [[DBG33]]
