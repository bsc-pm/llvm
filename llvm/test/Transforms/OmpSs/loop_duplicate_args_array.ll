...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  ...
  %array.begin3 = getelementptr inbounds [2 x %struct.S], [2 x %struct.S]* %s, i32 0, i32 0, !dbg !13
  %3 = getelementptr inbounds %struct.S, %struct.S* %array.begin3, i64 2, !dbg !13
  br label %arraydestroy.body, !dbg !13

arraydestroy.body:                                ; preds = %arraydestroy.body, %arrayctor.cont
  %arraydestroy.elementPast = phi %struct.S* [ %3, %arrayctor.cont ], [ %arraydestroy.element, %arraydestroy.body ], !dbg !13
  %arraydestroy.element = getelementptr inbounds %struct.S, %struct.S* %arraydestroy.elementPast, i64 -1, !dbg !13
  call void @_ZN1SD1Ev(%struct.S* %arraydestroy.element) #2, !dbg !13
  %arraydestroy.done = icmp eq %struct.S* %arraydestroy.element, %array.begin3, !dbg !13
  br i1 %arraydestroy.done, label %arraydestroy.done4, label %arraydestroy.body, !dbg !13
