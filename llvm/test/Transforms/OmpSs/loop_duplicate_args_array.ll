...
; CHECK-NEXT:    [[S:%.*]] = alloca [2 x [[STRUCT_S:%.*]]], align 1
; CHECK-NEXT:    [[I:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[I1:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[I2:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[ARRAY_BEGIN:%.*]] = getelementptr inbounds [2 x [[STRUCT_S]]], ptr [[S]], i32 0, i32 0, !dbg [[DBG12:![0-9]+]]
; CHECK-NEXT:    [[ARRAYCTOR_END:%.*]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAY_BEGIN]], i64 2, !dbg [[DBG12]]
; CHECK-NEXT:    br label [[ARRAYCTOR_LOOP:%.*]], !dbg [[DBG12]]
; CHECK:       arrayctor.loop:
; CHECK-NEXT:    [[ARRAYCTOR_CUR:%.*]] = phi ptr [ [[ARRAY_BEGIN]], [[ENTRY:%.*]] ], [ [[ARRAYCTOR_NEXT:%.*]], [[ARRAYCTOR_LOOP]] ], !dbg [[DBG12]]
; CHECK-NEXT:    call void @_ZN1SC1Ev(ptr noundef nonnull align 1 dereferenceable(1) [[ARRAYCTOR_CUR]]), !dbg [[DBG12]]
; CHECK-NEXT:    [[ARRAYCTOR_NEXT]] = getelementptr inbounds [[STRUCT_S]], ptr [[ARRAYCTOR_CUR]], i64 1, !dbg [[DBG12]]
; CHECK-NEXT:    [[ARRAYCTOR_DONE:%.*]] = icmp eq ptr [[ARRAYCTOR_NEXT]], [[ARRAYCTOR_END]], !dbg [[DBG12]]
; CHECK-NEXT:    br i1 [[ARRAYCTOR_DONE]], label [[ARRAYCTOR_CONT:%.*]], label [[ARRAYCTOR_LOOP]], !dbg [[DBG12]]
...
; CHECK-NEXT:    call void @oss_ctor_ZN1SC1Ev(ptr [[GEP_S19]], i64 2), !dbg [[DBG10]]
...
; CHECK-NEXT:    call void @oss_copy_ctor_ZN1SC1ERKS_(ptr [[S]], ptr [[GEP_S34]], i64 2), !dbg [[DBG9]]
...
; CHECK:       final.end24:
; CHECK-NEXT:    [[ARRAY_BEGIN3:%.*]] = getelementptr inbounds [2 x [[STRUCT_S]]], ptr [[S]], i32 0, i32 0, !dbg [[DBG16:![0-9]+]]
...
; CHECK:       final.then:
; CHECK-NEXT:    [[TMP43:%.*]] = call i32 @compute_lb(), !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP44:%.*]] = call i32 @compute_ub(), !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP45:%.*]] = call i32 @compute_step(), !dbg [[DBG11]]
; CHECK-NEXT:    store i32 [[TMP43]], ptr [[I]], align 4, !dbg [[DBG11]]
; CHECK-NEXT:    br label [[FOR_COND:%.*]], !dbg [[DBG11]]
; CHECK:       for.cond:
; CHECK-NEXT:    [[TMP46:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP47:%.*]] = icmp slt i32 [[TMP46]], [[TMP44]], !dbg [[DBG11]]
; CHECK-NEXT:    br i1 [[TMP47]], label [[TMP48:%.*]], label [[FOR_END:%.*]], !dbg [[DBG11]]
; CHECK:       48:
; CHECK-NEXT:    br label [[FOR_BODY:%.*]], !dbg [[DBG11]]
; CHECK:       for.body:
; CHECK-NEXT:    br label [[FOR_INCR:%.*]], !dbg [[DBG14]]
; CHECK:       final.then11:
; CHECK-NEXT:    [[TMP49:%.*]] = call i32 @compute_lb.1(), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP50:%.*]] = call i32 @compute_ub.2(), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP51:%.*]] = call i32 @compute_step.3(), !dbg [[DBG10]]
; CHECK-NEXT:    store i32 [[TMP49]], ptr [[I1]], align 4, !dbg [[DBG10]]
; CHECK-NEXT:    br label [[FOR_COND5:%.*]], !dbg [[DBG10]]
; CHECK:       for.cond5:
; CHECK-NEXT:    [[TMP52:%.*]] = load i32, ptr [[I1]], align 4, !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP53:%.*]] = icmp slt i32 [[TMP52]], [[TMP50]], !dbg [[DBG10]]
; CHECK-NEXT:    br i1 [[TMP53]], label [[TMP54:%.*]], label [[FOR_END7:%.*]], !dbg [[DBG10]]
; CHECK:       54:
; CHECK-NEXT:    br label [[FOR_BODY6:%.*]], !dbg [[DBG10]]
; CHECK:       for.body6:
; CHECK-NEXT:    br label [[FOR_INCR8:%.*]], !dbg [[DBG15]]
; CHECK:       final.then26:
; CHECK-NEXT:    [[TMP55:%.*]] = call i32 @compute_lb.4(), !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP56:%.*]] = call i32 @compute_ub.5(), !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP57:%.*]] = call i32 @compute_step.6(), !dbg [[DBG9]]
; CHECK-NEXT:    store i32 [[TMP55]], ptr [[I2]], align 4, !dbg [[DBG9]]
; CHECK-NEXT:    br label [[FOR_COND20:%.*]], !dbg [[DBG9]]
; CHECK:       for.cond20:
; CHECK-NEXT:    [[TMP58:%.*]] = load i32, ptr [[I2]], align 4, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP59:%.*]] = icmp slt i32 [[TMP58]], [[TMP56]], !dbg [[DBG9]]
; CHECK-NEXT:    br i1 [[TMP59]], label [[TMP60:%.*]], label [[FOR_END22:%.*]], !dbg [[DBG9]]
; CHECK:       60:
...
; CHECK:       for.incr:
; CHECK-NEXT:    [[TMP61:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP62:%.*]] = add i32 [[TMP61]], [[TMP45]], !dbg [[DBG11]]
; CHECK-NEXT:    store i32 [[TMP62]], ptr [[I]], align 4, !dbg [[DBG11]]
; CHECK-NEXT:    br label [[FOR_COND]], !dbg [[DBG11]]
; CHECK:       final.cond:
; CHECK-NEXT:    [[TMP63:%.*]] = call i32 @nanos6_in_final(), !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP64:%.*]] = icmp ne i32 [[TMP63]], 0, !dbg [[DBG11]]
; CHECK-NEXT:    br i1 [[TMP64]], label [[FINAL_THEN:%.*]], label [[CODEREPL:%.*]], !dbg [[DBG11]]
; CHECK:       for.end3:
; CHECK-NEXT:    br label [[FINAL_END]], !dbg [[DBG11]]
; CHECK:       for.end7:
; CHECK-NEXT:    br label [[FINAL_END9:%.*]], !dbg [[DBG10]]
; CHECK:       for.incr8:
; CHECK-NEXT:    [[TMP65:%.*]] = load i32, ptr [[I1]], align 4, !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP66:%.*]] = add i32 [[TMP65]], [[TMP51]], !dbg [[DBG10]]
; CHECK-NEXT:    store i32 [[TMP66]], ptr [[I1]], align 4, !dbg [[DBG10]]
; CHECK-NEXT:    br label [[FOR_COND5]], !dbg [[DBG10]]
; CHECK:       final.cond10:
; CHECK-NEXT:    [[TMP67:%.*]] = call i32 @nanos6_in_final(), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP68:%.*]] = icmp ne i32 [[TMP67]], 0, !dbg [[DBG10]]
; CHECK-NEXT:    br i1 [[TMP68]], label [[FINAL_THEN11:%.*]], label [[CODEREPL16:%.*]], !dbg [[DBG10]]
; CHECK:       for.end14:
; CHECK-NEXT:    br label [[FINAL_END9]], !dbg [[DBG10]]
; CHECK:       for.end22:
; CHECK-NEXT:    br label [[FINAL_END24]], !dbg [[DBG9]]
; CHECK:       for.incr23:
; CHECK-NEXT:    [[TMP69:%.*]] = load i32, ptr [[I2]], align 4, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP70:%.*]] = add i32 [[TMP69]], [[TMP57]], !dbg [[DBG9]]
; CHECK-NEXT:    store i32 [[TMP70]], ptr [[I2]], align 4, !dbg [[DBG9]]
; CHECK-NEXT:    br label [[FOR_COND20]], !dbg [[DBG9]]
; CHECK:       final.cond25:
; CHECK-NEXT:    [[TMP71:%.*]] = call i32 @nanos6_in_final(), !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP72:%.*]] = icmp ne i32 [[TMP71]], 0, !dbg [[DBG9]]
; CHECK-NEXT:    br i1 [[TMP72]], label [[FINAL_THEN26:%.*]], label [[CODEREPL31:%.*]], !dbg [[DBG9]]
; CHECK:       for.end29:
; CHECK-NEXT:    br label [[FINAL_END24]], !dbg [[DBG9]]
;
;
