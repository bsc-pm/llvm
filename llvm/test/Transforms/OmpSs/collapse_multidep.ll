...
; ModuleID = 'collapse_multidep.ll'
source_filename = "collapse_multidep.ll"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Checking we use lowerbound and upperbound to compute the dependency

; int array[50];
; int main() {
;     #pragma oss taskloop collapse(2) in( { array[i + j + k], k=0;10 } )
;     for (int i = 0; i < 10; ++i) {
;         for (int j = 0; j < 10; ++j) {
;         }
;     }
...
define internal %struct._depend_unpack_t @compute_dep(i32* %k, i64 %0) #2 !dbg !33 {
entry:
...
; CHECK-NEXT:   %59 = call %struct._depend_unpack_t @compute_dep(i32* %k, i64 0)
...
; CHECK-NEXT:   %65 = call %struct._depend_unpack_t @compute_dep(i32* %k, i64 0)
...
; CHECK-NEXT:   %68 = call %struct._depend_unpack_t.0 @compute_dep.4(i32* %i.ub, i32* %j.ub, i32* %k.remap, [50 x i32]* %array)
...
; CHECK-NEXT:   call void @nanos6_register_region_read_depinfo1(i8* %handler, i32 0, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @1, i32 0, i32 0), i8* %70, i64 %71, i64 %72, i64 %73)
...
!7 = !DIFile(filename: "collapse_multidep.ll", directory: "")
