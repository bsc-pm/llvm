...
; CHECK: define internal void @nanos6_unpacked_task_region_vla_senction_dep0(i32* %vla, i64 %0, i64 %1, i64 %2, i8* %3, %nanos6_address_translation_entry_t* %4) {
; CHECK-NEXT: newFuncRoot:
; CHECK-NEXT:   br label %5, !dbg !13
; CHECK: 5:                                                ; preds = %newFuncRoot
; CHECK-NEXT:   %size = alloca i32, align 4
; CHECK-NEXT:   %6 = mul nuw i64 %0, %1, !dbg !17
; CHECK-NEXT:   %7 = mul nuw i64 %6, %2, !dbg !17
...
; CHECK: define internal void @nanos6_unpacked_deps_vla_senction_dep0(i32* %0, i64 %1, i64 %2, i64 %3, i8* %4) {
; CHECK-NEXT: entry:
; CHECK-NEXT:   %5 = mul i64 %3, 4, !dbg !13
; CHECK-NEXT:   %6 = mul i64 %3, 4, !dbg !13
; CHECK-NEXT:   %7 = bitcast i32* %0 to i8*
; CHECK-NEXT:   call void @nanos6_register_region_read_depinfo3(i8* %4, i32 0, i8* null, i8* %7, i64 %5, i64 0, i64 %6, i64 %2, i64 0, i64 %2, i64 %1, i64 0, i64 %1)
; CHECK-NEXT:   ret void
; CHECK-NEXT: }

; CHECK: define internal void @nanos6_ol_deps_vla_senction_dep0(%nanos6_task_args_vla_senction_dep0* %0, i8* %1) {
; CHECK-NEXT: entry:
; CHECK-NEXT:   %gep_vla = getelementptr %nanos6_task_args_vla_senction_dep0, %nanos6_task_args_vla_senction_dep0* %0, i32 0, i32 0
; CHECK-NEXT:   %load_gep_vla = load i32*, i32** %gep_vla
; CHECK-NEXT:   %dims_gep = getelementptr %nanos6_task_args_vla_senction_dep0, %nanos6_task_args_vla_senction_dep0* %0, i32 0, i32 1
