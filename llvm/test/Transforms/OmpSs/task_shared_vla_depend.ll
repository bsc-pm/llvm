...
; CHECK-NEXT:    [[SIZE3:%.*]] = alloca i32, align 4
; CHECK-NEXT:    store i32 [[N:%.*]], i32* [[N_ADDR]], align 4
; CHECK-NEXT:    store i32 [[K:%.*]], i32* [[K_ADDR]], align 4
; CHECK-NEXT:    store i32 [[J:%.*]], i32* [[J_ADDR]], align 4
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, i32* [[N_ADDR]], align 4, !dbg !6
; CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], 1, !dbg !7
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[ADD]] to i64, !dbg !8
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, i32* [[K_ADDR]], align 4, !dbg !9
; CHECK-NEXT:    [[ADD1:%.*]] = add nsw i32 [[TMP2]], 2, !dbg !10
; CHECK-NEXT:    [[TMP3:%.*]] = zext i32 [[ADD1]] to i64, !dbg !8
; CHECK-NEXT:    [[TMP4:%.*]] = load i32, i32* [[J_ADDR]], align 4, !dbg !11
; CHECK-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP4]], 3, !dbg !12
; CHECK-NEXT:    [[TMP5:%.*]] = zext i32 [[ADD2]] to i64, !dbg !8
; CHECK-NEXT:    [[TMP6:%.*]] = call i8* @llvm.stacksave(), !dbg !8
; CHECK-NEXT:    store i8* [[TMP6]], i8** [[SAVED_STACK]], align 8, !dbg !8
; CHECK-NEXT:    [[TMP7:%.*]] = mul nuw i64 [[TMP1]], [[TMP3]], !dbg !8
; CHECK-NEXT:    [[TMP8:%.*]] = mul nuw i64 [[TMP7]], [[TMP5]], !dbg !8
; CHECK-NEXT:    [[VLA:%.*]] = alloca i32, i64 [[TMP8]], align 16, !dbg !8
; CHECK-NEXT:    store i64 [[TMP1]], i64* [[__VLA_EXPR0]], align 8, !dbg !8
; CHECK-NEXT:    store i64 [[TMP3]], i64* [[__VLA_EXPR1]], align 8, !dbg !8
; CHECK-NEXT:    store i64 [[TMP5]], i64* [[__VLA_EXPR2]], align 8, !dbg !8
; CHECK-NEXT:    [[TMP9:%.*]] = mul i64 [[TMP5]], 4, !dbg !13
; CHECK-NEXT:    [[TMP10:%.*]] = mul i64 [[TMP5]], 4, !dbg !13
; CHECK-NEXT:    br label [[FINAL_COND:%.*]], !dbg !13
; CHECK:       codeRepl:
; CHECK-NEXT:    [[TMP11:%.*]] = alloca %nanos6_task_args_vla_senction_dep0*, !dbg !13
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast %nanos6_task_args_vla_senction_dep0** [[TMP11]] to i8**, !dbg !13
; CHECK-NEXT:    [[TMP13:%.*]] = alloca i8*, !dbg !13
; CHECK-NEXT:    [[TMP14:%.*]] = mul nuw i64 4, [[TMP1]], !dbg !13
; CHECK-NEXT:    [[TMP15:%.*]] = mul nuw i64 [[TMP14]], [[TMP3]], !dbg !13
; CHECK-NEXT:    [[TMP16:%.*]] = mul nuw i64 [[TMP15]], [[TMP5]], !dbg !13
; CHECK-NEXT:    [[TMP17:%.*]] = add nuw i64 0, [[TMP16]], !dbg !13
; CHECK-NEXT:    [[TMP18:%.*]] = add nuw i64 32, [[TMP17]], !dbg !13
; CHECK-NEXT:    call void @nanos6_create_task(%nanos6_task_info_t* @task_info_var_vla_senction_dep0, %nanos6_task_invocation_info_t* @task_invocation_info_vla_senction_dep0, i64 [[TMP18]], i8** [[TMP12]], i8** [[TMP13]], i64 0, i64 1), !dbg !13
; CHECK-NEXT:    [[TMP19:%.*]] = load %nanos6_task_args_vla_senction_dep0*, %nanos6_task_args_vla_senction_dep0** [[TMP11]], !dbg !13
; CHECK-NEXT:    [[TMP20:%.*]] = bitcast %nanos6_task_args_vla_senction_dep0* [[TMP19]] to i8*, !dbg !13
; CHECK-NEXT:    [[ARGS_END:%.*]] = getelementptr i8, i8* [[TMP20]], i64 32, !dbg !13
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS_VLA_SENCTION_DEP0:%.*]], %nanos6_task_args_vla_senction_dep0* [[TMP19]], i32 0, i32 0, !dbg !13
; CHECK-NEXT:    [[TMP21:%.*]] = bitcast i32** [[GEP_VLA]] to i8**, !dbg !13
; CHECK-NEXT:    store i8* [[ARGS_END]], i8** [[TMP21]], align 4, !dbg !13
; CHECK-NEXT:    [[TMP22:%.*]] = mul nuw i64 4, [[TMP1]], !dbg !13
; CHECK-NEXT:    [[TMP23:%.*]] = mul nuw i64 [[TMP22]], [[TMP3]], !dbg !13
; CHECK-NEXT:    [[TMP24:%.*]] = mul nuw i64 [[TMP23]], [[TMP5]], !dbg !13
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr i8, i8* [[ARGS_END]], i64 [[TMP24]], !dbg !13
; CHECK-NEXT:    [[GEP_VLA1:%.*]] = getelementptr [[NANOS6_TASK_ARGS_VLA_SENCTION_DEP0]], %nanos6_task_args_vla_senction_dep0* [[TMP19]], i32 0, i32 0, !dbg !13
; CHECK-NEXT:    store i32* [[VLA]], i32** [[GEP_VLA1]], !dbg !13
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS_VLA_SENCTION_DEP0]], %nanos6_task_args_vla_senction_dep0* [[TMP19]], i32 0, i32 1, !dbg !13
; CHECK-NEXT:    store i64 [[TMP1]], i64* [[CAPT_GEP_]], !dbg !13
; CHECK-NEXT:    [[CAPT_GEP_2:%.*]] = getelementptr [[NANOS6_TASK_ARGS_VLA_SENCTION_DEP0]], %nanos6_task_args_vla_senction_dep0* [[TMP19]], i32 0, i32 2, !dbg !13
; CHECK-NEXT:    store i64 [[TMP3]], i64* [[CAPT_GEP_2]], !dbg !13
; CHECK-NEXT:    [[CAPT_GEP_3:%.*]] = getelementptr [[NANOS6_TASK_ARGS_VLA_SENCTION_DEP0]], %nanos6_task_args_vla_senction_dep0* [[TMP19]], i32 0, i32 3, !dbg !13
; CHECK-NEXT:    store i64 [[TMP5]], i64* [[CAPT_GEP_3]], !dbg !13
; CHECK-NEXT:    [[TMP26:%.*]] = load i8*, i8** [[TMP13]], !dbg !13
; CHECK-NEXT:    call void @nanos6_submit_task(i8* [[TMP26]]), !dbg !13
; CHECK-NEXT:    br label [[FINAL_END:%.*]], !dbg !13
; CHECK:       final.end:
; CHECK-NEXT:    [[TMP27:%.*]] = mul nuw i64 [[TMP1]], [[TMP3]], !dbg !14
; CHECK-NEXT:    [[TMP28:%.*]] = mul nuw i64 [[TMP27]], [[TMP5]], !dbg !14
; CHECK-NEXT:    [[TMP29:%.*]] = mul nuw i64 4, [[TMP28]], !dbg !14
; CHECK-NEXT:    [[CONV4:%.*]] = trunc i64 [[TMP29]] to i32, !dbg !14
; CHECK-NEXT:    store i32 [[CONV4]], i32* [[SIZE3]], align 4, !dbg !15
; CHECK-NEXT:    [[TMP30:%.*]] = load i8*, i8** [[SAVED_STACK]], align 8, !dbg !16
; CHECK-NEXT:    call void @llvm.stackrestore(i8* [[TMP30]]), !dbg !16
; CHECK-NEXT:    ret void, !dbg !16
; CHECK:       final.then:
; CHECK-NEXT:    [[SIZE_CLONE:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[TMP31:%.*]] = mul nuw i64 [[TMP1]], [[TMP3]], !dbg !17
; CHECK-NEXT:    [[TMP32:%.*]] = mul nuw i64 [[TMP31]], [[TMP5]], !dbg !17
; CHECK-NEXT:    [[TMP33:%.*]] = mul nuw i64 4, [[TMP32]], !dbg !17
; CHECK-NEXT:    [[CONV_CLONE:%.*]] = trunc i64 [[TMP33]] to i32, !dbg !17
; CHECK-NEXT:    store i32 [[CONV_CLONE]], i32* [[SIZE_CLONE]], align 4, !dbg !18
; CHECK-NEXT:    br label [[FINAL_END]], !dbg !14
; CHECK:       final.cond:
; CHECK-NEXT:    [[TMP34:%.*]] = call i32 @nanos6_in_final(), !dbg !13
; CHECK-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0, !dbg !13
; CHECK-NEXT:    br i1 [[TMP35]], label [[FINAL_THEN:%.*]], label [[CODEREPL:%.*]], !dbg !13
;
entry:
