...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[NUM_DEPS11:%.*]] = alloca i64, align 8, !dbg [[DBG9:![0-9]+]]
; CHECK-NEXT:    [[TMP0:%.*]] = alloca ptr, align 8, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP1:%.*]] = alloca ptr, align 8, !dbg [[DBG9]]
; CHECK-NEXT:    [[NUM_DEPS5:%.*]] = alloca i64, align 8, !dbg [[DBG10:![0-9]+]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG12:![0-9]+]]
; CHECK-NEXT:    [[TMP7:%.*]] = zext i32 [[TMP6]] to i64, !dbg [[DBG13:![0-9]+]]
; CHECK-NEXT:    [[TMP8:%.*]] = call ptr @llvm.stacksave.p0(), !dbg [[DBG13]]
; CHECK-NEXT:    store ptr [[TMP8]], ptr [[SAVED_STACK]], align 8, !dbg [[DBG13]]
; CHECK-NEXT:    [[VLA:%.*]] = alloca i32, i64 [[TMP7]], align 16, !dbg [[DBG13]]
; CHECK-NEXT:    store i64 [[TMP7]], ptr [[__VLA_EXPR0]], align 8, !dbg [[DBG13]]
...
; CHECK-NEXT:    call void @nanos6_create_task(ptr @task_info_var__Z3bari, ptr @task_invocation_info__Z3bari, ptr null, i64 0, ptr [[TMP5]], ptr [[TMP4]], i64 0, i64 [[TMP9]]), !dbg [[DBG11]]
; CHECK-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[TMP5]], align 8, !dbg [[DBG11]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = load i64, ptr [[NUM_DEPS5]], align 8, !dbg [[DBG10]]
; CHECK-NEXT:    call void @nanos6_create_task(ptr @task_info_var__Z3bari.12, ptr @task_invocation_info__Z3bari.8, ptr null, i64 16, ptr [[TMP3]], ptr [[TMP2]], i64 0, i64 [[TMP12]]), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP3]], align 8, !dbg [[DBG10]]
; CHECK-NEXT:    [[ARGS_END6:%.*]] = getelementptr i8, ptr [[TMP13]], i64 16, !dbg [[DBG10]]
; CHECK-NEXT:    [[GEP_N_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI_0:%.*]], ptr [[TMP13]], i32 0, i32 0, !dbg [[DBG10]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[GEP_N_ADDR]], ptr align 4 [[N_ADDR]], i64 4, i1 false), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[TMP2]], align 8, !dbg [[DBG10]]
...
; CHECK:       final.end1:
; CHECK-NEXT:    br label [[FINAL_COND8:%.*]], !dbg [[DBG9]]
; CHECK:       codeRepl10:
...
; CHECK-NEXT:    [[TMP15:%.*]] = mul nuw i64 4, [[TMP7]], !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP16:%.*]] = add nuw i64 0, [[TMP15]], !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP17:%.*]] = add nuw i64 16, [[TMP16]], !dbg [[DBG9]]
; CHECK-NEXT:    store i64 0, ptr [[NUM_DEPS11]], align 8, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP18:%.*]] = load i64, ptr [[NUM_DEPS11]], align 8, !dbg [[DBG9]]
; CHECK-NEXT:    call void @nanos6_create_task(ptr @task_info_var__Z3bari.24, ptr @task_invocation_info__Z3bari.20, ptr null, i64 [[TMP17]], ptr [[TMP1]], ptr [[TMP0]], i64 0, i64 [[TMP18]]), !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[TMP1]], align 8, !dbg [[DBG9]]
; CHECK-NEXT:    [[ARGS_END12:%.*]] = getelementptr i8, ptr [[TMP19]], i64 16, !dbg [[DBG9]]
; CHECK-NEXT:    [[GEP_VLA:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI_1:%.*]], ptr [[TMP19]], i32 0, i32 0, !dbg [[DBG9]]
; CHECK-NEXT:    store ptr [[ARGS_END12]], ptr [[GEP_VLA]], align 4, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP20:%.*]] = mul nuw i64 4, [[TMP7]], !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr [[ARGS_END12]], i64 [[TMP20]], !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP22:%.*]] = mul nuw i64 1, [[TMP7]], !dbg [[DBG9]]
; CHECK-NEXT:    [[GEP_VLA13:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI_1]], ptr [[TMP19]], i32 0, i32 0, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP23:%.*]] = load ptr, ptr [[GEP_VLA13]], align 8, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP24:%.*]] = mul nuw i64 [[TMP22]], 4, !dbg [[DBG9]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[TMP23]], ptr align 4 [[VLA]], i64 [[TMP24]], i1 false), !dbg [[DBG9]]
; CHECK-NEXT:    [[CAPT_GEP_:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI_1]], ptr [[TMP19]], i32 0, i32 1, !dbg [[DBG9]]
; CHECK-NEXT:    store i64 [[TMP7]], ptr [[CAPT_GEP_]], align 8, !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP25:%.*]] = load ptr, ptr [[TMP0]], align 8, !dbg [[DBG9]]
; CHECK-NEXT:    call void @nanos6_submit_task(ptr [[TMP25]]), !dbg [[DBG9]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[TMP1]]), !dbg [[DBG9]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[TMP0]]), !dbg [[DBG9]]
; CHECK-NEXT:    br label [[FINAL_END7:%.*]], !dbg [[DBG9]]
; CHECK:       final.end7:
...
; CHECK:       final.cond2:
; CHECK-NEXT:    [[TMP29:%.*]] = call i32 @nanos6_in_final(), !dbg [[DBG10]]
; CHECK-NEXT:    [[TMP30:%.*]] = icmp ne i32 [[TMP29]], 0, !dbg [[DBG10]]
; CHECK-NEXT:    br i1 [[TMP30]], label [[FINAL_THEN3:%.*]], label [[CODEREPL4:%.*]], !dbg [[DBG10]]
; CHECK:       final.cond8:
; CHECK-NEXT:    [[TMP31:%.*]] = call i32 @nanos6_in_final(), !dbg [[DBG9]]
; CHECK-NEXT:    [[TMP32:%.*]] = icmp ne i32 [[TMP31]], 0, !dbg [[DBG9]]
; CHECK-NEXT:    br i1 [[TMP32]], label [[FINAL_THEN9:%.*]], label [[CODEREPL10:%.*]], !dbg [[DBG9]]
;
;
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_unpacked_priority__Z3bari.4
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_ol_priority__Z3bari.5
; CHECK-SAME: (ptr [[TASK_ARGS:%.*]], ptr [[PRIORITY:%.*]]) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[GEP_N_ADDR:%.*]] = getelementptr [[NANOS6_TASK_ARGS__Z3BARI_0:%.*]], ptr [[TASK_ARGS]], i32 0, i32 0
; CHECK-NEXT:    br label [[END:%.*]]
; CHECK:       end:
; CHECK-NEXT:    call void @nanos6_unpacked_priority__Z3bari.4(ptr [[GEP_N_ADDR]], ptr [[PRIORITY]])
; CHECK-NEXT:    ret void
;
;
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_unpacked_priority__Z3bari.16
...
;
;
; CHECK-LABEL: define {{[^@]+}}@nanos6_ol_priority__Z3bari.17
; CHECK-SAME: (ptr [[TASK_ARGS:%.*]], ptr [[PRIORITY:%.*]]) {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    br label [[END:%.*]]
; CHECK:       end:
; CHECK-NEXT:    call void @nanos6_unpacked_priority__Z3bari.16(ptr [[LOAD_GEP_VLA]], i64 [[LOAD_CAPT_GEP]], ptr [[PRIORITY]])
; CHECK-NEXT:    ret void
;
;
