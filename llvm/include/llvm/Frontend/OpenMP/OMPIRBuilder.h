...
public:
  ...
  LLVM_ABI FunctionCallee createNosvForStaticInitFunction(unsigned IVSize,
                                                          bool IVSigned,
                                                          bool IsGPUDistribute);
  ...
  LLVM_ABI FunctionCallee createDispatchInitFunction(unsigned IVSize,
                                                     bool IVSigned);
  LLVM_ABI FunctionCallee createNosvDispatchInitFunction(unsigned IVSize,
                                                         bool IVSigned);
  ...
  LLVM_ABI FunctionCallee createDispatchNextFunction(unsigned IVSize,
                                                     bool IVSigned);
  LLVM_ABI FunctionCallee createNosvDispatchNextFunction(unsigned IVSize,
                                                         bool IVSigned);
