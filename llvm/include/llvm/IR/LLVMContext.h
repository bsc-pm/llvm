...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    OB_align = 10,                 // "align"
    // OmpSs IDs
    OB_oss_dir = 11,                              // "oss_dir"
    OB_oss_shared = 12,                           // "oss_shared"
    OB_oss_private = 13,                          // "oss_private"
    OB_oss_firstprivate = 14,                     // "oss_firstprivate"
    OB_oss_vla_dims = 15,                         // "oss_vla_dims"
    OB_oss_dep_in = 16,                           // "OB_oss_dep_in"
    OB_oss_dep_out = 17,                          // "OB_oss_dep_out"
    OB_oss_dep_inout = 18,                        // "OB_oss_dep_inout"
    OB_oss_dep_concurrent = 19,                   // "OB_oss_dep_concurrent"
    OB_oss_dep_commutative = 20,                  // "OB_oss_dep_commutative"
    OB_oss_dep_weakin = 21,                       // "OB_oss_dep_weakin"
    OB_oss_dep_weakout = 22,                      // "OB_oss_dep_weakout"
    OB_oss_dep_weakinout = 23,                    // "OB_oss_dep_weakinout"
    OB_oss_dep_weakconcurrent = 24,               // "OB_oss_dep_weakconcurrent"
    OB_oss_dep_weakcommutative = 25,              // "OB_oss_dep_weakcommutative"
    OB_oss_dep_reduction = 26,                    // "OB_oss_dep_reduction"
    OB_oss_dep_weakreduction = 27,                // "OB_oss_dep_weakreduction"
    OB_oss_reduction_init = 28,                   // "OB_oss_reduction_init"
    OB_oss_reduction_comb = 29,                   // "OB_oss_reduction_comb"
    OB_oss_final = 30,                            // "OB_oss_final"
    OB_oss_if = 31,                               // "OB_oss_if"
    OB_oss_cost = 32,                             // "OB_oss_cost"
    OB_oss_priority = 33,                         // "OB_oss_priority"
    OB_oss_label = 34,                            // "OB_oss_label"
    OB_oss_wait = 35,                             // "OB_oss_wait"
    OB_oss_captured = 36,                         // "OB_oss_captured"
    OB_oss_init = 37,                             // "OB_oss_init"
    OB_oss_deinit = 38,                           // "OB_oss_deinit"
    OB_oss_copy = 39,                             // "OB_oss_copy"
    OB_oss_loop_type = 40,                        // "OB_oss_loop_type"
    OB_oss_loop_ind_var = 41,                     // "OB_oss_loop_ind_var"
    OB_oss_loop_lower_bound = 42,                 // "OB_oss_loop_lower_bound"
    OB_oss_loop_upper_bound = 43,                 // "OB_oss_loop_upper_bound"
    OB_oss_loop_step = 44,                        // "OB_oss_loop_step"
    OB_oss_loop_chunksize = 45,                   // "OB_oss_loop_chunksize"
    OB_oss_loop_grainsize = 46,                   // "OB_oss_loop_grainsize"
    OB_oss_loop_unroll = 47,                      // "OB_oss_loop_unroll"
    OB_oss_loop_update = 48,                      // "OB_oss_loop_update"
    OB_oss_while_cond = 49,                       // "OB_oss_while_cond"
    OB_oss_multidep_range_in = 50,                // "OB_oss_multidep_range_in"
    OB_oss_multidep_range_out = 51,               // "OB_oss_multidep_range_out"
    OB_oss_multidep_range_inout = 52,             // "OB_oss_multidep_range_inout"
    OB_oss_multidep_range_concurrent = 53,        // "OB_oss_multidep_range_concurrent"
    OB_oss_multidep_range_commutative = 54,       // "OB_oss_multidep_range_commutative"
    OB_oss_multidep_range_weakin = 55,            // "OB_oss_multidep_range_weakin"
    OB_oss_multidep_range_weakout = 56,           // "OB_oss_multidep_range_weakout"
    OB_oss_multidep_range_weakinout = 57,         // "OB_oss_multidep_range_weakinout"
    OB_oss_multidep_range_weakconcurrent = 58,    // "OB_oss_multidep_range_weakconcurrent"
    OB_oss_multidep_range_weakcommutative = 59,   // "OB_oss_multidep_range_weakcommutative"
    OB_oss_decl_source = 60,                      // "OB_oss_decl_source"
    OB_oss_onready = 61,                          // "OB_oss_onready"
    OB_oss_device = 62,                           // "OB_oss_device"
    OB_oss_device_ndrange = 63,                   // "OB_oss_device_ndrange"
    OB_oss_device_grid = 64,                      // "OB_oss_device_grid"
    OB_oss_device_dev_func = 65,                  // "OB_oss_device_dev_func"
    OB_oss_device_call_order = 66,                // "OB_oss_device_call_order"
    OB_oss_device_shmem = 67,                     // "OB_oss_device_shmem"
    OB_oss_coro_handle = 68,                      // "OB_oss_coro_handle"
    OB_oss_coro_size_store = 69,                  // "OB_oss_coro_size_store"
    OB_oss_immediate = 70,                        // "OB_oss_immediate"
    OB_oss_microtask = 71,                        // "OB_oss_microtask"
