...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    // OmpSs IDs
    OB_oss_dir = 5,                    // "oss_dir"
    OB_oss_shared = 6,                 // "oss_shared"
    OB_oss_private = 7,                // "oss_private"
    OB_oss_firstprivate = 8,           // "oss_firstprivate"
    OB_oss_vla_dims = 9,               // "oss_vla_dims"
    OB_oss_dep_in = 10,                // "OB_oss_dep_in"
    OB_oss_dep_out = 11,               // "OB_oss_dep_out"
    OB_oss_dep_inout = 12,             // "OB_oss_dep_inout"
    OB_oss_dep_concurrent = 13,        // "OB_oss_dep_concurrent"
    OB_oss_dep_commutative = 14,       // "OB_oss_dep_commutative"
    OB_oss_dep_weakin = 15,            // "OB_oss_dep_weakin"
    OB_oss_dep_weakout = 16,           // "OB_oss_dep_weakout"
    OB_oss_dep_weakinout = 17,         // "OB_oss_dep_weakinout"
    OB_oss_dep_weakconcurrent = 18,    // "OB_oss_dep_weakconcurrent"
    OB_oss_dep_weakcommutative = 19,   // "OB_oss_dep_weakcommutative"
    OB_oss_dep_reduction = 20,         // "OB_oss_dep_reduction"
    OB_oss_dep_weakreduction = 21,     // "OB_oss_dep_weakreduction"
    OB_oss_reduction_init = 22,        // "OB_oss_reduction_init"
    OB_oss_reduction_comb = 23,        // "OB_oss_reduction_comb"
    OB_oss_final = 24,                 // "OB_oss_final"
    OB_oss_if = 25,                    // "OB_oss_if"
    OB_oss_cost = 26,                  // "OB_oss_cost"
    OB_oss_priority = 27,              // "OB_oss_priority"
    OB_oss_label = 28,                 // "OB_oss_label"
    OB_oss_wait = 29,                  // "OB_oss_wait"
    OB_oss_captured = 30,              // "OB_oss_captured"
    OB_oss_init = 31,                  // "OB_oss_init"
    OB_oss_deinit = 32,                // "OB_oss_deinit"
    OB_oss_copy = 33,                  // "OB_oss_copy"
    OB_oss_loop_type = 34,             // "OB_oss_loop_type"
    OB_oss_loop_ind_var = 35,          // "OB_oss_loop_ind_var"
