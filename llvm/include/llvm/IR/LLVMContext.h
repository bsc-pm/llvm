...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    OB_kcfi = 8,                   // "kcfi"
    // OmpSs IDs
    OB_oss_dir = 9,                               // "oss_dir"
    OB_oss_shared = 10,                           // "oss_shared"
    OB_oss_private = 11,                          // "oss_private"
    OB_oss_firstprivate = 12,                     // "oss_firstprivate"
    OB_oss_vla_dims = 13,                         // "oss_vla_dims"
    OB_oss_dep_in = 14,                           // "OB_oss_dep_in"
    OB_oss_dep_out = 15,                          // "OB_oss_dep_out"
    OB_oss_dep_inout = 16,                        // "OB_oss_dep_inout"
    OB_oss_dep_concurrent = 17,                   // "OB_oss_dep_concurrent"
    OB_oss_dep_commutative = 18,                  // "OB_oss_dep_commutative"
    OB_oss_dep_weakin = 19,                       // "OB_oss_dep_weakin"
    OB_oss_dep_weakout = 20,                      // "OB_oss_dep_weakout"
    OB_oss_dep_weakinout = 21,                    // "OB_oss_dep_weakinout"
    OB_oss_dep_weakconcurrent = 22,               // "OB_oss_dep_weakconcurrent"
    OB_oss_dep_weakcommutative = 23,              // "OB_oss_dep_weakcommutative"
    OB_oss_dep_reduction = 24,                    // "OB_oss_dep_reduction"
    OB_oss_dep_weakreduction = 25,                // "OB_oss_dep_weakreduction"
    OB_oss_reduction_init = 26,                   // "OB_oss_reduction_init"
    OB_oss_reduction_comb = 27,                   // "OB_oss_reduction_comb"
    OB_oss_final = 28,                            // "OB_oss_final"
    OB_oss_if = 29,                               // "OB_oss_if"
    OB_oss_cost = 30,                             // "OB_oss_cost"
    OB_oss_priority = 31,                         // "OB_oss_priority"
    OB_oss_label = 32,                            // "OB_oss_label"
    OB_oss_wait = 33,                             // "OB_oss_wait"
    OB_oss_captured = 34,                         // "OB_oss_captured"
    OB_oss_init = 35,                             // "OB_oss_init"
    OB_oss_deinit = 36,                           // "OB_oss_deinit"
    OB_oss_copy = 37,                             // "OB_oss_copy"
    OB_oss_loop_type = 38,                        // "OB_oss_loop_type"
    OB_oss_loop_ind_var = 39,                     // "OB_oss_loop_ind_var"
    OB_oss_loop_lower_bound = 40,                 // "OB_oss_loop_lower_bound"
    OB_oss_loop_upper_bound = 41,                 // "OB_oss_loop_upper_bound"
    OB_oss_loop_step = 42,                        // "OB_oss_loop_step"
    OB_oss_loop_chunksize = 43,                   // "OB_oss_loop_chunksize"
    OB_oss_loop_grainsize = 44,                   // "OB_oss_loop_grainsize"
    OB_oss_loop_unroll = 45,                      // "OB_oss_loop_unroll"
    OB_oss_loop_update = 46,                      // "OB_oss_loop_update"
    OB_oss_while_cond = 47,                       // "OB_oss_while_cond"
    OB_oss_multidep_range_in = 48,                // "OB_oss_multidep_range_in"
    OB_oss_multidep_range_out = 49,               // "OB_oss_multidep_range_out"
    OB_oss_multidep_range_inout = 50,             // "OB_oss_multidep_range_inout"
    OB_oss_multidep_range_concurrent = 51,        // "OB_oss_multidep_range_concurrent"
    OB_oss_multidep_range_commutative = 52,       // "OB_oss_multidep_range_commutative"
    OB_oss_multidep_range_weakin = 53,            // "OB_oss_multidep_range_weakin"
    OB_oss_multidep_range_weakout = 54,           // "OB_oss_multidep_range_weakout"
    OB_oss_multidep_range_weakinout = 55,         // "OB_oss_multidep_range_weakinout"
    OB_oss_multidep_range_weakconcurrent = 56,    // "OB_oss_multidep_range_weakconcurrent"
    OB_oss_multidep_range_weakcommutative = 57,   // "OB_oss_multidep_range_weakcommutative"
    OB_oss_decl_source = 58,                      // "OB_oss_decl_source"
    OB_oss_onready = 59,                          // "OB_oss_onready"
    ...
    OB_oss_device_shmem = 64,                     // "OB_oss_device_shmem"
  };
