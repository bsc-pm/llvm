...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    OB_oss_dep_reduction = 15,     // "OB_oss_dep_reduction"
    OB_oss_dep_weakreduction = 16, // "OB_oss_dep_weakreduction"
    OB_oss_reduction_init = 17,    // "OB_oss_reduction_init"
    OB_oss_reduction_comb = 18,    // "OB_oss_reduction_comb"
    OB_oss_final = 19,             // "OB_oss_final"
    OB_oss_if = 20,                // "OB_oss_if"
    OB_oss_cost = 21,              // "OB_oss_cost"
    OB_oss_priority = 22,          // "OB_oss_priority"
    OB_oss_captured = 23,          // "OB_oss_captured"
    OB_oss_init = 24,              // "OB_oss_init"
    OB_oss_deinit = 25,            // "OB_oss_deinit"
    OB_oss_copy = 26,              // "OB_oss_copy"
  };
