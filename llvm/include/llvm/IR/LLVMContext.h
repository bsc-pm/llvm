...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    OB_oss_multidep_range_in = 44,                // "OB_oss_multidep_range_in"
    OB_oss_multidep_range_out = 45,               // "OB_oss_multidep_range_out"
    OB_oss_multidep_range_inout = 46,             // "OB_oss_multidep_range_inout"
    OB_oss_multidep_range_concurrent = 47,        // "OB_oss_multidep_range_concurrent"
    OB_oss_multidep_range_commutative = 48,       // "OB_oss_multidep_range_commutative"
    OB_oss_multidep_range_weakin = 49,            // "OB_oss_multidep_range_weakin"
    OB_oss_multidep_range_weakout = 50,           // "OB_oss_multidep_range_weakout"
    OB_oss_multidep_range_weakinout = 51,         // "OB_oss_multidep_range_weakinout"
    OB_oss_multidep_range_weakconcurrent = 52,    // "OB_oss_multidep_range_weakconcurrent"
    OB_oss_multidep_range_weakcommutative = 53,   // "OB_oss_multidep_range_weakcommutative"
    OB_oss_decl_source = 54,                      // "OB_oss_decl_source"
    OB_oss_onready = 55,                          // "OB_oss_onready"
  };
