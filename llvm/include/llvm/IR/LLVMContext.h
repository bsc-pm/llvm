...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    OB_oss_reduction_init = 16,  // "OB_oss_reduction_init"
    OB_oss_reduction_comb = 17,  // "OB_oss_reduction_comb"
    OB_oss_final = 18,           // "OB_oss_final"
    OB_oss_if = 19,              // "OB_oss_if"
    OB_oss_cost = 20,            // "OB_oss_cost"
    OB_oss_priority = 21,        // "OB_oss_priority"
    OB_oss_captured = 22,        // "OB_oss_captured"
    OB_oss_init = 23,            // "OB_oss_init"
    OB_oss_deinit = 24,          // "OB_oss_deinit"
    OB_oss_copy = 25,            // "OB_oss_copy"
  };
