...
#undef LLVM_FIXED_MD_KIND
  ...
  enum : unsigned {
    ...
    // OmpSs IDs
    OB_oss_dir = 12,                              // "oss_dir"
    OB_oss_shared = 13,                           // "oss_shared"
    OB_oss_private = 14,                          // "oss_private"
    OB_oss_firstprivate = 15,                     // "oss_firstprivate"
    OB_oss_vla_dims = 16,                         // "oss_vla_dims"
    OB_oss_dep_in = 17,                           // "OB_oss_dep_in"
    OB_oss_dep_out = 18,                          // "OB_oss_dep_out"
    OB_oss_dep_inout = 19,                        // "OB_oss_dep_inout"
    OB_oss_dep_concurrent = 20,                   // "OB_oss_dep_concurrent"
    OB_oss_dep_commutative = 21,                  // "OB_oss_dep_commutative"
    OB_oss_dep_weakin = 22,                       // "OB_oss_dep_weakin"
    OB_oss_dep_weakout = 23,                      // "OB_oss_dep_weakout"
    OB_oss_dep_weakinout = 24,                    // "OB_oss_dep_weakinout"
    OB_oss_dep_weakconcurrent = 25,               // "OB_oss_dep_weakconcurrent"
    OB_oss_dep_weakcommutative = 26,              // "OB_oss_dep_weakcommutative"
    OB_oss_dep_reduction = 27,                    // "OB_oss_dep_reduction"
    OB_oss_dep_weakreduction = 28,                // "OB_oss_dep_weakreduction"
    OB_oss_reduction_init = 29,                   // "OB_oss_reduction_init"
    OB_oss_reduction_comb = 30,                   // "OB_oss_reduction_comb"
    OB_oss_final = 31,                            // "OB_oss_final"
    OB_oss_if = 32,                               // "OB_oss_if"
    OB_oss_cost = 33,                             // "OB_oss_cost"
    OB_oss_priority = 34,                         // "OB_oss_priority"
    OB_oss_label = 35,                            // "OB_oss_label"
    OB_oss_wait = 36,                             // "OB_oss_wait"
    OB_oss_captured = 37,                         // "OB_oss_captured"
    OB_oss_init = 38,                             // "OB_oss_init"
    OB_oss_deinit = 39,                           // "OB_oss_deinit"
    OB_oss_copy = 40,                             // "OB_oss_copy"
    OB_oss_loop_type = 41,                        // "OB_oss_loop_type"
    OB_oss_loop_ind_var = 42,                     // "OB_oss_loop_ind_var"
    OB_oss_loop_lower_bound = 43,                 // "OB_oss_loop_lower_bound"
    OB_oss_loop_upper_bound = 44,                 // "OB_oss_loop_upper_bound"
    OB_oss_loop_step = 45,                        // "OB_oss_loop_step"
    OB_oss_loop_chunksize = 46,                   // "OB_oss_loop_chunksize"
    OB_oss_loop_grainsize = 47,                   // "OB_oss_loop_grainsize"
    OB_oss_loop_unroll = 48,                      // "OB_oss_loop_unroll"
    OB_oss_loop_update = 49,                      // "OB_oss_loop_update"
    OB_oss_while_cond = 50,                       // "OB_oss_while_cond"
    OB_oss_multidep_range_in = 51,                // "OB_oss_multidep_range_in"
    OB_oss_multidep_range_out = 52,               // "OB_oss_multidep_range_out"
    OB_oss_multidep_range_inout = 53,             // "OB_oss_multidep_range_inout"
    OB_oss_multidep_range_concurrent = 54,        // "OB_oss_multidep_range_concurrent"
    OB_oss_multidep_range_commutative = 55,       // "OB_oss_multidep_range_commutative"
    OB_oss_multidep_range_weakin = 56,            // "OB_oss_multidep_range_weakin"
    OB_oss_multidep_range_weakout = 57,           // "OB_oss_multidep_range_weakout"
    OB_oss_multidep_range_weakinout = 58,         // "OB_oss_multidep_range_weakinout"
    OB_oss_multidep_range_weakconcurrent = 59,    // "OB_oss_multidep_range_weakconcurrent"
    OB_oss_multidep_range_weakcommutative = 60,   // "OB_oss_multidep_range_weakcommutative"
    OB_oss_decl_source = 61,                      // "OB_oss_decl_source"
    OB_oss_onready = 62,                          // "OB_oss_onready"
    OB_oss_device = 63,                           // "OB_oss_device"
    OB_oss_device_ndrange = 64,                   // "OB_oss_device_ndrange"
    OB_oss_device_grid = 65,                      // "OB_oss_device_grid"
    OB_oss_device_dev_func = 66,                  // "OB_oss_device_dev_func"
    OB_oss_device_call_order = 67,                // "OB_oss_device_call_order"
    OB_oss_device_shmem = 68,                     // "OB_oss_device_shmem"
    OB_oss_coro_handle = 69,                      // "OB_oss_coro_handle"
    OB_oss_coro_size_store = 70,                  // "OB_oss_coro_size_store"
    OB_oss_immediate = 71,                        // "OB_oss_immediate"
    OB_oss_microtask = 72,                        // "OB_oss_microtask"
