...
LLVM_ABI void initializeOmpSsLegacyPassPass(PassRegistry&);
LLVM_ABI void initializeOmpSsPreprocessingLegacyPassPass(PassRegistry&);
LLVM_ABI void initializeOmpSsRegionAnalysisLegacyPassPass(PassRegistry&);
LLVM_ABI void
