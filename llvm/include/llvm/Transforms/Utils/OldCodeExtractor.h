//===- Transform/Utils/OldCodeExtractor.h - Code extraction util ---*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_UTILS_OLDCODEEXTRACTOR_H
#define LLVM_TRANSFORMS_UTILS_OLDCODEEXTRACTOR_H
...
/// A cache for the OldCodeExtractor analysis. The operation \ref
/// OldCodeExtractor::extractCodeRegion is guaranteed not to invalidate this
...
class OldCodeExtractorAnalysisCache {
...
public:
  OldCodeExtractorAnalysisCache(Function &F);

  /// Get the allocas in the function at the time the analysis was created.
  /// Note that some of these allocas may no longer be present in the function,
  /// due to \ref OldCodeExtractor::extractCodeRegion.
  ...
  public:
    ...
    /// space.
    OldCodeExtractor(ArrayRef<BasicBlock *> BBs, DominatorTree *DT = nullptr,
    ...
    OldCodeExtractor(ArrayRef<BasicBlock *> BBs,
                  std::function<Function*(BasicBlock *header,
                                          BasicBlock *newRootNode,
                                          BasicBlock *newHeader,
                                          Function *oldFunction,
    ...
    ///
    /// Returns zero when called on a OldCodeExtractor instance where isEligible
    /// returns false.
    Function *extractCodeRegion(const OldCodeExtractorAnalysisCache &CEAC);
    ...
    ///
    /// \param CEAC - Cache to speed up operations for the OldCodeExtractor when
    ...
    bool
    isLegalToShrinkwrapLifetimeMarkers(const OldCodeExtractorAnalysisCache &CEAC,
    ...
    /// 'Allocas'.
    void findAllocas(const OldCodeExtractorAnalysisCache &CEAC,
  ...
  private:
    ...
    LifetimeMarkerInfo
    getLifetimeMarkers(const OldCodeExtractorAnalysisCache &CEAC,
...
#endif // LLVM_TRANSFORMS_UTILS_OLDCODEEXTRACTOR_H
