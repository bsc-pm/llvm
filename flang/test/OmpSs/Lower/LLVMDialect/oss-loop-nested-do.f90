...
! LLVMIRDialect:             %[[VAL_6:[-0-9A-Za-z._]+]] = llvm.mlir.constant(10 : index) : i64
...
! LLVMIRDialect:             %[[VAL_12:[-0-9A-Za-z._]+]] = llvm.trunc %[[VAL_7]] : i64 to i32
! LLVMIRDialect:             llvm.br ^bb1(%[[VAL_12]], %[[VAL_6]] : i32, i64)
...
! LLVMIRDialect:             llvm.br ^bb3(%[[VAL_12]], %[[VAL_6]] : i32, i64)
...
! LLVMIRDialect:             %[[VAL_21:[-0-9A-Za-z._]+]] = llvm.sub %[[VAL_17]], %[[VAL_7]]  : i64
...
! LLVMIRDialect:             %[[VAL_24:[-0-9A-Za-z._]+]] = llvm.sub %[[VAL_14]], %[[VAL_7]]  : i64
...
! LLVMIRDialect:             %[[VAL_13:[-0-9A-Za-z._]+]] = llvm.trunc %[[VAL_10]] : i64 to i32
! LLVMIRDialect:             llvm.br ^bb1(%[[VAL_13]], %[[VAL_9]] : i32, i64)
...
! LLVMIRDialect:             %[[VAL_19:[-0-9A-Za-z._]+]] = llvm.sub %[[VAL_15]], %[[VAL_10]]  : i64
