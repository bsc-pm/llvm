...
!LLVMIRDialect:  %[[DEP_0:.*]] = oss.dependency base(%[[VAR_I:.*]] : !llvm.ptr) function(@compute.dep0) arguments(%[[VAR_I:.*]] : !llvm.ptr) -> i32
!LLVMIRDialect-NEXT:  %[[DEP_1:.*]] = oss.dependency base(%[[VAR_I:.*]] : !llvm.ptr) function(@compute.dep1) arguments(%[[VAR_I:.*]] : !llvm.ptr) -> i32
!LLVMIRDialect-NEXT:  oss.release in(%[[DEP_0]] : i32) concurrent(%[[DEP_1]] : i32)
