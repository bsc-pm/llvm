...
!LLVMIR-NEXT: %{{.*}} = call i1 @llvm.directive.marker() [ "DIR.OSS"([8 x i8] c"RELEASE\00"), "QUAL.OSS.DEP.IN"(ptr %1, [11 x i8] c"dep string\00", ptr @compute.dep0, ptr %1), "QUAL.OSS.DEP.CONCURRENT"(ptr %1, [11 x i8] c"dep string\00", ptr @compute.dep1, ptr %1) ]
