...
!FIRDialect-NEXT:   %c6_i32_0 = arith.constant 6 : i32
!FIRDialect-NEXT:   %10 = arith.addi %9, %c6_i32_0 : i32
...
!FIRDialect-NEXT:   %13 = arith.subi %12, %c4_i64_1 : i64
!FIRDialect-NEXT:   %c1_i64_2 = arith.constant 1 : i64
!FIRDialect-NEXT:   %c4_i64_3 = arith.constant 4 : i64
!FIRDialect-NEXT:   %14 = arith.subi %c4_i64_1, %c4_i64_1 : i64
!FIRDialect-NEXT:   %15 = arith.subi %11, %c4_i64_1 : i64
