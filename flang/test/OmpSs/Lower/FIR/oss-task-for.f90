...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_3]] : i32) upper_bound(%[[VAL_4]] : i32) step(%[[VAL_5]] : i32) loop_type(%[[VAL_6]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_2]] : !fir.oss<i32>) {
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_11]] : i32) upper_bound(%[[VAL_12]] : i32) step(%[[VAL_13]] : i32) loop_type(%[[VAL_14]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) if(%[[VAL_10]] : i1) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_7]] : !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_19]] : i32) upper_bound(%[[VAL_20]] : i32) step(%[[VAL_21]] : i32) loop_type(%[[VAL_22]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) final(%[[VAL_18]] : i1) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_15]] : !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_25]] : i32) upper_bound(%[[VAL_26]] : i32) step(%[[VAL_27]] : i32) loop_type(%[[VAL_28]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) cost(%[[VAL_24]] : i32) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_23]] : !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_31]] : i32) upper_bound(%[[VAL_32]] : i32) step(%[[VAL_33]] : i32) loop_type(%[[VAL_34]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) priority(%[[VAL_30]] : i32) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_29]] : !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_36]] : i32) upper_bound(%[[VAL_37]] : i32) step(%[[VAL_38]] : i32) loop_type(%[[VAL_39]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_35]] : !fir.oss<i32>) default( defshared) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_42]] : i32) upper_bound(%[[VAL_43]] : i32) step(%[[VAL_44]] : i32) loop_type(%[[VAL_45]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) private(%[[VAL_0]], %[[VAL_1]] : !fir.ref<i32>, !fir.ref<i32>) private_type(%[[VAL_40]], %[[VAL_41]] : !fir.oss<i32>, !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_48]] : i32) upper_bound(%[[VAL_49]] : i32) step(%[[VAL_50]] : i32) loop_type(%[[VAL_51]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_46]] : !fir.oss<i32>) firstprivate(%[[VAL_0]] : !fir.ref<i32>) firstprivate_type(%[[VAL_47]] : !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_54]] : i32) upper_bound(%[[VAL_55]] : i32) step(%[[VAL_56]] : i32) loop_type(%[[VAL_57]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_53]] : !fir.oss<i32>) shared(%[[VAL_0]] : !fir.ref<i32>) shared_type(%[[VAL_52]] : !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_60]] : i32) upper_bound(%[[VAL_61]] : i32) step(%[[VAL_62]] : i32) loop_type(%[[VAL_63]] : i64) ind_var(%[[VAL_1]] : !fir.ref<i32>) private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_58]] : !fir.oss<i32>) chunksize(%[[VAL_59]] : i32) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
! FIRDialect:           return
! FIRDialect:         }
