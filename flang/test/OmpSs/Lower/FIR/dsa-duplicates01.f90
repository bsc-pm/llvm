...
! FIRDialect:           %[[VAL_3:[-0-9A-Za-z._]+]] = fir.alloca i32 {bindc_name = "i", uniq_name = "_QFEi"}
! FIRDialect:           %[[VAL_4:[-0-9A-Za-z._]+]] = fir.declare %[[VAL_3]] {uniq_name = "_QFEi"} : (!fir.ref<i32>) -> !fir.ref<i32>
! FIRDialect:           %[[VAL_5:[-0-9A-Za-z._]+]] = fir.alloca i32 {bindc_name = "j", uniq_name = "_QFEj"}
! FIRDialect:           %[[VAL_6:[-0-9A-Za-z._]+]] = fir.declare %[[VAL_5]] {uniq_name = "_QFEj"} : (!fir.ref<i32>) -> !fir.ref<i32>
! FIRDialect:           %[[VAL_7:[-0-9A-Za-z._]+]] = fir.alloca i32 {bindc_name = "k", uniq_name = "_QFEk"}
! FIRDialect:           %[[VAL_8:[-0-9A-Za-z._]+]] = fir.declare %[[VAL_7]] {uniq_name = "_QFEk"} : (!fir.ref<i32>) -> !fir.ref<i32>
! FIRDialect:           %[[VAL_9:[-0-9A-Za-z._]+]] = fir.alloca i32 {bindc_name = "u", uniq_name = "_QFEu"}
! FIRDialect:           %[[VAL_10:[-0-9A-Za-z._]+]] = fir.declare %[[VAL_9]] {uniq_name = "_QFEu"} : (!fir.ref<i32>) -> !fir.ref<i32>
...
! FIRDialect:           oss.task_for lower_bound(%[[VAL_2]] : i32) upper_bound(%[[VAL_1]] : i32) step(%[[VAL_2]] : i32) loop_type(%[[VAL_0]] : i64) ind_var(%[[VAL_4]] : !fir.ref<i32>) private(%[[VAL_4]], %[[VAL_4]], %[[VAL_6]], %[[VAL_6]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) private_type(%[[VAL_11]], %[[VAL_12]], %[[VAL_13]], %[[VAL_14]] : !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>) firstprivate(%[[VAL_8]], %[[VAL_8]], %[[VAL_10]], %[[VAL_10]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) firstprivate_type(%[[VAL_15]], %[[VAL_16]], %[[VAL_17]], %[[VAL_18]] : !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>) default( deffirstprivate) {
! FIRDialect:             %[[VAL_19:[-0-9A-Za-z._]+]] = arith.constant 1 : i32
! FIRDialect:             fir.store %[[VAL_19]] to %[[VAL_10]] : !fir.ref<i32>
...
! FIRDialect:           oss.taskloop lower_bound(%[[VAL_2]] : i32) upper_bound(%[[VAL_1]] : i32) step(%[[VAL_2]] : i32) loop_type(%[[VAL_0]] : i64) ind_var(%[[VAL_4]] : !fir.ref<i32>) private(%[[VAL_4]], %[[VAL_4]], %[[VAL_6]], %[[VAL_6]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) private_type(%[[VAL_20]], %[[VAL_21]], %[[VAL_22]], %[[VAL_23]] : !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>) firstprivate(%[[VAL_8]], %[[VAL_8]], %[[VAL_10]], %[[VAL_10]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) firstprivate_type(%[[VAL_24]], %[[VAL_25]], %[[VAL_26]], %[[VAL_27]] : !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>) default( deffirstprivate) {
! FIRDialect:             %[[VAL_28:[-0-9A-Za-z._]+]] = arith.constant 1 : i32
! FIRDialect:             fir.store %[[VAL_28]] to %[[VAL_10]] : !fir.ref<i32>
! FIRDialect:             oss.terminator
! FIRDialect:           }
...
! FIRDialect:           oss.taskloop_for lower_bound(%[[VAL_2]] : i32) upper_bound(%[[VAL_1]] : i32) step(%[[VAL_2]] : i32) loop_type(%[[VAL_0]] : i64) ind_var(%[[VAL_4]] : !fir.ref<i32>) private(%[[VAL_4]], %[[VAL_4]], %[[VAL_6]], %[[VAL_6]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) private_type(%[[VAL_29]], %[[VAL_30]], %[[VAL_31]], %[[VAL_32]] : !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>) firstprivate(%[[VAL_8]], %[[VAL_8]], %[[VAL_10]], %[[VAL_10]] : !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>, !fir.ref<i32>) firstprivate_type(%[[VAL_33]], %[[VAL_34]], %[[VAL_35]], %[[VAL_36]] : !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>, !fir.oss<i32>) default( deffirstprivate) {
! FIRDialect:             %[[VAL_37:[-0-9A-Za-z._]+]] = arith.constant 1 : i32
! FIRDialect:             fir.store %[[VAL_37]] to %[[VAL_10]] : !fir.ref<i32>
! FIRDialect:             oss.terminator
! FIRDialect:           }
! FIRDialect:           return
! FIRDialect:         }
