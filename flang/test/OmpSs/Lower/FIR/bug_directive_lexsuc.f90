...
! FIRDialect:             %[[VAL_1:[-0-9A-Za-z._]+]] = arith.constant 888 : i32
...
! FIRDialect:           %[[VAL_4:[-0-9A-Za-z._]+]] = arith.cmpi ne, %[[VAL_2]], %[[VAL_3]] : i32
! FIRDialect:           cf.cond_br %[[VAL_4]], ^bb1, ^bb2
! FIRDialect:         ^bb1:
...
! FIRDialect:           %[[VAL_8:[-0-9A-Za-z._]+]] = fir.call @_FortranAStopStatement(%[[VAL_5]], %[[VAL_6]], %[[VAL_7]]) fastmath<contract> : (i32, i1, i1) -> none
! FIRDialect:           fir.unreachable
! FIRDialect:         ^bb2:
! FIRDialect:           oss.task firstprivate(%[[VAL_0]] : !fir.ref<i32>) {
! FIRDialect:             %[[VAL_9:[-0-9A-Za-z._]+]] = arith.constant 777 : i32
! FIRDialect:             fir.store %[[VAL_9]] to %[[VAL_0]] : !fir.ref<i32>
! FIRDialect:             oss.terminator
! FIRDialect:           }
! FIRDialect:           return
! FIRDialect:         }
