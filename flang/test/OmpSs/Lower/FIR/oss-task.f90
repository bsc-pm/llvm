...
! FIRDialect:           oss.task private(%[[VAL_2]], %[[VAL_2]] : !fir.ref<i32>, !fir.ref<i32>) private_type(%[[VAL_7]], %[[VAL_7]] : !fir.oss<i32>, !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
! FIRDialect:           oss.task firstprivate(%[[VAL_2]], %[[VAL_2]] : !fir.ref<i32>, !fir.ref<i32>) firstprivate_type(%[[VAL_7]], %[[VAL_7]] : !fir.oss<i32>, !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
! FIRDialect:           oss.task shared(%[[VAL_2]], %[[VAL_2]] : !fir.ref<i32>, !fir.ref<i32>) shared_type(%[[VAL_7]], %[[VAL_7]] : !fir.oss<i32>, !fir.oss<i32>) {
! FIRDialect:             oss.terminator
! FIRDialect:           }
! FIRDialect:           return
! FIRDialect:         }
