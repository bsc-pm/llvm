...
! FIRDialect:           oss.task private(%[[VAL_1]] : !fir.ref<i32>) private_type(%[[VAL_3]] : !fir.oss<i32>) firstprivate(%[[VAL_0]], %[[VAL_2]] : !fir.ref<i32>, !fir.ref<i32>) firstprivate_type(%[[VAL_4]], %[[VAL_5]] : !fir.oss<i32>, !fir.oss<i32>) default( deffirstprivate) {
! FIRDialect:             %[[VAL_6:[-0-9A-Za-z._]+]] = arith.constant 1 : i32
! FIRDialect:             fir.store %[[VAL_6]] to %[[VAL_0]] : !fir.ref<i32>
