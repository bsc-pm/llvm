...
! FIRDialect:           oss.task firstprivate(%[[VAL_1]], %[[VAL_1]] : !fir.ref<i32>, !fir.ref<i32>) firstprivate_type(%[[VAL_2]], %[[VAL_2]] : !fir.oss<i32>, !fir.oss<i32>) {
! FIRDialect:             %[[VAL_3:[-0-9A-Za-z._]+]] = arith.constant 1 : i32
! FIRDialect:             %[[VAL_4:[-0-9A-Za-z._]+]] = fir.load %[[VAL_1]] : !fir.ref<i32>
! FIRDialect:             %[[VAL_5:[-0-9A-Za-z._]+]] = arith.addi %[[VAL_4]], %[[VAL_3]] : i32
! FIRDialect:             fir.store %[[VAL_5]] to %[[VAL_1]] : !fir.ref<i32>
