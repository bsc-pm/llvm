...
!FIRDialect-LABEL: func @compute.dep0(%arg0: !fir.ref<!fir.array<10x10xi32>>) -> (!fir.ref<!fir.array<10x10xi32>>, i64, i64, i64, i64, i64, i64)
...
!FIRDialect-NEXT:  %c10_i64_3 = arith.constant 10 : i64
!FIRDialect-NEXT:  %c1_i64_4 = arith.constant 1 : i64
...
!FIRDialect-NEXT:  %2 = arith.addi %1, %c1_i64_4 : i64
!FIRDialect-NEXT:  %3 = arith.subi %c1_i64_2, %c1_i64_2 : i64
!FIRDialect-NEXT:  %4 = arith.subi %c10_i64_3, %c1_i64_2 : i64
!FIRDialect-NEXT:  %5 = arith.addi %4, %c1_i64_4 : i64
...
!FIRDialect-NEXT:  return %arg0, %6, %7, %8, %c10_i64_1, %3, %5 : !fir.ref<!fir.array<10x10xi32>>, i64, i64, i64, i64, i64, i64
