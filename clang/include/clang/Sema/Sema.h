...
class Sema final {
  ...
  // 41. OmpSs-2 Directives and Clauses (SemaOmpSs.cpp)
...
public:
  ...
  /// passing string for message.
  OMPClause *ActOnOpenMPLabelClause(Expr *MS, SourceLocation StartLoc,
                                      SourceLocation LParenLoc,
                                      SourceLocation EndLoc);
...
private:
  ...
  /// \name OmpSs-2 Directives and Clauses
  /// Implementations are in SemaOmpSs.cpp
  ///@{
