...
class Parser : public CodeCompletionHandler {
  ...
  // 11. OmpSs-2 Constructs (ParseOmpSs.cpp)
...
public:
  ...
  public:
    ...
    void setOmpSsLoopDirectiveScope() {
      Self->SetOmpSsLoopDirectiveScope();
    }
...
public:
  ...
  /// \name OmpSs-2 Constructs
  /// Implementations are in ParseOmpSs.cpp
  ///@{
private:
  friend class ParsingOmpSsDirectiveRAII;

  /// Parsing OmpSs directive mode.
  bool OmpSsDirectiveParsing = false;

  /// Current kind of OmpSs clause
  OmpSsClauseKind OSSClauseKind = llvm::oss::OSSC_unknown;
