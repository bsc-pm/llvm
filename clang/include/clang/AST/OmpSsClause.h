...
class OSSClauseWithPreInit {
  ...
  OmpSsDirectiveKind CaptureRegion = OSSD_unknown;

protected:
  OSSClauseWithPreInit(const OSSClause *This) {
    assert(get(This) && "get is not tuned for pre-init.");
  }

  /// Set pre-initialization statement for the clause.
  void setPreInitStmt(Stmt *S, OmpSsDirectiveKind ThisRegion = OSSD_unknown) {
    PreInit = S;
...
public:
  ...
  OmpSsDirectiveKind getCaptureRegion() const { return CaptureRegion; }

  static OSSClauseWithPreInit *get(OSSClause *C);
  static const OSSClauseWithPreInit *get(const OSSClause *C);
};

/// Class that handles post-update expression for some clauses, like
/// 'lastprivate', 'reduction' etc.
class OSSClauseWithPostUpdate : public OSSClauseWithPreInit {
  friend class OSSClauseReader;
...
protected:
  OSSClauseWithPostUpdate(const OSSClause *This) : OSSClauseWithPreInit(This) {
...
public:
  ...
  static OSSClauseWithPostUpdate *get(OSSClause *C);
  static const OSSClauseWithPostUpdate *get(const OSSClause *C);
};
...
class OSSNumThreadsClause : public OSSClause, public OSSClauseWithPreInit {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSNumThreadsClause(Expr *NumThreads, Stmt *HelperNumThreads,
                      OmpSsDirectiveKind CaptureRegion,
                      SourceLocation StartLoc, SourceLocation LParenLoc,
                      SourceLocation EndLoc)
      : OSSClause(OSSC_num_threads, StartLoc, EndLoc),
        OSSClauseWithPreInit(this), LParenLoc(LParenLoc),
  ...
  /// Build an empty clause.
  OSSNumThreadsClause()
      : OSSClause(OSSC_num_threads, SourceLocation(), SourceLocation()),
        OSSClauseWithPreInit(this) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_num_threads;
  }
};
...
class OSSSafelenClause : public OSSClause {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSSafelenClause(Expr *Len, SourceLocation StartLoc, SourceLocation LParenLoc,
                   SourceLocation EndLoc)
      : OSSClause(OSSC_safelen, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Safelen(Len) {}

  /// Build an empty clause.
  explicit OSSSafelenClause()
      : OSSClause(OSSC_safelen, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_safelen;
  }
};
...
class OSSSimdlenClause : public OSSClause {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSSimdlenClause(Expr *Len, SourceLocation StartLoc, SourceLocation LParenLoc,
                   SourceLocation EndLoc)
      : OSSClause(OSSC_simdlen, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Simdlen(Len) {}

  /// Build an empty clause.
  explicit OSSSimdlenClause()
      : OSSClause(OSSC_simdlen, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_simdlen;
  }
};
...
public:
  ...
  OSSCollapseClause(Expr *Num, SourceLocation StartLoc,
      ...
      : OSSClause(OSSC_collapse, StartLoc, EndLoc), LParenLoc(LParenLoc),
        NumForLoops(Num) {}

  /// Build an empty clause.
  explicit OSSCollapseClause()
      : OSSClause(OSSC_collapse, SourceLocation(), SourceLocation()) {}
...
class OSSProcBindClause : public OSSClause {
  friend class OSSClauseReader;
  ...
  OmpSsProcBindClauseKind Kind = OSSC_PROC_BIND_unknown;
  ...
  void setProcBindKind(OmpSsProcBindClauseKind K) { Kind = K; }
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSProcBindClause(OmpSsProcBindClauseKind A, SourceLocation ALoc,
                    SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation EndLoc)
      : OSSClause(OSSC_proc_bind, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Kind(A), KindKwLoc(ALoc) {}

  /// Build an empty clause.
  OSSProcBindClause()
      : OSSClause(OSSC_proc_bind, SourceLocation(), SourceLocation()) {}
  ...
  /// Returns kind of the clause.
  OmpSsProcBindClauseKind getProcBindKind() const { return Kind; }
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_proc_bind;
  }
};
...
class OSSScheduleClause : public OSSClause, public OSSClauseWithPreInit {
  friend class OSSClauseReader;
  ...
  OmpSsScheduleClauseKind Kind = OSSC_SCHEDULE_unknown;

  /// Modifiers for 'schedule' clause.
  enum {FIRST, SECOND, NUM_MODIFIERS};
  OmpSsScheduleClauseModifier Modifiers[NUM_MODIFIERS];
  ...
  void setScheduleKind(OmpSsScheduleClauseKind K) { Kind = K; }

  /// Set the first schedule modifier.
  ///
  /// \param M Schedule modifier.
  void setFirstScheduleModifier(OmpSsScheduleClauseModifier M) {
    Modifiers[FIRST] = M;
  }
  ...
  ///
  /// \param M Schedule modifier.
  void setSecondScheduleModifier(OmpSsScheduleClauseModifier M) {
    Modifiers[SECOND] = M;
  }
  ...
  void setScheduleModifer(OmpSsScheduleClauseModifier M) {
    if (Modifiers[FIRST] == OSSC_SCHEDULE_MODIFIER_unknown)
      Modifiers[FIRST] = M;
    else {
      assert(Modifiers[SECOND] == OSSC_SCHEDULE_MODIFIER_unknown);
      Modifiers[SECOND] = M;
    }
  }
...
public:
  ...
  OSSScheduleClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation KLoc, SourceLocation CommaLoc,
                    SourceLocation EndLoc, OmpSsScheduleClauseKind Kind,
                    Expr *ChunkSize, Stmt *HelperChunkSize,
                    OmpSsScheduleClauseModifier M1, SourceLocation M1Loc,
                    OmpSsScheduleClauseModifier M2, SourceLocation M2Loc)
      : OSSClause(OSSC_schedule, StartLoc, EndLoc), OSSClauseWithPreInit(this),
  ...
  /// Build an empty clause.
  explicit OSSScheduleClause()
      : OSSClause(OSSC_schedule, SourceLocation(), SourceLocation()),
        OSSClauseWithPreInit(this) {
    Modifiers[FIRST] = OSSC_SCHEDULE_MODIFIER_unknown;
    Modifiers[SECOND] = OSSC_SCHEDULE_MODIFIER_unknown;
  }

  /// Get kind of the clause.
  OmpSsScheduleClauseKind getScheduleKind() const { return Kind; }

  /// Get the first modifier of the clause.
  OmpSsScheduleClauseModifier getFirstScheduleModifier() const {
    return Modifiers[FIRST];
  }

  /// Get the second modifier of the clause.
  OmpSsScheduleClauseModifier getSecondScheduleModifier() const {
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_schedule;
  }
};
...
/// parameter 2.
class OSSOrderedClause final
    : public OSSClause,
      private llvm::TrailingObjects<OSSOrderedClause, Expr *> {
  friend class OSSClauseReader;
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSOrderedClause(Expr *Num, unsigned NumLoops, SourceLocation StartLoc,
                   SourceLocation LParenLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_ordered, StartLoc, EndLoc), LParenLoc(LParenLoc),
        NumForLoops(Num), NumberOfLoops(NumLoops) {}

  /// Build an empty clause.
  explicit OSSOrderedClause(unsigned NumLoops)
      : OSSClause(OSSC_ordered, SourceLocation(), SourceLocation()),
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  static OSSOrderedClause *Create(const ASTContext &C, Expr *Num,
                                  unsigned NumLoops, SourceLocation StartLoc,
                                  SourceLocation LParenLoc,
                                  SourceLocation EndLoc);

  /// Build an empty clause.
  static OSSOrderedClause* CreateEmpty(const ASTContext &C, unsigned NumLoops);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_ordered;
  }
};
...
public:
  ...
  OSSNowaitClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_nowait, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OSSNowaitClause()
      : OSSClause(OSSC_nowait, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_nowait;
  }
};
...
class OSSUntiedClause : public OSSClause {
public:
  /// Build 'untied' clause.
  ///
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSUntiedClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_untied, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OSSUntiedClause()
      : OSSClause(OSSC_untied, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_untied;
  }
};
...
class OSSMergeableClause : public OSSClause {
public:
  /// Build 'mergeable' clause.
  ///
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSMergeableClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_mergeable, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OSSMergeableClause()
      : OSSClause(OSSC_mergeable, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_mergeable;
  }
};
...
public:
  ...
  /// Build an empty clause.
  OSSReadClause() : OSSClause(OSSC_read, SourceLocation(), SourceLocation()) {}
...
class OSSFirstprivateClause final
  ...
  OSSFirstprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                        SourceLocation EndLoc, unsigned N)
      : OSSVarListClause<OSSFirstprivateClause>(OSSC_firstprivate, StartLoc,
                                                LParenLoc, EndLoc, N),
        OSSClauseWithPreInit(this) {}
  ...
  explicit OSSFirstprivateClause(unsigned N)
      : OSSVarListClause<OSSFirstprivateClause>(
            OSSC_firstprivate, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OSSClauseWithPreInit(this) {}
...
public:
  ...
  /// of array type.
  /// \param PreInit Statement that must be executed before entering the OmpSs
...
/// with the variables 'a' and 'b'.
class OSSLastprivateClause final
    : public OSSVarListClause<OSSLastprivateClause>,
      public OSSClauseWithPostUpdate,
      private llvm::TrailingObjects<OSSLastprivateClause, Expr *> {
  ...
  /// \param EndLoc Ending location of the clause.
  /// \param N Number of the variables in the clause.
  OSSLastprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation EndLoc, unsigned N)
      : OSSVarListClause<OSSLastprivateClause>(OSSC_lastprivate, StartLoc,
                                               LParenLoc, EndLoc, N),
        OSSClauseWithPostUpdate(this) {}

  /// Build an empty clause.
  ///
  /// \param N Number of variables.
  explicit OSSLastprivateClause(unsigned N)
      : OSSVarListClause<OSSLastprivateClause>(
            OSSC_lastprivate, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OSSClauseWithPostUpdate(this) {}
...
public:
  ...
  /// OmpSs region with this clause.
  static OSSLastprivateClause *
  Create(const ASTContext &C, SourceLocation StartLoc, SourceLocation LParenLoc,
  ...
  /// \param C AST context.
  /// \param N The number of variables.
  static OSSLastprivateClause *CreateEmpty(const ASTContext &C, unsigned N);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_lastprivate;
  }
};
...
class OSSReductionClause final
  ...
  OSSReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc,
      ...
      : OSSVarListClause<OSSReductionClause>(OSSC_reduction, StartLoc,
                                             LParenLoc, EndLoc, N),
        OSSClauseWithPostUpdate(this), ColonLoc(ColonLoc),
...
class OSSTaskReductionClause final
    : public OSSVarListClause<OSSTaskReductionClause>,
      public OSSClauseWithPostUpdate,
      private llvm::TrailingObjects<OSSTaskReductionClause, Expr *> {
  friend class OSSClauseReader;
  friend OSSVarListClause;
  friend TrailingObjects;
  ...
  /// \param QualifierLoc The nested-name qualifier with location information
  /// \param NameInfo The full name info for reduction identifier.
  OSSTaskReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                         SourceLocation ColonLoc, SourceLocation EndLoc,
                         unsigned N, NestedNameSpecifierLoc QualifierLoc,
                         const DeclarationNameInfo &NameInfo)
      : OSSVarListClause<OSSTaskReductionClause>(OSSC_task_reduction, StartLoc,
                                                 LParenLoc, EndLoc, N),
        OSSClauseWithPostUpdate(this), ColonLoc(ColonLoc),
        QualifierLoc(QualifierLoc), NameInfo(NameInfo) {}
  ...
  ///
  /// \param N Number of variables.
  explicit OSSTaskReductionClause(unsigned N)
      : OSSVarListClause<OSSTaskReductionClause>(
            OSSC_task_reduction, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OSSClauseWithPostUpdate(this) {}
...
public:
  ...
  /// \param C AST context.
  /// \param N The number of variables.
  static OSSTaskReductionClause *CreateEmpty(const ASTContext &C, unsigned N);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_task_reduction;
  }
};
...
class OSSInReductionClause final
    : public OSSVarListClause<OSSInReductionClause>,
      public OSSClauseWithPostUpdate,
      private llvm::TrailingObjects<OSSInReductionClause, Expr *> {
  friend class OSSClauseReader;
  friend OSSVarListClause;
  friend TrailingObjects;
  ...
  /// \param QualifierLoc The nested-name qualifier with location information
  /// \param NameInfo The full name info for reduction identifier.
  OSSInReductionClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation ColonLoc, SourceLocation EndLoc,
                       unsigned N, NestedNameSpecifierLoc QualifierLoc,
                       const DeclarationNameInfo &NameInfo)
      : OSSVarListClause<OSSInReductionClause>(OSSC_in_reduction, StartLoc,
                                               LParenLoc, EndLoc, N),
        OSSClauseWithPostUpdate(this), ColonLoc(ColonLoc),
        QualifierLoc(QualifierLoc), NameInfo(NameInfo) {}
  ...
  ///
  /// \param N Number of variables.
  explicit OSSInReductionClause(unsigned N)
      : OSSVarListClause<OSSInReductionClause>(
            OSSC_in_reduction, SourceLocation(), SourceLocation(),
            SourceLocation(), N),
        OSSClauseWithPostUpdate(this) {}
...
public:
  ...
  /// \param C AST context.
  /// \param N The number of variables.
  static OSSInReductionClause *CreateEmpty(const ASTContext &C, unsigned N);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_in_reduction;
  }
};
...
class OSSLinearClause final
    : public OSSVarListClause<OSSLinearClause>,
      public OSSClauseWithPostUpdate,
      private llvm::TrailingObjects<OSSLinearClause, Expr *> {
  friend class OSSClauseReader;
  friend OSSVarListClause;
  friend TrailingObjects;

  /// Modifier of 'linear' clause.
  OmpSsLinearClauseKind Modifier = OSSC_LINEAR_val;
  ...
  OSSLinearClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                  OmpSsLinearClauseKind Modifier, SourceLocation ModifierLoc,
                  SourceLocation ColonLoc, SourceLocation EndLoc,
                  unsigned NumVars)
      : OSSVarListClause<OSSLinearClause>(OSSC_linear, StartLoc, LParenLoc,
                                          EndLoc, NumVars),
        OSSClauseWithPostUpdate(this), Modifier(Modifier),
        ModifierLoc(ModifierLoc), ColonLoc(ColonLoc) {}

  /// Build an empty clause.
  ///
  /// \param NumVars Number of variables.
  explicit OSSLinearClause(unsigned NumVars)
      : OSSVarListClause<OSSLinearClause>(OSSC_linear, SourceLocation(),
                                          SourceLocation(), SourceLocation(),
                                          NumVars),
        OSSClauseWithPostUpdate(this) {}
  ...
  ///
  /// { Vars[] /* in OSSVarListClause */; Privates[]; Inits[]; Updates[];
...
public:
  ...
  /// \param C AST context.
  /// \param NumVars Number of variables.
  static OSSLinearClause *CreateEmpty(const ASTContext &C, unsigned NumVars);

  /// Set modifier.
  void setModifier(OmpSsLinearClauseKind Kind) { Modifier = Kind; }

  /// Return modifier.
  OmpSsLinearClauseKind getModifier() const { return Modifier; }
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_linear;
  }
};
...
class OSSAlignedClause final
    : public OSSVarListClause<OSSAlignedClause>,
      private llvm::TrailingObjects<OSSAlignedClause, Expr *> {
  friend class OSSClauseReader;
  friend OSSVarListClause;
  friend TrailingObjects;
  ...
  /// \param EndLoc Ending location of the clause.
  /// \param NumVars Number of variables.
  OSSAlignedClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                   SourceLocation ColonLoc, SourceLocation EndLoc,
                   unsigned NumVars)
      : OSSVarListClause<OSSAlignedClause>(OSSC_aligned, StartLoc, LParenLoc,
                                           EndLoc, NumVars),
        ColonLoc(ColonLoc) {}
  ...
  ///
  /// \param NumVars Number of variables.
  explicit OSSAlignedClause(unsigned NumVars)
      : OSSVarListClause<OSSAlignedClause>(OSSC_aligned, SourceLocation(),
                                           SourceLocation(), SourceLocation(),
                                           NumVars) {}
...
public:
  ...
  /// \param VL List of references to the variables.
  /// \param A Alignment.
  static OSSAlignedClause *Create(const ASTContext &C, SourceLocation StartLoc,
                                  SourceLocation LParenLoc,
                                  SourceLocation ColonLoc,
                                  SourceLocation EndLoc, ArrayRef<Expr *> VL,
                                  Expr *A);
  ...
  /// \param C AST context.
  /// \param NumVars Number of variables.
  static OSSAlignedClause *CreateEmpty(const ASTContext &C, unsigned NumVars);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_aligned;
  }
};
...
class OSSCopyinClause final
  ...
  OSSCopyinClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                  SourceLocation EndLoc, unsigned N)
      : OSSVarListClause<OSSCopyinClause>(OSSC_copyin, StartLoc, LParenLoc,
                                          EndLoc, N) {}
  ...
  explicit OSSCopyinClause(unsigned N)
      : OSSVarListClause<OSSCopyinClause>(OSSC_copyin, SourceLocation(),
                                          SourceLocation(), SourceLocation(),
                                          N) {}
...
public:
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_copyin;
  }
};
...
/// with the variables 'a' and 'b'.
class OSSCopyprivateClause final
    : public OSSVarListClause<OSSCopyprivateClause>,
      private llvm::TrailingObjects<OSSCopyprivateClause, Expr *> {
  friend class OSSClauseReader;
  friend OSSVarListClause;
  friend TrailingObjects;
  ...
  /// \param EndLoc Ending location of the clause.
  /// \param N Number of the variables in the clause.
  OSSCopyprivateClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation EndLoc, unsigned N)
      : OSSVarListClause<OSSCopyprivateClause>(OSSC_copyprivate, StartLoc,
                                               LParenLoc, EndLoc, N) {}

  /// Build an empty clause.
  ///
  /// \param N Number of variables.
  explicit OSSCopyprivateClause(unsigned N)
      : OSSVarListClause<OSSCopyprivateClause>(
            OSSC_copyprivate, SourceLocation(), SourceLocation(),
            SourceLocation(), N) {}
...
public:
  ...
  /// \param C AST context.
  /// \param N The number of variables.
  static OSSCopyprivateClause *CreateEmpty(const ASTContext &C, unsigned N);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_copyprivate;
  }
};
...
/// of \a OSSExecutableDirective class and its derivatives and to use the
...
/// with the variables 'a' and 'b'.
class OSSFlushClause final
    : public OSSVarListClause<OSSFlushClause>,
      private llvm::TrailingObjects<OSSFlushClause, Expr *> {
  friend OSSVarListClause;
  friend TrailingObjects;
  ...
  /// \param EndLoc Ending location of the clause.
  /// \param N Number of the variables in the clause.
  OSSFlushClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                 SourceLocation EndLoc, unsigned N)
      : OSSVarListClause<OSSFlushClause>(OSSC_flush, StartLoc, LParenLoc,
                                         EndLoc, N) {}

  /// Build an empty clause.
  ///
  /// \param N Number of variables.
  explicit OSSFlushClause(unsigned N)
      : OSSVarListClause<OSSFlushClause>(OSSC_flush, SourceLocation(),
                                         SourceLocation(), SourceLocation(),
                                         N) {}
...
public:
  ...
  /// \param EndLoc Ending location of the clause.
  /// \param VL List of references to the variables.
  static OSSFlushClause *Create(const ASTContext &C, SourceLocation StartLoc,
                                SourceLocation LParenLoc, SourceLocation EndLoc,
                                ArrayRef<Expr *> VL);
  ...
  /// \param C AST context.
  /// \param N The number of variables.
  static OSSFlushClause *CreateEmpty(const ASTContext &C, unsigned N);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_flush;
  }
};
...
class OSSDeviceClause : public OSSClause, public OSSClauseWithPreInit {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSDeviceClause(Expr *E, Stmt *HelperE, OmpSsDirectiveKind CaptureRegion,
                  SourceLocation StartLoc, SourceLocation LParenLoc,
                  SourceLocation EndLoc)
      : OSSClause(OSSC_device, StartLoc, EndLoc), OSSClauseWithPreInit(this),
...
class OSSThreadsClause : public OSSClause {
public:
  /// Build 'threads' clause.
  ///
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSThreadsClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_threads, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OSSThreadsClause()
      : OSSClause(OSSC_threads, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_threads;
  }
};
...
class OSSSIMDClause : public OSSClause {
public:
  /// Build 'simd' clause.
  ///
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSSIMDClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_simd, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OSSSIMDClause() : OSSClause(OSSC_simd, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_simd;
  }
};

/// Struct that defines common infrastructure to handle mappable
/// expressions used in OmpSs clauses.
class OSSClauseMappableExprCommon {
public:
...
template <class T>
class OSSMappableExprListClause : public OSSVarListClause<T>,
                                  public OSSClauseMappableExprCommon {
  friend class OSSClauseReader;
...
protected:
  ...
  OSSMappableExprListClause(OmpSsClauseKind K, SourceLocation StartLoc,
                            SourceLocation LParenLoc, SourceLocation EndLoc,
                            unsigned NumVars, unsigned NumUniqueDeclarations,
                            unsigned NumComponentLists, unsigned NumComponents)
      : OSSVarListClause<T>(K, StartLoc, LParenLoc, EndLoc, NumVars),
...
/// with the variables 'a' and 'b'.
class OSSMapClause final : public OSSMappableExprListClause<OSSMapClause>,
                           private llvm::TrailingObjects<
                               OSSMapClause, Expr *, ValueDecl *, unsigned,
                               OSSClauseMappableExprCommon::MappableComponent> {
  friend class OSSClauseReader;
  friend OSSMappableExprListClause;
  friend OSSVarListClause;
  friend TrailingObjects;
  ...
  OmpSsMapClauseKind MapTypeModifier = OSSC_MAP_unknown;

  /// Map type for the 'map' clause.
  OmpSsMapClauseKind MapType = OSSC_MAP_unknown;
  ...
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSMapClause(OmpSsMapClauseKind MapTypeModifier,
                        OmpSsMapClauseKind MapType, bool MapTypeIsImplicit,
                        SourceLocation MapLoc, SourceLocation StartLoc,
                        SourceLocation LParenLoc, SourceLocation EndLoc,
                        unsigned NumVars, unsigned NumUniqueDeclarations,
                        unsigned NumComponentLists, unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_map, StartLoc, LParenLoc, EndLoc,
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSMapClause(unsigned NumVars, unsigned NumUniqueDeclarations,
                        unsigned NumComponentLists, unsigned NumComponents)
      : OSSMappableExprListClause(
            OSSC_map, SourceLocation(), SourceLocation(), SourceLocation(),
            NumVars, NumUniqueDeclarations, NumComponentLists, NumComponents) {}

  /// Set type modifier for the clause.
  ///
  /// \param T Type Modifier for the clause.
  void setMapTypeModifier(OmpSsMapClauseKind T) { MapTypeModifier = T; }

  /// Set type for the clause.
  ///
  /// \param T Type for the clause.
  void setMapType(OmpSsMapClauseKind T) { MapType = T; }
...
public:
  ...
  static OSSMapClause *Create(const ASTContext &C, SourceLocation StartLoc,
                              SourceLocation LParenLoc, SourceLocation EndLoc,
                              ArrayRef<Expr *> Vars,
                              ArrayRef<ValueDecl *> Declarations,
                              MappableExprComponentListsRef ComponentLists,
                              OmpSsMapClauseKind TypeModifier,
                              OmpSsMapClauseKind Type, bool TypeIsImplicit,
  ...
  /// clause.
  /// \param NumComponents Total number of expression components in the clause.
  static OSSMapClause *CreateEmpty(const ASTContext &C, unsigned NumVars,
                                   unsigned NumUniqueDeclarations,
                                   unsigned NumComponentLists,
                                   unsigned NumComponents);

  /// Fetches mapping kind for the clause.
  OmpSsMapClauseKind getMapType() const LLVM_READONLY { return MapType; }
  ...
  OmpSsMapClauseKind getMapTypeModifier() const LLVM_READONLY {
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_map;
  }
};
...
class OSSNumTeamsClause : public OSSClause, public OSSClauseWithPreInit {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSNumTeamsClause(Expr *E, Stmt *HelperE, OmpSsDirectiveKind CaptureRegion,
                    SourceLocation StartLoc, SourceLocation LParenLoc,
                    SourceLocation EndLoc)
      : OSSClause(OSSC_num_teams, StartLoc, EndLoc), OSSClauseWithPreInit(this),
  ...
  /// Build an empty clause.
  OSSNumTeamsClause()
      : OSSClause(OSSC_num_teams, SourceLocation(), SourceLocation()),
        OSSClauseWithPreInit(this) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_num_teams;
  }
};
...
/// with single expression 'n'.
class OSSThreadLimitClause : public OSSClause, public OSSClauseWithPreInit {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSThreadLimitClause(Expr *E, Stmt *HelperE,
                       OmpSsDirectiveKind CaptureRegion,
                       SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation EndLoc)
      : OSSClause(OSSC_thread_limit, StartLoc, EndLoc),
        OSSClauseWithPreInit(this), LParenLoc(LParenLoc), ThreadLimit(E) {
    setPreInitStmt(HelperE, CaptureRegion);
  }

  /// Build an empty clause.
  OSSThreadLimitClause()
      : OSSClause(OSSC_thread_limit, SourceLocation(), SourceLocation()),
        OSSClauseWithPreInit(this) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_thread_limit;
  }
};
...
public:
  ...
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSGrainsizeClause(Expr *Size, SourceLocation StartLoc,
                     SourceLocation LParenLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_grainsize, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Grainsize(Size) {}

  /// Build an empty clause.
  explicit OSSGrainsizeClause()
...
class OSSNogroupClause : public OSSClause {
public:
  /// Build 'nogroup' clause.
  ///
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSNogroupClause(SourceLocation StartLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_nogroup, StartLoc, EndLoc) {}

  /// Build an empty clause.
  OSSNogroupClause()
      : OSSClause(OSSC_nogroup, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_nogroup;
  }
};
...
/// with single expression '4'.
class OSSNumTasksClause : public OSSClause {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param StartLoc Starting location of the clause.
  /// \param EndLoc Ending location of the clause.
  OSSNumTasksClause(Expr *Size, SourceLocation StartLoc,
                    SourceLocation LParenLoc, SourceLocation EndLoc)
      : OSSClause(OSSC_num_tasks, StartLoc, EndLoc), LParenLoc(LParenLoc),
        NumTasks(Size) {}

  /// Build an empty clause.
  explicit OSSNumTasksClause()
      : OSSClause(OSSC_num_tasks, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_num_tasks;
  }
};
...
class OSSHintClause : public OSSClause {
  friend class OSSClauseReader;
...
public:
  ...
  /// \param LParenLoc Location of '('.
  /// \param EndLoc Ending location of the clause.
  OSSHintClause(Expr *Hint, SourceLocation StartLoc, SourceLocation LParenLoc,
                SourceLocation EndLoc)
      : OSSClause(OSSC_hint, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Hint(Hint) {}

  /// Build an empty clause.
  OSSHintClause() : OSSClause(OSSC_hint, SourceLocation(), SourceLocation()) {}
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_hint;
  }
};
...
class OSSDistScheduleClause : public OSSClause, public OSSClauseWithPreInit {
  friend class OSSClauseReader;
  ...
  /// A kind of the 'schedule' clause.
  OmpSsDistScheduleClauseKind Kind = OSSC_DIST_SCHEDULE_unknown;
  ...
  ///
  /// \param K Schedule kind.
  void setDistScheduleKind(OmpSsDistScheduleClauseKind K) { Kind = K; }
...
public:
  ...
  /// \param ChunkSize Chunk size.
  /// \param HelperChunkSize Helper chunk size for combined directives.
  OSSDistScheduleClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                        SourceLocation KLoc, SourceLocation CommaLoc,
                        SourceLocation EndLoc,
                        OmpSsDistScheduleClauseKind Kind, Expr *ChunkSize,
                        Stmt *HelperChunkSize)
      : OSSClause(OSSC_dist_schedule, StartLoc, EndLoc),
        OSSClauseWithPreInit(this), LParenLoc(LParenLoc), Kind(Kind),
        KindLoc(KLoc), CommaLoc(CommaLoc), ChunkSize(ChunkSize) {
    setPreInitStmt(HelperChunkSize);
  }

  /// Build an empty clause.
  explicit OSSDistScheduleClause()
      : OSSClause(OSSC_dist_schedule, SourceLocation(), SourceLocation()),
        OSSClauseWithPreInit(this) {}

  /// Get kind of the clause.
  OmpSsDistScheduleClauseKind getDistScheduleKind() const { return Kind; }
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_dist_schedule;
  }
};
...
class OSSDefaultmapClause : public OSSClause {
  friend class OSSClauseReader;
  ...
  OmpSsDefaultmapClauseModifier Modifier = OSSC_DEFAULTMAP_MODIFIER_unknown;

  /// Locations of modifiers.
  SourceLocation ModifierLoc;

  /// A kind of the 'defaultmap' clause.
  OmpSsDefaultmapClauseKind Kind = OSSC_DEFAULTMAP_unknown;
  ...
  void setDefaultmapKind(OmpSsDefaultmapClauseKind K) { Kind = K; }

  /// Set the defaultmap modifier.
  ///
  /// \param M Defaultmap modifier.
  void setDefaultmapModifier(OmpSsDefaultmapClauseModifier M) {
    Modifier = M;
  }
...
public:
  ...
  OSSDefaultmapClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                      SourceLocation MLoc, SourceLocation KLoc,
                      SourceLocation EndLoc, OmpSsDefaultmapClauseKind Kind,
                      OmpSsDefaultmapClauseModifier M)
      : OSSClause(OSSC_defaultmap, StartLoc, EndLoc), LParenLoc(LParenLoc),
        Modifier(M), ModifierLoc(MLoc), Kind(Kind), KindLoc(KLoc) {}

  /// Build an empty clause.
  explicit OSSDefaultmapClause()
      : OSSClause(OSSC_defaultmap, SourceLocation(), SourceLocation()) {}

  /// Get kind of the clause.
  OmpSsDefaultmapClauseKind getDefaultmapKind() const { return Kind; }

  /// Get the modifier of the clause.
  OmpSsDefaultmapClauseModifier getDefaultmapModifier() const {
    return Modifier;
  }
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_defaultmap;
  }
};
...
/// with the variables 'a' and 'b'.
class OSSToClause final : public OSSMappableExprListClause<OSSToClause>,
                          private llvm::TrailingObjects<
                              OSSToClause, Expr *, ValueDecl *, unsigned,
                              OSSClauseMappableExprCommon::MappableComponent> {
  friend class OSSClauseReader;
  friend OSSMappableExprListClause;
  friend OSSVarListClause;
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSToClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                       SourceLocation EndLoc, unsigned NumVars,
                       unsigned NumUniqueDeclarations,
                       unsigned NumComponentLists, unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_to, StartLoc, LParenLoc, EndLoc, NumVars,
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSToClause(unsigned NumVars, unsigned NumUniqueDeclarations,
                       unsigned NumComponentLists, unsigned NumComponents)
      : OSSMappableExprListClause(
            OSSC_to, SourceLocation(), SourceLocation(), SourceLocation(),
            NumVars, NumUniqueDeclarations, NumComponentLists, NumComponents) {}
...
public:
  ...
  /// \param Declarations Declarations used in the clause.
  /// \param ComponentLists Component lists used in the clause.
  static OSSToClause *Create(const ASTContext &C, SourceLocation StartLoc,
                             SourceLocation LParenLoc, SourceLocation EndLoc,
                             ArrayRef<Expr *> Vars,
                             ArrayRef<ValueDecl *> Declarations,
                             MappableExprComponentListsRef ComponentLists);
  ...
  /// clause.
  /// \param NumComponents Total number of expression components in the clause.
  static OSSToClause *CreateEmpty(const ASTContext &C, unsigned NumVars,
                                  unsigned NumUniqueDeclarations,
                                  unsigned NumComponentLists,
                                  unsigned NumComponents);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_to;
  }
};
...
/// with the variables 'a' and 'b'.
class OSSFromClause final
    : public OSSMappableExprListClause<OSSFromClause>,
      private llvm::TrailingObjects<
          OSSFromClause, Expr *, ValueDecl *, unsigned,
          OSSClauseMappableExprCommon::MappableComponent> {
  friend class OSSClauseReader;
  friend OSSMappableExprListClause;
  friend OSSVarListClause;
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSFromClause(SourceLocation StartLoc, SourceLocation LParenLoc,
                         SourceLocation EndLoc, unsigned NumVars,
                         unsigned NumUniqueDeclarations,
                         unsigned NumComponentLists, unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_from, StartLoc, LParenLoc, EndLoc,
                                  NumVars, NumUniqueDeclarations,
                                  NumComponentLists, NumComponents) {}
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSFromClause(unsigned NumVars, unsigned NumUniqueDeclarations,
                         unsigned NumComponentLists, unsigned NumComponents)
      : OSSMappableExprListClause(
            OSSC_from, SourceLocation(), SourceLocation(), SourceLocation(),
            NumVars, NumUniqueDeclarations, NumComponentLists, NumComponents) {}
...
public:
  ...
  /// \param Declarations Declarations used in the clause.
  /// \param ComponentLists Component lists used in the clause.
  static OSSFromClause *Create(const ASTContext &C, SourceLocation StartLoc,
                               SourceLocation LParenLoc, SourceLocation EndLoc,
                               ArrayRef<Expr *> Vars,
                               ArrayRef<ValueDecl *> Declarations,
                               MappableExprComponentListsRef ComponentLists);
  ...
  /// clause.
  /// \param NumComponents Total number of expression components in the clause.
  static OSSFromClause *CreateEmpty(const ASTContext &C, unsigned NumVars,
                                    unsigned NumUniqueDeclarations,
                                    unsigned NumComponentLists,
                                    unsigned NumComponents);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_from;
  }
};
...
class OSSUseDevicePtrClause final
    : public OSSMappableExprListClause<OSSUseDevicePtrClause>,
      private llvm::TrailingObjects<
          OSSUseDevicePtrClause, Expr *, ValueDecl *, unsigned,
          OSSClauseMappableExprCommon::MappableComponent> {
  friend class OSSClauseReader;
  friend OSSMappableExprListClause;
  friend OSSVarListClause;
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSUseDevicePtrClause(SourceLocation StartLoc,
                                 SourceLocation LParenLoc,
                                 SourceLocation EndLoc, unsigned NumVars,
                                 unsigned NumUniqueDeclarations,
                                 unsigned NumComponentLists,
                                 unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_use_device_ptr, StartLoc, LParenLoc,
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSUseDevicePtrClause(unsigned NumVars,
                                 unsigned NumUniqueDeclarations,
                                 unsigned NumComponentLists,
                                 unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_use_device_ptr, SourceLocation(),
...
public:
  ...
  /// clause.
  /// \param NumComponents Total number of expression components in the clause.
  static OSSUseDevicePtrClause *CreateEmpty(const ASTContext &C,
                                            unsigned NumVars,
                                            unsigned NumUniqueDeclarations,
                                            unsigned NumComponentLists,
                                            unsigned NumComponents);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_use_device_ptr;
  }
};
...
class OSSIsDevicePtrClause final
    : public OSSMappableExprListClause<OSSIsDevicePtrClause>,
      private llvm::TrailingObjects<
          OSSIsDevicePtrClause, Expr *, ValueDecl *, unsigned,
          OSSClauseMappableExprCommon::MappableComponent> {
  friend class OSSClauseReader;
  friend OSSMappableExprListClause;
  friend OSSVarListClause;
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSIsDevicePtrClause(SourceLocation StartLoc,
                                SourceLocation LParenLoc, SourceLocation EndLoc,
                                unsigned NumVars,
                                unsigned NumUniqueDeclarations,
                                unsigned NumComponentLists,
                                unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_is_device_ptr, StartLoc, LParenLoc,
                                  EndLoc, NumVars, NumUniqueDeclarations,
                                  NumComponentLists, NumComponents) {}
  ...
  /// \param NumComponentLists Number of component lists in this clause.
  /// \param NumComponents Total number of expression components in the clause.
  explicit OSSIsDevicePtrClause(unsigned NumVars,
                                unsigned NumUniqueDeclarations,
                                unsigned NumComponentLists,
                                unsigned NumComponents)
      : OSSMappableExprListClause(OSSC_is_device_ptr, SourceLocation(),
                                  SourceLocation(), SourceLocation(), NumVars,
                                  NumUniqueDeclarations, NumComponentLists,
                                  NumComponents) {}
...
public:
  ...
  /// clause.
  /// \param NumComponents Total number of expression components in the clause.
  static OSSIsDevicePtrClause *CreateEmpty(const ASTContext &C,
                                           unsigned NumVars,
                                           unsigned NumUniqueDeclarations,
                                           unsigned NumComponentLists,
                                           unsigned NumComponents);
  ...
  static bool classof(const OSSClause *T) {
    return T->getClauseKind() == OSSC_is_device_ptr;
  }
};
