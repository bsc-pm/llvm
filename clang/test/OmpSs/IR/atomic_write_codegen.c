...
// LIN64-NEXT:    [[ATOMIC_LOAD99:%.*]] = load atomic i8, ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED:%.*]], ptr @bfx4_packed, i32 0, i32 1) monotonic, align 1, !dbg [[DBG97:![0-9]+]]
...
// LIN64-NEXT:    [[TMP73:%.*]] = cmpxchg ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1), i8 [[TMP70]], i8 [[TMP72]] monotonic monotonic, align 1, !dbg [[DBG97]]
...
// LIN64-NEXT:    [[ATOMIC_LOAD118:%.*]] = load atomic i8, ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1) monotonic, align 1, !dbg [[DBG101:![0-9]+]]
...
// LIN64-NEXT:    [[TMP86:%.*]] = cmpxchg ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1), i8 [[TMP83]], i8 [[TMP85]] monotonic monotonic, align 1, !dbg [[DBG101]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD99:%.*]] = load atomic i8, ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED:%.*]], ptr @bfx4_packed, i32 0, i32 1) monotonic, align 1, !dbg [[DBG97:![0-9]+]]
...
// PPC64-NEXT:    [[TMP73:%.*]] = cmpxchg ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1), i8 [[TMP70]], i8 [[TMP72]] monotonic monotonic, align 1, !dbg [[DBG97]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD119:%.*]] = load atomic i8, ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1) monotonic, align 1, !dbg [[DBG101:![0-9]+]]
...
// PPC64-NEXT:    [[TMP86:%.*]] = cmpxchg ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1), i8 [[TMP83]], i8 [[TMP85]] monotonic monotonic, align 1, !dbg [[DBG101]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD96:%.*]] = load atomic i8, ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED:%.*]], ptr @bfx4_packed, i32 0, i32 1) monotonic, align 1, !dbg [[DBG96:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP77:%.*]] = cmpxchg ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1), i8 [[TMP74]], i8 [[TMP76]] monotonic monotonic, align 1, !dbg [[DBG96]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD115:%.*]] = load atomic i8, ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1) monotonic, align 1, !dbg [[DBG100:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP90:%.*]] = cmpxchg ptr getelementptr inbounds ([[STRUCT_BITFIELDS4_PACKED]], ptr @bfx4_packed, i32 0, i32 1), i8 [[TMP87]], i8 [[TMP89]] monotonic monotonic, align 1, !dbg [[DBG100]]
