...
// LIN64-NEXT:    [[ATOMIC_LOAD258:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG130:![0-9]+]]
...
// LIN64-NEXT:    [[TMP181:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP178]], i8 [[TMP180]] monotonic monotonic, align 1, !dbg [[DBG130]]
...
// LIN64-NEXT:    [[ATOMIC_LOAD290:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG138:![0-9]+]]
...
// LIN64-NEXT:    [[TMP194:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP191]], i8 [[TMP193]] monotonic monotonic, align 1, !dbg [[DBG138]]
...
// PPC64-NEXT:    [[CIV_IMAG:%.*]] = load i32, ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG45]]
...
// PPC64:       atomic_cont29:
// PPC64-NEXT:    [[ATOMIC_TEMP28_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP28]], i32 0, i32 0, !dbg [[DBG46]]
// PPC64-NEXT:    [[ATOMIC_TEMP28_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP28_REALP]], align 4, !dbg [[DBG46]]
// PPC64-NEXT:    [[ATOMIC_TEMP28_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP28]], i32 0, i32 1, !dbg [[DBG46]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP30_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP30]], i32 0, i32 0, !dbg [[DBG46]]
// PPC64-NEXT:    [[ATOMIC_TEMP30_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP30]], i32 0, i32 1, !dbg [[DBG46]]
...
// PPC64-NEXT:    [[CFV_IMAG:%.*]] = load float, ptr getelementptr inbounds ({ float, float }, ptr @cfv, i32 0, i32 1), align 4, !dbg [[DBG48]]
...
// PPC64:       atomic_cont34:
// PPC64-NEXT:    [[ATOMIC_TEMP33_REALP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP33]], i32 0, i32 0, !dbg [[DBG49]]
// PPC64-NEXT:    [[ATOMIC_TEMP33_REAL:%.*]] = load float, ptr [[ATOMIC_TEMP33_REALP]], align 4, !dbg [[DBG49]]
// PPC64-NEXT:    [[ATOMIC_TEMP33_IMAGP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP33]], i32 0, i32 1, !dbg [[DBG49]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP35_REALP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP35]], i32 0, i32 0, !dbg [[DBG49]]
// PPC64-NEXT:    [[ATOMIC_TEMP35_IMAGP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP35]], i32 0, i32 1, !dbg [[DBG49]]
...
// PPC64-NEXT:    [[CDV_IMAG:%.*]] = load double, ptr getelementptr inbounds ({ double, double }, ptr @cdv, i32 0, i32 1), align 8, !dbg [[DBG51]]
...
// PPC64:       atomic_cont39:
// PPC64-NEXT:    [[ATOMIC_TEMP38_REALP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP38]], i32 0, i32 0, !dbg [[DBG52]]
// PPC64-NEXT:    [[ATOMIC_TEMP38_REAL:%.*]] = load double, ptr [[ATOMIC_TEMP38_REALP]], align 8, !dbg [[DBG52]]
// PPC64-NEXT:    [[ATOMIC_TEMP38_IMAGP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP38]], i32 0, i32 1, !dbg [[DBG52]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP40_REALP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP40]], i32 0, i32 0, !dbg [[DBG52]]
// PPC64-NEXT:    [[ATOMIC_TEMP40_IMAGP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP40]], i32 0, i32 1, !dbg [[DBG52]]
...
// PPC64-NEXT:    [[TOBOOL:%.*]] = trunc i8 [[TMP65]] to i1, !dbg [[DBG54]]
...
// PPC64-NEXT:    [[TOBOOL48:%.*]] = trunc i8 [[TMP68]] to i1, !dbg [[DBG57]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL]], ptr [[ATOMIC_TEMP47]], align 1, !dbg [[DBG57]]
...
// PPC64-NEXT:    br i1 [[TMP72]], label [[ATOMIC_EXIT51:%.*]], label [[ATOMIC_CONT46]], !dbg [[DBG57]]
// PPC64:       atomic_exit51:
// PPC64-NEXT:    [[TMP73:%.*]] = load i8, ptr @ucv, align 1, !dbg [[DBG59:![0-9]+]]
// PPC64-NEXT:    [[CONV52:%.*]] = zext i8 [[TMP73]] to i32, !dbg [[DBG59]]
// PPC64-NEXT:    [[ATOMIC_LOAD53:%.*]] = load atomic i8, ptr @cx seq_cst, align 1, !dbg [[DBG60:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT54:%.*]], !dbg [[DBG60]]
// PPC64:       atomic_cont54:
// PPC64-NEXT:    [[TMP74:%.*]] = phi i8 [ [[ATOMIC_LOAD53]], [[ATOMIC_EXIT51]] ], [ [[TMP77:%.*]], [[ATOMIC_CONT54]] ], !dbg [[DBG60]]
// PPC64-NEXT:    [[CONV56:%.*]] = sext i8 [[TMP74]] to i32, !dbg [[DBG60]]
// PPC64-NEXT:    [[SHR57:%.*]] = ashr i32 [[CONV56]], [[CONV52]], !dbg [[DBG61:![0-9]+]]
// PPC64-NEXT:    [[CONV58:%.*]] = trunc i32 [[SHR57]] to i8, !dbg [[DBG60]]
// PPC64-NEXT:    store i8 [[CONV58]], ptr [[ATOMIC_TEMP55]], align 1, !dbg [[DBG60]]
// PPC64-NEXT:    [[TMP75:%.*]] = load i8, ptr [[ATOMIC_TEMP55]], align 1, !dbg [[DBG60]]
...
// PPC64-NEXT:    br i1 [[TMP78]], label [[ATOMIC_EXIT59:%.*]], label [[ATOMIC_CONT54]], !dbg [[DBG60]]
// PPC64:       atomic_exit59:
// PPC64-NEXT:    fence release
// PPC64-NEXT:    [[TMP79:%.*]] = load i16, ptr @sv, align 2, !dbg [[DBG62:![0-9]+]]
// PPC64-NEXT:    [[CONV60:%.*]] = sext i16 [[TMP79]] to i32, !dbg [[DBG62]]
// PPC64-NEXT:    [[ATOMIC_LOAD61:%.*]] = load atomic i64, ptr @ulx monotonic, align 8, !dbg [[DBG63:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT62:%.*]], !dbg [[DBG63]]
// PPC64:       atomic_cont62:
// PPC64-NEXT:    [[TMP80:%.*]] = phi i64 [ [[ATOMIC_LOAD61]], [[ATOMIC_EXIT59]] ], [ [[TMP83:%.*]], [[ATOMIC_CONT62]] ], !dbg [[DBG63]]
...
// PPC64-NEXT:    store i64 [[CONV65]], ptr [[ATOMIC_TEMP63]], align 8, !dbg [[DBG63]]
// PPC64-NEXT:    [[TMP81:%.*]] = load i64, ptr [[ATOMIC_TEMP63]], align 8, !dbg [[DBG63]]
...
// PPC64-NEXT:    br i1 [[TMP84]], label [[ATOMIC_EXIT66:%.*]], label [[ATOMIC_CONT62]], !dbg [[DBG63]]
// PPC64:       atomic_exit66:
// PPC64-NEXT:    [[TMP85:%.*]] = load i16, ptr @usv, align 2, !dbg [[DBG65:![0-9]+]]
// PPC64-NEXT:    [[CONV67:%.*]] = zext i16 [[TMP85]] to i64, !dbg [[DBG65]]
// PPC64-NEXT:    [[ATOMIC_LOAD68:%.*]] = load atomic i64, ptr @lx monotonic, align 8, !dbg [[DBG66:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT69:%.*]], !dbg [[DBG66]]
// PPC64:       atomic_cont69:
// PPC64-NEXT:    [[TMP86:%.*]] = phi i64 [ [[ATOMIC_LOAD68]], [[ATOMIC_EXIT66]] ], [ [[TMP89:%.*]], [[ATOMIC_CONT69]] ], !dbg [[DBG66]]
// PPC64-NEXT:    [[REM:%.*]] = srem i64 [[TMP86]], [[CONV67]], !dbg [[DBG67:![0-9]+]]
// PPC64-NEXT:    store i64 [[REM]], ptr [[ATOMIC_TEMP70]], align 8, !dbg [[DBG66]]
// PPC64-NEXT:    [[TMP87:%.*]] = load i64, ptr [[ATOMIC_TEMP70]], align 8, !dbg [[DBG66]]
...
// PPC64-NEXT:    br i1 [[TMP90]], label [[ATOMIC_EXIT71:%.*]], label [[ATOMIC_CONT69]], !dbg [[DBG66]]
// PPC64:       atomic_exit71:
...
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP72]], i32 noundef signext 0), !dbg [[DBG73:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT73:%.*]], !dbg [[DBG73]]
// PPC64:       atomic_cont73:
// PPC64-NEXT:    [[ATOMIC_TEMP72_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP72]], i32 0, i32 0, !dbg [[DBG73]]
// PPC64-NEXT:    [[ATOMIC_TEMP72_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP72_REALP]], align 4, !dbg [[DBG73]]
// PPC64-NEXT:    [[ATOMIC_TEMP72_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP72]], i32 0, i32 1, !dbg [[DBG73]]
// PPC64-NEXT:    [[ATOMIC_TEMP72_IMAG:%.*]] = load i32, ptr [[ATOMIC_TEMP72_IMAGP]], align 4, !dbg [[DBG73]]
...
// PPC64-NEXT:    [[ADD_R77:%.*]] = add i64 [[TMP95]], [[CONV75]], !dbg [[DBG74:![0-9]+]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP74_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP74]], i32 0, i32 0, !dbg [[DBG73]]
// PPC64-NEXT:    [[ATOMIC_TEMP74_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP74]], i32 0, i32 1, !dbg [[DBG73]]
// PPC64-NEXT:    store i32 [[CONV79]], ptr [[ATOMIC_TEMP74_REALP]], align 4, !dbg [[DBG73]]
// PPC64-NEXT:    store i32 [[CONV80]], ptr [[ATOMIC_TEMP74_IMAGP]], align 4, !dbg [[DBG73]]
// PPC64-NEXT:    [[CALL81:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP72]], ptr noundef [[ATOMIC_TEMP74]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG73]]
...
// PPC64-NEXT:    [[CONV83:%.*]] = uitofp i64 [[TMP96]] to float, !dbg [[DBG75]]
// PPC64-NEXT:    [[ATOMIC_LOAD84:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG76:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT85:%.*]], !dbg [[DBG76]]
// PPC64:       atomic_cont85:
// PPC64-NEXT:    [[TMP97:%.*]] = phi i32 [ [[ATOMIC_LOAD84]], [[ATOMIC_EXIT82]] ], [ [[TMP101:%.*]], [[ATOMIC_CONT85]] ], !dbg [[DBG76]]
// PPC64-NEXT:    [[TMP98:%.*]] = bitcast i32 [[TMP97]] to float, !dbg [[DBG76]]
// PPC64-NEXT:    [[MUL87:%.*]] = fmul float [[TMP98]], [[CONV83]], !dbg [[DBG77:![0-9]+]]
// PPC64-NEXT:    store float [[MUL87]], ptr [[ATOMIC_TEMP86]], align 4, !dbg [[DBG76]]
// PPC64-NEXT:    [[TMP99:%.*]] = load i32, ptr [[ATOMIC_TEMP86]], align 4, !dbg [[DBG76]]
...
// PPC64-NEXT:    br i1 [[TMP102]], label [[ATOMIC_EXIT88:%.*]], label [[ATOMIC_CONT85]], !dbg [[DBG76]]
// PPC64:       atomic_exit88:
// PPC64-NEXT:    [[TMP103:%.*]] = load i64, ptr @llv, align 8, !dbg [[DBG78:![0-9]+]]
// PPC64-NEXT:    [[CONV89:%.*]] = sitofp i64 [[TMP103]] to double, !dbg [[DBG78]]
// PPC64-NEXT:    [[ATOMIC_LOAD90:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG79:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT91:%.*]], !dbg [[DBG79]]
// PPC64:       atomic_cont91:
// PPC64-NEXT:    [[TMP104:%.*]] = phi i64 [ [[ATOMIC_LOAD90]], [[ATOMIC_EXIT88]] ], [ [[TMP108:%.*]], [[ATOMIC_CONT91]] ], !dbg [[DBG79]]
// PPC64-NEXT:    [[TMP105:%.*]] = bitcast i64 [[TMP104]] to double, !dbg [[DBG79]]
// PPC64-NEXT:    [[DIV93:%.*]] = fdiv double [[TMP105]], [[CONV89]], !dbg [[DBG80:![0-9]+]]
// PPC64-NEXT:    store double [[DIV93]], ptr [[ATOMIC_TEMP92]], align 8, !dbg [[DBG79]]
// PPC64-NEXT:    [[TMP106:%.*]] = load i64, ptr [[ATOMIC_TEMP92]], align 8, !dbg [[DBG79]]
...
// PPC64-NEXT:    br i1 [[TMP109]], label [[ATOMIC_EXIT94:%.*]], label [[ATOMIC_CONT91]], !dbg [[DBG79]]
// PPC64:       atomic_exit94:
// PPC64-NEXT:    [[TMP110:%.*]] = load i64, ptr @ullv, align 8, !dbg [[DBG81:![0-9]+]]
// PPC64-NEXT:    [[CONV95:%.*]] = uitofp i64 [[TMP110]] to ppc_fp128, !dbg [[DBG81]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @ldx, ptr noundef [[ATOMIC_TEMP96]], i32 noundef signext 0), !dbg [[DBG82:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT97:%.*]], !dbg [[DBG82]]
// PPC64:       atomic_cont97:
// PPC64-NEXT:    [[TMP111:%.*]] = load ppc_fp128, ptr [[ATOMIC_TEMP96]], align 16, !dbg [[DBG82]]
// PPC64-NEXT:    [[SUB99:%.*]] = fsub ppc_fp128 [[TMP111]], [[CONV95]], !dbg [[DBG83:![0-9]+]]
// PPC64-NEXT:    store ppc_fp128 [[SUB99]], ptr [[ATOMIC_TEMP98]], align 16, !dbg [[DBG82]]
// PPC64-NEXT:    [[CALL100:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 16, ptr noundef @ldx, ptr noundef [[ATOMIC_TEMP96]], ptr noundef [[ATOMIC_TEMP98]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG82]]
...
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP102]], i32 noundef signext 0), !dbg [[DBG85:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT103:%.*]], !dbg [[DBG85]]
// PPC64:       atomic_cont103:
// PPC64-NEXT:    [[ATOMIC_TEMP102_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP102]], i32 0, i32 0, !dbg [[DBG85]]
// PPC64-NEXT:    [[ATOMIC_TEMP102_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP102_REALP]], align 4, !dbg [[DBG85]]
// PPC64-NEXT:    [[ATOMIC_TEMP102_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP102]], i32 0, i32 1, !dbg [[DBG85]]
// PPC64-NEXT:    [[ATOMIC_TEMP102_IMAG:%.*]] = load i32, ptr [[ATOMIC_TEMP102_IMAGP]], align 4, !dbg [[DBG85]]
...
// PPC64-NEXT:    [[CALL107:%.*]] = call { float, float } @__divsc3(float noundef [[TMP112]], float noundef 0.000000e+00, float noundef [[CONV105]], float noundef [[CONV106]]) #[[ATTR2:[0-9]+]], !dbg [[DBG86:![0-9]+]]
// PPC64-NEXT:    [[TMP113:%.*]] = extractvalue { float, float } [[CALL107]], 0, !dbg [[DBG86]]
// PPC64-NEXT:    [[TMP114:%.*]] = extractvalue { float, float } [[CALL107]], 1, !dbg [[DBG86]]
// PPC64-NEXT:    [[CONV108:%.*]] = fptosi float [[TMP113]] to i32, !dbg [[DBG84]]
// PPC64-NEXT:    [[CONV109:%.*]] = fptosi float [[TMP114]] to i32, !dbg [[DBG84]]
// PPC64-NEXT:    [[ATOMIC_TEMP104_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP104]], i32 0, i32 0, !dbg [[DBG85]]
// PPC64-NEXT:    [[ATOMIC_TEMP104_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP104]], i32 0, i32 1, !dbg [[DBG85]]
// PPC64-NEXT:    store i32 [[CONV108]], ptr [[ATOMIC_TEMP104_REALP]], align 4, !dbg [[DBG85]]
// PPC64-NEXT:    store i32 [[CONV109]], ptr [[ATOMIC_TEMP104_IMAGP]], align 4, !dbg [[DBG85]]
// PPC64-NEXT:    [[CALL110:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP102]], ptr noundef [[ATOMIC_TEMP104]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG85]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD112:%.*]] = load atomic i16, ptr @sx monotonic, align 2, !dbg [[DBG88:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT113:%.*]], !dbg [[DBG88]]
// PPC64:       atomic_cont113:
// PPC64-NEXT:    [[TMP116:%.*]] = phi i16 [ [[ATOMIC_LOAD112]], [[ATOMIC_EXIT111]] ], [ [[TMP119:%.*]], [[ATOMIC_CONT113]] ], !dbg [[DBG88]]
// PPC64-NEXT:    [[CONV115:%.*]] = sext i16 [[TMP116]] to i32, !dbg [[DBG88]]
// PPC64-NEXT:    [[CONV116:%.*]] = sitofp i32 [[CONV115]] to double, !dbg [[DBG88]]
// PPC64-NEXT:    [[ADD117:%.*]] = fadd double [[CONV116]], [[TMP115]], !dbg [[DBG89:![0-9]+]]
// PPC64-NEXT:    [[CONV118:%.*]] = fptosi double [[ADD117]] to i16, !dbg [[DBG88]]
// PPC64-NEXT:    store i16 [[CONV118]], ptr [[ATOMIC_TEMP114]], align 2, !dbg [[DBG88]]
// PPC64-NEXT:    [[TMP117:%.*]] = load i16, ptr [[ATOMIC_TEMP114]], align 2, !dbg [[DBG88]]
...
// PPC64-NEXT:    br i1 [[TMP120]], label [[ATOMIC_EXIT119:%.*]], label [[ATOMIC_CONT113]], !dbg [[DBG88]]
// PPC64:       atomic_exit119:
// PPC64-NEXT:    [[TMP121:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG90:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD120:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG91:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT121:%.*]], !dbg [[DBG91]]
// PPC64:       atomic_cont121:
// PPC64-NEXT:    [[TMP122:%.*]] = phi i8 [ [[ATOMIC_LOAD120]], [[ATOMIC_EXIT119]] ], [ [[TMP125:%.*]], [[ATOMIC_CONT121]] ], !dbg [[DBG91]]
// PPC64-NEXT:    [[TOBOOL123:%.*]] = trunc i8 [[TMP122]] to i1, !dbg [[DBG91]]
// PPC64-NEXT:    [[CONV124:%.*]] = zext i1 [[TOBOOL123]] to i32, !dbg [[DBG91]]
// PPC64-NEXT:    [[CONV125:%.*]] = sitofp i32 [[CONV124]] to ppc_fp128, !dbg [[DBG91]]
// PPC64-NEXT:    [[MUL126:%.*]] = fmul ppc_fp128 [[TMP121]], [[CONV125]], !dbg [[DBG92:![0-9]+]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL128]], ptr [[ATOMIC_TEMP122]], align 1, !dbg [[DBG91]]
// PPC64-NEXT:    [[TMP123:%.*]] = load i8, ptr [[ATOMIC_TEMP122]], align 1, !dbg [[DBG91]]
...
// PPC64-NEXT:    br i1 [[TMP126]], label [[ATOMIC_EXIT129:%.*]], label [[ATOMIC_CONT121]], !dbg [[DBG91]]
// PPC64:       atomic_exit129:
// PPC64-NEXT:    fence release
// PPC64-NEXT:    [[CIV_REAL130:%.*]] = load i32, ptr @civ, align 4, !dbg [[DBG93:![0-9]+]]
// PPC64-NEXT:    [[CIV_IMAG131:%.*]] = load i32, ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG93]]
// PPC64-NEXT:    [[ATOMIC_LOAD132:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG94:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT133:%.*]], !dbg [[DBG94]]
// PPC64:       atomic_cont133:
// PPC64-NEXT:    [[TMP127:%.*]] = phi i8 [ [[ATOMIC_LOAD132]], [[ATOMIC_EXIT129]] ], [ [[TMP130:%.*]], [[ATOMIC_CONT133]] ], !dbg [[DBG94]]
// PPC64-NEXT:    [[TOBOOL135:%.*]] = trunc i8 [[TMP127]] to i1, !dbg [[DBG94]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL142]], ptr [[ATOMIC_TEMP134]], align 1, !dbg [[DBG94]]
// PPC64-NEXT:    [[TMP128:%.*]] = load i8, ptr [[ATOMIC_TEMP134]], align 1, !dbg [[DBG94]]
...
// PPC64-NEXT:    br i1 [[TMP131]], label [[ATOMIC_EXIT143:%.*]], label [[ATOMIC_CONT133]], !dbg [[DBG94]]
...
// PPC64-NEXT:    [[TOBOOL144:%.*]] = trunc i8 [[TMP133]] to i1, !dbg [[DBG97]]
// PPC64-NEXT:    [[CONV145:%.*]] = zext i1 [[TOBOOL144]] to i32, !dbg [[DBG97]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @int4x, ptr noundef [[ATOMIC_TEMP146]], i32 noundef signext 0), !dbg [[DBG98:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT147:%.*]], !dbg [[DBG98]]
// PPC64:       atomic_cont147:
// PPC64-NEXT:    [[TMP134:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP146]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    store <4 x i32> [[TMP134]], ptr [[ATOMIC_TEMP148]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    [[TMP135:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP146]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    store <4 x i32> [[TMP135]], ptr [[ATOMIC_TEMP149]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    [[TMP136:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP149]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    [[VECEXT:%.*]] = extractelement <4 x i32> [[TMP136]], i16 [[TMP132]], !dbg [[DBG98]]
// PPC64-NEXT:    [[OR:%.*]] = or i32 [[VECEXT]], [[CONV145]], !dbg [[DBG99:![0-9]+]]
// PPC64-NEXT:    [[TMP137:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP148]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    [[VECINS:%.*]] = insertelement <4 x i32> [[TMP137]], i32 [[OR]], i16 [[TMP132]], !dbg [[DBG98]]
// PPC64-NEXT:    store <4 x i32> [[VECINS]], ptr [[ATOMIC_TEMP148]], align 16, !dbg [[DBG98]]
// PPC64-NEXT:    [[CALL150:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 16, ptr noundef @int4x, ptr noundef [[ATOMIC_TEMP146]], ptr noundef [[ATOMIC_TEMP148]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG98]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD152:%.*]] = load atomic i32, ptr @bfx monotonic, align 4, !dbg [[DBG101:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT153:%.*]], !dbg [[DBG101]]
// PPC64:       atomic_cont153:
// PPC64-NEXT:    [[TMP139:%.*]] = phi i32 [ [[ATOMIC_LOAD152]], [[ATOMIC_EXIT151]] ], [ [[TMP142:%.*]], [[ATOMIC_CONT153]] ], !dbg [[DBG101]]
// PPC64-NEXT:    store i32 [[TMP139]], ptr [[ATOMIC_TEMP154]], align 4, !dbg [[DBG101]]
// PPC64-NEXT:    store i32 [[TMP139]], ptr [[ATOMIC_TEMP155]], align 4, !dbg [[DBG101]]
// PPC64-NEXT:    [[BF_LOAD:%.*]] = load i32, ptr [[ATOMIC_TEMP155]], align 4, !dbg [[DBG101]]
// PPC64-NEXT:    [[BF_ASHR:%.*]] = ashr i32 [[BF_LOAD]], 1, !dbg [[DBG101]]
// PPC64-NEXT:    [[CONV156:%.*]] = sitofp i32 [[BF_ASHR]] to ppc_fp128, !dbg [[DBG102:![0-9]+]]
// PPC64-NEXT:    [[SUB157:%.*]] = fsub ppc_fp128 [[CONV156]], [[TMP138]], !dbg [[DBG103:![0-9]+]]
// PPC64-NEXT:    [[CONV158:%.*]] = fptosi ppc_fp128 [[SUB157]] to i32, !dbg [[DBG102]]
// PPC64-NEXT:    [[BF_LOAD159:%.*]] = load i32, ptr [[ATOMIC_TEMP154]], align 4, !dbg [[DBG101]]
...
// PPC64-NEXT:    store i32 [[BF_SET]], ptr [[ATOMIC_TEMP154]], align 4, !dbg [[DBG101]]
// PPC64-NEXT:    [[TMP140:%.*]] = load i32, ptr [[ATOMIC_TEMP154]], align 4, !dbg [[DBG101]]
...
// PPC64-NEXT:    br i1 [[TMP143]], label [[ATOMIC_EXIT160:%.*]], label [[ATOMIC_CONT153]], !dbg [[DBG101]]
// PPC64:       atomic_exit160:
// PPC64-NEXT:    [[TMP144:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG104:![0-9]+]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 4, ptr noundef @bfx_packed, ptr noundef [[ATOMIC_TEMP161]], i32 noundef signext 0), !dbg [[DBG105:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT162:%.*]], !dbg [[DBG105]]
// PPC64:       atomic_cont162:
// PPC64-NEXT:    [[TMP145:%.*]] = load i32, ptr [[ATOMIC_TEMP161]], align 1, !dbg [[DBG105]]
// PPC64-NEXT:    store i32 [[TMP145]], ptr [[ATOMIC_TEMP163]], align 1, !dbg [[DBG105]]
// PPC64-NEXT:    [[TMP146:%.*]] = load i32, ptr [[ATOMIC_TEMP161]], align 1, !dbg [[DBG105]]
// PPC64-NEXT:    store i32 [[TMP146]], ptr [[ATOMIC_TEMP164]], align 4, !dbg [[DBG105]]
// PPC64-NEXT:    [[BF_LOAD165:%.*]] = load i32, ptr [[ATOMIC_TEMP164]], align 1, !dbg [[DBG105]]
...
// PPC64-NEXT:    [[MUL168:%.*]] = fmul ppc_fp128 [[CONV167]], [[TMP144]], !dbg [[DBG107:![0-9]+]]
// PPC64-NEXT:    [[CONV169:%.*]] = fptosi ppc_fp128 [[MUL168]] to i32, !dbg [[DBG106]]
// PPC64-NEXT:    [[BF_LOAD170:%.*]] = load i32, ptr [[ATOMIC_TEMP163]], align 1, !dbg [[DBG105]]
...
// PPC64-NEXT:    store i32 [[BF_SET174]], ptr [[ATOMIC_TEMP163]], align 1, !dbg [[DBG105]]
// PPC64-NEXT:    [[CALL175:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 4, ptr noundef @bfx_packed, ptr noundef [[ATOMIC_TEMP161]], ptr noundef [[ATOMIC_TEMP163]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG105]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD177:%.*]] = load atomic i32, ptr @bfx2 monotonic, align 4, !dbg [[DBG109:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT178:%.*]], !dbg [[DBG109]]
// PPC64:       atomic_cont178:
// PPC64-NEXT:    [[TMP148:%.*]] = phi i32 [ [[ATOMIC_LOAD177]], [[ATOMIC_EXIT176]] ], [ [[TMP151:%.*]], [[ATOMIC_CONT178]] ], !dbg [[DBG109]]
// PPC64-NEXT:    store i32 [[TMP148]], ptr [[ATOMIC_TEMP179]], align 4, !dbg [[DBG109]]
// PPC64-NEXT:    store i32 [[TMP148]], ptr [[ATOMIC_TEMP180]], align 4, !dbg [[DBG109]]
// PPC64-NEXT:    [[BF_LOAD181:%.*]] = load i32, ptr [[ATOMIC_TEMP180]], align 4, !dbg [[DBG109]]
...
// PPC64-NEXT:    [[SUB185:%.*]] = fsub ppc_fp128 [[CONV184]], [[TMP147]], !dbg [[DBG111:![0-9]+]]
// PPC64-NEXT:    [[CONV186:%.*]] = fptosi ppc_fp128 [[SUB185]] to i32, !dbg [[DBG110]]
// PPC64-NEXT:    [[BF_LOAD187:%.*]] = load i32, ptr [[ATOMIC_TEMP179]], align 4, !dbg [[DBG109]]
...
// PPC64-NEXT:    store i32 [[BF_SET190]], ptr [[ATOMIC_TEMP179]], align 4, !dbg [[DBG109]]
// PPC64-NEXT:    [[TMP149:%.*]] = load i32, ptr [[ATOMIC_TEMP179]], align 4, !dbg [[DBG109]]
...
// PPC64-NEXT:    br i1 [[TMP152]], label [[ATOMIC_EXIT191:%.*]], label [[ATOMIC_CONT178]], !dbg [[DBG109]]
// PPC64:       atomic_exit191:
// PPC64-NEXT:    [[TMP153:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG112:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD192:%.*]] = load atomic i8, ptr @bfx2_packed monotonic, align 1, !dbg [[DBG113:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT193:%.*]], !dbg [[DBG113]]
// PPC64:       atomic_cont193:
// PPC64-NEXT:    [[TMP154:%.*]] = phi i8 [ [[ATOMIC_LOAD192]], [[ATOMIC_EXIT191]] ], [ [[TMP158:%.*]], [[ATOMIC_CONT193]] ], !dbg [[DBG113]]
// PPC64-NEXT:    store i8 [[TMP154]], ptr [[ATOMIC_TEMP194]], align 1, !dbg [[DBG113]]
// PPC64-NEXT:    store i8 [[TMP154]], ptr [[ATOMIC_TEMP195]], align 1, !dbg [[DBG113]]
// PPC64-NEXT:    [[BF_LOAD196:%.*]] = load i8, ptr [[ATOMIC_TEMP195]], align 1, !dbg [[DBG113]]
...
// PPC64-NEXT:    [[DIV200:%.*]] = fdiv ppc_fp128 [[TMP153]], [[CONV199]], !dbg [[DBG115:![0-9]+]]
// PPC64-NEXT:    [[CONV201:%.*]] = fptosi ppc_fp128 [[DIV200]] to i32, !dbg [[DBG112]]
// PPC64-NEXT:    [[TMP155:%.*]] = trunc i32 [[CONV201]] to i8, !dbg [[DBG113]]
// PPC64-NEXT:    [[BF_LOAD202:%.*]] = load i8, ptr [[ATOMIC_TEMP194]], align 1, !dbg [[DBG113]]
// PPC64-NEXT:    [[BF_VALUE203:%.*]] = and i8 [[TMP155]], 1, !dbg [[DBG113]]
// PPC64-NEXT:    [[BF_CLEAR204:%.*]] = and i8 [[BF_LOAD202]], -2, !dbg [[DBG113]]
// PPC64-NEXT:    [[BF_SET205:%.*]] = or i8 [[BF_CLEAR204]], [[BF_VALUE203]], !dbg [[DBG113]]
// PPC64-NEXT:    store i8 [[BF_SET205]], ptr [[ATOMIC_TEMP194]], align 1, !dbg [[DBG113]]
// PPC64-NEXT:    [[TMP156:%.*]] = load i8, ptr [[ATOMIC_TEMP194]], align 1, !dbg [[DBG113]]
...
// PPC64-NEXT:    br i1 [[TMP159]], label [[ATOMIC_EXIT206:%.*]], label [[ATOMIC_CONT193]], !dbg [[DBG113]]
// PPC64:       atomic_exit206:
// PPC64-NEXT:    [[TMP160:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG116:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD207:%.*]] = load atomic i32, ptr @bfx3 monotonic, align 4, !dbg [[DBG117:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT208:%.*]], !dbg [[DBG117]]
// PPC64:       atomic_cont208:
// PPC64-NEXT:    [[TMP161:%.*]] = phi i32 [ [[ATOMIC_LOAD207]], [[ATOMIC_EXIT206]] ], [ [[TMP164:%.*]], [[ATOMIC_CONT208]] ], !dbg [[DBG117]]
// PPC64-NEXT:    store i32 [[TMP161]], ptr [[ATOMIC_TEMP209]], align 4, !dbg [[DBG117]]
// PPC64-NEXT:    store i32 [[TMP161]], ptr [[ATOMIC_TEMP210]], align 4, !dbg [[DBG117]]
// PPC64-NEXT:    [[BF_LOAD211:%.*]] = load i32, ptr [[ATOMIC_TEMP210]], align 4, !dbg [[DBG117]]
...
// PPC64-NEXT:    [[DIV215:%.*]] = fdiv ppc_fp128 [[CONV214]], [[TMP160]], !dbg [[DBG119:![0-9]+]]
// PPC64-NEXT:    [[CONV216:%.*]] = fptosi ppc_fp128 [[DIV215]] to i32, !dbg [[DBG118]]
// PPC64-NEXT:    [[BF_LOAD217:%.*]] = load i32, ptr [[ATOMIC_TEMP209]], align 4, !dbg [[DBG117]]
...
// PPC64-NEXT:    store i32 [[BF_SET221]], ptr [[ATOMIC_TEMP209]], align 4, !dbg [[DBG117]]
// PPC64-NEXT:    [[TMP162:%.*]] = load i32, ptr [[ATOMIC_TEMP209]], align 4, !dbg [[DBG117]]
...
// PPC64-NEXT:    br i1 [[TMP165]], label [[ATOMIC_EXIT222:%.*]], label [[ATOMIC_CONT208]], !dbg [[DBG117]]
// PPC64:       atomic_exit222:
// PPC64-NEXT:    [[TMP166:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG120:![0-9]+]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 3, ptr noundef @bfx3_packed, ptr noundef [[ATOMIC_TEMP223]], i32 noundef signext 0), !dbg [[DBG121:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT224:%.*]], !dbg [[DBG121]]
// PPC64:       atomic_cont224:
// PPC64-NEXT:    [[TMP167:%.*]] = load i24, ptr [[ATOMIC_TEMP223]], align 1, !dbg [[DBG121]]
// PPC64-NEXT:    store i24 [[TMP167]], ptr [[ATOMIC_TEMP225]], align 1, !dbg [[DBG121]]
// PPC64-NEXT:    [[TMP168:%.*]] = load i24, ptr [[ATOMIC_TEMP223]], align 1, !dbg [[DBG121]]
// PPC64-NEXT:    store i24 [[TMP168]], ptr [[ATOMIC_TEMP226]], align 1, !dbg [[DBG121]]
// PPC64-NEXT:    [[BF_LOAD227:%.*]] = load i24, ptr [[ATOMIC_TEMP226]], align 1, !dbg [[DBG121]]
...
// PPC64-NEXT:    [[ADD232:%.*]] = fadd ppc_fp128 [[CONV231]], [[TMP166]], !dbg [[DBG123:![0-9]+]]
// PPC64-NEXT:    [[CONV233:%.*]] = fptosi ppc_fp128 [[ADD232]] to i32, !dbg [[DBG122]]
// PPC64-NEXT:    [[TMP169:%.*]] = trunc i32 [[CONV233]] to i24, !dbg [[DBG121]]
// PPC64-NEXT:    [[BF_LOAD234:%.*]] = load i24, ptr [[ATOMIC_TEMP225]], align 1, !dbg [[DBG121]]
// PPC64-NEXT:    [[BF_VALUE235:%.*]] = and i24 [[TMP169]], 16383, !dbg [[DBG121]]
...
// PPC64-NEXT:    store i24 [[BF_SET238]], ptr [[ATOMIC_TEMP225]], align 1, !dbg [[DBG121]]
// PPC64-NEXT:    [[CALL239:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 3, ptr noundef @bfx3_packed, ptr noundef [[ATOMIC_TEMP223]], ptr noundef [[ATOMIC_TEMP225]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG121]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD241:%.*]] = load atomic i64, ptr @bfx4 monotonic, align 8, !dbg [[DBG125:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT242:%.*]], !dbg [[DBG125]]
// PPC64:       atomic_cont242:
// PPC64-NEXT:    [[TMP171:%.*]] = phi i64 [ [[ATOMIC_LOAD241]], [[ATOMIC_EXIT240]] ], [ [[TMP175:%.*]], [[ATOMIC_CONT242]] ], !dbg [[DBG125]]
// PPC64-NEXT:    store i64 [[TMP171]], ptr [[ATOMIC_TEMP243]], align 8, !dbg [[DBG125]]
// PPC64-NEXT:    store i64 [[TMP171]], ptr [[ATOMIC_TEMP244]], align 8, !dbg [[DBG125]]
// PPC64-NEXT:    [[BF_LOAD245:%.*]] = load i64, ptr [[ATOMIC_TEMP244]], align 8, !dbg [[DBG125]]
...
// PPC64-NEXT:    [[MUL250:%.*]] = fmul ppc_fp128 [[CONV249]], [[TMP170]], !dbg [[DBG127:![0-9]+]]
// PPC64-NEXT:    [[CONV251:%.*]] = fptosi ppc_fp128 [[MUL250]] to i32, !dbg [[DBG126]]
// PPC64-NEXT:    [[TMP172:%.*]] = zext i32 [[CONV251]] to i64, !dbg [[DBG125]]
// PPC64-NEXT:    [[BF_LOAD252:%.*]] = load i64, ptr [[ATOMIC_TEMP243]], align 8, !dbg [[DBG125]]
// PPC64-NEXT:    [[BF_VALUE253:%.*]] = and i64 [[TMP172]], 1, !dbg [[DBG125]]
...
// PPC64-NEXT:    store i64 [[BF_SET256]], ptr [[ATOMIC_TEMP243]], align 8, !dbg [[DBG125]]
// PPC64-NEXT:    [[TMP173:%.*]] = load i64, ptr [[ATOMIC_TEMP243]], align 8, !dbg [[DBG125]]
...
// PPC64-NEXT:    br i1 [[TMP176]], label [[ATOMIC_EXIT257:%.*]], label [[ATOMIC_CONT242]], !dbg [[DBG125]]
// PPC64:       atomic_exit257:
// PPC64-NEXT:    [[TMP177:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG128:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD258:%.*]] = load atomic i8, ptr @bfx4_packed monotonic, align 1, !dbg [[DBG129:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT259:%.*]], !dbg [[DBG129]]
// PPC64:       atomic_cont259:
// PPC64-NEXT:    [[TMP178:%.*]] = phi i8 [ [[ATOMIC_LOAD258]], [[ATOMIC_EXIT257]] ], [ [[TMP182:%.*]], [[ATOMIC_CONT259]] ], !dbg [[DBG129]]
// PPC64-NEXT:    store i8 [[TMP178]], ptr [[ATOMIC_TEMP260]], align 1, !dbg [[DBG129]]
// PPC64-NEXT:    store i8 [[TMP178]], ptr [[ATOMIC_TEMP261]], align 1, !dbg [[DBG129]]
// PPC64-NEXT:    [[BF_LOAD262:%.*]] = load i8, ptr [[ATOMIC_TEMP261]], align 1, !dbg [[DBG129]]
...
// PPC64-NEXT:    [[SUB266:%.*]] = fsub ppc_fp128 [[CONV265]], [[TMP177]], !dbg [[DBG131:![0-9]+]]
// PPC64-NEXT:    [[CONV267:%.*]] = fptosi ppc_fp128 [[SUB266]] to i32, !dbg [[DBG130]]
// PPC64-NEXT:    [[TMP179:%.*]] = trunc i32 [[CONV267]] to i8, !dbg [[DBG129]]
// PPC64-NEXT:    [[BF_LOAD268:%.*]] = load i8, ptr [[ATOMIC_TEMP260]], align 1, !dbg [[DBG129]]
// PPC64-NEXT:    [[BF_VALUE269:%.*]] = and i8 [[TMP179]], 1, !dbg [[DBG129]]
...
// PPC64-NEXT:    store i8 [[BF_SET272]], ptr [[ATOMIC_TEMP260]], align 1, !dbg [[DBG129]]
// PPC64-NEXT:    [[TMP180:%.*]] = load i8, ptr [[ATOMIC_TEMP260]], align 1, !dbg [[DBG129]]
// PPC64-NEXT:    [[TMP181:%.*]] = cmpxchg ptr @bfx4_packed, i8 [[TMP178]], i8 [[TMP180]] monotonic monotonic, align 1, !dbg [[DBG129]]
// PPC64-NEXT:    [[TMP182]] = extractvalue { i8, i1 } [[TMP181]], 0, !dbg [[DBG129]]
// PPC64-NEXT:    [[TMP183:%.*]] = extractvalue { i8, i1 } [[TMP181]], 1, !dbg [[DBG129]]
// PPC64-NEXT:    br i1 [[TMP183]], label [[ATOMIC_EXIT273:%.*]], label [[ATOMIC_CONT259]], !dbg [[DBG129]]
// PPC64:       atomic_exit273:
// PPC64-NEXT:    [[TMP184:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG132:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD274:%.*]] = load atomic i64, ptr @bfx4 monotonic, align 8, !dbg [[DBG133:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT275:%.*]], !dbg [[DBG133]]
// PPC64:       atomic_cont275:
// PPC64-NEXT:    [[TMP185:%.*]] = phi i64 [ [[ATOMIC_LOAD274]], [[ATOMIC_EXIT273]] ], [ [[TMP188:%.*]], [[ATOMIC_CONT275]] ], !dbg [[DBG133]]
// PPC64-NEXT:    store i64 [[TMP185]], ptr [[ATOMIC_TEMP276]], align 8, !dbg [[DBG133]]
// PPC64-NEXT:    store i64 [[TMP185]], ptr [[ATOMIC_TEMP277]], align 8, !dbg [[DBG133]]
// PPC64-NEXT:    [[BF_LOAD278:%.*]] = load i64, ptr [[ATOMIC_TEMP277]], align 8, !dbg [[DBG133]]
...
// PPC64-NEXT:    [[DIV282:%.*]] = fdiv ppc_fp128 [[CONV281]], [[TMP184]], !dbg [[DBG135:![0-9]+]]
// PPC64-NEXT:    [[CONV283:%.*]] = fptosi ppc_fp128 [[DIV282]] to i64, !dbg [[DBG134]]
// PPC64-NEXT:    [[BF_LOAD284:%.*]] = load i64, ptr [[ATOMIC_TEMP276]], align 8, !dbg [[DBG133]]
...
// PPC64-NEXT:    store i64 [[BF_SET288]], ptr [[ATOMIC_TEMP276]], align 8, !dbg [[DBG133]]
// PPC64-NEXT:    [[TMP186:%.*]] = load i64, ptr [[ATOMIC_TEMP276]], align 8, !dbg [[DBG133]]
...
// PPC64-NEXT:    br i1 [[TMP189]], label [[ATOMIC_EXIT289:%.*]], label [[ATOMIC_CONT275]], !dbg [[DBG133]]
// PPC64:       atomic_exit289:
// PPC64-NEXT:    [[TMP190:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG136:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD290:%.*]] = load atomic i8, ptr @bfx4_packed monotonic, align 1, !dbg [[DBG137:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT291:%.*]], !dbg [[DBG137]]
// PPC64:       atomic_cont291:
// PPC64-NEXT:    [[TMP191:%.*]] = phi i8 [ [[ATOMIC_LOAD290]], [[ATOMIC_EXIT289]] ], [ [[TMP195:%.*]], [[ATOMIC_CONT291]] ], !dbg [[DBG137]]
// PPC64-NEXT:    store i8 [[TMP191]], ptr [[ATOMIC_TEMP292]], align 1, !dbg [[DBG137]]
// PPC64-NEXT:    store i8 [[TMP191]], ptr [[ATOMIC_TEMP293]], align 1, !dbg [[DBG137]]
// PPC64-NEXT:    [[BF_LOAD294:%.*]] = load i8, ptr [[ATOMIC_TEMP293]], align 1, !dbg [[DBG137]]
...
// PPC64-NEXT:    [[ADD299:%.*]] = fadd ppc_fp128 [[CONV298]], [[TMP190]], !dbg [[DBG139:![0-9]+]]
// PPC64-NEXT:    [[CONV300:%.*]] = fptosi ppc_fp128 [[ADD299]] to i64, !dbg [[DBG138]]
// PPC64-NEXT:    [[TMP192:%.*]] = trunc i64 [[CONV300]] to i8, !dbg [[DBG137]]
// PPC64-NEXT:    [[BF_LOAD301:%.*]] = load i8, ptr [[ATOMIC_TEMP292]], align 1, !dbg [[DBG137]]
// PPC64-NEXT:    [[BF_VALUE302:%.*]] = and i8 [[TMP192]], 127, !dbg [[DBG137]]
// PPC64-NEXT:    [[BF_CLEAR303:%.*]] = and i8 [[BF_LOAD301]], -128, !dbg [[DBG137]]
// PPC64-NEXT:    [[BF_SET304:%.*]] = or i8 [[BF_CLEAR303]], [[BF_VALUE302]], !dbg [[DBG137]]
// PPC64-NEXT:    store i8 [[BF_SET304]], ptr [[ATOMIC_TEMP292]], align 1, !dbg [[DBG137]]
// PPC64-NEXT:    [[TMP193:%.*]] = load i8, ptr [[ATOMIC_TEMP292]], align 1, !dbg [[DBG137]]
// PPC64-NEXT:    [[TMP194:%.*]] = cmpxchg ptr @bfx4_packed, i8 [[TMP191]], i8 [[TMP193]] monotonic monotonic, align 1, !dbg [[DBG137]]
// PPC64-NEXT:    [[TMP195]] = extractvalue { i8, i1 } [[TMP194]], 0, !dbg [[DBG137]]
// PPC64-NEXT:    [[TMP196:%.*]] = extractvalue { i8, i1 } [[TMP194]], 1, !dbg [[DBG137]]
// PPC64-NEXT:    br i1 [[TMP196]], label [[ATOMIC_EXIT305:%.*]], label [[ATOMIC_CONT291]], !dbg [[DBG137]]
// PPC64:       atomic_exit305:
// PPC64-NEXT:    [[TMP197:%.*]] = load i64, ptr @ulv, align 8, !dbg [[DBG140:![0-9]+]]
// PPC64-NEXT:    [[CONV306:%.*]] = uitofp i64 [[TMP197]] to float, !dbg [[DBG140]]
// PPC64-NEXT:    [[ATOMIC_LOAD307:%.*]] = load atomic i64, ptr @float2x monotonic, align 8, !dbg [[DBG141:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT308:%.*]], !dbg [[DBG141]]
// PPC64:       atomic_cont308:
// PPC64-NEXT:    [[TMP198:%.*]] = phi i64 [ [[ATOMIC_LOAD307]], [[ATOMIC_EXIT305]] ], [ [[TMP206:%.*]], [[ATOMIC_CONT308]] ], !dbg [[DBG141]]
// PPC64-NEXT:    store i64 [[TMP198]], ptr [[ATOMIC_TEMP309]], align 8, !dbg [[DBG141]]
// PPC64-NEXT:    [[TMP199:%.*]] = bitcast i64 [[TMP198]] to <2 x float>, !dbg [[DBG141]]
// PPC64-NEXT:    store <2 x float> [[TMP199]], ptr [[ATOMIC_TEMP310]], align 8, !dbg [[DBG141]]
// PPC64-NEXT:    [[TMP200:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP310]], align 8, !dbg [[DBG141]]
// PPC64-NEXT:    [[TMP201:%.*]] = extractelement <2 x float> [[TMP200]], i64 0, !dbg [[DBG141]]
// PPC64-NEXT:    [[SUB311:%.*]] = fsub float [[CONV306]], [[TMP201]], !dbg [[DBG142:![0-9]+]]
// PPC64-NEXT:    [[TMP202:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP309]], align 8, !dbg [[DBG141]]
// PPC64-NEXT:    [[TMP203:%.*]] = insertelement <2 x float> [[TMP202]], float [[SUB311]], i64 0, !dbg [[DBG141]]
// PPC64-NEXT:    store <2 x float> [[TMP203]], ptr [[ATOMIC_TEMP309]], align 8, !dbg [[DBG141]]
// PPC64-NEXT:    [[TMP204:%.*]] = load i64, ptr [[ATOMIC_TEMP309]], align 8, !dbg [[DBG141]]
...
// PPC64-NEXT:    br i1 [[TMP207]], label [[ATOMIC_EXIT312:%.*]], label [[ATOMIC_CONT308]], !dbg [[DBG141]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD250:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG128:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP190:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP187]], i8 [[TMP189]] monotonic monotonic, align 1, !dbg [[DBG128]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD282:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG136:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP203:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP200]], i8 [[TMP202]] monotonic monotonic, align 1, !dbg [[DBG136]]
