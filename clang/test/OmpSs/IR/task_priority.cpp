...
// LIN64-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.PRIORITY"(ptr @compute_priority.3), "QUAL.OSS.DECL.SOURCE"([22 x i8] c"task_priority.cpp:8:1\00") ], !dbg [[DBG21:![0-9]+]]
...
// LIN64-NEXT:    [[TMP8:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.PRIORITY"(ptr @compute_priority.4, ptr [[CALL_ARG]]), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_priority.cpp:10:1\00") ], !dbg [[DBG23:![0-9]+]]
...
// PPC64-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.PRIORITY"(ptr @compute_priority.3), "QUAL.OSS.DECL.SOURCE"([22 x i8] c"task_priority.cpp:8:1\00") ], !dbg [[DBG21:![0-9]+]]
...
// PPC64-NEXT:    [[TMP8:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.PRIORITY"(ptr @compute_priority.4, ptr [[CALL_ARG]]), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_priority.cpp:10:1\00") ], !dbg [[DBG23:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.PRIORITY"(ptr @compute_priority.3), "QUAL.OSS.DECL.SOURCE"([22 x i8] c"task_priority.cpp:8:1\00") ], !dbg [[DBG21:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP8:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.PRIORITY"(ptr @compute_priority.4, ptr [[CALL_ARG]]), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_priority.cpp:10:1\00") ], !dbg [[DBG23:![0-9]+]]
