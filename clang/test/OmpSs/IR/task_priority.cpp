...
// PPC64-SAME: () #[[ATTR3:[0-9]+]] !dbg [[DBG25:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[N:%.*]]) #[[ATTR3]] !dbg [[DBG30:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[VLA:%.*]], i64 [[TMP0:%.*]]) #[[ATTR3]] !dbg [[DBG33:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: () #[[ATTR3]] !dbg [[DBG37:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[N:%.*]]) #[[ATTR3]] !dbg [[DBG40:![0-9]+]] {
// PPC64-NEXT:  entry:
// PPC64-NEXT:    [[N_ADDR:%.*]] = alloca ptr, align 8
// PPC64-NEXT:    store ptr [[N]], ptr [[N_ADDR]], align 8
...
// AARCH64-SAME: (i32 noundef [[N:%.*]]) #[[ATTR0]] !dbg [[DBG14:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-SAME: (i32 noundef [[N:%.*]]) #[[ATTR0]] !dbg [[DBG16:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[N_ADDR:%.*]] = alloca i32, align 4
...
// AARCH64-NEXT:    [[VLA:%.*]] = alloca i32, i64 [[TMP1]], align 4, !dbg [[DBG18]]
// AARCH64-NEXT:    store i64 [[TMP1]], ptr [[__VLA_EXPR0]], align 8, !dbg [[DBG18]]
// AARCH64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.PRIORITY"(ptr @compute_priority) ], !dbg [[DBG19:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP3]]), !dbg [[DBG20:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[N_ADDR]], i32 undef), "QUAL.OSS.PRIORITY"(ptr @compute_priority.1, ptr [[N_ADDR]]) ], !dbg [[DBG21:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP4]]), !dbg [[DBG22:![0-9]+]]
// AARCH64-NEXT:    [[TMP5:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[VLA]], i32 undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]]), "QUAL.OSS.PRIORITY"(ptr @compute_priority.2, ptr [[VLA]], i64 [[TMP1]]), "QUAL.OSS.CAPTURED"(i64 [[TMP1]]) ], !dbg [[DBG23:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP5]]), !dbg [[DBG24:![0-9]+]]
// AARCH64-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.PRIORITY"(ptr @compute_priority.3), "QUAL.OSS.DECL.SOURCE"([9 x i8] c"foo1:8:9\00") ], !dbg [[DBG25:![0-9]+]]
// AARCH64-NEXT:    call void @_Z4foo1v(), !dbg [[DBG25]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP6]]), !dbg [[DBG25]]
// AARCH64-NEXT:    [[TMP7:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG26:![0-9]+]]
// AARCH64-NEXT:    store i32 [[TMP7]], ptr [[CALL_ARG]], align 4, !dbg [[DBG26]]
// AARCH64-NEXT:    [[TMP8:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.PRIORITY"(ptr @compute_priority.4, ptr [[CALL_ARG]]), "QUAL.OSS.DECL.SOURCE"([10 x i8] c"foo2:10:9\00") ], !dbg [[DBG27:![0-9]+]]
// AARCH64-NEXT:    [[TMP9:%.*]] = load i32, ptr [[CALL_ARG]], align 4, !dbg [[DBG26]]
// AARCH64-NEXT:    call void @_Z4foo2i(i32 noundef [[TMP9]]), !dbg [[DBG27]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP8]]), !dbg [[DBG27]]
// AARCH64-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !dbg [[DBG28:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.stackrestore(ptr [[TMP10]]), !dbg [[DBG28]]
// AARCH64-NEXT:    ret void, !dbg [[DBG28]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_priority
// AARCH64-SAME: () #[[ATTR3:[0-9]+]] !dbg [[DBG29:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[CALL:%.*]] = call noundef i32 @_Z3fooIiET_v(), !dbg [[DBG30:![0-9]+]]
// AARCH64-NEXT:    ret i32 [[CALL]], !dbg [[DBG30]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@_Z3fooIiET_v
// AARCH64-SAME: () #[[ATTR0]] comdat !dbg [[DBG32:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    ret i32 0, !dbg [[DBG33:![0-9]+]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_priority.1
// AARCH64-SAME: (ptr [[N:%.*]]) #[[ATTR3]] !dbg [[DBG34:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[N_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[N]], ptr [[N_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG35:![0-9]+]]
// AARCH64-NEXT:    ret i32 [[TMP0]], !dbg [[DBG35]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_priority.2
// AARCH64-SAME: (ptr [[VLA:%.*]], i64 [[TMP0:%.*]]) #[[ATTR3]] !dbg [[DBG37:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 1, !dbg [[DBG38:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !dbg [[DBG38]]
// AARCH64-NEXT:    ret i32 [[TMP1]], !dbg [[DBG40:![0-9]+]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_priority.3
// AARCH64-SAME: () #[[ATTR3]] !dbg [[DBG41:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[CALL:%.*]] = call noundef i32 @_Z3fooIiET_v(), !dbg [[DBG42:![0-9]+]]
// AARCH64-NEXT:    ret i32 [[CALL]], !dbg [[DBG42]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_priority.4
// AARCH64-SAME: (ptr [[N:%.*]]) #[[ATTR3]] !dbg [[DBG44:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[N_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[N]], ptr [[N_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG45:![0-9]+]]
// AARCH64-NEXT:    ret i32 [[TMP0]], !dbg [[DBG45]]
//
