...
// LIN64-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG1]], ptr undef), "QUAL.OSS.DEP.IN"(ptr [[CALL_ARG1]], [20 x i8] c"pvla[sizeof(*pvla)]\00", ptr @compute_dep.9, ptr [[CALL_ARG1]], i64 [[TMP1]]), "QUAL.OSS.CAPTURED"(i64 [[TMP1]]), "QUAL.OSS.DECL.SOURCE"([10 x i8] c"foo3:26:9\00") ], !dbg [[DBG73]]
...
// PPC64-SAME: (ptr [[P:%.*]], ptr [[N:%.*]]) #[[ATTR2:[0-9]+]] !dbg [[DBG18:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[N:%.*]], ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG24:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[P:%.*]]) #[[ATTR2]] !dbg [[DBG30:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG34:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[P:%.*]], ptr [[N:%.*]]) #[[ATTR2]] !dbg [[DBG38:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[N:%.*]], ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG43:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[P:%.*]]) #[[ATTR2]] !dbg [[DBG48:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG52:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[VLA:%.*]], ptr [[N:%.*]], ptr [[M:%.*]]) #[[ATTR2]] !dbg [[DBG60:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[PVLA:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG76:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[VLA:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], i64 [[TMP0:%.*]], i64 [[TMP1:%.*]], i64 [[TMP2:%.*]]) #[[ATTR2]] !dbg [[DBG96:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[VLA:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], ptr [[C:%.*]], i64 [[TMP0:%.*]], i64 [[TMP1:%.*]], i64 [[TMP2:%.*]]) #[[ATTR2]] !dbg [[DBG101:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr [[VLA:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], ptr [[C:%.*]], i64 [[TMP0:%.*]], i64 [[TMP1:%.*]], i64 [[TMP2:%.*]]) #[[ATTR2]] !dbg [[DBG105:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// AARCH64-SAME: (ptr noundef [[P:%.*]], i32 noundef [[N:%.*]]) #[[ATTR0:[0-9]+]] !dbg [[DBG9:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @array, [10 x [20 x i32]] undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[P_ADDR]], ptr undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[N_ADDR]], i32 undef), "QUAL.OSS.DEP.IN"(ptr [[P_ADDR]], [9 x i8] c"[n + 1]p\00", ptr @compute_dep, ptr [[P_ADDR]], ptr [[N_ADDR]]), "QUAL.OSS.DEP.IN"(ptr @array, [13 x i8] c"[n + 2]array\00", ptr @compute_dep.1, ptr [[N_ADDR]], ptr @array) ], !dbg [[DBG13:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]), !dbg [[DBG14:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @array, [10 x [20 x i32]] undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[P_ADDR]], ptr undef), "QUAL.OSS.DEP.IN"(ptr [[P_ADDR]], [10 x i8] c"([3]p)[2]\00", ptr @compute_dep.2, ptr [[P_ADDR]]), "QUAL.OSS.DEP.IN"(ptr @array, [14 x i8] c"([4]array)[3]\00", ptr @compute_dep.3, ptr @array) ], !dbg [[DBG15:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP1]]), !dbg [[DBG16:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @array, [10 x [20 x i32]] undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[P_ADDR]], ptr undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[N_ADDR]], i32 undef), "QUAL.OSS.DEP.IN"(ptr [[P_ADDR]], [14 x i8] c"([3]p)[2 : n]\00", ptr @compute_dep.4, ptr [[P_ADDR]], ptr [[N_ADDR]]), "QUAL.OSS.DEP.IN"(ptr @array, [18 x i8] c"([4]array)[3 : n]\00", ptr @compute_dep.5, ptr [[N_ADDR]], ptr @array) ], !dbg [[DBG17:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP2]]), !dbg [[DBG18:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @array, [10 x [20 x i32]] undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[P_ADDR]], ptr undef), "QUAL.OSS.DEP.IN"(ptr [[P_ADDR]], [8 x i8] c"[3]p[2]\00", ptr @compute_dep.6, ptr [[P_ADDR]]), "QUAL.OSS.DEP.IN"(ptr @array, [12 x i8] c"[4]array[3]\00", ptr @compute_dep.7, ptr @array) ], !dbg [[DBG19:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP3]]), !dbg [[DBG20:![0-9]+]]
// AARCH64-NEXT:    ret void, !dbg [[DBG21:![0-9]+]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep
// AARCH64-SAME: (ptr [[P:%.*]], ptr [[N:%.*]]) #[[ATTR2:[0-9]+]] !dbg [[DBG22:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[P]], align 8, !dbg [[DBG23:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG25:![0-9]+]]
// AARCH64-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP1]], 1, !dbg [[DBG26:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP9:%.*]] = load [[STRUCT__DEPEND_UNPACK_T]], ptr [[RETVAL]], align 8, !dbg [[DBG27:![0-9]+]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T]] [[TMP9]], !dbg [[DBG27]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.1
// AARCH64-SAME: (ptr [[N:%.*]], ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG28:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[ARRAY]], i64 0, i64 0, !dbg [[DBG29:![0-9]+]]
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG31:![0-9]+]]
// AARCH64-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], 2, !dbg [[DBG32:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP9:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_0]], ptr [[RETVAL]], align 8, !dbg [[DBG33:![0-9]+]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP9]], !dbg [[DBG33]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.2
// AARCH64-SAME: (ptr [[P:%.*]]) #[[ATTR2]] !dbg [[DBG34:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[RETVAL:%.*]] = alloca [[STRUCT__DEPEND_UNPACK_T_1:%.*]], align 8
// AARCH64-NEXT:    [[P_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[P]], ptr [[P_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[P]], align 8, !dbg [[DBG35:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [3 x ptr], ptr [[TMP0]], i64 0, i64 0, !dbg [[DBG37:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP5:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_1]], ptr [[RETVAL]], align 8, !dbg [[DBG35]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_1]] [[TMP5]], !dbg [[DBG35]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.3
// AARCH64-SAME: (ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG38:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[RETVAL:%.*]] = alloca [[STRUCT__DEPEND_UNPACK_T_2:%.*]], align 8
// AARCH64-NEXT:    [[ARRAY_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[ARRAY]], ptr [[ARRAY_ADDR]], align 8
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[ARRAY]], i64 0, i64 0, !dbg [[DBG39:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYDECAY1:%.*]] = getelementptr inbounds [4 x [20 x i32]], ptr [[ARRAYDECAY]], i64 0, i64 0, !dbg [[DBG41:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP7:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_2]], ptr [[RETVAL]], align 8, !dbg [[DBG39]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_2]] [[TMP7]], !dbg [[DBG39]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.4
// AARCH64-SAME: (ptr [[P:%.*]], ptr [[N:%.*]]) #[[ATTR2]] !dbg [[DBG42:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    store ptr [[P]], ptr [[P_ADDR]], align 8
// AARCH64-NEXT:    store ptr [[N]], ptr [[N_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG43:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// AARCH64-NEXT:    [[TMP2:%.*]] = add i64 2, [[TMP1]]
// AARCH64-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[P]], align 8, !dbg [[DBG45:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [3 x ptr], ptr [[TMP3]], i64 0, i64 0, !dbg [[DBG46:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = mul i64 [[TMP2]], 8
...
// AARCH64-NEXT:    store i64 [[TMP4]], ptr [[TMP8]], align 8
// AARCH64-NEXT:    [[TMP9:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_3]], ptr [[RETVAL]], align 8, !dbg [[DBG45]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_3]] [[TMP9]], !dbg [[DBG45]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.5
// AARCH64-SAME: (ptr [[N:%.*]], ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG47:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    store ptr [[N]], ptr [[N_ADDR]], align 8
// AARCH64-NEXT:    store ptr [[ARRAY]], ptr [[ARRAY_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG48:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// AARCH64-NEXT:    [[TMP2:%.*]] = add i64 3, [[TMP1]]
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[ARRAY]], i64 0, i64 0, !dbg [[DBG50:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYDECAY1:%.*]] = getelementptr inbounds [4 x [20 x i32]], ptr [[ARRAYDECAY]], i64 0, i64 0, !dbg [[DBG51:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP10:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_4]], ptr [[RETVAL]], align 8, !dbg [[DBG50]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_4]] [[TMP10]], !dbg [[DBG50]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.6
// AARCH64-SAME: (ptr [[P:%.*]]) #[[ATTR2]] !dbg [[DBG52:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[RETVAL:%.*]] = alloca [[STRUCT__DEPEND_UNPACK_T_5:%.*]], align 8
// AARCH64-NEXT:    [[P_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[P]], ptr [[P_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[P]], align 8, !dbg [[DBG53:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds ptr, ptr [[TMP0]], i64 2, !dbg [[DBG53]]
// AARCH64-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[ARRAYIDX]], align 8, !dbg [[DBG53]]
...
// AARCH64-NEXT:    [[TMP6:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_5]], ptr [[RETVAL]], align 8, !dbg [[DBG55:![0-9]+]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_5]] [[TMP6]], !dbg [[DBG55]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.7
// AARCH64-SAME: (ptr [[ARRAY:%.*]]) #[[ATTR2]] !dbg [[DBG56:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[RETVAL:%.*]] = alloca [[STRUCT__DEPEND_UNPACK_T_6:%.*]], align 8
// AARCH64-NEXT:    [[ARRAY_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[ARRAY]], ptr [[ARRAY_ADDR]], align 8
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[ARRAY]], i64 0, i64 3, !dbg [[DBG57:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [20 x i32], ptr [[ARRAYIDX]], i64 0, i64 0, !dbg [[DBG57]]
...
// AARCH64-NEXT:    store i64 16, ptr [[TMP3]], align 8
// AARCH64-NEXT:    [[TMP4:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_6]], ptr [[RETVAL]], align 8, !dbg [[DBG59:![0-9]+]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_6]] [[TMP4]], !dbg [[DBG59]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@foo2
// AARCH64-SAME: () #[[ATTR0]] !dbg [[DBG60:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[N:%.*]] = alloca i32, align 4
// AARCH64-NEXT:    [[M:%.*]] = alloca i32, align 4
// AARCH64-NEXT:    [[VLA:%.*]] = alloca [10 x i32], align 4
// AARCH64-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], [10 x i32] undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[N]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[M]], i32 undef), "QUAL.OSS.DEP.INOUT"(ptr [[VLA]], [12 x i8] c"([n]vla)[m]\00", ptr @compute_dep.8, ptr [[VLA]], ptr [[N]], ptr [[M]]) ], !dbg [[DBG61:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]), !dbg [[DBG62:![0-9]+]]
// AARCH64-NEXT:    ret void, !dbg [[DBG63:![0-9]+]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.8
// AARCH64-SAME: (ptr [[VLA:%.*]], ptr [[N:%.*]], ptr [[M:%.*]]) #[[ATTR2]] !dbg [[DBG64:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[M]], align 4, !dbg [[DBG65:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// AARCH64-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 1
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x i32], ptr [[VLA]], i64 0, i64 0, !dbg [[DBG67:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = load i32, ptr [[N]], align 4, !dbg [[DBG68:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP12:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_7]], ptr [[RETVAL]], align 8, !dbg [[DBG68]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_7]] [[TMP12]], !dbg [[DBG68]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@foo3
// AARCH64-SAME: (i32 noundef [[N:%.*]], ptr noundef [[PVLA:%.*]]) #[[ATTR0]] !dbg [[DBG69:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[N_ADDR:%.*]] = alloca i32, align 4
// AARCH64-NEXT:    [[PVLA_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store i32 [[N]], ptr [[N_ADDR]], align 4
// AARCH64-NEXT:    store ptr [[PVLA]], ptr [[PVLA_ADDR]], align 8
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG70:![0-9]+]]
// AARCH64-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP0]], 1, !dbg [[DBG71:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = zext i32 [[SUB]] to i64
// AARCH64-NEXT:    ret void, !dbg [[DBG72:![0-9]+]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@bar
// AARCH64-SAME: () #[[ATTR0]] !dbg [[DBG73:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    store i32 10, ptr [[CALL_ARG]], align 4, !dbg [[DBG74:![0-9]+]]
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[CALL_ARG]], align 4, !dbg [[DBG75:![0-9]+]]
// AARCH64-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP0]], 1, !dbg [[DBG76:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = zext i32 [[SUB]] to i64, !dbg [[DBG77:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr [[MAT]], i64 0, i64 0, !dbg [[DBG78:![0-9]+]]
// AARCH64-NEXT:    store ptr [[ARRAYDECAY]], ptr [[CALL_ARG1]], align 8, !dbg [[DBG78]]
// AARCH64-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG1]], ptr undef), "QUAL.OSS.DEP.IN"(ptr [[CALL_ARG1]], [20 x i8] c"pvla[sizeof(*pvla)]\00", ptr @compute_dep.9, ptr [[CALL_ARG1]], i64 [[TMP1]]), "QUAL.OSS.CAPTURED"(i64 [[TMP1]]), "QUAL.OSS.DECL.SOURCE"([10 x i8] c"foo3:26:9\00") ], !dbg [[DBG77]]
// AARCH64-NEXT:    [[TMP3:%.*]] = load i32, ptr [[CALL_ARG]], align 4, !dbg [[DBG74]]
// AARCH64-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[CALL_ARG1]], align 8, !dbg [[DBG78]]
// AARCH64-NEXT:    call void @foo3(i32 noundef [[TMP3]], ptr noundef [[TMP4]]), !dbg [[DBG77]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP2]]), !dbg [[DBG77]]
// AARCH64-NEXT:    ret void, !dbg [[DBG79:![0-9]+]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.9
// AARCH64-SAME: (ptr [[PVLA:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG80:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[PVLA]], align 8, !dbg [[DBG81:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = mul nuw i64 4, [[TMP0]], !dbg [[DBG83:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = add i64 [[TMP2]], 1
// AARCH64-NEXT:    [[TMP4:%.*]] = load ptr, ptr [[PVLA]], align 8, !dbg [[DBG84:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP14:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_8]], ptr [[RETVAL]], align 8, !dbg [[DBG84]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_8]] [[TMP14]], !dbg [[DBG84]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@foo4
// AARCH64-SAME: (i32 noundef [[X:%.*]], i32 noundef [[Y:%.*]], i32 noundef [[Z:%.*]]) #[[ATTR0]] !dbg [[DBG85:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[X_ADDR]], align 4, !dbg [[DBG86:![0-9]+]]
// AARCH64-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], 1, !dbg [[DBG87:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = zext i32 [[ADD]] to i64, !dbg [[DBG88:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = load i32, ptr [[Y_ADDR]], align 4, !dbg [[DBG89:![0-9]+]]
// AARCH64-NEXT:    [[ADD1:%.*]] = add nsw i32 [[TMP2]], 2, !dbg [[DBG90:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = zext i32 [[ADD1]] to i64, !dbg [[DBG88]]
// AARCH64-NEXT:    [[TMP4:%.*]] = load i32, ptr [[Z_ADDR]], align 4, !dbg [[DBG91:![0-9]+]]
// AARCH64-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP4]], 3, !dbg [[DBG92:![0-9]+]]
// AARCH64-NEXT:    [[TMP5:%.*]] = zext i32 [[ADD2]] to i64, !dbg [[DBG88]]
// AARCH64-NEXT:    [[TMP6:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG88]]
// AARCH64-NEXT:    store ptr [[TMP6]], ptr [[SAVED_STACK]], align 8, !dbg [[DBG88]]
// AARCH64-NEXT:    [[TMP7:%.*]] = mul nuw i64 [[TMP1]], [[TMP3]], !dbg [[DBG88]]
// AARCH64-NEXT:    [[TMP8:%.*]] = mul nuw i64 [[TMP7]], [[TMP5]], !dbg [[DBG88]]
// AARCH64-NEXT:    [[VLA:%.*]] = alloca i32, i64 [[TMP8]], align 4, !dbg [[DBG88]]
// AARCH64-NEXT:    store i64 [[TMP1]], ptr [[__VLA_EXPR0]], align 8, !dbg [[DBG88]]
// AARCH64-NEXT:    store i64 [[TMP3]], ptr [[__VLA_EXPR1]], align 8, !dbg [[DBG88]]
// AARCH64-NEXT:    store i64 [[TMP5]], ptr [[__VLA_EXPR2]], align 8, !dbg [[DBG88]]
// AARCH64-NEXT:    [[TMP9:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], i32 undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]), "QUAL.OSS.FIRSTPRIVATE"(ptr [[A]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[B]], i32 undef), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]), "QUAL.OSS.DEP.INOUT"(ptr [[VLA]], [17 x i8] c"([a](vla[2]))[b]\00", ptr @compute_dep.10, ptr [[VLA]], ptr [[A]], ptr [[B]], i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]) ], !dbg [[DBG93:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP9]]), !dbg [[DBG94:![0-9]+]]
// AARCH64-NEXT:    [[TMP10:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], i32 undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]), "QUAL.OSS.FIRSTPRIVATE"(ptr [[A]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[B]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[C]], i32 undef), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]), "QUAL.OSS.DEP.INOUT"(ptr [[VLA]], [15 x i8] c"[c]([a][b]vla)\00", ptr @compute_dep.11, ptr [[VLA]], ptr [[A]], ptr [[B]], ptr [[C]], i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]) ], !dbg [[DBG95:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP10]]), !dbg [[DBG96:![0-9]+]]
// AARCH64-NEXT:    [[TMP11:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], i32 undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]), "QUAL.OSS.FIRSTPRIVATE"(ptr [[A]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[B]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[C]], i32 undef), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]), "QUAL.OSS.DEP.INOUT"(ptr [[VLA]], [28 x i8] c"[c]([a][b]vla[sizeof(vla)])\00", ptr @compute_dep.12, ptr [[VLA]], ptr [[A]], ptr [[B]], ptr [[C]], i64 [[TMP1]], i64 [[TMP3]], i64 [[TMP5]]) ], !dbg [[DBG97:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP11]]), !dbg [[DBG98:![0-9]+]]
// AARCH64-NEXT:    [[TMP12:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !dbg [[DBG99:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.stackrestore(ptr [[TMP12]]), !dbg [[DBG99]]
// AARCH64-NEXT:    ret void, !dbg [[DBG99]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.10
// AARCH64-SAME: (ptr [[VLA:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], i64 [[TMP0:%.*]], i64 [[TMP1:%.*]], i64 [[TMP2:%.*]]) #[[ATTR2]] !dbg [[DBG100:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    [[TMP3:%.*]] = load i32, ptr [[B]], align 4, !dbg [[DBG101:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = sext i32 [[TMP3]] to i64
// AARCH64-NEXT:    [[TMP5:%.*]] = add i64 [[TMP4]], 1
// AARCH64-NEXT:    [[TMP6:%.*]] = mul nuw i64 [[TMP1]], [[TMP2]], !dbg [[DBG103:![0-9]+]]
// AARCH64-NEXT:    [[TMP7:%.*]] = mul nsw i64 2, [[TMP6]], !dbg [[DBG103]]
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 [[TMP7]], !dbg [[DBG103]]
// AARCH64-NEXT:    [[TMP8:%.*]] = load i32, ptr [[A]], align 4, !dbg [[DBG104:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP19:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_9]], ptr [[RETVAL]], align 8, !dbg [[DBG104]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_9]] [[TMP19]], !dbg [[DBG104]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.11
// AARCH64-SAME: (ptr [[VLA:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], ptr [[C:%.*]], i64 [[TMP0:%.*]], i64 [[TMP1:%.*]], i64 [[TMP2:%.*]]) #[[ATTR2]] !dbg [[DBG105:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    store i64 [[TMP1]], ptr [[DOTADDR1]], align 8
// AARCH64-NEXT:    store i64 [[TMP2]], ptr [[DOTADDR2]], align 8
// AARCH64-NEXT:    [[TMP3:%.*]] = load i32, ptr [[C]], align 4, !dbg [[DBG106:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64
// AARCH64-NEXT:    [[TMP5:%.*]] = load i32, ptr [[B]], align 4, !dbg [[DBG108:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP22:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_10]], ptr [[RETVAL]], align 8, !dbg [[DBG108]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_10]] [[TMP22]], !dbg [[DBG108]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@compute_dep.12
// AARCH64-SAME: (ptr [[VLA:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], ptr [[C:%.*]], i64 [[TMP0:%.*]], i64 [[TMP1:%.*]], i64 [[TMP2:%.*]]) #[[ATTR2]] !dbg [[DBG109:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    store i64 [[TMP1]], ptr [[DOTADDR1]], align 8
// AARCH64-NEXT:    store i64 [[TMP2]], ptr [[DOTADDR2]], align 8
// AARCH64-NEXT:    [[TMP3:%.*]] = mul nuw i64 [[TMP0]], [[TMP1]], !dbg [[DBG110:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = mul nuw i64 [[TMP3]], [[TMP2]], !dbg [[DBG110]]
// AARCH64-NEXT:    [[TMP5:%.*]] = mul nuw i64 4, [[TMP4]], !dbg [[DBG110]]
// AARCH64-NEXT:    [[TMP6:%.*]] = mul nuw i64 [[TMP1]], [[TMP2]], !dbg [[DBG112:![0-9]+]]
// AARCH64-NEXT:    [[TMP7:%.*]] = mul nsw i64 [[TMP5]], [[TMP6]], !dbg [[DBG112]]
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 [[TMP7]], !dbg [[DBG112]]
// AARCH64-NEXT:    [[TMP8:%.*]] = load i32, ptr [[C]], align 4, !dbg [[DBG113:![0-9]+]]
// AARCH64-NEXT:    [[TMP9:%.*]] = zext i32 [[TMP8]] to i64
// AARCH64-NEXT:    [[TMP10:%.*]] = load i32, ptr [[B]], align 4, !dbg [[DBG114:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP24:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_11]], ptr [[RETVAL]], align 8, !dbg [[DBG114]]
// AARCH64-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_11]] [[TMP24]], !dbg [[DBG114]]
//
