...
// CHECK: %0 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"([10 x [20 x i32]]* @array), "QUAL.OSS.FIRSTPRIVATE"(i32*** %p.addr), "QUAL.OSS.FIRSTPRIVATE"(i32* %n.addr), "QUAL.OSS.DEP.IN"(i32*** %p.addr, %struct._depend_unpack_t (i32***, i32*)* @compute_dep, i32*** %p.addr, i32* %n.addr), "QUAL.OSS.DEP.IN"([10 x [20 x i32]]* @array, %struct._depend_unpack_t.0 (i32*, [10 x [20 x i32]]*)* @compute_dep.1, i32* %n.addr, [10 x [20 x i32]]* @array) ]
// CHECK-NEXT: call void @llvm.directive.region.exit(token %0)
// CHECK-NEXT: %1 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"([10 x [20 x i32]]* @array), "QUAL.OSS.FIRSTPRIVATE"(i32*** %p.addr), "QUAL.OSS.DEP.IN"(i32*** %p.addr, %struct._depend_unpack_t.1 (i32***)* @compute_dep.2, i32*** %p.addr), "QUAL.OSS.DEP.IN"([10 x [20 x i32]]* @array, %struct._depend_unpack_t.2 ([10 x [20 x i32]]*)* @compute_dep.3, [10 x [20 x i32]]* @array) ]
// CHECK-NEXT: call void @llvm.directive.region.exit(token %1)
// CHECK-NEXT: %2 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"([10 x [20 x i32]]* @array), "QUAL.OSS.FIRSTPRIVATE"(i32*** %p.addr), "QUAL.OSS.FIRSTPRIVATE"(i32* %n.addr), "QUAL.OSS.DEP.IN"(i32*** %p.addr, %struct._depend_unpack_t.3 (i32***, i32*)* @compute_dep.4, i32*** %p.addr, i32* %n.addr), "QUAL.OSS.DEP.IN"([10 x [20 x i32]]* @array, %struct._depend_unpack_t.4 (i32*, [10 x [20 x i32]]*)* @compute_dep.5, i32* %n.addr, [10 x [20 x i32]]* @array) ]
// CHECK-NEXT: call void @llvm.directive.region.exit(token %2)
// CHECK-NEXT: %3 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"([10 x [20 x i32]]* @array), "QUAL.OSS.FIRSTPRIVATE"(i32*** %p.addr), "QUAL.OSS.DEP.IN"(i32*** %p.addr, %struct._depend_unpack_t.5 (i32***)* @compute_dep.6, i32*** %p.addr), "QUAL.OSS.DEP.IN"([10 x [20 x i32]]* @array, %struct._depend_unpack_t.6 ([10 x [20 x i32]]*)* @compute_dep.7, [10 x [20 x i32]]* @array) ]
// CHECK-NEXT: call void @llvm.directive.region.exit(token %3)


// CHECK: define internal %struct._depend_unpack_t @compute_dep(i32*** %p.addr, i32* %n.addr) {
// CHECK-NEXT: entry:
// CHECK-NEXT:   %return.val = alloca %struct._depend_unpack_t, align 8
// CHECK-NEXT:   %0 = load i32**, i32*** %p.addr, align 8
...
// CHECK-NEXT:   %5 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %return.val, i32 0, i32 0
// CHECK-NEXT:   store i32** %0, i32*** %5, align 8
// CHECK-NEXT:   %6 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %return.val, i32 0, i32 1
// CHECK-NEXT:   store i64 %3, i64* %6, align 8
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %return.val, i32 0, i32 2
// CHECK-NEXT:   store i64 0, i64* %7, align 8
// CHECK-NEXT:   %8 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %return.val, i32 0, i32 3
// CHECK-NEXT:   store i64 %4, i64* %8, align 8
// CHECK-NEXT:   %9 = load %struct._depend_unpack_t, %struct._depend_unpack_t* %return.val, align 8
// CHECK-NEXT:   ret %struct._depend_unpack_t %9
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.0 @compute_dep.1(i32* %n.addr, [10 x [20 x i32]]* %array) {
// CHECK-NEXT: entry:
...
// CHECK-NEXT:   %2 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 0
// CHECK-NEXT:   store [20 x i32]* %arraydecay, [20 x i32]** %2, align 8
// CHECK-NEXT:   %3 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 1
// CHECK-NEXT:   store i64 80, i64* %3, align 8
// CHECK-NEXT:   %4 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 2
// CHECK-NEXT:   store i64 0, i64* %4, align 8
// CHECK-NEXT:   %5 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 3
// CHECK-NEXT:   store i64 80, i64* %5, align 8
// CHECK-NEXT:   %6 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 4
// CHECK-NEXT:   store i64 %1, i64* %6, align 8
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 5
// CHECK-NEXT:   store i64 0, i64* %7, align 8
// CHECK-NEXT:   %8 = getelementptr inbounds %struct._depend_unpack_t.0, %struct._depend_unpack_t.0* %return.val, i32 0, i32 6
...
// CHECK: define internal %struct._depend_unpack_t.1 @compute_dep.2(i32*** %p.addr) {
// CHECK-NEXT: entry:
...
// CHECK-NEXT:   %6 = load %struct._depend_unpack_t.1, %struct._depend_unpack_t.1* %return.val, align 8
...
// CHECK-NEXT:   %arraydecay = getelementptr inbounds [10 x [20 x i32]], [10 x [20 x i32]]* %array, i64 0, i64 0, !dbg !11
// CHECK-NEXT:   %0 = bitcast [20 x i32]* %arraydecay to [4 x [20 x i32]]*, !dbg !11
// CHECK-NEXT:   %arraydecay1 = getelementptr inbounds [4 x [20 x i32]], [4 x [20 x i32]]* %0, i64 0, i64 0, !dbg !11
...
// CHECK-NEXT:   %5 = getelementptr inbounds %struct._depend_unpack_t.2, %struct._depend_unpack_t.2* %return.val, i32 0, i32 4
// CHECK-NEXT:   store i64 4, i64* %5, align 8
// CHECK-NEXT:   %6 = getelementptr inbounds %struct._depend_unpack_t.2, %struct._depend_unpack_t.2* %return.val, i32 0, i32 5
// CHECK-NEXT:   store i64 3, i64* %6, align 8
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t.2, %struct._depend_unpack_t.2* %return.val, i32 0, i32 6
// CHECK-NEXT:   store i64 4, i64* %7, align 8
// CHECK-NEXT:   %8 = load %struct._depend_unpack_t.2, %struct._depend_unpack_t.2* %return.val, align 8
// CHECK-NEXT:   ret %struct._depend_unpack_t.2 %8
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.3 @compute_dep.4(i32*** %p.addr, i32* %n.addr) {
// CHECK-NEXT: entry:
// CHECK-NEXT:   %return.val = alloca %struct._depend_unpack_t.3, align 8
// CHECK-NEXT:   %0 = load i32, i32* %n.addr, align 4
// CHECK-NEXT:   %1 = sext i32 %0 to i64
// CHECK-NEXT:   %2 = add i64 2, %1
// CHECK-NEXT:   %3 = load i32**, i32*** %p.addr, align 8
...
// CHECK-NEXT:   %6 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %return.val, i32 0, i32 0
// CHECK-NEXT:   store i32** %arraydecay, i32*** %6, align 8
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %return.val, i32 0, i32 1
// CHECK-NEXT:   store i64 24, i64* %7, align 8
// CHECK-NEXT:   %8 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %return.val, i32 0, i32 2
// CHECK-NEXT:   store i64 16, i64* %8, align 8
// CHECK-NEXT:   %9 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %return.val, i32 0, i32 3
// CHECK-NEXT:   store i64 %5, i64* %9, align 8
// CHECK-NEXT:   %10 = load %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %return.val, align 8
// CHECK-NEXT:   ret %struct._depend_unpack_t.3 %10
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.4 @compute_dep.5(i32* %n.addr, [10 x [20 x i32]]* %array) {
// CHECK-NEXT: entry:
...
// CHECK-NEXT: %4 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 0
// CHECK-NEXT: store [20 x i32]* %arraydecay1, [20 x i32]** %4, align 8
// CHECK-NEXT: %5 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 1
// CHECK-NEXT: store i64 80, i64* %5, align 8
// CHECK-NEXT: %6 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 2
// CHECK-NEXT: store i64 0, i64* %6, align 8
// CHECK-NEXT: %7 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 3
// CHECK-NEXT: store i64 80, i64* %7, align 8
// CHECK-NEXT: %8 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 4
// CHECK-NEXT: store i64 4, i64* %8, align 8
// CHECK-NEXT: %9 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 5
// CHECK-NEXT: store i64 3, i64* %9, align 8
// CHECK-NEXT: %10 = getelementptr inbounds %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, i32 0, i32 6
// CHECK-NEXT: store i64 %2, i64* %10, align 8
// CHECK-NEXT: %11 = load %struct._depend_unpack_t.4, %struct._depend_unpack_t.4* %return.val, align 8
// CHECK-NEXT: ret %struct._depend_unpack_t.4 %11
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.5 @compute_dep.6(i32*** %p.addr) {
// CHECK-NEXT: entry:
...
// CHECK-NEXT:   %2 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %return.val, i32 0, i32 0
// CHECK-NEXT:   store i32* %1, i32** %2, align 8
// CHECK-NEXT:   %3 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %return.val, i32 0, i32 1
// CHECK-NEXT:   store i64 12, i64* %3, align 8
// CHECK-NEXT:   %4 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %return.val, i32 0, i32 2
// CHECK-NEXT:   store i64 0, i64* %4, align 8
// CHECK-NEXT:   %5 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %return.val, i32 0, i32 3
// CHECK-NEXT:   store i64 12, i64* %5, align 8
// CHECK-NEXT:   %6 = load %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %return.val, align 8
...
// CHECK-NEXT:   %arrayidx = getelementptr inbounds [10 x [20 x i32]], [10 x [20 x i32]]* %array, i64 0, i64 3
...
// CHECK-NEXT:   %4 = load %struct._depend_unpack_t.6, %struct._depend_unpack_t.6* %return.val, align 8
...
// CHECK: %0 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"([10 x i32]* %vla), "QUAL.OSS.FIRSTPRIVATE"(i32* %n), "QUAL.OSS.FIRSTPRIVATE"(i32* %m), "QUAL.OSS.DEP.INOUT"([10 x i32]* %vla, %struct._depend_unpack_t.7 ([10 x i32]*, i32*, i32*)* @compute_dep.8, [10 x i32]* %vla, i32* %n, i32* %m) ]
...
// CHECK-NEXT:   %0 = load i32, i32* %m, align 4
// CHECK-NEXT:   %1 = sext i32 %0 to i64
...
// CHECK-NEXT:   %12 = load %struct._depend_unpack_t.7, %struct._depend_unpack_t.7* %return.val, align 8
...
// CHECK: %3 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(i32* %call_arg), "QUAL.OSS.FIRSTPRIVATE"(i32** %call_arg1), "QUAL.OSS.DEP.IN"(i32** %call_arg1, %struct._depend_unpack_t.8 (i32**, i64)* @compute_dep.9, i32** %call_arg1, i64 %1), "QUAL.OSS.CAPTURED"(i64 %1) ]

// CHECK: define internal %struct._depend_unpack_t.8 @compute_dep.9(i32** %call_arg1, i64 %0) {
// CHECK-NEXT: entry:
// CHECK-NEXT:   %return.val = alloca %struct._depend_unpack_t.8, align 8
// CHECK-NEXT:   %1 = load i32*, i32** %call_arg1, align 8
// CHECK-NEXT:   %2 = mul nuw i64 4, %0
// CHECK-NEXT:   %3 = add i64 %2, 1
// CHECK-NEXT:   %4 = load i32*, i32** %call_arg1, align 8
// CHECK-NEXT:   %5 = mul i64 %0, 4
// CHECK-NEXT:   %6 = mul i64 %0, 4
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 0
// CHECK-NEXT:   store i32* %4, i32** %7, align 8
// CHECK-NEXT:   %8 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 1
// CHECK-NEXT:   store i64 %5, i64* %8, align 8
// CHECK-NEXT:   %9 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 2
// CHECK-NEXT:   store i64 0, i64* %9, align 8
// CHECK-NEXT:   %10 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 3
// CHECK-NEXT:   store i64 %6, i64* %10, align 8
// CHECK-NEXT:   %11 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 4
// CHECK-NEXT:   store i64 1, i64* %11, align 8
// CHECK-NEXT:   %12 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 5
// CHECK-NEXT:   store i64 %2, i64* %12, align 8
// CHECK-NEXT:   %13 = getelementptr inbounds %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, i32 0, i32 6
// CHECK-NEXT:   store i64 %3, i64* %13, align 8
// CHECK-NEXT:   %14 = load %struct._depend_unpack_t.8, %struct._depend_unpack_t.8* %return.val, align 8
