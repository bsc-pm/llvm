...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], ptr undef), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_function2.cpp:5:1\00") ], !dbg [[DBG10:![0-9]+]]
