...
// CHECK-NEXT:    store i32 0, ptr [[I1]], align 4, !dbg [[DBG18:![0-9]+]]
// CHECK-NEXT:    store i32 0, ptr [[J2]], align 4, !dbg [[DBG19:![0-9]+]]
...
// CHECK-NEXT:    call void @llvm.directive.region.exit(token [[TMP1]]), !dbg [[DBG21:![0-9]+]]
// CHECK-NEXT:    ret void, !dbg [[DBG22:![0-9]+]]
//
//
// CHECK-LABEL: define {{[^@]+}}@_Z12nonconstantsIiEvv
// CHECK-SAME: () #[[ATTR0]] comdat !dbg [[DBG23:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[I1:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[J2:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[LB1]], align 4, !dbg [[DBG24:![0-9]+]]
// CHECK-NEXT:    store i32 [[TMP0]], ptr [[I]], align 4, !dbg [[DBG25:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[LB2]], align 4, !dbg [[DBG26:![0-9]+]]
// CHECK-NEXT:    store i32 [[TMP1]], ptr [[J]], align 4, !dbg [[DBG27:![0-9]+]]
...
// CHECK-NEXT:    call void @llvm.directive.region.exit(token [[TMP2]]), !dbg [[DBG29:![0-9]+]]
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[LB1]], align 4, !dbg [[DBG30:![0-9]+]]
// CHECK-NEXT:    store i32 [[TMP3]], ptr [[I1]], align 4, !dbg [[DBG31:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[LB2]], align 4, !dbg [[DBG32:![0-9]+]]
// CHECK-NEXT:    store i32 [[TMP4]], ptr [[J2]], align 4, !dbg [[DBG33:![0-9]+]]
// CHECK-NEXT:    [[TMP5:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @v, [10 x [20 x i32]] undef), "QUAL.OSS.PRIVATE"(ptr [[I1]], i32 undef), "QUAL.OSS.PRIVATE"(ptr [[J2]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB1]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB1]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP1]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB2]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB2]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP2]], i32 undef), "QUAL.OSS.MULTIDEP.RANGE.IN"(ptr [[I1]], ptr [[J2]], ptr @compute_dep.6, ptr [[I1]], ptr [[LB1]], ptr [[UB1]], ptr [[STEP1]], ptr [[J2]], ptr [[LB2]], ptr [[UB2]], ptr [[STEP2]], ptr @v, [48 x i8] c"{ v[i][j], i = lb1:ub1:step1, j=lb2
// CHECK-NEXT:    call void @llvm.directive.region.exit(token [[TMP5]]), !dbg [[DBG35:![0-9]+]]
// CHECK-NEXT:    ret void, !dbg [[DBG36:![0-9]+]]
//
//
// CHECK-LABEL: define {{[^@]+}}@_Z12nonconstantsIsEvv
// CHECK-SAME: () #[[ATTR0]] comdat !dbg [[DBG37:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr [[LB1]], align 2, !dbg [[DBG38:![0-9]+]]
// CHECK-NEXT:    [[CONV:%.*]] = sext i16 [[TMP0]] to i32, !dbg [[DBG38]]
// CHECK-NEXT:    store i32 [[CONV]], ptr [[I]], align 4, !dbg [[DBG39:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr [[LB2]], align 2, !dbg [[DBG40:![0-9]+]]
// CHECK-NEXT:    [[CONV1:%.*]] = sext i16 [[TMP1]] to i32, !dbg [[DBG40]]
// CHECK-NEXT:    store i32 [[CONV1]], ptr [[J]], align 4, !dbg [[DBG41:![0-9]+]]
...
// CHECK-NEXT:    call void @llvm.directive.region.exit(token [[TMP2]]), !dbg [[DBG43:![0-9]+]]
// CHECK-NEXT:    [[TMP3:%.*]] = load i16, ptr [[LB1]], align 2, !dbg [[DBG44:![0-9]+]]
// CHECK-NEXT:    [[CONV3:%.*]] = sext i16 [[TMP3]] to i32, !dbg [[DBG44]]
// CHECK-NEXT:    store i32 [[CONV3]], ptr [[I2]], align 4, !dbg [[DBG45:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = load i16, ptr [[LB2]], align 2, !dbg [[DBG46:![0-9]+]]
// CHECK-NEXT:    [[CONV5:%.*]] = sext i16 [[TMP4]] to i32, !dbg [[DBG46]]
// CHECK-NEXT:    store i32 [[CONV5]], ptr [[J4]], align 4, !dbg [[DBG47:![0-9]+]]
// CHECK-NEXT:    [[TMP5:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @v, [10 x [20 x i32]] undef), "QUAL.OSS.PRIVATE"(ptr [[I2]], i32 undef), "QUAL.OSS.PRIVATE"(ptr [[J4]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB1]], i16 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB1]], i16 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP1]], i16 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB2]], i16 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB2]], i16 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP2]], i16 undef), "QUAL.OSS.MULTIDEP.RANGE.IN"(ptr [[I2]], ptr [[J4]], ptr @compute_dep.10, ptr [[I2]], ptr [[LB1]], ptr [[UB1]], ptr [[STEP1]], ptr [[J4]], ptr [[LB2]], ptr [[UB2]], ptr [[STEP2]], ptr @v, [48 x i8] c"{ v[i][j], i = lb1:ub1:step1, j=lb2
// CHECK-NEXT:    call void @llvm.directive.region.exit(token [[TMP5]]), !dbg [[DBG49:![0-9]+]]
// CHECK-NEXT:    ret void, !dbg [[DBG50:![0-9]+]]
//
//
// CHECK-LABEL: define {{[^@]+}}@compute_dep
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2:[0-9]+]] !dbg [[DBG51:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    ]
// CHECK:       1:
// CHECK-NEXT:    [[TMP2:%.*]] = load [[STRUCT__DEPEND_UNPACK_T]], ptr [[RETVAL]], align 4, !dbg [[DBG52:![0-9]+]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T]] [[TMP2]], !dbg [[DBG52]]
// CHECK:       3:
// CHECK-NEXT:    br label [[TMP1:%.*]]
// CHECK:       4:
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG54:![0-9]+]]
...
// CHECK-NEXT:    br label [[TMP1]]
// CHECK:       10:
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG55:![0-9]+]]
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], ptr [[V:%.*]]) #[[ATTR2]] !dbg [[DBG56:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG57:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 1
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG59:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = sext i32 [[TMP3]] to i64
// CHECK-NEXT:    [[TMP5:%.*]] = add i64 [[TMP4]], 1
// CHECK-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[V]], i64 0, i64 0, !dbg [[DBG60:![0-9]+]]
...
// CHECK-NEXT:    [[TMP15:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_0]], ptr [[RETVAL]], align 8, !dbg [[DBG60]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_0]] [[TMP15]], !dbg [[DBG60]]
//
//
// CHECK-LABEL: define {{[^@]+}}@compute_dep.2
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG61:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    ]
// CHECK:       1:
// CHECK-NEXT:    [[TMP2:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_1]], ptr [[RETVAL]], align 4, !dbg [[DBG62:![0-9]+]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_1]] [[TMP2]], !dbg [[DBG62]]
// CHECK:       3:
// CHECK-NEXT:    br label [[TMP1:%.*]]
// CHECK:       4:
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG64:![0-9]+]]
...
// CHECK-NEXT:    br label [[TMP1]]
// CHECK:       10:
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG65:![0-9]+]]
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], ptr [[V:%.*]]) #[[ATTR2]] !dbg [[DBG66:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store ptr [[J]], ptr [[J_ADDR]], align 8
// CHECK-NEXT:    store ptr [[V]], ptr [[V_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG67:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 1
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG69:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = sext i32 [[TMP3]] to i64
// CHECK-NEXT:    [[TMP5:%.*]] = add i64 [[TMP4]], 1
// CHECK-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[V]], i64 0, i64 0, !dbg [[DBG70:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = mul i64 [[TMP1]], 4
// CHECK-NEXT:    [[TMP7:%.*]] = mul i64 [[TMP2]], 4
...
// CHECK-NEXT:    store i64 [[TMP5]], ptr [[TMP14]], align 8
// CHECK-NEXT:    [[TMP15:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_2]], ptr [[RETVAL]], align 8, !dbg [[DBG70]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_2]] [[TMP15]], !dbg [[DBG70]]
//
//
// CHECK-LABEL: define {{[^@]+}}@compute_dep.4
// CHECK-SAME: (ptr [[I:%.*]], ptr [[LB1:%.*]], ptr [[UB1:%.*]], ptr [[J:%.*]], ptr [[LB2:%.*]], ptr [[UB2:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG71:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    ]
// CHECK:       1:
// CHECK-NEXT:    [[TMP2:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_3]], ptr [[RETVAL]], align 4, !dbg [[DBG72:![0-9]+]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_3]] [[TMP2]], !dbg [[DBG72]]
// CHECK:       3:
// CHECK-NEXT:    br label [[TMP1:%.*]]
// CHECK:       4:
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[LB1]], align 4, !dbg [[DBG74:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG75:![0-9]+]]
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[UB1]], align 4, !dbg [[DBG76:![0-9]+]]
...
// CHECK-NEXT:    br label [[TMP1]]
// CHECK:       12:
// CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[LB2]], align 4, !dbg [[DBG77:![0-9]+]]
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG78:![0-9]+]]
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[UB2]], align 4, !dbg [[DBG72]]
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], ptr [[LB1:%.*]], ptr [[LB2:%.*]], ptr [[UB1:%.*]], ptr [[UB2:%.*]], ptr [[V:%.*]]) #[[ATTR2]] !dbg [[DBG79:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[LB1:%.*]], ptr [[UB1:%.*]], ptr [[STEP1:%.*]], ptr [[J:%.*]], ptr [[LB2:%.*]], ptr [[UB2:%.*]], ptr [[STEP2:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG84:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    ]
// CHECK:       1:
// CHECK-NEXT:    [[TMP2:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_5]], ptr [[RETVAL]], align 4, !dbg [[DBG85:![0-9]+]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_5]] [[TMP2]], !dbg [[DBG85]]
// CHECK:       3:
// CHECK-NEXT:    br label [[TMP1:%.*]]
// CHECK:       4:
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[LB1]], align 4, !dbg [[DBG87:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG88:![0-9]+]]
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[UB1]], align 4, !dbg [[DBG89:![0-9]+]]
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[STEP1]], align 4, !dbg [[DBG90:![0-9]+]]
...
// CHECK-NEXT:    br label [[TMP1]]
// CHECK:       13:
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[LB2]], align 4, !dbg [[DBG91:![0-9]+]]
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG92:![0-9]+]]
// CHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr [[UB2]], align 4, !dbg [[DBG93:![0-9]+]]
// CHECK-NEXT:    [[TMP17:%.*]] = add i32 [[TMP14]], [[TMP16]]
// CHECK-NEXT:    [[TMP18:%.*]] = add i32 [[TMP17]], -1
// CHECK-NEXT:    [[TMP19:%.*]] = load i32, ptr [[STEP2]], align 4, !dbg [[DBG85]]
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], ptr [[LB1:%.*]], ptr [[LB2:%.*]], ptr [[UB1:%.*]], ptr [[UB2:%.*]], ptr [[STEP1:%.*]], ptr [[STEP2:%.*]], ptr [[V:%.*]]) #[[ATTR2]] !dbg [[DBG94:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store ptr [[STEP2]], ptr [[STEP2_ADDR]], align 8
// CHECK-NEXT:    store ptr [[V]], ptr [[V_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG95:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 1
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG97:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = sext i32 [[TMP3]] to i64
// CHECK-NEXT:    [[TMP5:%.*]] = add i64 [[TMP4]], 1
// CHECK-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[V]], i64 0, i64 0, !dbg [[DBG98:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = mul i64 [[TMP1]], 4
// CHECK-NEXT:    [[TMP7:%.*]] = mul i64 [[TMP2]], 4
...
// CHECK-NEXT:    store i64 [[TMP5]], ptr [[TMP14]], align 8
// CHECK-NEXT:    [[TMP15:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_6]], ptr [[RETVAL]], align 8, !dbg [[DBG98]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_6]] [[TMP15]], !dbg [[DBG98]]
//
//
// CHECK-LABEL: define {{[^@]+}}@compute_dep.8
// CHECK-SAME: (ptr [[I:%.*]], ptr [[LB1:%.*]], ptr [[UB1:%.*]], ptr [[J:%.*]], ptr [[LB2:%.*]], ptr [[UB2:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG99:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    ]
// CHECK:       1:
// CHECK-NEXT:    [[TMP2:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_7]], ptr [[RETVAL]], align 4, !dbg [[DBG100:![0-9]+]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_7]] [[TMP2]], !dbg [[DBG100]]
// CHECK:       3:
// CHECK-NEXT:    br label [[TMP1:%.*]]
// CHECK:       4:
// CHECK-NEXT:    [[TMP5:%.*]] = load i16, ptr [[LB1]], align 2, !dbg [[DBG102:![0-9]+]]
// CHECK-NEXT:    [[CONV:%.*]] = sext i16 [[TMP5]] to i32, !dbg [[DBG102]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG103:![0-9]+]]
// CHECK-NEXT:    [[TMP7:%.*]] = load i16, ptr [[UB1]], align 2, !dbg [[DBG104:![0-9]+]]
// CHECK-NEXT:    [[CONV1:%.*]] = sext i16 [[TMP7]] to i32, !dbg [[DBG104]]
...
// CHECK-NEXT:    br label [[TMP1]]
// CHECK:       12:
// CHECK-NEXT:    [[TMP13:%.*]] = load i16, ptr [[LB2]], align 2, !dbg [[DBG105:![0-9]+]]
// CHECK-NEXT:    [[CONV2:%.*]] = sext i16 [[TMP13]] to i32, !dbg [[DBG105]]
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG106:![0-9]+]]
// CHECK-NEXT:    [[TMP15:%.*]] = load i16, ptr [[UB2]], align 2, !dbg [[DBG100]]
// CHECK-NEXT:    [[CONV3:%.*]] = sext i16 [[TMP15]] to i32, !dbg [[DBG100]]
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], ptr [[LB1:%.*]], ptr [[LB2:%.*]], ptr [[UB1:%.*]], ptr [[UB2:%.*]], ptr [[V:%.*]]) #[[ATTR2]] !dbg [[DBG107:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store ptr [[UB2]], ptr [[UB2_ADDR]], align 8
// CHECK-NEXT:    store ptr [[V]], ptr [[V_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG108:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 1
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG110:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = sext i32 [[TMP3]] to i64
// CHECK-NEXT:    [[TMP5:%.*]] = add i64 [[TMP4]], 1
// CHECK-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[V]], i64 0, i64 0, !dbg [[DBG111:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = mul i64 [[TMP1]], 4
// CHECK-NEXT:    [[TMP7:%.*]] = mul i64 [[TMP2]], 4
...
// CHECK-NEXT:    store i64 [[TMP5]], ptr [[TMP14]], align 8
// CHECK-NEXT:    [[TMP15:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_8]], ptr [[RETVAL]], align 8, !dbg [[DBG111]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_8]] [[TMP15]], !dbg [[DBG111]]
//
//
// CHECK-LABEL: define {{[^@]+}}@compute_dep.10
// CHECK-SAME: (ptr [[I:%.*]], ptr [[LB1:%.*]], ptr [[UB1:%.*]], ptr [[STEP1:%.*]], ptr [[J:%.*]], ptr [[LB2:%.*]], ptr [[UB2:%.*]], ptr [[STEP2:%.*]], i64 [[TMP0:%.*]]) #[[ATTR2]] !dbg [[DBG112:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    ]
// CHECK:       1:
// CHECK-NEXT:    [[TMP2:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_9]], ptr [[RETVAL]], align 4, !dbg [[DBG113:![0-9]+]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_9]] [[TMP2]], !dbg [[DBG113]]
// CHECK:       3:
// CHECK-NEXT:    br label [[TMP1:%.*]]
// CHECK:       4:
// CHECK-NEXT:    [[TMP5:%.*]] = load i16, ptr [[LB1]], align 2, !dbg [[DBG115:![0-9]+]]
// CHECK-NEXT:    [[CONV:%.*]] = sext i16 [[TMP5]] to i32, !dbg [[DBG115]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG116:![0-9]+]]
// CHECK-NEXT:    [[TMP7:%.*]] = load i16, ptr [[UB1]], align 2, !dbg [[DBG117:![0-9]+]]
// CHECK-NEXT:    [[CONV1:%.*]] = sext i16 [[TMP7]] to i32, !dbg [[DBG117]]
// CHECK-NEXT:    [[TMP8:%.*]] = load i16, ptr [[STEP1]], align 2, !dbg [[DBG118:![0-9]+]]
// CHECK-NEXT:    [[CONV2:%.*]] = sext i16 [[TMP8]] to i32, !dbg [[DBG118]]
...
// CHECK-NEXT:    br label [[TMP1]]
// CHECK:       13:
// CHECK-NEXT:    [[TMP14:%.*]] = load i16, ptr [[LB2]], align 2, !dbg [[DBG119:![0-9]+]]
// CHECK-NEXT:    [[CONV3:%.*]] = sext i16 [[TMP14]] to i32, !dbg [[DBG119]]
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG120:![0-9]+]]
// CHECK-NEXT:    [[TMP16:%.*]] = load i16, ptr [[UB2]], align 2, !dbg [[DBG121:![0-9]+]]
// CHECK-NEXT:    [[CONV4:%.*]] = sext i16 [[TMP16]] to i32, !dbg [[DBG121]]
// CHECK-NEXT:    [[TMP17:%.*]] = add i32 [[CONV3]], [[CONV4]]
// CHECK-NEXT:    [[TMP18:%.*]] = add i32 [[TMP17]], -1
// CHECK-NEXT:    [[TMP19:%.*]] = load i16, ptr [[STEP2]], align 2, !dbg [[DBG113]]
// CHECK-NEXT:    [[CONV5:%.*]] = sext i16 [[TMP19]] to i32, !dbg [[DBG113]]
...
// CHECK-SAME: (ptr [[I:%.*]], ptr [[J:%.*]], ptr [[LB1:%.*]], ptr [[LB2:%.*]], ptr [[UB1:%.*]], ptr [[UB2:%.*]], ptr [[STEP1:%.*]], ptr [[STEP2:%.*]], ptr [[V:%.*]]) #[[ATTR2]] !dbg [[DBG122:![0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store ptr [[STEP2]], ptr [[STEP2_ADDR]], align 8
// CHECK-NEXT:    store ptr [[V]], ptr [[V_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[J]], align 4, !dbg [[DBG123:![0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[TMP0]] to i64
// CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 1
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG125:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = sext i32 [[TMP3]] to i64
// CHECK-NEXT:    [[TMP5:%.*]] = add i64 [[TMP4]], 1
// CHECK-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [10 x [20 x i32]], ptr [[V]], i64 0, i64 0, !dbg [[DBG126:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = mul i64 [[TMP1]], 4
// CHECK-NEXT:    [[TMP7:%.*]] = mul i64 [[TMP2]], 4
...
// CHECK-NEXT:    store i64 [[TMP5]], ptr [[TMP14]], align 8
// CHECK-NEXT:    [[TMP15:%.*]] = load [[STRUCT__DEPEND_UNPACK_T_10]], ptr [[RETVAL]], align 8, !dbg [[DBG126]]
// CHECK-NEXT:    ret [[STRUCT__DEPEND_UNPACK_T_10]] [[TMP15]], !dbg [[DBG126]]
//
