...
// CHECK-NEXT:   %2 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 0
// CHECK-NEXT:   store i32 0, i32* %2, align 4
// CHECK-NEXT:   %3 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 1
// CHECK-NEXT:   store i32 %0, i32* %3, align 4
// CHECK-NEXT:   %4 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 2
// CHECK-NEXT:   store i32 9, i32* %4, align 4
// CHECK-NEXT:   %5 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 3
// CHECK-NEXT:   store i32 1, i32* %5, align 4
// CHECK-NEXT:   %6 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 4
// CHECK-NEXT:   store i32 0, i32* %6, align 4
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 5
// CHECK-NEXT:   store i32 %1, i32* %7, align 4
// CHECK-NEXT:   %8 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 6
// CHECK-NEXT:   store i32 19, i32* %8, align 4
// CHECK-NEXT:   %9 = getelementptr inbounds %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, i32 0, i32 7
// CHECK-NEXT:   store i32 1, i32* %9, align 4
// CHECK-NEXT:   %10 = load %struct._depend_unpack_t, %struct._depend_unpack_t* %retval, align 4
// CHECK-NEXT:   ret %struct._depend_unpack_t %10
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.1 @compute_dep.2(i32* %i, i32* %j)
// CHECK: entry:
...
// CHECK-NEXT:   store i32 1, i32* %5, align 4
// CHECK-NEXT:   %6 = getelementptr inbounds %struct._depend_unpack_t.1, %struct._depend_unpack_t.1* %retval, i32 0, i32 4
// CHECK-NEXT:   store i32 0, i32* %6, align 4
// CHECK-NEXT:   %7 = getelementptr inbounds %struct._depend_unpack_t.1, %struct._depend_unpack_t.1* %retval, i32 0, i32 5
// CHECK-NEXT:   store i32 %1, i32* %7, align 4
// CHECK-NEXT:   %8 = getelementptr inbounds %struct._depend_unpack_t.1, %struct._depend_unpack_t.1* %retval, i32 0, i32 6
// CHECK-NEXT:   store i32 19, i32* %8, align 4
// CHECK-NEXT:   %9 = getelementptr inbounds %struct._depend_unpack_t.1, %struct._depend_unpack_t.1* %retval, i32 0, i32 7
// CHECK-NEXT:   store i32 1, i32* %9, align 4
// CHECK-NEXT:   %10 = load %struct._depend_unpack_t.1, %struct._depend_unpack_t.1* %retval, align 4
...
// CHECK-NEXT:   %3 = load i32, i32* %lb2, align 4
// CHECK-NEXT:   %4 = load i32, i32* %j, align 4
// CHECK-NEXT:   %5 = load i32, i32* %ub2, align 4
...
// CHECK-NEXT:   %12 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %retval, i32 0, i32 4
// CHECK-NEXT:   store i32 %3, i32* %12, align 4
// CHECK-NEXT:   %13 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %retval, i32 0, i32 5
// CHECK-NEXT:   store i32 %4, i32* %13, align 4
// CHECK-NEXT:   %14 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %retval, i32 0, i32 6
// CHECK-NEXT:   store i32 %7, i32* %14, align 4
// CHECK-NEXT:   %15 = getelementptr inbounds %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %retval, i32 0, i32 7
// CHECK-NEXT:   store i32 1, i32* %15, align 4
// CHECK-NEXT:   %16 = load %struct._depend_unpack_t.3, %struct._depend_unpack_t.3* %retval, align 4
// CHECK-NEXT:   ret %struct._depend_unpack_t.3 %16
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.5 @compute_dep.6(i32* %i, i32* %lb1, i32* %ub1, i32* %step1, i32* %j, i32* %lb2, i32* %ub2, i32* %step2)
// CHECK: entry:
...
// CHECK-NEXT:   %5 = load i32, i32* %j, align 4
...
// CHECK-NEXT:   %10 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 0
// CHECK-NEXT:   store i32 %0, i32* %10, align 4
// CHECK-NEXT:   %11 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 1
// CHECK-NEXT:   store i32 %1, i32* %11, align 4
// CHECK-NEXT:   %12 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 2
// CHECK-NEXT:   store i32 %2, i32* %12, align 4
// CHECK-NEXT:   %13 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 3
// CHECK-NEXT:   store i32 %3, i32* %13, align 4
// CHECK-NEXT:   %14 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 4
// CHECK-NEXT:   store i32 %4, i32* %14, align 4
// CHECK-NEXT:   %15 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 5
// CHECK-NEXT:   store i32 %5, i32* %15, align 4
// CHECK-NEXT:   %16 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 6
// CHECK-NEXT:   store i32 %8, i32* %16, align 4
// CHECK-NEXT:   %17 = getelementptr inbounds %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, i32 0, i32 7
// CHECK-NEXT:   store i32 %9, i32* %17, align 4
// CHECK-NEXT:   %18 = load %struct._depend_unpack_t.5, %struct._depend_unpack_t.5* %retval, align 4
...
// CHECK:   %0 = load i16, i16* %lb1, align 2
...
// CHECK-NEXT:   store i32 1, i32* %11, align 4
// CHECK-NEXT:   %12 = getelementptr inbounds %struct._depend_unpack_t.7, %struct._depend_unpack_t.7* %retval, i32 0, i32 4
// CHECK-NEXT:   store i32 %conv2, i32* %12, align 4
// CHECK-NEXT:   %13 = getelementptr inbounds %struct._depend_unpack_t.7, %struct._depend_unpack_t.7* %retval, i32 0, i32 5
// CHECK-NEXT:   store i32 %4, i32* %13, align 4
// CHECK-NEXT:   %14 = getelementptr inbounds %struct._depend_unpack_t.7, %struct._depend_unpack_t.7* %retval, i32 0, i32 6
// CHECK-NEXT:   store i32 %7, i32* %14, align 4
// CHECK-NEXT:   %15 = getelementptr inbounds %struct._depend_unpack_t.7, %struct._depend_unpack_t.7* %retval, i32 0, i32 7
// CHECK-NEXT:   store i32 1, i32* %15, align 4
// CHECK-NEXT:   %16 = load %struct._depend_unpack_t.7, %struct._depend_unpack_t.7* %retval, align 4
// CHECK-NEXT:   ret %struct._depend_unpack_t.7 %16
// CHECK-NEXT: }

// CHECK: define internal %struct._depend_unpack_t.9 @compute_dep.10(i32* %i, i16* %lb1, i16* %ub1, i16* %step1, i32* %j, i16* %lb2, i16* %ub2, i16* %step2)
// CHECK: entry:
...
// CHECK-NEXT:   %10 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 0
// CHECK-NEXT:   store i32 %conv, i32* %10, align 4
// CHECK-NEXT:   %11 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 1
// CHECK-NEXT:   store i32 %1, i32* %11, align 4
// CHECK-NEXT:   %12 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 2
// CHECK-NEXT:   store i32 %conv1, i32* %12, align 4
// CHECK-NEXT:   %13 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 3
// CHECK-NEXT:   store i32 %conv2, i32* %13, align 4
// CHECK-NEXT:   %14 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 4
// CHECK-NEXT:   store i32 %conv3, i32* %14, align 4
// CHECK-NEXT:   %15 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 5
// CHECK-NEXT:   store i32 %5, i32* %15, align 4
// CHECK-NEXT:   %16 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 6
// CHECK-NEXT:   store i32 %8, i32* %16, align 4
// CHECK-NEXT:   %17 = getelementptr inbounds %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, i32 0, i32 7
// CHECK-NEXT:   store i32 %conv5, i32* %17, align 4
// CHECK-NEXT:   %18 = load %struct._depend_unpack_t.9, %struct._depend_unpack_t.9* %retval, align 4
