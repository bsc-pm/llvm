...
// LIN64-NEXT:    [[X:%.*]] = getelementptr inbounds [[STRUCT_C:%.*]], ptr [[C]], i32 0, i32 0, !dbg [[DBG101:![0-9]+]]
...
// PPC64-NEXT:    [[X:%.*]] = getelementptr inbounds [[STRUCT_C:%.*]], ptr [[C]], i32 0, i32 0, !dbg [[DBG101:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP2:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG10]]
...
// AARCH64-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], [7 x i32] undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 7), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 7), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [11 x i8] c"aVLA[5][:]\00", ptr @compute_dep.12, ptr [[VLA]], i64 [[TMP1]]), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [12 x i8] c"aVLA[5][1:]\00", ptr @compute_dep.13, ptr [[VLA]], i64 [[TMP1]]), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [13 x i8] c"aVLA[5][: 2]\00", ptr @compute_dep.14, ptr [[VLA]], i64 [[TMP1]]), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [15 x i8] c"aVLA[5][3 : 4]\00", ptr @compute_dep.15, ptr [[VLA]], i64 [[TMP1]]) ], !dbg [[DBG17:![0-9]+]]
...
// AARCH64-NEXT:    call void @llvm.stackrestore(ptr [[TMP7]]), !dbg [[DBG19]]
...
// AARCH64-NEXT:    [[X:%.*]] = getelementptr inbounds [[STRUCT_C:%.*]], ptr [[C]], i32 0, i32 0, !dbg [[DBG101:![0-9]+]]
