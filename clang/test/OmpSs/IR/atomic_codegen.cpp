...
// LIN64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP]]) #[[ATTR2:[0-9]+]], !dbg [[DBG14:![0-9]+]]
...
// LIN64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP2]]) #[[ATTR2]], !dbg [[DBG18:![0-9]+]]
...
// LIN64:       atomic_exit:
// LIN64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP6]]) #[[ATTR2]], !dbg [[DBG23:![0-9]+]]
...
// LIN64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP11]]) #[[ATTR2]], !dbg [[DBG31:![0-9]+]]
// LIN64-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]), !dbg [[DBG32:![0-9]+]]
// LIN64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[S]]) #[[ATTR2]], !dbg [[DBG33:![0-9]+]]
...
// LIN64-NEXT:    call void @__clang_call_terminate(ptr [[TMP16]]) #[[ATTR7:[0-9]+]], !dbg [[DBG11]]
// LIN64-NEXT:    unreachable, !dbg [[DBG11]]
//
//
// LIN64-LABEL: define {{[^@]+}}@_ZN2StC1Ev
// LIN64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR1:[0-9]+]] comdat align 2 !dbg [[DBG34:![0-9]+]] {
// LIN64-NEXT:  entry:
...
// LIN64-SAME: (ptr noundef [[TMP0:%.*]]) #[[ATTR3:[0-9]+]] comdat {
// LIN64-NEXT:    [[TMP2:%.*]] = call ptr @__cxa_begin_catch(ptr [[TMP0]]) #[[ATTR2]]
// LIN64-NEXT:    call void @_ZSt9terminatev() #[[ATTR7]]
// LIN64-NEXT:    unreachable
//
//
// LIN64-LABEL: define {{[^@]+}}@_ZN2St3getEv
// LIN64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) #[[ATTR4:[0-9]+]] comdat align 2 !dbg [[DBG37:![0-9]+]] {
// LIN64-NEXT:  entry:
// LIN64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// LIN64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// LIN64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// LIN64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5:[0-9]+]] comdat align 2 !dbg [[DBG39:![0-9]+]] {
// LIN64-NEXT:  entry:
// LIN64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// LIN64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// LIN64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// LIN64-NEXT:    call void @_ZN2StD2Ev(ptr noundef nonnull align 8 dereferenceable(8) [[THIS1]]) #[[ATTR2]], !dbg [[DBG40:![0-9]+]]
...
// LIN64-SAME: () #[[ATTR4]] personality ptr @__gxx_personality_v0 !dbg [[DBG45:![0-9]+]] {
// LIN64-NEXT:  entry:
...
// LIN64-NEXT:    call void @__clang_call_terminate(ptr [[TMP7]]) #[[ATTR7]], !dbg [[DBG47]]
// LIN64-NEXT:    unreachable, !dbg [[DBG47]]
//
//
// LIN64-LABEL: define {{[^@]+}}@_ZN2StC2Ev
// LIN64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5]] comdat align 2 !dbg [[DBG56:![0-9]+]] {
// LIN64-NEXT:  entry:
// LIN64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// LIN64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// LIN64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// LIN64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5]] comdat align 2 !dbg [[DBG58:![0-9]+]] {
// LIN64-NEXT:  entry:
// LIN64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// LIN64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// LIN64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// PPC64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP]]) #[[ATTR2:[0-9]+]], !dbg [[DBG14:![0-9]+]]
...
// PPC64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP2]]) #[[ATTR2]], !dbg [[DBG18:![0-9]+]]
...
// PPC64:       atomic_exit:
// PPC64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP6]]) #[[ATTR2]], !dbg [[DBG23:![0-9]+]]
...
// PPC64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP11]]) #[[ATTR2]], !dbg [[DBG31:![0-9]+]]
// PPC64-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]), !dbg [[DBG32:![0-9]+]]
// PPC64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[S]]) #[[ATTR2]], !dbg [[DBG33:![0-9]+]]
...
// PPC64-NEXT:    call void @__clang_call_terminate(ptr [[TMP16]]) #[[ATTR7:[0-9]+]], !dbg [[DBG11]]
// PPC64-NEXT:    unreachable, !dbg [[DBG11]]
//
//
// PPC64-LABEL: define {{[^@]+}}@_ZN2StC1Ev
// PPC64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR1:[0-9]+]] comdat !dbg [[DBG34:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-SAME: (ptr noundef [[TMP0:%.*]]) #[[ATTR3:[0-9]+]] comdat {
// PPC64-NEXT:    [[TMP2:%.*]] = call ptr @__cxa_begin_catch(ptr [[TMP0]]) #[[ATTR2]]
// PPC64-NEXT:    call void @_ZSt9terminatev() #[[ATTR7]]
// PPC64-NEXT:    unreachable
//
//
// PPC64-LABEL: define {{[^@]+}}@_ZN2St3getEv
// PPC64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) #[[ATTR4:[0-9]+]] comdat !dbg [[DBG37:![0-9]+]] {
// PPC64-NEXT:  entry:
// PPC64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// PPC64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// PPC64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// PPC64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5:[0-9]+]] comdat !dbg [[DBG39:![0-9]+]] {
// PPC64-NEXT:  entry:
// PPC64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// PPC64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// PPC64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// PPC64-NEXT:    call void @_ZN2StD2Ev(ptr noundef nonnull align 8 dereferenceable(8) [[THIS1]]) #[[ATTR2]], !dbg [[DBG40:![0-9]+]]
...
// PPC64-SAME: () #[[ATTR4]] personality ptr @__gxx_personality_v0 !dbg [[DBG45:![0-9]+]] {
// PPC64-NEXT:  entry:
...
// PPC64-NEXT:    call void @__clang_call_terminate(ptr [[TMP7]]) #[[ATTR7]], !dbg [[DBG47]]
// PPC64-NEXT:    unreachable, !dbg [[DBG47]]
//
//
// PPC64-LABEL: define {{[^@]+}}@_ZN2StC2Ev
// PPC64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5]] comdat !dbg [[DBG56:![0-9]+]] {
// PPC64-NEXT:  entry:
// PPC64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// PPC64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// PPC64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// PPC64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5]] comdat !dbg [[DBG58:![0-9]+]] {
// PPC64-NEXT:  entry:
// PPC64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// PPC64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// PPC64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// AARCH64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP]]) #[[ATTR2:[0-9]+]], !dbg [[DBG14:![0-9]+]]
...
// AARCH64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP2]]) #[[ATTR2]], !dbg [[DBG18:![0-9]+]]
...
// AARCH64:       atomic_exit:
// AARCH64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP6]]) #[[ATTR2]], !dbg [[DBG23:![0-9]+]]
...
// AARCH64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[REF_TMP11]]) #[[ATTR2]], !dbg [[DBG31:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]), !dbg [[DBG32:![0-9]+]]
// AARCH64-NEXT:    call void @_ZN2StD1Ev(ptr noundef nonnull align 8 dereferenceable(8) [[S]]) #[[ATTR2]], !dbg [[DBG33:![0-9]+]]
...
// AARCH64-NEXT:    call void @__clang_call_terminate(ptr [[TMP16]]) #[[ATTR7:[0-9]+]], !dbg [[DBG11]]
// AARCH64-NEXT:    unreachable, !dbg [[DBG11]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@_ZN2StC1Ev
// AARCH64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR1:[0-9]+]] comdat align 2 !dbg [[DBG34:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-SAME: (ptr noundef [[TMP0:%.*]]) #[[ATTR3:[0-9]+]] comdat {
// AARCH64-NEXT:    [[TMP2:%.*]] = call ptr @__cxa_begin_catch(ptr [[TMP0]]) #[[ATTR2]]
// AARCH64-NEXT:    call void @_ZSt9terminatev() #[[ATTR7]]
// AARCH64-NEXT:    unreachable
//
//
// AARCH64-LABEL: define {{[^@]+}}@_ZN2St3getEv
// AARCH64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) #[[ATTR4:[0-9]+]] comdat align 2 !dbg [[DBG37:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// AARCH64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// AARCH64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5:[0-9]+]] comdat align 2 !dbg [[DBG39:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// AARCH64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// AARCH64-NEXT:    call void @_ZN2StD2Ev(ptr noundef nonnull align 8 dereferenceable(8) [[THIS1]]) #[[ATTR2]], !dbg [[DBG40:![0-9]+]]
...
// AARCH64-SAME: () #[[ATTR4]] personality ptr @__gxx_personality_v0 !dbg [[DBG45:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// AARCH64-NEXT:    call void @__clang_call_terminate(ptr [[TMP7]]) #[[ATTR7]], !dbg [[DBG47]]
// AARCH64-NEXT:    unreachable, !dbg [[DBG47]]
//
//
// AARCH64-LABEL: define {{[^@]+}}@_ZN2StC2Ev
// AARCH64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5]] comdat align 2 !dbg [[DBG56:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// AARCH64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// AARCH64-SAME: (ptr noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR5]] comdat align 2 !dbg [[DBG58:![0-9]+]] {
// AARCH64-NEXT:  entry:
// AARCH64-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// AARCH64-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
