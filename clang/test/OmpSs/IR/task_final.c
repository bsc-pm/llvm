...
// AARCH64-SAME: (i32 noundef [[A:%.*]]) #[[ATTR0:[0-9]+]] !dbg [[DBG9:![0-9]+]] {
// AARCH64-NEXT:  entry:
...
// LIN64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.FINAL"(i1 [[TOBOOL1]]), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"bar:7:9\00") ], !dbg [[DBG16]]
...
// PPC64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.FINAL"(i1 [[TOBOOL1]]), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"bar:7:9\00") ], !dbg [[DBG16]]
...
// AARCH64-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FINAL"(i1 [[TOBOOL]]) ], !dbg [[DBG16]]
...
// AARCH64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.FINAL"(i1 [[TOBOOL1]]), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"bar:7:9\00") ], !dbg [[DBG20]]
