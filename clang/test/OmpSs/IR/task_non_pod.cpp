...
// CHECK-NEXT: %x1 = getelementptr inbounds %struct.S, %struct.S* %1, i32 0, i32 0
// CHECK-NEXT: %2 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(%struct.S* %0), "QUAL.OSS.SHARED"(%struct.S* %1), "QUAL.OSS.DEP.IN"(i32* %x, i64 4, i64 0, i64 4), "QUAL.OSS.DEP.IN"(i32* %x1, i64 4, i64 0, i64 4) ]
