...
// CHECK: %1 = call token @llvm.directive.region.entry() [ "DIR.OSS"([9 x i8] c"TASKLOOP\00"), "QUAL.OSS.PRIVATE"(i32* %i1), "QUAL.OSS.LOOP.IND.VAR"(i32* %i1), "QUAL.OSS.LOOP.LOWER.BOUND"(i32 ()* @compute_lb.4), "QUAL.OSS.LOOP.UPPER.BOUND"(i32 ()* @compute_ub.5), "QUAL.OSS.LOOP.STEP"(i32 ()* @compute_step.6), "QUAL.OSS.LOOP.TYPE"(i64 0, i64 1, i64 1, i64 1, i64 1) ]
...
// CHECK: define internal i32 @compute_lb.4()
// CHECK: entry:
// CHECK-NEXT:   ret i32 0
// CHECK-NEXT: }

// CHECK: define internal i32 @compute_ub.5()
// CHECK: entry:
// CHECK-NEXT:   ret i32 10
// CHECK-NEXT: }

// CHECK: define internal i32 @compute_step.6()
// CHECK: entry:
// CHECK-NEXT:   ret i32 1
// CHECK-NEXT: }
