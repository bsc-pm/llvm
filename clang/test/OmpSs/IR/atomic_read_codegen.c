...
// LIN64-NEXT:    [[ATOMIC_LOAD11:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG21:![0-9]+]]
// LIN64-NEXT:    [[TMP0:%.*]] = bitcast i32 [[ATOMIC_LOAD11]] to float, !dbg [[DBG21]]
// LIN64-NEXT:    store float [[TMP0]], ptr @fv, align 4, !dbg [[DBG21]]
// LIN64-NEXT:    [[ATOMIC_LOAD12:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG22:![0-9]+]]
// LIN64-NEXT:    [[TMP1:%.*]] = bitcast i64 [[ATOMIC_LOAD12]] to double, !dbg [[DBG22]]
// LIN64-NEXT:    store double [[TMP1]], ptr @dv, align 8, !dbg [[DBG22]]
// LIN64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @ldx, ptr noundef [[ATOMIC_TEMP]], i32 noundef 0), !dbg [[DBG23:![0-9]+]]
// LIN64-NEXT:    [[TMP2:%.*]] = load x86_fp80, ptr [[ATOMIC_TEMP]], align 16, !dbg [[DBG23]]
// LIN64-NEXT:    store x86_fp80 [[TMP2]], ptr @ldv, align 16, !dbg [[DBG23]]
...
// LIN64-NEXT:    [[ATOMIC_LOAD30:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG35:![0-9]+]]
// LIN64-NEXT:    [[TMP3:%.*]] = bitcast i32 [[ATOMIC_LOAD30]] to float, !dbg [[DBG35]]
// LIN64-NEXT:    [[CONV31:%.*]] = fptoui float [[TMP3]] to i64, !dbg [[DBG35]]
// LIN64-NEXT:    store i64 [[CONV31]], ptr @ulv, align 8, !dbg [[DBG35]]
// LIN64-NEXT:    [[ATOMIC_LOAD32:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG36:![0-9]+]]
// LIN64-NEXT:    [[TMP4:%.*]] = bitcast i64 [[ATOMIC_LOAD32]] to double, !dbg [[DBG36]]
// LIN64-NEXT:    [[CONV33:%.*]] = fptosi double [[TMP4]] to i64, !dbg [[DBG36]]
...
// LIN64-NEXT:    [[TMP5:%.*]] = load x86_fp80, ptr [[ATOMIC_TEMP34]], align 16, !dbg [[DBG37]]
// LIN64-NEXT:    [[CONV35:%.*]] = fptoui x86_fp80 [[TMP5]] to i64, !dbg [[DBG37]]
...
// LIN64-NEXT:    [[TMP6:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP50]], align 16, !dbg [[DBG44]]
// LIN64-NEXT:    [[VECEXT:%.*]] = extractelement <4 x i32> [[TMP6]], i32 0, !dbg [[DBG44]]
...
// LIN64-NEXT:    [[ATOMIC_LOAD90:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG52:![0-9]+]]
...
// LIN64-NEXT:    [[ATOMIC_LOAD103:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) acquire, align 1, !dbg [[DBG54:![0-9]+]]
...
// LIN64-NEXT:    [[TMP7:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP110]], align 8, !dbg [[DBG55]]
// LIN64-NEXT:    [[TMP8:%.*]] = extractelement <2 x float> [[TMP7]], i64 0, !dbg [[DBG55]]
// LIN64-NEXT:    [[CONV111:%.*]] = fptoui float [[TMP8]] to i64, !dbg [[DBG55]]
// LIN64-NEXT:    store i64 [[CONV111]], ptr @ulv, align 8, !dbg [[DBG55]]
// LIN64-NEXT:    [[TMP9:%.*]] = call i32 @llvm.read_register.i32(metadata [[META2:![0-9]+]]), !dbg [[DBG56:![0-9]+]]
// LIN64-NEXT:    fence acquire
// LIN64-NEXT:    [[CONV112:%.*]] = sitofp i32 [[TMP9]] to double, !dbg [[DBG56]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL]], ptr @bv, align 1, !dbg [[DBG9]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD11:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG20:![0-9]+]]
// PPC64-NEXT:    [[TMP0:%.*]] = bitcast i32 [[ATOMIC_LOAD11]] to float, !dbg [[DBG20]]
// PPC64-NEXT:    store float [[TMP0]], ptr @fv, align 4, !dbg [[DBG20]]
// PPC64-NEXT:    [[ATOMIC_LOAD12:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG21:![0-9]+]]
// PPC64-NEXT:    [[TMP1:%.*]] = bitcast i64 [[ATOMIC_LOAD12]] to double, !dbg [[DBG21]]
// PPC64-NEXT:    store double [[TMP1]], ptr @dv, align 8, !dbg [[DBG21]]
...
// PPC64-NEXT:    [[TMP2:%.*]] = load ppc_fp128, ptr [[ATOMIC_TEMP]], align 16, !dbg [[DBG22]]
// PPC64-NEXT:    store ppc_fp128 [[TMP2]], ptr @ldv, align 16, !dbg [[DBG22]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP13_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP13]], i32 0, i32 0, !dbg [[DBG23]]
// PPC64-NEXT:    [[ATOMIC_TEMP13_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP13_REALP]], align 4, !dbg [[DBG23]]
// PPC64-NEXT:    [[ATOMIC_TEMP13_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP13]], i32 0, i32 1, !dbg [[DBG23]]
...
// PPC64-NEXT:    store i32 [[ATOMIC_TEMP13_IMAG]], ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG23]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP14_REALP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP14]], i32 0, i32 0, !dbg [[DBG24]]
// PPC64-NEXT:    [[ATOMIC_TEMP14_REAL:%.*]] = load float, ptr [[ATOMIC_TEMP14_REALP]], align 4, !dbg [[DBG24]]
// PPC64-NEXT:    [[ATOMIC_TEMP14_IMAGP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP14]], i32 0, i32 1, !dbg [[DBG24]]
...
// PPC64-NEXT:    store float [[ATOMIC_TEMP14_IMAG]], ptr getelementptr inbounds ({ float, float }, ptr @cfv, i32 0, i32 1), align 4, !dbg [[DBG24]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP15_REALP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP15]], i32 0, i32 0, !dbg [[DBG25]]
// PPC64-NEXT:    [[ATOMIC_TEMP15_REAL:%.*]] = load double, ptr [[ATOMIC_TEMP15_REALP]], align 8, !dbg [[DBG25]]
// PPC64-NEXT:    [[ATOMIC_TEMP15_IMAGP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP15]], i32 0, i32 1, !dbg [[DBG25]]
...
// PPC64-NEXT:    store double [[ATOMIC_TEMP15_IMAG]], ptr getelementptr inbounds ({ double, double }, ptr @cdv, i32 0, i32 1), align 8, !dbg [[DBG25]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL18]], ptr @bv, align 1, !dbg [[DBG26]]
// PPC64-NEXT:    [[ATOMIC_LOAD19:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG27:![0-9]+]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD21:%.*]] = load atomic i8, ptr @cx seq_cst, align 1, !dbg [[DBG28:![0-9]+]]
// PPC64-NEXT:    fence acquire
// PPC64-NEXT:    store i8 [[ATOMIC_LOAD21]], ptr @ucv, align 1, !dbg [[DBG28]]
// PPC64-NEXT:    [[ATOMIC_LOAD22:%.*]] = load atomic i64, ptr @ulx monotonic, align 8, !dbg [[DBG29:![0-9]+]]
// PPC64-NEXT:    [[CONV23:%.*]] = trunc i64 [[ATOMIC_LOAD22]] to i16, !dbg [[DBG29]]
// PPC64-NEXT:    store i16 [[CONV23]], ptr @sv, align 2, !dbg [[DBG29]]
// PPC64-NEXT:    [[ATOMIC_LOAD24:%.*]] = load atomic i64, ptr @lx monotonic, align 8, !dbg [[DBG30:![0-9]+]]
// PPC64-NEXT:    [[CONV25:%.*]] = trunc i64 [[ATOMIC_LOAD24]] to i16, !dbg [[DBG30]]
// PPC64-NEXT:    store i16 [[CONV25]], ptr @usv, align 2, !dbg [[DBG30]]
// PPC64-NEXT:    [[ATOMIC_LOAD26:%.*]] = load atomic i32, ptr @uix seq_cst, align 4, !dbg [[DBG31:![0-9]+]]
// PPC64-NEXT:    fence acquire
// PPC64-NEXT:    store i32 [[ATOMIC_LOAD26]], ptr @iv, align 4, !dbg [[DBG31]]
// PPC64-NEXT:    [[ATOMIC_LOAD27:%.*]] = load atomic i32, ptr @ix monotonic, align 4, !dbg [[DBG32:![0-9]+]]
// PPC64-NEXT:    store i32 [[ATOMIC_LOAD27]], ptr @uiv, align 4, !dbg [[DBG32]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP28]], i32 noundef signext 0), !dbg [[DBG33:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_TEMP28_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP28]], i32 0, i32 0, !dbg [[DBG33]]
// PPC64-NEXT:    [[ATOMIC_TEMP28_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP28_REALP]], align 4, !dbg [[DBG33]]
// PPC64-NEXT:    [[ATOMIC_TEMP28_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP28]], i32 0, i32 1, !dbg [[DBG33]]
// PPC64-NEXT:    [[ATOMIC_TEMP28_IMAG:%.*]] = load i32, ptr [[ATOMIC_TEMP28_IMAGP]], align 4, !dbg [[DBG33]]
// PPC64-NEXT:    [[CONV29:%.*]] = sext i32 [[ATOMIC_TEMP28_REAL]] to i64, !dbg [[DBG33]]
// PPC64-NEXT:    store i64 [[CONV29]], ptr @lv, align 8, !dbg [[DBG33]]
// PPC64-NEXT:    [[ATOMIC_LOAD30:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG34:![0-9]+]]
// PPC64-NEXT:    [[TMP3:%.*]] = bitcast i32 [[ATOMIC_LOAD30]] to float, !dbg [[DBG34]]
// PPC64-NEXT:    [[CONV31:%.*]] = fptoui float [[TMP3]] to i64, !dbg [[DBG34]]
// PPC64-NEXT:    store i64 [[CONV31]], ptr @ulv, align 8, !dbg [[DBG34]]
// PPC64-NEXT:    [[ATOMIC_LOAD32:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG35:![0-9]+]]
// PPC64-NEXT:    [[TMP4:%.*]] = bitcast i64 [[ATOMIC_LOAD32]] to double, !dbg [[DBG35]]
// PPC64-NEXT:    [[CONV33:%.*]] = fptosi double [[TMP4]] to i64, !dbg [[DBG35]]
// PPC64-NEXT:    store i64 [[CONV33]], ptr @llv, align 8, !dbg [[DBG35]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @ldx, ptr noundef [[ATOMIC_TEMP34]], i32 noundef signext 0), !dbg [[DBG36:![0-9]+]]
// PPC64-NEXT:    [[TMP5:%.*]] = load ppc_fp128, ptr [[ATOMIC_TEMP34]], align 16, !dbg [[DBG36]]
// PPC64-NEXT:    [[CONV35:%.*]] = fptoui ppc_fp128 [[TMP5]] to i64, !dbg [[DBG36]]
// PPC64-NEXT:    store i64 [[CONV35]], ptr @ullv, align 8, !dbg [[DBG36]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP36]], i32 noundef signext 0), !dbg [[DBG37:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_TEMP36_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP36]], i32 0, i32 0, !dbg [[DBG37]]
// PPC64-NEXT:    [[ATOMIC_TEMP36_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP36_REALP]], align 4, !dbg [[DBG37]]
// PPC64-NEXT:    [[ATOMIC_TEMP36_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP36]], i32 0, i32 1, !dbg [[DBG37]]
// PPC64-NEXT:    [[ATOMIC_TEMP36_IMAG:%.*]] = load i32, ptr [[ATOMIC_TEMP36_IMAGP]], align 4, !dbg [[DBG37]]
// PPC64-NEXT:    [[CONV37:%.*]] = sitofp i32 [[ATOMIC_TEMP36_REAL]] to float, !dbg [[DBG37]]
// PPC64-NEXT:    store float [[CONV37]], ptr @fv, align 4, !dbg [[DBG37]]
// PPC64-NEXT:    [[ATOMIC_LOAD38:%.*]] = load atomic i16, ptr @sx monotonic, align 2, !dbg [[DBG38:![0-9]+]]
// PPC64-NEXT:    [[CONV39:%.*]] = sitofp i16 [[ATOMIC_LOAD38]] to double, !dbg [[DBG38]]
// PPC64-NEXT:    store double [[CONV39]], ptr @dv, align 8, !dbg [[DBG38]]
// PPC64-NEXT:    [[ATOMIC_LOAD40:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG39:![0-9]+]]
// PPC64-NEXT:    [[TOBOOL41:%.*]] = trunc i8 [[ATOMIC_LOAD40]] to i1, !dbg [[DBG39]]
// PPC64-NEXT:    [[CONV42:%.*]] = uitofp i1 [[TOBOOL41]] to ppc_fp128, !dbg [[DBG39]]
// PPC64-NEXT:    store ppc_fp128 [[CONV42]], ptr @ldv, align 16, !dbg [[DBG39]]
// PPC64-NEXT:    [[ATOMIC_LOAD43:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG40:![0-9]+]]
// PPC64-NEXT:    [[TOBOOL44:%.*]] = trunc i8 [[ATOMIC_LOAD43]] to i1, !dbg [[DBG40]]
// PPC64-NEXT:    [[CONV45:%.*]] = zext i1 [[TOBOOL44]] to i32, !dbg [[DBG40]]
// PPC64-NEXT:    store i32 [[CONV45]], ptr @civ, align 4, !dbg [[DBG40]]
// PPC64-NEXT:    store i32 0, ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG40]]
// PPC64-NEXT:    [[ATOMIC_LOAD46:%.*]] = load atomic i16, ptr @usx monotonic, align 2, !dbg [[DBG41:![0-9]+]]
// PPC64-NEXT:    [[CONV47:%.*]] = uitofp i16 [[ATOMIC_LOAD46]] to float, !dbg [[DBG41]]
// PPC64-NEXT:    store float [[CONV47]], ptr @cfv, align 4, !dbg [[DBG41]]
// PPC64-NEXT:    store float 0.000000e+00, ptr getelementptr inbounds ({ float, float }, ptr @cfv, i32 0, i32 1), align 4, !dbg [[DBG41]]
// PPC64-NEXT:    [[ATOMIC_LOAD48:%.*]] = load atomic i64, ptr @llx monotonic, align 8, !dbg [[DBG42:![0-9]+]]
// PPC64-NEXT:    [[CONV49:%.*]] = sitofp i64 [[ATOMIC_LOAD48]] to double, !dbg [[DBG42]]
// PPC64-NEXT:    store double [[CONV49]], ptr @cdv, align 8, !dbg [[DBG42]]
// PPC64-NEXT:    store double 0.000000e+00, ptr getelementptr inbounds ({ double, double }, ptr @cdv, i32 0, i32 1), align 8, !dbg [[DBG42]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @int4x, ptr noundef [[ATOMIC_TEMP50]], i32 noundef signext 0), !dbg [[DBG43:![0-9]+]]
// PPC64-NEXT:    [[TMP6:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP50]], align 16, !dbg [[DBG43]]
// PPC64-NEXT:    [[VECEXT:%.*]] = extractelement <4 x i32> [[TMP6]], i32 0, !dbg [[DBG43]]
// PPC64-NEXT:    [[TOBOOL51:%.*]] = icmp ne i32 [[VECEXT]], 0, !dbg [[DBG43]]
// PPC64-NEXT:    [[FROMBOOL52:%.*]] = zext i1 [[TOBOOL51]] to i8, !dbg [[DBG43]]
// PPC64-NEXT:    store i8 [[FROMBOOL52]], ptr @bv, align 1, !dbg [[DBG43]]
// PPC64-NEXT:    [[ATOMIC_LOAD53:%.*]] = load atomic i32, ptr @bfx monotonic, align 4, !dbg [[DBG44:![0-9]+]]
// PPC64-NEXT:    store i32 [[ATOMIC_LOAD53]], ptr [[ATOMIC_TEMP54]], align 4, !dbg [[DBG44]]
// PPC64-NEXT:    [[BF_LOAD:%.*]] = load i32, ptr [[ATOMIC_TEMP54]], align 4, !dbg [[DBG44]]
// PPC64-NEXT:    [[BF_ASHR:%.*]] = ashr i32 [[BF_LOAD]], 1, !dbg [[DBG44]]
// PPC64-NEXT:    [[CONV55:%.*]] = sitofp i32 [[BF_ASHR]] to ppc_fp128, !dbg [[DBG44]]
// PPC64-NEXT:    store ppc_fp128 [[CONV55]], ptr @ldv, align 16, !dbg [[DBG44]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 4, ptr noundef @bfx_packed, ptr noundef [[ATOMIC_TEMP56]], i32 noundef signext 0), !dbg [[DBG45:![0-9]+]]
// PPC64-NEXT:    [[BF_LOAD57:%.*]] = load i32, ptr [[ATOMIC_TEMP56]], align 1, !dbg [[DBG45]]
// PPC64-NEXT:    [[BF_ASHR58:%.*]] = ashr i32 [[BF_LOAD57]], 1, !dbg [[DBG45]]
// PPC64-NEXT:    [[CONV59:%.*]] = sitofp i32 [[BF_ASHR58]] to ppc_fp128, !dbg [[DBG45]]
// PPC64-NEXT:    store ppc_fp128 [[CONV59]], ptr @ldv, align 16, !dbg [[DBG45]]
// PPC64-NEXT:    [[ATOMIC_LOAD60:%.*]] = load atomic i32, ptr @bfx2 monotonic, align 4, !dbg [[DBG46:![0-9]+]]
// PPC64-NEXT:    store i32 [[ATOMIC_LOAD60]], ptr [[ATOMIC_TEMP61]], align 4, !dbg [[DBG46]]
// PPC64-NEXT:    [[BF_LOAD62:%.*]] = load i32, ptr [[ATOMIC_TEMP61]], align 4, !dbg [[DBG46]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV64]], ptr @ldv, align 16, !dbg [[DBG46]]
// PPC64-NEXT:    [[ATOMIC_LOAD65:%.*]] = load atomic i8, ptr @bfx2_packed monotonic, align 1, !dbg [[DBG47:![0-9]+]]
// PPC64-NEXT:    store i8 [[ATOMIC_LOAD65]], ptr [[ATOMIC_TEMP66]], align 1, !dbg [[DBG47]]
// PPC64-NEXT:    [[BF_LOAD67:%.*]] = load i8, ptr [[ATOMIC_TEMP66]], align 1, !dbg [[DBG47]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV70]], ptr @ldv, align 16, !dbg [[DBG47]]
// PPC64-NEXT:    [[ATOMIC_LOAD71:%.*]] = load atomic i32, ptr @bfx3 monotonic, align 4, !dbg [[DBG48:![0-9]+]]
// PPC64-NEXT:    store i32 [[ATOMIC_LOAD71]], ptr [[ATOMIC_TEMP72]], align 4, !dbg [[DBG48]]
// PPC64-NEXT:    [[BF_LOAD73:%.*]] = load i32, ptr [[ATOMIC_TEMP72]], align 4, !dbg [[DBG48]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV76]], ptr @ldv, align 16, !dbg [[DBG48]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 3, ptr noundef @bfx3_packed, ptr noundef [[ATOMIC_TEMP77]], i32 noundef signext 0), !dbg [[DBG49:![0-9]+]]
// PPC64-NEXT:    [[BF_LOAD78:%.*]] = load i24, ptr [[ATOMIC_TEMP77]], align 1, !dbg [[DBG49]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV82]], ptr @ldv, align 16, !dbg [[DBG49]]
// PPC64-NEXT:    [[ATOMIC_LOAD83:%.*]] = load atomic i64, ptr @bfx4 monotonic, align 8, !dbg [[DBG50:![0-9]+]]
// PPC64-NEXT:    store i64 [[ATOMIC_LOAD83]], ptr [[ATOMIC_TEMP84]], align 8, !dbg [[DBG50]]
// PPC64-NEXT:    [[BF_LOAD85:%.*]] = load i64, ptr [[ATOMIC_TEMP84]], align 8, !dbg [[DBG50]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV89]], ptr @ldv, align 16, !dbg [[DBG50]]
// PPC64-NEXT:    [[ATOMIC_LOAD90:%.*]] = load atomic i8, ptr @bfx4_packed monotonic, align 1, !dbg [[DBG51:![0-9]+]]
// PPC64-NEXT:    store i8 [[ATOMIC_LOAD90]], ptr [[ATOMIC_TEMP91]], align 1, !dbg [[DBG51]]
// PPC64-NEXT:    [[BF_LOAD92:%.*]] = load i8, ptr [[ATOMIC_TEMP91]], align 1, !dbg [[DBG51]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV95]], ptr @ldv, align 16, !dbg [[DBG51]]
// PPC64-NEXT:    [[ATOMIC_LOAD96:%.*]] = load atomic i64, ptr @bfx4 monotonic, align 8, !dbg [[DBG52:![0-9]+]]
// PPC64-NEXT:    store i64 [[ATOMIC_LOAD96]], ptr [[ATOMIC_TEMP97]], align 8, !dbg [[DBG52]]
// PPC64-NEXT:    [[BF_LOAD98:%.*]] = load i64, ptr [[ATOMIC_TEMP97]], align 8, !dbg [[DBG52]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV101]], ptr @ldv, align 16, !dbg [[DBG52]]
// PPC64-NEXT:    [[ATOMIC_LOAD102:%.*]] = load atomic i8, ptr @bfx4_packed acquire, align 1, !dbg [[DBG53:![0-9]+]]
// PPC64-NEXT:    store i8 [[ATOMIC_LOAD102]], ptr [[ATOMIC_TEMP103]], align 1, !dbg [[DBG53]]
// PPC64-NEXT:    [[BF_LOAD104:%.*]] = load i8, ptr [[ATOMIC_TEMP103]], align 1, !dbg [[DBG53]]
...
// PPC64-NEXT:    store ppc_fp128 [[CONV108]], ptr @ldv, align 16, !dbg [[DBG53]]
// PPC64-NEXT:    [[ATOMIC_LOAD109:%.*]] = load atomic i64, ptr @float2x monotonic, align 8, !dbg [[DBG54:![0-9]+]]
// PPC64-NEXT:    store i64 [[ATOMIC_LOAD109]], ptr [[ATOMIC_TEMP110]], align 8, !dbg [[DBG54]]
// PPC64-NEXT:    [[TMP7:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP110]], align 8, !dbg [[DBG54]]
// PPC64-NEXT:    [[TMP8:%.*]] = extractelement <2 x float> [[TMP7]], i64 0, !dbg [[DBG54]]
// PPC64-NEXT:    [[CONV111:%.*]] = fptoui float [[TMP8]] to i64, !dbg [[DBG54]]
// PPC64-NEXT:    store i64 [[CONV111]], ptr @ulv, align 8, !dbg [[DBG54]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD11:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG20:![0-9]+]]
// AARCH64-NEXT:    [[TMP0:%.*]] = bitcast i32 [[ATOMIC_LOAD11]] to float, !dbg [[DBG20]]
// AARCH64-NEXT:    store float [[TMP0]], ptr @fv, align 4, !dbg [[DBG20]]
// AARCH64-NEXT:    [[ATOMIC_LOAD12:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG21:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = bitcast i64 [[ATOMIC_LOAD12]] to double, !dbg [[DBG21]]
// AARCH64-NEXT:    store double [[TMP1]], ptr @dv, align 8, !dbg [[DBG21]]
// AARCH64-NEXT:    [[ATOMIC_LOAD13:%.*]] = load atomic i128, ptr @ldx monotonic, align 16, !dbg [[DBG22:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = bitcast i128 [[ATOMIC_LOAD13]] to fp128, !dbg [[DBG22]]
// AARCH64-NEXT:    store fp128 [[TMP2]], ptr @ldv, align 16, !dbg [[DBG22]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD30:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG34:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = bitcast i32 [[ATOMIC_LOAD30]] to float, !dbg [[DBG34]]
// AARCH64-NEXT:    [[CONV31:%.*]] = fptoui float [[TMP3]] to i64, !dbg [[DBG34]]
// AARCH64-NEXT:    store i64 [[CONV31]], ptr @ulv, align 8, !dbg [[DBG34]]
// AARCH64-NEXT:    [[ATOMIC_LOAD32:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG35:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = bitcast i64 [[ATOMIC_LOAD32]] to double, !dbg [[DBG35]]
// AARCH64-NEXT:    [[CONV33:%.*]] = fptosi double [[TMP4]] to i64, !dbg [[DBG35]]
// AARCH64-NEXT:    store i64 [[CONV33]], ptr @llv, align 8, !dbg [[DBG35]]
// AARCH64-NEXT:    [[ATOMIC_LOAD34:%.*]] = load atomic i128, ptr @ldx monotonic, align 16, !dbg [[DBG36:![0-9]+]]
// AARCH64-NEXT:    [[TMP5:%.*]] = bitcast i128 [[ATOMIC_LOAD34]] to fp128, !dbg [[DBG36]]
// AARCH64-NEXT:    [[CONV35:%.*]] = fptoui fp128 [[TMP5]] to i64, !dbg [[DBG36]]
...
// AARCH64-NEXT:    [[TMP6:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP51]], align 16, !dbg [[DBG43]]
// AARCH64-NEXT:    [[VECEXT:%.*]] = extractelement <4 x i32> [[TMP6]], i32 0, !dbg [[DBG43]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD91:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG51:![0-9]+]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD104:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) acquire, align 1, !dbg [[DBG53:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP7:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP111]], align 8, !dbg [[DBG54]]
// AARCH64-NEXT:    [[TMP8:%.*]] = extractelement <2 x float> [[TMP7]], i64 0, !dbg [[DBG54]]
// AARCH64-NEXT:    [[CONV112:%.*]] = fptoui float [[TMP8]] to i64, !dbg [[DBG54]]
