...
// PPC64-NEXT:    [[ATOMIC_LOAD90:%.*]] = load atomic i8, ptr @bfx4_packed monotonic, align 1, !dbg [[DBG52:![0-9]+]]
...
// PPC64-NEXT:    [[ATOMIC_LOAD102:%.*]] = load atomic i8, ptr @bfx4_packed acquire, align 1, !dbg [[DBG54:![0-9]+]]
