...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.DEVICE"(i32 1), "QUAL.OSS.DEVICE.DEVFUNC"([8 x i8] c"_Z3foov\00"), "QUAL.OSS.DEVICE.NDRANGE"(i32 1, i32 1, i32 1), "QUAL.OSS.DEVICE.CALL.ORDER"(), "QUAL.OSS.DECL.SOURCE"([21 x i8] c"task_ndrange.cpp:5:9\00") ], !dbg [[DBG9:![0-9]+]]
...
// CHECK-NEXT:    [[TMP5:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], ptr undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG1]], ptr undef), "QUAL.OSS.DEVICE"(i32 1), "QUAL.OSS.DEVICE.DEVFUNC"([23 x i8] c"_Z4foo1ILi1EiEvPT0_S1_\00"), "QUAL.OSS.DEVICE.NDRANGE"(i32 1, i32 [[TMP2]], i32 [[TMP4]]), "QUAL.OSS.DEVICE.CALL.ORDER"(ptr [[CALL_ARG]], ptr [[CALL_ARG1]]), "QUAL.OSS.DECL.SOURCE"([21 x i8] c"task_ndrange.cpp:7:9\00") ], !dbg [[DBG16:![0-9]+]]
