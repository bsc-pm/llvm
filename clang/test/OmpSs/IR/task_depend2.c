...
// CHECK: %arraydecay = getelementptr inbounds [5 x [6 x i32]], [5 x [6 x i32]]* %b, i32 0, i32 0
// CHECK-NEXT: %arraydecay1 = getelementptr inbounds [5 x [6 x i32]], [5 x [6 x i32]]* %b, i32 0, i32 0
// CHECK-NEXT: %arraydecay2 = getelementptr inbounds [5 x [6 x i32]], [5 x [6 x i32]]* %b, i32 0, i32 0
...
// CHECK: %arraydecay3 = getelementptr inbounds [5 x [6 x [7 x i32]]], [5 x [6 x [7 x i32]]]* %d, i32 0, i32 0
...
// CHECK: %arraydecay4 = getelementptr inbounds [5 x i32], [5 x i32]* %e, i32 0, i32 0
...
// CHECK-NEXT: %arraydecay = getelementptr inbounds [10 x i32], [10 x i32]* %x2, i32 0, i32 0
