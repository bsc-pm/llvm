...
// CHECK: %arraydecay = getelementptr inbounds [5 x i32], [5 x i32]* %ai, i32 0, i32 0
...
// CHECK: %1 = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(i32* @foo1_var), "QUAL.OSS.SHARED"([5 x i32]* @foo1_array), "QUAL.OSS.SHARED"(%struct.Foo1_struct* @foo1_s), "QUAL.OSS.FIRSTPRIVATE"(i32** @foo1_ptr), "QUAL.OSS.DEP.IN"(i32* @foo1_var, i64 4, i64 0, i64 4), "QUAL.OSS.DEP.IN"(i32* %0, i64 4, i64 0, i64 4), "QUAL.OSS.DEP.IN"(i32* getelementptr inbounds ([5 x i32], [5 x i32]* @foo1_array, i32 0, i32 0), i64 4, i64 12, i64 16), "QUAL.OSS.DEP.IN"(i32* getelementptr inbounds ([5 x i32], [5 x i32]* @foo1_array, i32 0, i32 0), i64 4, i64 -8, i64 -4), "QUAL.OSS.DEP.IN"(i32* getelementptr inbounds (%struct.Foo1_struct, %struct.Foo1_struct* @foo1_s, i32 0, i32 0), i64 4, i64 0, i64 4) ]
