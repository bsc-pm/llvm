...
// CHECK-NEXT:   call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %3, i8* align 4 bitcast ([3 x i32]* @__const._Z9constantsIiEvv.discrete.array.1 to i8*), i64 12, i1 false)
...
// CHECK-NEXT:   %1 = load i32, i32* %lb1, align 4
...
// CHECK-NEXT:   %2 = load i32, i32* %lb1, align 4
...
// CHECK-NEXT:   %5 = load i32, i32* %lb2, align 4
...
// CHECK-NEXT:   %6 = load i32, i32* %lb2, align 4
...
// CHECK-NEXT:   %7 = load i32, i32* %lb2, align 4
...
// CHECK-NEXT:   %arrayinit.element = getelementptr inbounds i32, i32* %arrayinit.begin, i64 1
// CHECK-NEXT:   %1 = load i16, i16* %lb1, align 2
...
// CHECK-NEXT:   %2 = load i16, i16* %lb1, align 2
...
// CHECK-NEXT:   %5 = load i16, i16* %lb2, align 2
...
// CHECK-NEXT:   %6 = load i16, i16* %lb2, align 2
...
// CHECK-NEXT:   %7 = load i16, i16* %lb2, align 2
