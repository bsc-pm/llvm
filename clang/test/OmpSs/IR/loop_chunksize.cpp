...
// AARCH64-NEXT:    store i32 0, ptr [[I]], align 4, !dbg [[DBG11:![0-9]+]]
// AARCH64-NEXT:    [[CALL:%.*]] = call noundef i32 @_Z3fooIiET_v(), !dbg [[DBG12:![0-9]+]]
...
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP3]]), !dbg [[DBG14:![0-9]+]]
// AARCH64-NEXT:    store i32 0, ptr [[I1]], align 4, !dbg [[DBG15:![0-9]+]]
// AARCH64-NEXT:    [[CALL2:%.*]] = call noundef i32 @_Z3fooIiET_v(), !dbg [[DBG16:![0-9]+]]
...
// AARCH64-NEXT:    store i32 0, ptr [[I3]], align 4, !dbg [[DBG19:![0-9]+]]
// AARCH64-NEXT:    [[TMP5:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG20:![0-9]+]]
...
// AARCH64-NEXT:    store i32 0, ptr [[I4]], align 4, !dbg [[DBG23:![0-9]+]]
// AARCH64-NEXT:    [[TMP7:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG24:![0-9]+]]
...
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP8]]), !dbg [[DBG26:![0-9]+]]
// AARCH64-NEXT:    store i32 0, ptr [[I5]], align 4, !dbg [[DBG27:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 1, !dbg [[DBG28:![0-9]+]]
// AARCH64-NEXT:    [[TMP9:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !dbg [[DBG28]]
...
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP10]]), !dbg [[DBG30:![0-9]+]]
// AARCH64-NEXT:    store i32 0, ptr [[I6]], align 4, !dbg [[DBG31:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 1, !dbg [[DBG32:![0-9]+]]
// AARCH64-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX7]], align 4, !dbg [[DBG32]]
// AARCH64-NEXT:    [[TMP12:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([13 x i8] c"TASKLOOP.FOR\00"), "QUAL.OSS.PRIVATE"(ptr [[I6]], i32 undef), "QUAL.OSS.LOOP.IND.VAR"(ptr [[I6]]), "QUAL.OSS.LOOP.LOWER.BOUND"(ptr @compute_lb.13), "QUAL.OSS.LOOP.UPPER.BOUND"(ptr @compute_ub.14), "QUAL.OSS.LOOP.STEP"(ptr @compute_step.15), "QUAL.OSS.LOOP.CHUNKSIZE"(i32 [[TMP11]]), "QUAL.OSS.LOOP.TYPE"(i64 0, i64 1, i64 1, i64 1, i64 1) ], !dbg [[DBG33:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP12]]), !dbg [[DBG34:![0-9]+]]
