...
// CHECK-NEXT:    [[TMP5:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([13 x i8] c"TASKITER.FOR\00"), "QUAL.OSS.SHARED"(ptr @sum, i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[I1]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP_ADDR]], i32 undef), "QUAL.OSS.LOOP.IND.VAR"(ptr [[I1]]), "QUAL.OSS.LOOP.LOWER.BOUND"(ptr @compute_lb.1, ptr [[LB_ADDR]]), "QUAL.OSS.LOOP.UPPER.BOUND"(ptr @compute_ub.2, ptr [[UB_ADDR]]), "QUAL.OSS.LOOP.STEP"(ptr @compute_step.3, ptr [[STEP_ADDR]]), "QUAL.OSS.LOOP.TYPE"(i64 1, i64 1, i64 1, i64 1, i64 1) ], !dbg [[DBG17:![0-9]+]]
...
// CHECK-NEXT:    [[TMP9:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([13 x i8] c"TASKITER.FOR\00"), "QUAL.OSS.SHARED"(ptr @sum, i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[I3]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP_ADDR]], i32 undef), "QUAL.OSS.LOOP.IND.VAR"(ptr [[I3]]), "QUAL.OSS.LOOP.LOWER.BOUND"(ptr @compute_lb.4, ptr [[UB_ADDR]]), "QUAL.OSS.LOOP.UPPER.BOUND"(ptr @compute_ub.5, ptr [[LB_ADDR]]), "QUAL.OSS.LOOP.STEP"(ptr @compute_step.6, ptr [[STEP_ADDR]]), "QUAL.OSS.LOOP.TYPE"(i64 2, i64 1, i64 1, i64 1, i64 1) ], !dbg [[DBG23:![0-9]+]]
...
// CHECK-NEXT:    [[TMP13:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([13 x i8] c"TASKITER.FOR\00"), "QUAL.OSS.SHARED"(ptr @sum, i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[I5]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[UB_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[LB_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[STEP_ADDR]], i32 undef), "QUAL.OSS.LOOP.IND.VAR"(ptr [[I5]]), "QUAL.OSS.LOOP.LOWER.BOUND"(ptr @compute_lb.7, ptr [[UB_ADDR]]), "QUAL.OSS.LOOP.UPPER.BOUND"(ptr @compute_ub.8, ptr [[LB_ADDR]]), "QUAL.OSS.LOOP.STEP"(ptr @compute_step.9, ptr [[STEP_ADDR]]), "QUAL.OSS.LOOP.TYPE"(i64 3, i64 1, i64 1, i64 1, i64 1) ], !dbg [[DBG29:![0-9]+]]
