...
// CHECK-LABEL: @main(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"foo:5:9\00") ], !dbg [[DBG12:![0-9]+]]
...
// CHECK-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"foo:5:9\00") ], !dbg [[DBG13:![0-9]+]]
// CHECK-NEXT:    invoke void @_Z3foov()
