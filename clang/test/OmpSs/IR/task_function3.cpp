...
// CHECK-NEXT: call void @_ZN1S4foo1Ei(%struct.S* noundef nonnull align 4 dereferenceable(4) %0, i32 noundef %2)
...
// CHECK-NEXT: call void @_ZN1S4foo1Ei(%struct.S* noundef nonnull align 4 dereferenceable(4) %4, i32 noundef %6)
