...
// LIN64-NEXT:    [[ATOMIC_LOAD282:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG148:![0-9]+]]
...
// LIN64-NEXT:    [[TMP180:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP177]], i8 [[TMP179]] monotonic monotonic, align 1, !dbg [[DBG148]]
...
// LIN64-NEXT:    [[ATOMIC_LOAD315:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) acquire, align 1, !dbg [[DBG156:![0-9]+]]
...
// LIN64-NEXT:    [[TMP193:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP190]], i8 [[TMP192]] acquire acquire, align 1, !dbg [[DBG156]]
...
// PPC64-NEXT:    [[CIV_IMAG:%.*]] = load i32, ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG53]]
...
// PPC64:       atomic_cont39:
// PPC64-NEXT:    [[ATOMIC_TEMP38_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP38]], i32 0, i32 0, !dbg [[DBG54]]
// PPC64-NEXT:    [[ATOMIC_TEMP38_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP38_REALP]], align 4, !dbg [[DBG54]]
// PPC64-NEXT:    [[ATOMIC_TEMP38_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP38]], i32 0, i32 1, !dbg [[DBG54]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP40_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP40]], i32 0, i32 0, !dbg [[DBG54]]
// PPC64-NEXT:    [[ATOMIC_TEMP40_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP40]], i32 0, i32 1, !dbg [[DBG54]]
...
// PPC64-NEXT:    store float [[CONV44]], ptr getelementptr inbounds ({ float, float }, ptr @cfv, i32 0, i32 1), align 4, !dbg [[DBG54]]
// PPC64-NEXT:    [[CFV_REAL:%.*]] = load float, ptr @cfv, align 4, !dbg [[DBG56:![0-9]+]]
// PPC64-NEXT:    [[CFV_IMAG:%.*]] = load float, ptr getelementptr inbounds ({ float, float }, ptr @cfv, i32 0, i32 1), align 4, !dbg [[DBG56]]
...
// PPC64:       atomic_cont46:
// PPC64-NEXT:    [[ATOMIC_TEMP45_REALP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP45]], i32 0, i32 0, !dbg [[DBG57]]
// PPC64-NEXT:    [[ATOMIC_TEMP45_REAL:%.*]] = load float, ptr [[ATOMIC_TEMP45_REALP]], align 4, !dbg [[DBG57]]
// PPC64-NEXT:    [[ATOMIC_TEMP45_IMAGP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP45]], i32 0, i32 1, !dbg [[DBG57]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP47_REALP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP47]], i32 0, i32 0, !dbg [[DBG57]]
// PPC64-NEXT:    [[ATOMIC_TEMP47_IMAGP:%.*]] = getelementptr inbounds { float, float }, ptr [[ATOMIC_TEMP47]], i32 0, i32 1, !dbg [[DBG57]]
...
// PPC64-NEXT:    store i32 [[CONV51]], ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG57]]
// PPC64-NEXT:    [[CDV_REAL:%.*]] = load double, ptr @cdv, align 8, !dbg [[DBG59:![0-9]+]]
// PPC64-NEXT:    [[CDV_IMAG:%.*]] = load double, ptr getelementptr inbounds ({ double, double }, ptr @cdv, i32 0, i32 1), align 8, !dbg [[DBG59]]
...
// PPC64:       atomic_cont53:
// PPC64-NEXT:    [[ATOMIC_TEMP52_REALP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP52]], i32 0, i32 0, !dbg [[DBG60]]
// PPC64-NEXT:    [[ATOMIC_TEMP52_REAL:%.*]] = load double, ptr [[ATOMIC_TEMP52_REALP]], align 8, !dbg [[DBG60]]
// PPC64-NEXT:    [[ATOMIC_TEMP52_IMAGP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP52]], i32 0, i32 1, !dbg [[DBG60]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP54_REALP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP54]], i32 0, i32 0, !dbg [[DBG60]]
// PPC64-NEXT:    [[ATOMIC_TEMP54_IMAGP:%.*]] = getelementptr inbounds { double, double }, ptr [[ATOMIC_TEMP54]], i32 0, i32 1, !dbg [[DBG60]]
...
// PPC64-NEXT:    store float [[CONV58]], ptr getelementptr inbounds ({ float, float }, ptr @cfv, i32 0, i32 1), align 4, !dbg [[DBG60]]
// PPC64-NEXT:    [[TMP64:%.*]] = load i8, ptr @bv, align 1, !dbg [[DBG62:![0-9]+]]
// PPC64-NEXT:    [[TOBOOL:%.*]] = trunc i8 [[TMP64]] to i1, !dbg [[DBG62]]
...
// PPC64-NEXT:    [[TOBOOL65:%.*]] = trunc i8 [[TMP67]] to i1, !dbg [[DBG66]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL]], ptr [[ATOMIC_TEMP64]], align 1, !dbg [[DBG66]]
...
// PPC64-NEXT:    br i1 [[TMP71]], label [[ATOMIC_EXIT69:%.*]], label [[ATOMIC_CONT63]], !dbg [[DBG66]]
// PPC64:       atomic_exit69:
// PPC64-NEXT:    [[FROMBOOL70:%.*]] = zext i1 [[TOBOOL65]] to i8, !dbg [[DBG66]]
// PPC64-NEXT:    store i8 [[FROMBOOL70]], ptr @bv, align 1, !dbg [[DBG66]]
// PPC64-NEXT:    [[TMP72:%.*]] = load i8, ptr @ucv, align 1, !dbg [[DBG69:![0-9]+]]
// PPC64-NEXT:    [[CONV71:%.*]] = zext i8 [[TMP72]] to i32, !dbg [[DBG69]]
// PPC64-NEXT:    [[ATOMIC_LOAD72:%.*]] = load atomic i8, ptr @cx seq_cst, align 1, !dbg [[DBG70:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT73:%.*]], !dbg [[DBG70]]
// PPC64:       atomic_cont73:
// PPC64-NEXT:    [[TMP73:%.*]] = phi i8 [ [[ATOMIC_LOAD72]], [[ATOMIC_EXIT69]] ], [ [[TMP76:%.*]], [[ATOMIC_CONT73]] ], !dbg [[DBG70]]
// PPC64-NEXT:    [[CONV75:%.*]] = sext i8 [[TMP73]] to i32, !dbg [[DBG71:![0-9]+]]
// PPC64-NEXT:    [[SHR76:%.*]] = ashr i32 [[CONV75]], [[CONV71]], !dbg [[DBG72:![0-9]+]]
// PPC64-NEXT:    [[CONV77:%.*]] = trunc i32 [[SHR76]] to i8, !dbg [[DBG71]]
// PPC64-NEXT:    store i8 [[CONV77]], ptr [[ATOMIC_TEMP74]], align 1, !dbg [[DBG70]]
// PPC64-NEXT:    [[TMP74:%.*]] = load i8, ptr [[ATOMIC_TEMP74]], align 1, !dbg [[DBG70]]
...
// PPC64-NEXT:    br i1 [[TMP77]], label [[ATOMIC_EXIT78:%.*]], label [[ATOMIC_CONT73]], !dbg [[DBG70]]
// PPC64:       atomic_exit78:
// PPC64-NEXT:    store i8 [[CONV77]], ptr @cv, align 1, !dbg [[DBG70]]
// PPC64-NEXT:    [[TMP78:%.*]] = load i16, ptr @sv, align 2, !dbg [[DBG73:![0-9]+]]
// PPC64-NEXT:    [[CONV79:%.*]] = sext i16 [[TMP78]] to i32, !dbg [[DBG73]]
// PPC64-NEXT:    [[ATOMIC_LOAD80:%.*]] = load atomic i64, ptr @ulx monotonic, align 8, !dbg [[DBG74:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT81:%.*]], !dbg [[DBG74]]
// PPC64:       atomic_cont81:
// PPC64-NEXT:    [[TMP79:%.*]] = phi i64 [ [[ATOMIC_LOAD80]], [[ATOMIC_EXIT78]] ], [ [[TMP82:%.*]], [[ATOMIC_CONT81]] ], !dbg [[DBG74]]
...
// PPC64-NEXT:    store i64 [[CONV84]], ptr [[ATOMIC_TEMP82]], align 8, !dbg [[DBG74]]
// PPC64-NEXT:    [[TMP80:%.*]] = load i64, ptr [[ATOMIC_TEMP82]], align 8, !dbg [[DBG74]]
...
// PPC64-NEXT:    br i1 [[TMP83]], label [[ATOMIC_EXIT85:%.*]], label [[ATOMIC_CONT81]], !dbg [[DBG74]]
// PPC64:       atomic_exit85:
// PPC64-NEXT:    store i64 [[CONV84]], ptr @ulv, align 8, !dbg [[DBG74]]
// PPC64-NEXT:    [[TMP84:%.*]] = load i16, ptr @usv, align 2, !dbg [[DBG76:![0-9]+]]
// PPC64-NEXT:    [[CONV86:%.*]] = zext i16 [[TMP84]] to i64, !dbg [[DBG76]]
// PPC64-NEXT:    [[ATOMIC_LOAD87:%.*]] = load atomic i64, ptr @lx monotonic, align 8, !dbg [[DBG77:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT88:%.*]], !dbg [[DBG77]]
// PPC64:       atomic_cont88:
// PPC64-NEXT:    [[TMP85:%.*]] = phi i64 [ [[ATOMIC_LOAD87]], [[ATOMIC_EXIT85]] ], [ [[TMP88:%.*]], [[ATOMIC_CONT88]] ], !dbg [[DBG77]]
// PPC64-NEXT:    [[REM:%.*]] = srem i64 [[TMP85]], [[CONV86]], !dbg [[DBG78:![0-9]+]]
// PPC64-NEXT:    store i64 [[REM]], ptr [[ATOMIC_TEMP89]], align 8, !dbg [[DBG77]]
// PPC64-NEXT:    [[TMP86:%.*]] = load i64, ptr [[ATOMIC_TEMP89]], align 8, !dbg [[DBG77]]
...
// PPC64-NEXT:    br i1 [[TMP89]], label [[ATOMIC_EXIT90:%.*]], label [[ATOMIC_CONT88]], !dbg [[DBG77]]
// PPC64:       atomic_exit90:
...
// PPC64-NEXT:    [[OR91:%.*]] = or i32 [[TMP90]], [[TMP91]], !dbg [[DBG81:![0-9]+]]
// PPC64-NEXT:    store i32 [[OR91]], ptr @uiv, align 4, !dbg [[DBG80]]
...
// PPC64-NEXT:    [[AND92:%.*]] = and i32 [[TMP93]], [[TMP92]], !dbg [[DBG84:![0-9]+]]
// PPC64-NEXT:    store i32 [[AND92]], ptr @iv, align 4, !dbg [[DBG83]]
// PPC64-NEXT:    [[TMP94:%.*]] = load i64, ptr @lv, align 8, !dbg [[DBG85:![0-9]+]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP93]], i32 noundef signext 0), !dbg [[DBG86:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT94:%.*]], !dbg [[DBG86]]
// PPC64:       atomic_cont94:
// PPC64-NEXT:    [[ATOMIC_TEMP93_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP93]], i32 0, i32 0, !dbg [[DBG86]]
// PPC64-NEXT:    [[ATOMIC_TEMP93_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP93_REALP]], align 4, !dbg [[DBG86]]
// PPC64-NEXT:    [[ATOMIC_TEMP93_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP93]], i32 0, i32 1, !dbg [[DBG86]]
// PPC64-NEXT:    [[ATOMIC_TEMP93_IMAG:%.*]] = load i32, ptr [[ATOMIC_TEMP93_IMAGP]], align 4, !dbg [[DBG86]]
...
// PPC64-NEXT:    [[ADD_R98:%.*]] = add i64 [[TMP94]], [[CONV96]], !dbg [[DBG88:![0-9]+]]
...
// PPC64-NEXT:    [[ATOMIC_TEMP95_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP95]], i32 0, i32 0, !dbg [[DBG86]]
// PPC64-NEXT:    [[ATOMIC_TEMP95_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP95]], i32 0, i32 1, !dbg [[DBG86]]
// PPC64-NEXT:    store i32 [[CONV100]], ptr [[ATOMIC_TEMP95_REALP]], align 4, !dbg [[DBG86]]
// PPC64-NEXT:    store i32 [[CONV101]], ptr [[ATOMIC_TEMP95_IMAGP]], align 4, !dbg [[DBG86]]
// PPC64-NEXT:    [[CALL102:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP93]], ptr noundef [[ATOMIC_TEMP95]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG86]]
// PPC64-NEXT:    br i1 [[CALL102]], label [[ATOMIC_EXIT103:%.*]], label [[ATOMIC_CONT94]], !dbg [[DBG86]]
// PPC64:       atomic_exit103:
// PPC64-NEXT:    store i32 [[ATOMIC_TEMP93_REAL]], ptr @civ, align 4, !dbg [[DBG86]]
// PPC64-NEXT:    store i32 [[ATOMIC_TEMP93_IMAG]], ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG86]]
// PPC64-NEXT:    [[TMP95:%.*]] = load i64, ptr @ulv, align 8, !dbg [[DBG89:![0-9]+]]
// PPC64-NEXT:    [[CONV104:%.*]] = uitofp i64 [[TMP95]] to float, !dbg [[DBG89]]
// PPC64-NEXT:    [[ATOMIC_LOAD105:%.*]] = load atomic i32, ptr @fx monotonic, align 4, !dbg [[DBG90:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT106:%.*]], !dbg [[DBG90]]
// PPC64:       atomic_cont106:
// PPC64-NEXT:    [[TMP96:%.*]] = phi i32 [ [[ATOMIC_LOAD105]], [[ATOMIC_EXIT103]] ], [ [[TMP100:%.*]], [[ATOMIC_CONT106]] ], !dbg [[DBG90]]
// PPC64-NEXT:    [[TMP97:%.*]] = bitcast i32 [[TMP96]] to float, !dbg [[DBG90]]
// PPC64-NEXT:    [[MUL108:%.*]] = fmul float [[TMP97]], [[CONV104]], !dbg [[DBG91:![0-9]+]]
// PPC64-NEXT:    store float [[MUL108]], ptr [[ATOMIC_TEMP107]], align 4, !dbg [[DBG90]]
// PPC64-NEXT:    [[TMP98:%.*]] = load i32, ptr [[ATOMIC_TEMP107]], align 4, !dbg [[DBG90]]
...
// PPC64-NEXT:    br i1 [[TMP101]], label [[ATOMIC_EXIT109:%.*]], label [[ATOMIC_CONT106]], !dbg [[DBG90]]
// PPC64:       atomic_exit109:
// PPC64-NEXT:    store float [[MUL108]], ptr @fv, align 4, !dbg [[DBG90]]
// PPC64-NEXT:    [[TMP102:%.*]] = load i64, ptr @llv, align 8, !dbg [[DBG92:![0-9]+]]
// PPC64-NEXT:    [[CONV110:%.*]] = sitofp i64 [[TMP102]] to double, !dbg [[DBG92]]
// PPC64-NEXT:    [[ATOMIC_LOAD111:%.*]] = load atomic i64, ptr @dx monotonic, align 8, !dbg [[DBG93:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT112:%.*]], !dbg [[DBG93]]
// PPC64:       atomic_cont112:
// PPC64-NEXT:    [[TMP103:%.*]] = phi i64 [ [[ATOMIC_LOAD111]], [[ATOMIC_EXIT109]] ], [ [[TMP107:%.*]], [[ATOMIC_CONT112]] ], !dbg [[DBG93]]
// PPC64-NEXT:    [[TMP104:%.*]] = bitcast i64 [[TMP103]] to double, !dbg [[DBG93]]
// PPC64-NEXT:    [[DIV114:%.*]] = fdiv double [[TMP104]], [[CONV110]], !dbg [[DBG94:![0-9]+]]
// PPC64-NEXT:    store double [[DIV114]], ptr [[ATOMIC_TEMP113]], align 8, !dbg [[DBG93]]
// PPC64-NEXT:    [[TMP105:%.*]] = load i64, ptr [[ATOMIC_TEMP113]], align 8, !dbg [[DBG93]]
...
// PPC64-NEXT:    br i1 [[TMP108]], label [[ATOMIC_EXIT115:%.*]], label [[ATOMIC_CONT112]], !dbg [[DBG93]]
// PPC64:       atomic_exit115:
// PPC64-NEXT:    store double [[DIV114]], ptr @dv, align 8, !dbg [[DBG93]]
// PPC64-NEXT:    [[TMP109:%.*]] = load i64, ptr @ullv, align 8, !dbg [[DBG95:![0-9]+]]
// PPC64-NEXT:    [[CONV116:%.*]] = uitofp i64 [[TMP109]] to ppc_fp128, !dbg [[DBG95]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @ldx, ptr noundef [[ATOMIC_TEMP117]], i32 noundef signext 0), !dbg [[DBG96:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT118:%.*]], !dbg [[DBG96]]
// PPC64:       atomic_cont118:
// PPC64-NEXT:    [[TMP110:%.*]] = load ppc_fp128, ptr [[ATOMIC_TEMP117]], align 16, !dbg [[DBG96]]
// PPC64-NEXT:    [[SUB120:%.*]] = fsub ppc_fp128 [[TMP110]], [[CONV116]], !dbg [[DBG97:![0-9]+]]
// PPC64-NEXT:    store ppc_fp128 [[SUB120]], ptr [[ATOMIC_TEMP119]], align 16, !dbg [[DBG96]]
// PPC64-NEXT:    [[CALL121:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 16, ptr noundef @ldx, ptr noundef [[ATOMIC_TEMP117]], ptr noundef [[ATOMIC_TEMP119]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG96]]
...
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP123]], i32 noundef signext 0), !dbg [[DBG99:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT124:%.*]], !dbg [[DBG99]]
// PPC64:       atomic_cont124:
// PPC64-NEXT:    [[ATOMIC_TEMP123_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP123]], i32 0, i32 0, !dbg [[DBG99]]
// PPC64-NEXT:    [[ATOMIC_TEMP123_REAL:%.*]] = load i32, ptr [[ATOMIC_TEMP123_REALP]], align 4, !dbg [[DBG99]]
// PPC64-NEXT:    [[ATOMIC_TEMP123_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP123]], i32 0, i32 1, !dbg [[DBG99]]
// PPC64-NEXT:    [[ATOMIC_TEMP123_IMAG:%.*]] = load i32, ptr [[ATOMIC_TEMP123_IMAGP]], align 4, !dbg [[DBG99]]
...
// PPC64-NEXT:    [[CALL128:%.*]] = call { float, float } @__divsc3(float noundef [[TMP111]], float noundef 0.000000e+00, float noundef [[CONV126]], float noundef [[CONV127]]) #[[ATTR2:[0-9]+]], !dbg [[DBG101:![0-9]+]]
// PPC64-NEXT:    [[TMP112:%.*]] = extractvalue { float, float } [[CALL128]], 0, !dbg [[DBG101]]
// PPC64-NEXT:    [[TMP113:%.*]] = extractvalue { float, float } [[CALL128]], 1, !dbg [[DBG101]]
// PPC64-NEXT:    [[CONV129:%.*]] = fptosi float [[TMP112]] to i32, !dbg [[DBG98]]
// PPC64-NEXT:    [[CONV130:%.*]] = fptosi float [[TMP113]] to i32, !dbg [[DBG98]]
// PPC64-NEXT:    [[ATOMIC_TEMP125_REALP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP125]], i32 0, i32 0, !dbg [[DBG99]]
// PPC64-NEXT:    [[ATOMIC_TEMP125_IMAGP:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[ATOMIC_TEMP125]], i32 0, i32 1, !dbg [[DBG99]]
// PPC64-NEXT:    store i32 [[CONV129]], ptr [[ATOMIC_TEMP125_REALP]], align 4, !dbg [[DBG99]]
// PPC64-NEXT:    store i32 [[CONV130]], ptr [[ATOMIC_TEMP125_IMAGP]], align 4, !dbg [[DBG99]]
// PPC64-NEXT:    [[CALL131:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 8, ptr noundef @cix, ptr noundef [[ATOMIC_TEMP123]], ptr noundef [[ATOMIC_TEMP125]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG99]]
// PPC64-NEXT:    br i1 [[CALL131]], label [[ATOMIC_EXIT132:%.*]], label [[ATOMIC_CONT124]], !dbg [[DBG99]]
// PPC64:       atomic_exit132:
// PPC64-NEXT:    store i32 [[CONV129]], ptr @civ, align 4, !dbg [[DBG99]]
// PPC64-NEXT:    store i32 [[CONV130]], ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG99]]
// PPC64-NEXT:    [[TMP114:%.*]] = load double, ptr @dv, align 8, !dbg [[DBG102:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD133:%.*]] = load atomic i16, ptr @sx monotonic, align 2, !dbg [[DBG103:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT134:%.*]], !dbg [[DBG103]]
// PPC64:       atomic_cont134:
// PPC64-NEXT:    [[TMP115:%.*]] = phi i16 [ [[ATOMIC_LOAD133]], [[ATOMIC_EXIT132]] ], [ [[TMP118:%.*]], [[ATOMIC_CONT134]] ], !dbg [[DBG103]]
// PPC64-NEXT:    [[CONV136:%.*]] = sext i16 [[TMP115]] to i32, !dbg [[DBG104:![0-9]+]]
// PPC64-NEXT:    [[CONV137:%.*]] = sitofp i32 [[CONV136]] to double, !dbg [[DBG104]]
// PPC64-NEXT:    [[ADD138:%.*]] = fadd double [[CONV137]], [[TMP114]], !dbg [[DBG105:![0-9]+]]
// PPC64-NEXT:    [[CONV139:%.*]] = fptosi double [[ADD138]] to i16, !dbg [[DBG104]]
// PPC64-NEXT:    store i16 [[CONV139]], ptr [[ATOMIC_TEMP135]], align 2, !dbg [[DBG103]]
// PPC64-NEXT:    [[TMP116:%.*]] = load i16, ptr [[ATOMIC_TEMP135]], align 2, !dbg [[DBG103]]
...
// PPC64-NEXT:    br i1 [[TMP119]], label [[ATOMIC_EXIT140:%.*]], label [[ATOMIC_CONT134]], !dbg [[DBG103]]
// PPC64:       atomic_exit140:
// PPC64-NEXT:    store i16 [[CONV139]], ptr @sv, align 2, !dbg [[DBG103]]
// PPC64-NEXT:    [[TMP120:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG106:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD141:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG107:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT142:%.*]], !dbg [[DBG107]]
// PPC64:       atomic_cont142:
// PPC64-NEXT:    [[TMP121:%.*]] = phi i8 [ [[ATOMIC_LOAD141]], [[ATOMIC_EXIT140]] ], [ [[TMP124:%.*]], [[ATOMIC_CONT142]] ], !dbg [[DBG107]]
// PPC64-NEXT:    [[TOBOOL144:%.*]] = trunc i8 [[TMP121]] to i1, !dbg [[DBG107]]
// PPC64-NEXT:    [[CONV145:%.*]] = zext i1 [[TOBOOL144]] to i32, !dbg [[DBG108:![0-9]+]]
// PPC64-NEXT:    [[CONV146:%.*]] = sitofp i32 [[CONV145]] to ppc_fp128, !dbg [[DBG108]]
// PPC64-NEXT:    [[MUL147:%.*]] = fmul ppc_fp128 [[TMP120]], [[CONV146]], !dbg [[DBG109:![0-9]+]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL149]], ptr [[ATOMIC_TEMP143]], align 1, !dbg [[DBG107]]
// PPC64-NEXT:    [[TMP122:%.*]] = load i8, ptr [[ATOMIC_TEMP143]], align 1, !dbg [[DBG107]]
...
// PPC64-NEXT:    br i1 [[TMP125]], label [[ATOMIC_EXIT150:%.*]], label [[ATOMIC_CONT142]], !dbg [[DBG107]]
// PPC64:       atomic_exit150:
// PPC64-NEXT:    [[FROMBOOL151:%.*]] = zext i1 [[TOBOOL144]] to i8, !dbg [[DBG107]]
// PPC64-NEXT:    store i8 [[FROMBOOL151]], ptr @bv, align 1, !dbg [[DBG107]]
// PPC64-NEXT:    [[CIV_REAL152:%.*]] = load i32, ptr @civ, align 4, !dbg [[DBG110:![0-9]+]]
// PPC64-NEXT:    [[CIV_IMAG153:%.*]] = load i32, ptr getelementptr inbounds ({ i32, i32 }, ptr @civ, i32 0, i32 1), align 4, !dbg [[DBG110]]
// PPC64-NEXT:    [[ATOMIC_LOAD154:%.*]] = load atomic i8, ptr @bx monotonic, align 1, !dbg [[DBG111:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT155:%.*]], !dbg [[DBG111]]
// PPC64:       atomic_cont155:
// PPC64-NEXT:    [[TMP126:%.*]] = phi i8 [ [[ATOMIC_LOAD154]], [[ATOMIC_EXIT150]] ], [ [[TMP129:%.*]], [[ATOMIC_CONT155]] ], !dbg [[DBG111]]
// PPC64-NEXT:    [[TOBOOL157:%.*]] = trunc i8 [[TMP126]] to i1, !dbg [[DBG111]]
...
// PPC64-NEXT:    store i8 [[FROMBOOL164]], ptr [[ATOMIC_TEMP156]], align 1, !dbg [[DBG111]]
// PPC64-NEXT:    [[TMP127:%.*]] = load i8, ptr [[ATOMIC_TEMP156]], align 1, !dbg [[DBG111]]
...
// PPC64-NEXT:    br i1 [[TMP130]], label [[ATOMIC_EXIT165:%.*]], label [[ATOMIC_CONT155]], !dbg [[DBG111]]
// PPC64:       atomic_exit165:
// PPC64-NEXT:    [[FROMBOOL166:%.*]] = zext i1 [[TOBOOL163]] to i8, !dbg [[DBG111]]
// PPC64-NEXT:    store i8 [[FROMBOOL166]], ptr @bv, align 1, !dbg [[DBG111]]
// PPC64-NEXT:    [[TMP131:%.*]] = load i16, ptr @sv, align 2, !dbg [[DBG114:![0-9]+]]
// PPC64-NEXT:    [[TMP132:%.*]] = load i8, ptr @bv, align 1, !dbg [[DBG115:![0-9]+]]
// PPC64-NEXT:    [[TOBOOL167:%.*]] = trunc i8 [[TMP132]] to i1, !dbg [[DBG115]]
// PPC64-NEXT:    [[CONV168:%.*]] = zext i1 [[TOBOOL167]] to i32, !dbg [[DBG115]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 16, ptr noundef @int4x, ptr noundef [[ATOMIC_TEMP169]], i32 noundef signext 0), !dbg [[DBG116:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT170:%.*]], !dbg [[DBG116]]
// PPC64:       atomic_cont170:
// PPC64-NEXT:    [[TMP133:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP169]], align 16, !dbg [[DBG116]]
// PPC64-NEXT:    store <4 x i32> [[TMP133]], ptr [[ATOMIC_TEMP171]], align 16, !dbg [[DBG116]]
// PPC64-NEXT:    [[TMP134:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP169]], align 16, !dbg [[DBG116]]
// PPC64-NEXT:    store <4 x i32> [[TMP134]], ptr [[ATOMIC_TEMP172]], align 16, !dbg [[DBG116]]
// PPC64-NEXT:    [[TMP135:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP172]], align 16, !dbg [[DBG116]]
...
// PPC64-NEXT:    [[TMP136:%.*]] = load <4 x i32>, ptr [[ATOMIC_TEMP171]], align 16, !dbg [[DBG116]]
// PPC64-NEXT:    [[VECINS:%.*]] = insertelement <4 x i32> [[TMP136]], i32 [[OR173]], i16 [[TMP131]], !dbg [[DBG116]]
// PPC64-NEXT:    store <4 x i32> [[VECINS]], ptr [[ATOMIC_TEMP171]], align 16, !dbg [[DBG116]]
// PPC64-NEXT:    [[CALL174:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 16, ptr noundef @int4x, ptr noundef [[ATOMIC_TEMP169]], ptr noundef [[ATOMIC_TEMP171]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG116]]
// PPC64-NEXT:    br i1 [[CALL174]], label [[ATOMIC_EXIT175:%.*]], label [[ATOMIC_CONT170]], !dbg [[DBG116]]
// PPC64:       atomic_exit175:
// PPC64-NEXT:    store i32 [[OR173]], ptr @iv, align 4, !dbg [[DBG116]]
// PPC64-NEXT:    [[TMP137:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG118:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD176:%.*]] = load atomic i32, ptr @bfx monotonic, align 4, !dbg [[DBG119:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT177:%.*]], !dbg [[DBG119]]
// PPC64:       atomic_cont177:
// PPC64-NEXT:    [[TMP138:%.*]] = phi i32 [ [[ATOMIC_LOAD176]], [[ATOMIC_EXIT175]] ], [ [[TMP141:%.*]], [[ATOMIC_CONT177]] ], !dbg [[DBG119]]
// PPC64-NEXT:    store i32 [[TMP138]], ptr [[ATOMIC_TEMP178]], align 4, !dbg [[DBG119]]
// PPC64-NEXT:    store i32 [[TMP138]], ptr [[ATOMIC_TEMP179]], align 4, !dbg [[DBG119]]
// PPC64-NEXT:    [[BF_LOAD:%.*]] = load i32, ptr [[ATOMIC_TEMP179]], align 4, !dbg [[DBG119]]
// PPC64-NEXT:    [[BF_ASHR:%.*]] = ashr i32 [[BF_LOAD]], 1, !dbg [[DBG119]]
// PPC64-NEXT:    [[CONV180:%.*]] = sitofp i32 [[BF_ASHR]] to ppc_fp128, !dbg [[DBG120:![0-9]+]]
// PPC64-NEXT:    [[SUB181:%.*]] = fsub ppc_fp128 [[CONV180]], [[TMP137]], !dbg [[DBG121:![0-9]+]]
// PPC64-NEXT:    [[CONV182:%.*]] = fptosi ppc_fp128 [[SUB181]] to i32, !dbg [[DBG120]]
// PPC64-NEXT:    [[BF_LOAD183:%.*]] = load i32, ptr [[ATOMIC_TEMP178]], align 4, !dbg [[DBG119]]
...
// PPC64-NEXT:    store i32 [[BF_SET]], ptr [[ATOMIC_TEMP178]], align 4, !dbg [[DBG119]]
// PPC64-NEXT:    [[TMP139:%.*]] = load i32, ptr [[ATOMIC_TEMP178]], align 4, !dbg [[DBG119]]
...
// PPC64-NEXT:    br i1 [[TMP142]], label [[ATOMIC_EXIT184:%.*]], label [[ATOMIC_CONT177]], !dbg [[DBG119]]
// PPC64:       atomic_exit184:
// PPC64-NEXT:    store i32 [[CONV182]], ptr @iv, align 4, !dbg [[DBG119]]
// PPC64-NEXT:    [[TMP143:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG122:![0-9]+]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 4, ptr noundef @bfx_packed, ptr noundef [[ATOMIC_TEMP185]], i32 noundef signext 0), !dbg [[DBG123:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT186:%.*]], !dbg [[DBG123]]
// PPC64:       atomic_cont186:
// PPC64-NEXT:    [[TMP144:%.*]] = load i32, ptr [[ATOMIC_TEMP185]], align 1, !dbg [[DBG123]]
// PPC64-NEXT:    store i32 [[TMP144]], ptr [[ATOMIC_TEMP187]], align 1, !dbg [[DBG123]]
// PPC64-NEXT:    [[TMP145:%.*]] = load i32, ptr [[ATOMIC_TEMP185]], align 1, !dbg [[DBG123]]
// PPC64-NEXT:    store i32 [[TMP145]], ptr [[ATOMIC_TEMP188]], align 4, !dbg [[DBG123]]
// PPC64-NEXT:    [[BF_LOAD189:%.*]] = load i32, ptr [[ATOMIC_TEMP188]], align 1, !dbg [[DBG123]]
...
// PPC64-NEXT:    [[MUL192:%.*]] = fmul ppc_fp128 [[CONV191]], [[TMP143]], !dbg [[DBG125:![0-9]+]]
// PPC64-NEXT:    [[CONV193:%.*]] = fptosi ppc_fp128 [[MUL192]] to i32, !dbg [[DBG124]]
// PPC64-NEXT:    [[BF_LOAD194:%.*]] = load i32, ptr [[ATOMIC_TEMP187]], align 1, !dbg [[DBG123]]
...
// PPC64-NEXT:    store i32 [[BF_SET198]], ptr [[ATOMIC_TEMP187]], align 1, !dbg [[DBG123]]
// PPC64-NEXT:    [[CALL199:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 4, ptr noundef @bfx_packed, ptr noundef [[ATOMIC_TEMP185]], ptr noundef [[ATOMIC_TEMP187]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG123]]
// PPC64-NEXT:    br i1 [[CALL199]], label [[ATOMIC_EXIT200:%.*]], label [[ATOMIC_CONT186]], !dbg [[DBG123]]
// PPC64:       atomic_exit200:
// PPC64-NEXT:    store i32 [[BF_ASHR190]], ptr @iv, align 4, !dbg [[DBG123]]
// PPC64-NEXT:    [[TMP146:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG126:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD201:%.*]] = load atomic i32, ptr @bfx2 monotonic, align 4, !dbg [[DBG127:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT202:%.*]], !dbg [[DBG127]]
// PPC64:       atomic_cont202:
// PPC64-NEXT:    [[TMP147:%.*]] = phi i32 [ [[ATOMIC_LOAD201]], [[ATOMIC_EXIT200]] ], [ [[TMP150:%.*]], [[ATOMIC_CONT202]] ], !dbg [[DBG127]]
// PPC64-NEXT:    store i32 [[TMP147]], ptr [[ATOMIC_TEMP203]], align 4, !dbg [[DBG127]]
// PPC64-NEXT:    store i32 [[TMP147]], ptr [[ATOMIC_TEMP204]], align 4, !dbg [[DBG127]]
// PPC64-NEXT:    [[BF_LOAD205:%.*]] = load i32, ptr [[ATOMIC_TEMP204]], align 4, !dbg [[DBG127]]
...
// PPC64-NEXT:    [[SUB209:%.*]] = fsub ppc_fp128 [[CONV208]], [[TMP146]], !dbg [[DBG129:![0-9]+]]
// PPC64-NEXT:    [[CONV210:%.*]] = fptosi ppc_fp128 [[SUB209]] to i32, !dbg [[DBG128]]
// PPC64-NEXT:    [[BF_LOAD211:%.*]] = load i32, ptr [[ATOMIC_TEMP203]], align 4, !dbg [[DBG127]]
...
// PPC64-NEXT:    store i32 [[BF_SET214]], ptr [[ATOMIC_TEMP203]], align 4, !dbg [[DBG127]]
// PPC64-NEXT:    [[TMP148:%.*]] = load i32, ptr [[ATOMIC_TEMP203]], align 4, !dbg [[DBG127]]
...
// PPC64-NEXT:    br i1 [[TMP151]], label [[ATOMIC_EXIT215:%.*]], label [[ATOMIC_CONT202]], !dbg [[DBG127]]
// PPC64:       atomic_exit215:
// PPC64-NEXT:    store i32 [[CONV210]], ptr @iv, align 4, !dbg [[DBG127]]
// PPC64-NEXT:    [[TMP152:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG130:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD216:%.*]] = load atomic i8, ptr @bfx2_packed monotonic, align 1, !dbg [[DBG131:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT217:%.*]], !dbg [[DBG131]]
// PPC64:       atomic_cont217:
// PPC64-NEXT:    [[TMP153:%.*]] = phi i8 [ [[ATOMIC_LOAD216]], [[ATOMIC_EXIT215]] ], [ [[TMP157:%.*]], [[ATOMIC_CONT217]] ], !dbg [[DBG131]]
// PPC64-NEXT:    store i8 [[TMP153]], ptr [[ATOMIC_TEMP218]], align 1, !dbg [[DBG131]]
// PPC64-NEXT:    store i8 [[TMP153]], ptr [[ATOMIC_TEMP219]], align 1, !dbg [[DBG131]]
// PPC64-NEXT:    [[BF_LOAD220:%.*]] = load i8, ptr [[ATOMIC_TEMP219]], align 1, !dbg [[DBG131]]
...
// PPC64-NEXT:    [[DIV224:%.*]] = fdiv ppc_fp128 [[TMP152]], [[CONV223]], !dbg [[DBG133:![0-9]+]]
// PPC64-NEXT:    [[CONV225:%.*]] = fptosi ppc_fp128 [[DIV224]] to i32, !dbg [[DBG130]]
// PPC64-NEXT:    [[TMP154:%.*]] = trunc i32 [[CONV225]] to i8, !dbg [[DBG131]]
// PPC64-NEXT:    [[BF_LOAD226:%.*]] = load i8, ptr [[ATOMIC_TEMP218]], align 1, !dbg [[DBG131]]
// PPC64-NEXT:    [[BF_VALUE227:%.*]] = and i8 [[TMP154]], 1, !dbg [[DBG131]]
// PPC64-NEXT:    [[BF_CLEAR228:%.*]] = and i8 [[BF_LOAD226]], -2, !dbg [[DBG131]]
// PPC64-NEXT:    [[BF_SET229:%.*]] = or i8 [[BF_CLEAR228]], [[BF_VALUE227]], !dbg [[DBG131]]
// PPC64-NEXT:    store i8 [[BF_SET229]], ptr [[ATOMIC_TEMP218]], align 1, !dbg [[DBG131]]
// PPC64-NEXT:    [[TMP155:%.*]] = load i8, ptr [[ATOMIC_TEMP218]], align 1, !dbg [[DBG131]]
...
// PPC64-NEXT:    br i1 [[TMP158]], label [[ATOMIC_EXIT230:%.*]], label [[ATOMIC_CONT217]], !dbg [[DBG131]]
// PPC64:       atomic_exit230:
// PPC64-NEXT:    store i32 [[CONV225]], ptr @iv, align 4, !dbg [[DBG131]]
// PPC64-NEXT:    [[TMP159:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG134:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD231:%.*]] = load atomic i32, ptr @bfx3 monotonic, align 4, !dbg [[DBG135:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT232:%.*]], !dbg [[DBG135]]
// PPC64:       atomic_cont232:
// PPC64-NEXT:    [[TMP160:%.*]] = phi i32 [ [[ATOMIC_LOAD231]], [[ATOMIC_EXIT230]] ], [ [[TMP163:%.*]], [[ATOMIC_CONT232]] ], !dbg [[DBG135]]
// PPC64-NEXT:    store i32 [[TMP160]], ptr [[ATOMIC_TEMP233]], align 4, !dbg [[DBG135]]
// PPC64-NEXT:    store i32 [[TMP160]], ptr [[ATOMIC_TEMP234]], align 4, !dbg [[DBG135]]
// PPC64-NEXT:    [[BF_LOAD235:%.*]] = load i32, ptr [[ATOMIC_TEMP234]], align 4, !dbg [[DBG135]]
...
// PPC64-NEXT:    [[DIV239:%.*]] = fdiv ppc_fp128 [[CONV238]], [[TMP159]], !dbg [[DBG137:![0-9]+]]
// PPC64-NEXT:    [[CONV240:%.*]] = fptosi ppc_fp128 [[DIV239]] to i32, !dbg [[DBG136]]
// PPC64-NEXT:    [[BF_LOAD241:%.*]] = load i32, ptr [[ATOMIC_TEMP233]], align 4, !dbg [[DBG135]]
...
// PPC64-NEXT:    store i32 [[BF_SET245]], ptr [[ATOMIC_TEMP233]], align 4, !dbg [[DBG135]]
// PPC64-NEXT:    [[TMP161:%.*]] = load i32, ptr [[ATOMIC_TEMP233]], align 4, !dbg [[DBG135]]
...
// PPC64-NEXT:    br i1 [[TMP164]], label [[ATOMIC_EXIT246:%.*]], label [[ATOMIC_CONT232]], !dbg [[DBG135]]
// PPC64:       atomic_exit246:
// PPC64-NEXT:    store i32 [[BF_ASHR237]], ptr @iv, align 4, !dbg [[DBG135]]
// PPC64-NEXT:    [[TMP165:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG138:![0-9]+]]
// PPC64-NEXT:    call void @__atomic_load(i64 noundef 3, ptr noundef @bfx3_packed, ptr noundef [[ATOMIC_TEMP247]], i32 noundef signext 0), !dbg [[DBG139:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT248:%.*]], !dbg [[DBG139]]
// PPC64:       atomic_cont248:
// PPC64-NEXT:    [[TMP166:%.*]] = load i24, ptr [[ATOMIC_TEMP247]], align 1, !dbg [[DBG139]]
// PPC64-NEXT:    store i24 [[TMP166]], ptr [[ATOMIC_TEMP249]], align 1, !dbg [[DBG139]]
// PPC64-NEXT:    [[TMP167:%.*]] = load i24, ptr [[ATOMIC_TEMP247]], align 1, !dbg [[DBG139]]
// PPC64-NEXT:    store i24 [[TMP167]], ptr [[ATOMIC_TEMP250]], align 1, !dbg [[DBG139]]
// PPC64-NEXT:    [[BF_LOAD251:%.*]] = load i24, ptr [[ATOMIC_TEMP250]], align 1, !dbg [[DBG139]]
...
// PPC64-NEXT:    [[ADD256:%.*]] = fadd ppc_fp128 [[CONV255]], [[TMP165]], !dbg [[DBG141:![0-9]+]]
// PPC64-NEXT:    [[CONV257:%.*]] = fptosi ppc_fp128 [[ADD256]] to i32, !dbg [[DBG140]]
// PPC64-NEXT:    [[TMP168:%.*]] = trunc i32 [[CONV257]] to i24, !dbg [[DBG139]]
// PPC64-NEXT:    [[BF_LOAD258:%.*]] = load i24, ptr [[ATOMIC_TEMP249]], align 1, !dbg [[DBG139]]
// PPC64-NEXT:    [[BF_VALUE259:%.*]] = and i24 [[TMP168]], 16383, !dbg [[DBG139]]
...
// PPC64-NEXT:    store i24 [[BF_SET262]], ptr [[ATOMIC_TEMP249]], align 1, !dbg [[DBG139]]
// PPC64-NEXT:    [[CALL263:%.*]] = call zeroext i1 @__atomic_compare_exchange(i64 noundef 3, ptr noundef @bfx3_packed, ptr noundef [[ATOMIC_TEMP247]], ptr noundef [[ATOMIC_TEMP249]], i32 noundef signext 0, i32 noundef signext 0), !dbg [[DBG139]]
// PPC64-NEXT:    br i1 [[CALL263]], label [[ATOMIC_EXIT264:%.*]], label [[ATOMIC_CONT248]], !dbg [[DBG139]]
// PPC64:       atomic_exit264:
// PPC64-NEXT:    store i32 [[CONV257]], ptr @iv, align 4, !dbg [[DBG139]]
// PPC64-NEXT:    [[TMP169:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG142:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD265:%.*]] = load atomic i64, ptr @bfx4 monotonic, align 8, !dbg [[DBG143:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT266:%.*]], !dbg [[DBG143]]
// PPC64:       atomic_cont266:
// PPC64-NEXT:    [[TMP170:%.*]] = phi i64 [ [[ATOMIC_LOAD265]], [[ATOMIC_EXIT264]] ], [ [[TMP174:%.*]], [[ATOMIC_CONT266]] ], !dbg [[DBG143]]
// PPC64-NEXT:    store i64 [[TMP170]], ptr [[ATOMIC_TEMP267]], align 8, !dbg [[DBG143]]
// PPC64-NEXT:    store i64 [[TMP170]], ptr [[ATOMIC_TEMP268]], align 8, !dbg [[DBG143]]
// PPC64-NEXT:    [[BF_LOAD269:%.*]] = load i64, ptr [[ATOMIC_TEMP268]], align 8, !dbg [[DBG143]]
...
// PPC64-NEXT:    [[MUL274:%.*]] = fmul ppc_fp128 [[CONV273]], [[TMP169]], !dbg [[DBG145:![0-9]+]]
// PPC64-NEXT:    [[CONV275:%.*]] = fptosi ppc_fp128 [[MUL274]] to i32, !dbg [[DBG144]]
// PPC64-NEXT:    [[TMP171:%.*]] = zext i32 [[CONV275]] to i64, !dbg [[DBG143]]
// PPC64-NEXT:    [[BF_LOAD276:%.*]] = load i64, ptr [[ATOMIC_TEMP267]], align 8, !dbg [[DBG143]]
// PPC64-NEXT:    [[BF_VALUE277:%.*]] = and i64 [[TMP171]], 1, !dbg [[DBG143]]
...
// PPC64-NEXT:    store i64 [[BF_SET280]], ptr [[ATOMIC_TEMP267]], align 8, !dbg [[DBG143]]
// PPC64-NEXT:    [[TMP172:%.*]] = load i64, ptr [[ATOMIC_TEMP267]], align 8, !dbg [[DBG143]]
...
// PPC64-NEXT:    br i1 [[TMP175]], label [[ATOMIC_EXIT281:%.*]], label [[ATOMIC_CONT266]], !dbg [[DBG143]]
// PPC64:       atomic_exit281:
// PPC64-NEXT:    store i32 [[CONV275]], ptr @iv, align 4, !dbg [[DBG143]]
// PPC64-NEXT:    [[TMP176:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG146:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD282:%.*]] = load atomic i8, ptr @bfx4_packed monotonic, align 1, !dbg [[DBG147:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT283:%.*]], !dbg [[DBG147]]
// PPC64:       atomic_cont283:
// PPC64-NEXT:    [[TMP177:%.*]] = phi i8 [ [[ATOMIC_LOAD282]], [[ATOMIC_EXIT281]] ], [ [[TMP181:%.*]], [[ATOMIC_CONT283]] ], !dbg [[DBG147]]
// PPC64-NEXT:    store i8 [[TMP177]], ptr [[ATOMIC_TEMP284]], align 1, !dbg [[DBG147]]
// PPC64-NEXT:    store i8 [[TMP177]], ptr [[ATOMIC_TEMP285]], align 1, !dbg [[DBG147]]
// PPC64-NEXT:    [[BF_LOAD286:%.*]] = load i8, ptr [[ATOMIC_TEMP285]], align 1, !dbg [[DBG147]]
...
// PPC64-NEXT:    [[SUB290:%.*]] = fsub ppc_fp128 [[CONV289]], [[TMP176]], !dbg [[DBG149:![0-9]+]]
// PPC64-NEXT:    [[CONV291:%.*]] = fptosi ppc_fp128 [[SUB290]] to i32, !dbg [[DBG148]]
// PPC64-NEXT:    [[TMP178:%.*]] = trunc i32 [[CONV291]] to i8, !dbg [[DBG147]]
// PPC64-NEXT:    [[BF_LOAD292:%.*]] = load i8, ptr [[ATOMIC_TEMP284]], align 1, !dbg [[DBG147]]
// PPC64-NEXT:    [[BF_VALUE293:%.*]] = and i8 [[TMP178]], 1, !dbg [[DBG147]]
...
// PPC64-NEXT:    store i8 [[BF_SET296]], ptr [[ATOMIC_TEMP284]], align 1, !dbg [[DBG147]]
// PPC64-NEXT:    [[TMP179:%.*]] = load i8, ptr [[ATOMIC_TEMP284]], align 1, !dbg [[DBG147]]
// PPC64-NEXT:    [[TMP180:%.*]] = cmpxchg ptr @bfx4_packed, i8 [[TMP177]], i8 [[TMP179]] monotonic monotonic, align 1, !dbg [[DBG147]]
// PPC64-NEXT:    [[TMP181]] = extractvalue { i8, i1 } [[TMP180]], 0, !dbg [[DBG147]]
// PPC64-NEXT:    [[TMP182:%.*]] = extractvalue { i8, i1 } [[TMP180]], 1, !dbg [[DBG147]]
// PPC64-NEXT:    br i1 [[TMP182]], label [[ATOMIC_EXIT297:%.*]], label [[ATOMIC_CONT283]], !dbg [[DBG147]]
// PPC64:       atomic_exit297:
// PPC64-NEXT:    store i32 [[BF_CAST288]], ptr @iv, align 4, !dbg [[DBG147]]
// PPC64-NEXT:    [[TMP183:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG150:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD298:%.*]] = load atomic i64, ptr @bfx4 monotonic, align 8, !dbg [[DBG151:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT299:%.*]], !dbg [[DBG151]]
// PPC64:       atomic_cont299:
// PPC64-NEXT:    [[TMP184:%.*]] = phi i64 [ [[ATOMIC_LOAD298]], [[ATOMIC_EXIT297]] ], [ [[TMP187:%.*]], [[ATOMIC_CONT299]] ], !dbg [[DBG151]]
// PPC64-NEXT:    store i64 [[TMP184]], ptr [[ATOMIC_TEMP300]], align 8, !dbg [[DBG151]]
// PPC64-NEXT:    store i64 [[TMP184]], ptr [[ATOMIC_TEMP301]], align 8, !dbg [[DBG151]]
// PPC64-NEXT:    [[BF_LOAD302:%.*]] = load i64, ptr [[ATOMIC_TEMP301]], align 8, !dbg [[DBG151]]
...
// PPC64-NEXT:    [[DIV306:%.*]] = fdiv ppc_fp128 [[CONV305]], [[TMP183]], !dbg [[DBG153:![0-9]+]]
// PPC64-NEXT:    [[CONV307:%.*]] = fptosi ppc_fp128 [[DIV306]] to i64, !dbg [[DBG152]]
// PPC64-NEXT:    [[BF_LOAD308:%.*]] = load i64, ptr [[ATOMIC_TEMP300]], align 8, !dbg [[DBG151]]
...
// PPC64-NEXT:    store i64 [[BF_SET312]], ptr [[ATOMIC_TEMP300]], align 8, !dbg [[DBG151]]
// PPC64-NEXT:    [[TMP185:%.*]] = load i64, ptr [[ATOMIC_TEMP300]], align 8, !dbg [[DBG151]]
...
// PPC64-NEXT:    br i1 [[TMP188]], label [[ATOMIC_EXIT313:%.*]], label [[ATOMIC_CONT299]], !dbg [[DBG151]]
// PPC64:       atomic_exit313:
// PPC64-NEXT:    [[CONV314:%.*]] = trunc i64 [[CONV307]] to i32, !dbg [[DBG151]]
// PPC64-NEXT:    store i32 [[CONV314]], ptr @iv, align 4, !dbg [[DBG151]]
// PPC64-NEXT:    [[TMP189:%.*]] = load ppc_fp128, ptr @ldv, align 16, !dbg [[DBG154:![0-9]+]]
// PPC64-NEXT:    [[ATOMIC_LOAD315:%.*]] = load atomic i8, ptr @bfx4_packed acquire, align 1, !dbg [[DBG155:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT316:%.*]], !dbg [[DBG155]]
// PPC64:       atomic_cont316:
// PPC64-NEXT:    [[TMP190:%.*]] = phi i8 [ [[ATOMIC_LOAD315]], [[ATOMIC_EXIT313]] ], [ [[TMP194:%.*]], [[ATOMIC_CONT316]] ], !dbg [[DBG155]]
// PPC64-NEXT:    store i8 [[TMP190]], ptr [[ATOMIC_TEMP317]], align 1, !dbg [[DBG155]]
// PPC64-NEXT:    store i8 [[TMP190]], ptr [[ATOMIC_TEMP318]], align 1, !dbg [[DBG155]]
// PPC64-NEXT:    [[BF_LOAD319:%.*]] = load i8, ptr [[ATOMIC_TEMP318]], align 1, !dbg [[DBG155]]
...
// PPC64-NEXT:    [[ADD324:%.*]] = fadd ppc_fp128 [[CONV323]], [[TMP189]], !dbg [[DBG157:![0-9]+]]
// PPC64-NEXT:    [[CONV325:%.*]] = fptosi ppc_fp128 [[ADD324]] to i64, !dbg [[DBG156]]
// PPC64-NEXT:    [[TMP191:%.*]] = trunc i64 [[CONV325]] to i8, !dbg [[DBG155]]
// PPC64-NEXT:    [[BF_LOAD326:%.*]] = load i8, ptr [[ATOMIC_TEMP317]], align 1, !dbg [[DBG155]]
// PPC64-NEXT:    [[BF_VALUE327:%.*]] = and i8 [[TMP191]], 127, !dbg [[DBG155]]
// PPC64-NEXT:    [[BF_CLEAR328:%.*]] = and i8 [[BF_LOAD326]], -128, !dbg [[DBG155]]
// PPC64-NEXT:    [[BF_SET329:%.*]] = or i8 [[BF_CLEAR328]], [[BF_VALUE327]], !dbg [[DBG155]]
// PPC64-NEXT:    store i8 [[BF_SET329]], ptr [[ATOMIC_TEMP317]], align 1, !dbg [[DBG155]]
// PPC64-NEXT:    [[TMP192:%.*]] = load i8, ptr [[ATOMIC_TEMP317]], align 1, !dbg [[DBG155]]
// PPC64-NEXT:    [[TMP193:%.*]] = cmpxchg ptr @bfx4_packed, i8 [[TMP190]], i8 [[TMP192]] acquire acquire, align 1, !dbg [[DBG155]]
// PPC64-NEXT:    [[TMP194]] = extractvalue { i8, i1 } [[TMP193]], 0, !dbg [[DBG155]]
// PPC64-NEXT:    [[TMP195:%.*]] = extractvalue { i8, i1 } [[TMP193]], 1, !dbg [[DBG155]]
// PPC64-NEXT:    br i1 [[TMP195]], label [[ATOMIC_EXIT330:%.*]], label [[ATOMIC_CONT316]], !dbg [[DBG155]]
// PPC64:       atomic_exit330:
// PPC64-NEXT:    [[CONV331:%.*]] = trunc i64 [[CONV325]] to i32, !dbg [[DBG155]]
// PPC64-NEXT:    store i32 [[CONV331]], ptr @iv, align 4, !dbg [[DBG155]]
// PPC64-NEXT:    [[TMP196:%.*]] = load i64, ptr @ulv, align 8, !dbg [[DBG158:![0-9]+]]
// PPC64-NEXT:    [[CONV332:%.*]] = uitofp i64 [[TMP196]] to float, !dbg [[DBG158]]
// PPC64-NEXT:    [[ATOMIC_LOAD333:%.*]] = load atomic i64, ptr @float2x acquire, align 8, !dbg [[DBG159:![0-9]+]]
// PPC64-NEXT:    br label [[ATOMIC_CONT334:%.*]], !dbg [[DBG159]]
// PPC64:       atomic_cont334:
// PPC64-NEXT:    [[TMP197:%.*]] = phi i64 [ [[ATOMIC_LOAD333]], [[ATOMIC_EXIT330]] ], [ [[TMP205:%.*]], [[ATOMIC_CONT334]] ], !dbg [[DBG159]]
// PPC64-NEXT:    store i64 [[TMP197]], ptr [[ATOMIC_TEMP335]], align 8, !dbg [[DBG159]]
// PPC64-NEXT:    [[TMP198:%.*]] = bitcast i64 [[TMP197]] to <2 x float>, !dbg [[DBG159]]
// PPC64-NEXT:    store <2 x float> [[TMP198]], ptr [[ATOMIC_TEMP336]], align 8, !dbg [[DBG159]]
// PPC64-NEXT:    [[TMP199:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP336]], align 8, !dbg [[DBG159]]
// PPC64-NEXT:    [[TMP200:%.*]] = extractelement <2 x float> [[TMP199]], i64 0, !dbg [[DBG159]]
// PPC64-NEXT:    [[SUB337:%.*]] = fsub float [[CONV332]], [[TMP200]], !dbg [[DBG160:![0-9]+]]
// PPC64-NEXT:    [[TMP201:%.*]] = load <2 x float>, ptr [[ATOMIC_TEMP335]], align 8, !dbg [[DBG159]]
// PPC64-NEXT:    [[TMP202:%.*]] = insertelement <2 x float> [[TMP201]], float [[SUB337]], i64 0, !dbg [[DBG159]]
// PPC64-NEXT:    store <2 x float> [[TMP202]], ptr [[ATOMIC_TEMP335]], align 8, !dbg [[DBG159]]
// PPC64-NEXT:    [[TMP203:%.*]] = load i64, ptr [[ATOMIC_TEMP335]], align 8, !dbg [[DBG159]]
...
// PPC64-NEXT:    br i1 [[TMP206]], label [[ATOMIC_EXIT338:%.*]], label [[ATOMIC_CONT334]], !dbg [[DBG159]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD274:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) monotonic, align 1, !dbg [[DBG146:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP189:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP186]], i8 [[TMP188]] monotonic monotonic, align 1, !dbg [[DBG146]]
...
// AARCH64-NEXT:    [[ATOMIC_LOAD307:%.*]] = load atomic i8, ptr getelementptr (i8, ptr @bfx4_packed, i64 2) acquire, align 1, !dbg [[DBG154:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP202:%.*]] = cmpxchg ptr getelementptr (i8, ptr @bfx4_packed, i64 2), i8 [[TMP199]], i8 [[TMP201]] acquire acquire, align 1, !dbg [[DBG154]]
