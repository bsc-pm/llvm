...
// LIN64-NEXT:    [[TMP7:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], [7 x i32] undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 7, i64 [[TMP3]], i64 7), "QUAL.OSS.FIRSTPRIVATE"(ptr [[I]], i32 undef), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 7, i64 [[TMP3]], i64 7), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [14 x i8] c"array[i][i+1]\00", ptr @compute_dep, ptr [[VLA]], ptr [[I]], i64 [[TMP1]], i64 7, i64 [[TMP3]]), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [7 x i8] c"*array\00", ptr @compute_dep.1, ptr [[VLA]], i64 [[TMP1]], i64 7, i64 [[TMP3]]) ], !dbg [[DBG13:![0-9]+]]
...
// PPC64-NEXT:    [[TMP7:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], [7 x i32] undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 7, i64 [[TMP3]], i64 7), "QUAL.OSS.FIRSTPRIVATE"(ptr [[I]], i32 undef), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 7, i64 [[TMP3]], i64 7), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [14 x i8] c"array[i][i+1]\00", ptr @compute_dep, ptr [[VLA]], ptr [[I]], i64 [[TMP1]], i64 7, i64 [[TMP3]]), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [7 x i8] c"*array\00", ptr @compute_dep.1, ptr [[VLA]], i64 [[TMP1]], i64 7, i64 [[TMP3]]) ], !dbg [[DBG13:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP2:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG15:![0-9]+]]
// AARCH64-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP2]], 1, !dbg [[DBG16:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = zext i32 [[ADD]] to i64, !dbg [[DBG14]]
// AARCH64-NEXT:    [[TMP4:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG14]]
// AARCH64-NEXT:    store ptr [[TMP4]], ptr [[SAVED_STACK]], align 8, !dbg [[DBG14]]
// AARCH64-NEXT:    [[TMP5:%.*]] = mul nuw i64 [[TMP1]], 7, !dbg [[DBG14]]
// AARCH64-NEXT:    [[TMP6:%.*]] = mul nuw i64 [[TMP5]], [[TMP3]], !dbg [[DBG14]]
// AARCH64-NEXT:    [[VLA:%.*]] = alloca [7 x i32], i64 [[TMP6]], align 4, !dbg [[DBG14]]
// AARCH64-NEXT:    store i64 [[TMP1]], ptr [[__VLA_EXPR0]], align 8, !dbg [[DBG14]]
// AARCH64-NEXT:    store i64 [[TMP3]], ptr [[__VLA_EXPR1]], align 8, !dbg [[DBG14]]
// AARCH64-NEXT:    [[TMP7:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr [[VLA]], [7 x i32] undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 7, i64 [[TMP3]], i64 7), "QUAL.OSS.FIRSTPRIVATE"(ptr [[I]], i32 undef), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 7, i64 [[TMP3]], i64 7), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [14 x i8] c"array[i][i+1]\00", ptr @compute_dep, ptr [[VLA]], ptr [[I]], i64 [[TMP1]], i64 7, i64 [[TMP3]]), "QUAL.OSS.DEP.IN"(ptr [[VLA]], [7 x i8] c"*array\00", ptr @compute_dep.1, ptr [[VLA]], i64 [[TMP1]], i64 7, i64 [[TMP3]]) ], !dbg [[DBG17:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP7]]), !dbg [[DBG18:![0-9]+]]
// AARCH64-NEXT:    [[TMP8:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG19:![0-9]+]]
// AARCH64-NEXT:    [[ADD1:%.*]] = add nsw i32 [[TMP8]], 1, !dbg [[DBG20:![0-9]+]]
// AARCH64-NEXT:    [[TMP9:%.*]] = zext i32 [[ADD1]] to i64, !dbg [[DBG21:![0-9]+]]
// AARCH64-NEXT:    [[TMP10:%.*]] = load i32, ptr [[N_ADDR]], align 4, !dbg [[DBG22:![0-9]+]]
// AARCH64-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP10]], 1, !dbg [[DBG23:![0-9]+]]
// AARCH64-NEXT:    [[TMP11:%.*]] = zext i32 [[ADD2]] to i64, !dbg [[DBG21]]
// AARCH64-NEXT:    [[TMP12:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[P_ARRAY]], ptr undef), "QUAL.OSS.CAPTURED"(i64 [[TMP9]], i64 7, i64 [[TMP11]], i64 7), "QUAL.OSS.DEP.IN"(ptr [[P_ARRAY]], [11 x i8] c"p_array[0]\00", ptr @compute_dep.2, ptr [[P_ARRAY]], i64 [[TMP9]], i64 7, i64 [[TMP11]]) ], !dbg [[DBG24:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP12]]), !dbg [[DBG25:![0-9]+]]
// AARCH64-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !dbg [[DBG26:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.stackrestore(ptr [[TMP13]]), !dbg [[DBG26]]
...
// AARCH64-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @p, i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[X_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[Y]], i32 undef) ], !dbg [[DBG40:![0-9]+]]
// AARCH64-NEXT:    [[SAVED_STACK:%.*]] = alloca ptr, align 8
// AARCH64-NEXT:    [[__VLA_EXPR0:%.*]] = alloca i64, align 8
// AARCH64-NEXT:    [[__VLA_EXPR1:%.*]] = alloca i64, align 8
// AARCH64-NEXT:    [[__VLA_EXPR2:%.*]] = alloca i64, align 8
// AARCH64-NEXT:    [[TMP1:%.*]] = load i32, ptr [[X_ADDR]], align 4, !dbg [[DBG41:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = zext i32 [[TMP1]] to i64, !dbg [[DBG42:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = load i32, ptr [[Y]], align 4, !dbg [[DBG43:![0-9]+]]
// AARCH64-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64, !dbg [[DBG42]]
// AARCH64-NEXT:    [[TMP5:%.*]] = load i32, ptr @p, align 4, !dbg [[DBG44:![0-9]+]]
// AARCH64-NEXT:    [[TMP6:%.*]] = zext i32 [[TMP5]] to i64, !dbg [[DBG42]]
// AARCH64-NEXT:    [[TMP7:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG42]]
// AARCH64-NEXT:    store ptr [[TMP7]], ptr [[SAVED_STACK]], align 8, !dbg [[DBG42]]
// AARCH64-NEXT:    [[TMP8:%.*]] = mul nuw i64 [[TMP2]], 7, !dbg [[DBG42]]
// AARCH64-NEXT:    [[TMP9:%.*]] = mul nuw i64 [[TMP8]], [[TMP4]], !dbg [[DBG42]]
// AARCH64-NEXT:    [[TMP10:%.*]] = mul nuw i64 [[TMP9]], [[TMP6]], !dbg [[DBG42]]
// AARCH64-NEXT:    [[VLA:%.*]] = alloca i32, i64 [[TMP10]], align 4, !dbg [[DBG42]]
// AARCH64-NEXT:    store i64 [[TMP2]], ptr [[__VLA_EXPR0]], align 8, !dbg [[DBG42]]
// AARCH64-NEXT:    store i64 [[TMP4]], ptr [[__VLA_EXPR1]], align 8, !dbg [[DBG42]]
// AARCH64-NEXT:    store i64 [[TMP6]], ptr [[__VLA_EXPR2]], align 8, !dbg [[DBG42]]
// AARCH64-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !dbg [[DBG45:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.stackrestore(ptr [[TMP11]]), !dbg [[DBG45]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]), !dbg [[DBG45]]
// AARCH64-NEXT:    [[TMP12:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.SHARED"(ptr @p, i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[X_ADDR]], i32 undef), "QUAL.OSS.FIRSTPRIVATE"(ptr [[Y]], i32 undef) ], !dbg [[DBG46:![0-9]+]]
// AARCH64-NEXT:    [[Z:%.*]] = alloca i32, align 4
// AARCH64-NEXT:    [[TMP13:%.*]] = load i32, ptr [[X_ADDR]], align 4, !dbg [[DBG47:![0-9]+]]
// AARCH64-NEXT:    [[TMP14:%.*]] = load i32, ptr [[Y]], align 4, !dbg [[DBG48:![0-9]+]]
// AARCH64-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP13]], [[TMP14]], !dbg [[DBG49:![0-9]+]]
// AARCH64-NEXT:    [[TMP15:%.*]] = load i32, ptr @p, align 4, !dbg [[DBG50:![0-9]+]]
// AARCH64-NEXT:    [[ADD1:%.*]] = add nsw i32 [[ADD]], [[TMP15]], !dbg [[DBG51:![0-9]+]]
// AARCH64-NEXT:    store i32 [[ADD1]], ptr [[Z]], align 4, !dbg [[DBG52:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP12]]), !dbg [[DBG53:![0-9]+]]
...
// AARCH64-NEXT:    [[__VLA_EXPR1:%.*]] = alloca i64, align 8
// AARCH64-NEXT:    store i32 [[X:%.*]], ptr [[X_ADDR]], align 4
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[X_ADDR]], align 4, !dbg [[DBG56:![0-9]+]]
// AARCH64-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], 1, !dbg [[DBG57:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = zext i32 [[ADD]] to i64, !dbg [[DBG58:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = load i32, ptr [[Y]], align 4, !dbg [[DBG59:![0-9]+]]
// AARCH64-NEXT:    [[ADD1:%.*]] = add nsw i32 [[TMP2]], 1, !dbg [[DBG60:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = zext i32 [[ADD1]] to i64, !dbg [[DBG58]]
// AARCH64-NEXT:    [[TMP4:%.*]] = call ptr @llvm.stacksave(), !dbg [[DBG58]]
// AARCH64-NEXT:    store ptr [[TMP4]], ptr [[SAVED_STACK]], align 8, !dbg [[DBG58]]
// AARCH64-NEXT:    [[TMP5:%.*]] = mul nuw i64 [[TMP1]], [[TMP3]], !dbg [[DBG58]]
// AARCH64-NEXT:    [[VLA:%.*]] = alloca i32, i64 [[TMP5]], align 4, !dbg [[DBG58]]
// AARCH64-NEXT:    store i64 [[TMP1]], ptr [[__VLA_EXPR0]], align 8, !dbg [[DBG58]]
// AARCH64-NEXT:    store i64 [[TMP3]], ptr [[__VLA_EXPR1]], align 8, !dbg [[DBG58]]
// AARCH64-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[VLA]], i32 undef), "QUAL.OSS.VLA.DIMS"(ptr [[VLA]], i64 [[TMP1]], i64 [[TMP3]]), "QUAL.OSS.CAPTURED"(i64 [[TMP1]], i64 [[TMP3]]) ], !dbg [[DBG61:![0-9]+]]
// AARCH64-NEXT:    [[TMP7:%.*]] = mul nsw i64 0, [[TMP3]], !dbg [[DBG62:![0-9]+]]
// AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 [[TMP7]], !dbg [[DBG62]]
// AARCH64-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds i32, ptr [[ARRAYIDX]], i64 0, !dbg [[DBG62]]
// AARCH64-NEXT:    store i32 1, ptr [[ARRAYIDX2]], align 4, !dbg [[DBG63:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP6]]), !dbg [[DBG64:![0-9]+]]
// AARCH64-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !dbg [[DBG65:![0-9]+]]
// AARCH64-NEXT:    call void @llvm.stackrestore(ptr [[TMP8]]), !dbg [[DBG65]]
