...
// LIN64-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], [[STRUCT_HALF]] undef), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_function5.cpp:9:1\00") ], !dbg [[DBG10:![0-9]+]]
...
// PPC64-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], [[STRUCT_HALF]] undef), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_function5.cpp:9:1\00") ], !dbg [[DBG10:![0-9]+]]
...
// AARCH64-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], [[STRUCT_HALF]] undef), "QUAL.OSS.DECL.SOURCE"([23 x i8] c"task_function5.cpp:9:1\00") ], !dbg [[DBG10:![0-9]+]]
