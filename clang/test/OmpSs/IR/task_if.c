...
// LIN64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.IF"(i1 [[TOBOOL1]]), "QUAL.OSS.DEVICE.DEVFUNC"([4 x i8] c"bar\00"), "QUAL.OSS.DECL.SOURCE"([14 x i8] c"task_if.c:7:1\00") ], !dbg [[DBG16]]
...
// PPC64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.IF"(i1 [[TOBOOL1]]), "QUAL.OSS.DEVICE.DEVFUNC"([4 x i8] c"bar\00"), "QUAL.OSS.DECL.SOURCE"([14 x i8] c"task_if.c:7:1\00") ], !dbg [[DBG16]]
...
// AARCH64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.IF"(i1 [[TOBOOL1]]), "QUAL.OSS.DEVICE.DEVFUNC"([4 x i8] c"bar\00"), "QUAL.OSS.DECL.SOURCE"([14 x i8] c"task_if.c:7:1\00") ], !dbg [[DBG16]]
