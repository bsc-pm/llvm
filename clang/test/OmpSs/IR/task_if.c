...
// LIN64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.IF"(i1 [[TOBOOL1]]), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"bar:7:9\00") ], !dbg [[DBG16]]
...
// PPC64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.IF"(i1 [[TOBOOL1]]), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"bar:7:9\00") ], !dbg [[DBG16]]
...
// AARCH64-NEXT:    [[TMP0:%.*]] = load i32, ptr [[A]], align 4, !dbg [[DBG15:![0-9]+]]
// AARCH64-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP0]], 0, !dbg [[DBG16:![0-9]+]]
// AARCH64-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.IF"(i1 [[TOBOOL]]) ], !dbg [[DBG16]]
// AARCH64-NEXT:    call void @llvm.directive.region.exit(token [[TMP1]]), !dbg [[DBG17:![0-9]+]]
// AARCH64-NEXT:    store i32 3, ptr [[CALL_ARG]], align 4, !dbg [[DBG18:![0-9]+]]
// AARCH64-NEXT:    [[TMP2:%.*]] = load i32, ptr [[CALL_ARG]], align 4, !dbg [[DBG19:![0-9]+]]
// AARCH64-NEXT:    [[TOBOOL1:%.*]] = icmp ne i32 [[TMP2]], 0, !dbg [[DBG20:![0-9]+]]
// AARCH64-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OSS"([5 x i8] c"TASK\00"), "QUAL.OSS.FIRSTPRIVATE"(ptr [[CALL_ARG]], i32 undef), "QUAL.OSS.IF"(i1 [[TOBOOL1]]), "QUAL.OSS.DECL.SOURCE"([8 x i8] c"bar:7:9\00") ], !dbg [[DBG20]]
// AARCH64-NEXT:    [[TMP4:%.*]] = load i32, ptr [[CALL_ARG]], align 4, !dbg [[DBG18]]
// AARCH64-NEXT:    call void @bar(i32 noundef [[TMP4]]), !dbg [[DBG20]]
