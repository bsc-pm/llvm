// RUN: %clang_cc1 -fompss-2 -fompss-fpga-hls-tasks-dir /tmp -fompss-fpga -fompss-fpga-wrapper-code -fompss-fpga-dump -ferror-limit 100 %s | FileCheck %s
...
// CHECK:static ap_uint<64> __mcxx_taskId;
// CHECK-EMPTY:
...
// CHECK-NEXT:};
// CHECK-EMPTY:
// CHECK-NEXT:struct mcxx_outaxis {
// CHECK-NEXT:  ap_uint<64> data;
// CHECK-NEXT:  ap_uint<2> dest;
// CHECK-NEXT:  ap_uint<1> last;
// CHECK-NEXT:};
// CHECK-NEXT:void depend_moved();
// CHECK-NEXT:void depend_moved() {
// CHECK-NEXT:}
// CHECK-NEXT:void foo_moved() {
