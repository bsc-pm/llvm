...
void test_i8_atomics(_Atomic(int8_t) * a, int8_t b) {
  // RV32I: load atomic i8, i8* %a seq_cst, align 1
  // RV32I: store atomic i8 %b, i8* %a seq_cst, align 1
  // RV32I: atomicrmw add i8* %a, i8 %b seq_cst
  // RV64I: load atomic i8, i8* %a seq_cst, align 1
  // RV64I: store atomic i8 %b, i8* %a seq_cst, align 1
  // RV64I: atomicrmw add i8* %a, i8 %b seq_cst
...
void test_i32_atomics(_Atomic(int32_t) * a, int32_t b) {
  // RV32I: load atomic i32, i32* %a seq_cst, align 4
  // RV32I: store atomic i32 %b, i32* %a seq_cst, align 4
  // RV32I: atomicrmw add i32* %a, i32 %b seq_cst
  ...
  // RV64I: load atomic i32, i32* %a seq_cst, align 4
  // RV64I: store atomic i32 %b, i32* %a seq_cst, align 4
  // RV64I: atomicrmw add i32* %a, i32 %b seq_cst
...
void test_i64_atomics(_Atomic(int64_t) * a, int64_t b) {
  ...
  // RV64I: load atomic i64, i64* %a seq_cst, align 8
  // RV64I: store atomic i64 %b, i64* %a seq_cst, align 8
  // RV64I: atomicrmw add i64* %a, i64 %b seq_cst
